...
bool TypeChecker_types_compatible(TypeChecker* self, const char* target, const char* source)
{
    ...
    if ((strcmp(t, "Allocator") == 0LL) && ((strcmp(s, "KaiAllocator") == 0LL) || (strcmp(s, "CAlloc") == 0LL)))
    {
        return true;
    }
    if (strcmp(t, s) == 0LL)
...
const char* Codegen_map_type(Codegen* self, const char* type_name)
{
    ...
    if (strcmp(resolved_type, "Allocator") == 0LL)
    {
        return "KaiAllocator";
    }
