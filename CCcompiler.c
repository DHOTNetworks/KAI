...
struct TokenValue {
    uint8_t tag;
    union {
        struct { int64_t v; } tv_int;
        struct { double v; } tv_float;
        struct { bool v; } tv_bool;
        struct { char v; } tv_char;
        struct { const char* v; } tv_str;
    };
};
struct Token {
    TokenType tok_type;
...
int main(int argc, char** argv)
{
    ...
    }
    {
        ...
        if (strcmp(first_arg, "fix") == 0LL)
        {
            ...
            while (i2 < argc)
            {
                ...
                if (strcmp(a, "--patch") == 0LL)
                {
                    fix_mode = "patch";
                }
                else
                if (strcmp(a, "--apply") == 0LL)
                {
                    fix_mode = "apply";
                }
                else
    ...
    while (i < argc)
    {
        ...
        bool matched = true;
        {
            ...
            if (strcmp(arg, "-O0") == 0LL)
            {
                opt_level = "-O0";
            }
            else
            if (strcmp(arg, "-O1") == 0LL)
            {
                opt_level = "-O1";
            }
            else
            if (strcmp(arg, "-O2") == 0LL)
            {
                opt_level = "-O2";
            }
            else
            if (strcmp(arg, "-O3") == 0LL)
            {
                opt_level = "-O3";
            }
            else
            if (strcmp(arg, "-Os") == 0LL)
            {
                opt_level = "-Os";
            }
            else
...
{
    {
        ...
        int64_t before = (aligned_addr - ((int64_t)(((unsigned long long)(raw)))));
        if (before > 0LL)
        {
            _kai_munmap(raw, before);
        }
        int64_t after_start = (aligned_addr + 65536LL);
        int64_t after_len = ((((int64_t)(((unsigned long long)(raw)))) + 131072LL) - after_start);
        if (after_len > 0LL)
        {
...
{
    {
        ...
        int64_t aligned_addr = ((((int64_t)(((unsigned long long)(raw)))) + 65535LL) & (-65536LL));
        uint8_t* slab = ((uint8_t*)(((unsigned long long)(aligned_addr))));
        ((int64_t*)(slab))[0LL] = ((int64_t)(((unsigned long long)(raw))));
    ...
    int64_t objsz = class_obj_size(idx);
    {
        ...
        while (slab != ((uint8_t*)(((unsigned long long)(0LL)))))
        {
            ...
            if (hdr->next_bump_idx < hdr->capacity)
            {
                ...
                uint8_t* ptr = ((uint8_t*)(((unsigned long long)((((int64_t)(((unsigned long long)(slab)))) + off)))));
...
TokenType keyword_type(const char* ident)
{
    ...
    if (strcmp(ident, "var") == 0LL)
    {
        return TokenType_VAR;
    }
    else
    if (strcmp(ident, "fn") == 0LL)
    {
        return TokenType_FUNC;
    }
    else
    if (strcmp(ident, "if") == 0LL)
    {
        return TokenType_IF;
    }
    else
    if (strcmp(ident, "else") == 0LL)
    {
        return TokenType_ELSE;
    }
    else
    if (strcmp(ident, "while") == 0LL)
    {
        return TokenType_WHILE;
    }
    else
    if (strcmp(ident, "for") == 0LL)
    {
        return TokenType_FOR;
    }
    else
    if (strcmp(ident, "in") == 0LL)
    {
        return TokenType_IN;
    }
    else
    if (strcmp(ident, "return") == 0LL)
    {
    ...
    if (strcmp(ident, "false") == 0LL)
    {
        return TokenType_BOOL_LIT;
    }
    else
    if (strcmp(ident, "struct") == 0LL)
    {
        return TokenType_STRUCT;
    }
    else
    if (strcmp(ident, "impl") == 0LL)
    {
        return TokenType_IMPL;
    }
    else
    if (strcmp(ident, "mut") == 0LL)
    {
        return TokenType_MUT;
    }
    else
    if (strcmp(ident, "unsafe") == 0LL)
    {
        return TokenType_UNSAFE;
    }
    else
    if (strcmp(ident, "extern") == 0LL)
    {
        return TokenType_EXTERN;
    }
    else
    if (strcmp(ident, "enum") == 0LL)
    {
        return TokenType_ENUM;
    }
    else
    if (strcmp(ident, "match") == 0LL)
    {
        return TokenType_MATCH;
    }
    else
    if (strcmp(ident, "case") == 0LL)
    {
        return TokenType_CASE;
    }
    else
    if (strcmp(ident, "use") == 0LL)
    {
        return TokenType_USE;
    }
    else
    if (strcmp(ident, "check") == 0LL)
    {
        return TokenType_CHECK;
    }
    else
    if (strcmp(ident, "trait") == 0LL)
    {
        return TokenType_TRAIT;
    }
    else
    if (strcmp(ident, "pub") == 0LL)
    {
        return TokenType_PUB;
    }
    else
    if (strcmp(ident, "import") == 0LL)
    {
        return TokenType_IMPORT;
    }
    else
    if (strcmp(ident, "cimport") == 0LL)
    {
        return TokenType_CIMPORT;
    }
    else
    if (strcmp(ident, "from") == 0LL)
    {
        return TokenType_FROM;
    }
    else
    if (strcmp(ident, "as") == 0LL)
    {
        return TokenType_AS;
    }
    else
    if (strcmp(ident, "sizeof") == 0LL)
    {
        return TokenType_SIZEOF;
    }
    else
    if (strcmp(ident, "defer") == 0LL)
    {
        return TokenType_DEFER;
    }
    else
    if (strcmp(ident, "errdefer") == 0LL)
    {
        return TokenType_ERRDEFER;
    }
    else
    if (strcmp(ident, "none") == 0LL)
    {
        return TokenType_NONE;
    }
    else
    if (strcmp(ident, "try") == 0LL)
    {
        return TokenType_TRY;
    }
    else
    if (strcmp(ident, "catch") == 0LL)
    {
        return TokenType_CATCH;
    }
    else
    if (strcmp(ident, "own") == 0LL)
    {
        return TokenType_OWN;
    }
    else
    if (strcmp(ident, "error") == 0LL)
    {
        return TokenType_ERROR;
    }
    else
    if (strcmp(ident, "asm") == 0LL)
    {
        return TokenType_ASM;
    }
    else
    if (strcmp(ident, "volatile") == 0LL)
    {
        return TokenType_VOLATILE;
    }
    else
    if (strcmp(ident, "break") == 0LL)
    {
        return TokenType_BREAK;
    }
    else
    if (strcmp(ident, "continue") == 0LL)
    {
...
TokenValue make_keyword_value(const char* ident, TokenType ttype)
{
    ...
    return (TokenValue){ .tag = TokenValue_tv_str_TAG, .tv_str = { .v = ident } };
}
Lexer Lexer_init(KaiAllocator* allocator, const char* source, const char* source_file)
{
    Lexer self = (Lexer){0};
...
void Lexer_lex_identifier(Lexer* self)
{
    ...
    {
        Lexer_emit(self, TokenType_IDENTIFIER, (TokenValue){ .tag = TokenValue_tv_str_TAG, .tv_str = { .v = ident } });
    }
    else
    if (ktype == TokenType_BOOL_LIT)
    {
        Lexer_emit(self, TokenType_BOOL_LIT, make_keyword_value(ident, TokenType_BOOL_LIT));
    }
    else
    {
        Lexer_emit(self, ktype, (TokenValue){ .tag = TokenValue_tv_str_TAG, .tv_str = { .v = ident } });
    }
}
void Lexer_lex_number(Lexer* self)
{
    ...
    if ((Lexer_peek(self, 0LL) == '.') && (Lexer_peek(self, 1LL) != '.'))
    {
        ...
        Lexer_emit(self, TokenType_FLOAT_LIT, (TokenValue){ .tag = TokenValue_tv_str_TAG, .tv_str = { .v = num_str } });
    }
    else
    {
        const char* num_str = StringBuilder_to_str(&(sb));
        Lexer_emit(self, TokenType_INT_LIT, (TokenValue){ .tag = TokenValue_tv_str_TAG, .tv_str = { .v = num_str } });
    }
}
void Lexer_lex_string(Lexer* self)
{
    ...
    Lexer_emit(self, TokenType_STRING_LIT, (TokenValue){ .tag = TokenValue_tv_str_TAG, .tv_str = { .v = s } });
}
void Lexer_lex_char(Lexer* self)
{
    (void)(Lexer_advance(self));
...
int64_t Lexer_compute_indent(Lexer* self)
{
    ...
    while ((temp < self->source_len) && (!done))
    {
        ...
        if (((c == '/') && ((temp + 1LL) < self->source_len)) && (self->source[(temp + 1LL)] == '/'))
        {
...
void Lexer_lex(Lexer* self)
{
    ...
    while (self->cursor < self->source_len)
    {
        ...
        if (self->cursor < self->source_len)
        {
            ...
            if ((c == '-') && (Lexer_peek(self, 1LL) == '>'))
            {
                (void)(Lexer_advance(self));
                (void)(Lexer_advance(self));
                Lexer_emit(self, TokenType_ARROW, (TokenValue){ .tag = TokenValue_tv_str_TAG, .tv_str = { .v = "->" } });
            }
            else
            if ((c == '=') && (Lexer_peek(self, 1LL) == '>'))
            {
                (void)(Lexer_advance(self));
                (void)(Lexer_advance(self));
                Lexer_emit(self, TokenType_FAT_ARROW, (TokenValue){ .tag = TokenValue_tv_str_TAG, .tv_str = { .v = "=>" } });
            }
            else
            if ((c == '+') && (Lexer_peek(self, 1LL) == '='))
            {
                (void)(Lexer_advance(self));
                (void)(Lexer_advance(self));
                Lexer_emit(self, TokenType_PLUS_ASSIGN, (TokenValue){ .tag = TokenValue_tv_str_TAG, .tv_str = { .v = "+=" } });
            }
            else
            if ((c == '-') && (Lexer_peek(self, 1LL) == '='))
            {
                (void)(Lexer_advance(self));
                (void)(Lexer_advance(self));
                Lexer_emit(self, TokenType_MINUS_ASSIGN, (TokenValue){ .tag = TokenValue_tv_str_TAG, .tv_str = { .v = "-=" } });
            }
            else
            if ((c == '=') && (Lexer_peek(self, 1LL) == '='))
            {
                (void)(Lexer_advance(self));
                (void)(Lexer_advance(self));
                Lexer_emit(self, TokenType_EQ, (TokenValue){ .tag = TokenValue_tv_str_TAG, .tv_str = { .v = "==" } });
            }
            else
            if ((c == '!') && (Lexer_peek(self, 1LL) == '='))
            {
                (void)(Lexer_advance(self));
                (void)(Lexer_advance(self));
                Lexer_emit(self, TokenType_NE, (TokenValue){ .tag = TokenValue_tv_str_TAG, .tv_str = { .v = "!=" } });
            }
            else
            if ((c == '<') && (Lexer_peek(self, 1LL) == '='))
            {
                (void)(Lexer_advance(self));
                (void)(Lexer_advance(self));
                Lexer_emit(self, TokenType_LE, (TokenValue){ .tag = TokenValue_tv_str_TAG, .tv_str = { .v = "<=" } });
            }
            else
            if ((c == '>') && (Lexer_peek(self, 1LL) == '='))
            {
                (void)(Lexer_advance(self));
                (void)(Lexer_advance(self));
                Lexer_emit(self, TokenType_GE, (TokenValue){ .tag = TokenValue_tv_str_TAG, .tv_str = { .v = ">=" } });
            }
            else
            if ((c == '&') && (Lexer_peek(self, 1LL) == '&'))
            {
                (void)(Lexer_advance(self));
                (void)(Lexer_advance(self));
                Lexer_emit(self, TokenType_AND, (TokenValue){ .tag = TokenValue_tv_str_TAG, .tv_str = { .v = "&&" } });
            }
            else
            if ((c == '|') && (Lexer_peek(self, 1LL) == '|'))
            {
                (void)(Lexer_advance(self));
                (void)(Lexer_advance(self));
                Lexer_emit(self, TokenType_OR, (TokenValue){ .tag = TokenValue_tv_str_TAG, .tv_str = { .v = "||" } });
            }
            else
            if ((c == '<') && (Lexer_peek(self, 1LL) == '<'))
            {
                (void)(Lexer_advance(self));
                (void)(Lexer_advance(self));
                Lexer_emit(self, TokenType_LSHIFT, (TokenValue){ .tag = TokenValue_tv_str_TAG, .tv_str = { .v = "<<" } });
            }
            else
            if ((c == '>') && (Lexer_peek(self, 1LL) == '>'))
            {
                (void)(Lexer_advance(self));
                (void)(Lexer_advance(self));
                Lexer_emit(self, TokenType_RSHIFT, (TokenValue){ .tag = TokenValue_tv_str_TAG, .tv_str = { .v = ">>" } });
            }
            else
            if (((c == '.') && (Lexer_peek(self, 1LL) == '.')) && (Lexer_peek(self, 2LL) == '='))
            {
                (void)(Lexer_advance(self));
                (void)(Lexer_advance(self));
                (void)(Lexer_advance(self));
                Lexer_emit(self, TokenType_DOTDOTEQ, (TokenValue){ .tag = TokenValue_tv_str_TAG, .tv_str = { .v = "..=" } });
            }
            else
            if ((c == '.') && (Lexer_peek(self, 1LL) == '.'))
            {
                (void)(Lexer_advance(self));
                (void)(Lexer_advance(self));
                Lexer_emit(self, TokenType_DOTDOT, (TokenValue){ .tag = TokenValue_tv_str_TAG, .tv_str = { .v = ".." } });
            }
            else
            if (c == '+')
            {
                (void)(Lexer_advance(self));
                Lexer_emit(self, TokenType_PLUS, (TokenValue){ .tag = TokenValue_tv_str_TAG, .tv_str = { .v = "+" } });
            }
            else
            if (c == '-')
            {
                (void)(Lexer_advance(self));
                Lexer_emit(self, TokenType_MINUS, (TokenValue){ .tag = TokenValue_tv_str_TAG, .tv_str = { .v = "-" } });
            }
            else
            if (c == '*')
            {
                (void)(Lexer_advance(self));
                Lexer_emit(self, TokenType_MUL, (TokenValue){ .tag = TokenValue_tv_str_TAG, .tv_str = { .v = "*" } });
            }
            else
            if (c == '/')
            {
                (void)(Lexer_advance(self));
                Lexer_emit(self, TokenType_DIV, (TokenValue){ .tag = TokenValue_tv_str_TAG, .tv_str = { .v = "/" } });
            }
            else
            if (c == '%')
            {
                (void)(Lexer_advance(self));
                Lexer_emit(self, TokenType_MOD, (TokenValue){ .tag = TokenValue_tv_str_TAG, .tv_str = { .v = "%" } });
            }
            else
            if (c == '=')
            {
                (void)(Lexer_advance(self));
                Lexer_emit(self, TokenType_ASSIGN, (TokenValue){ .tag = TokenValue_tv_str_TAG, .tv_str = { .v = "=" } });
            }
            else
            if (c == '<')
            {
                (void)(Lexer_advance(self));
                Lexer_emit(self, TokenType_LT, (TokenValue){ .tag = TokenValue_tv_str_TAG, .tv_str = { .v = "<" } });
            }
            else
            if (c == '>')
            {
                (void)(Lexer_advance(self));
                Lexer_emit(self, TokenType_GT, (TokenValue){ .tag = TokenValue_tv_str_TAG, .tv_str = { .v = ">" } });
            }
            else
            if (c == ':')
            {
                (void)(Lexer_advance(self));
                Lexer_emit(self, TokenType_COLON, (TokenValue){ .tag = TokenValue_tv_str_TAG, .tv_str = { .v = ":" } });
            }
            else
            if (c == ';')
            {
                (void)(Lexer_advance(self));
                Lexer_emit(self, TokenType_SEMICOLON, (TokenValue){ .tag = TokenValue_tv_str_TAG, .tv_str = { .v = ";" } });
            }
            else
            if (c == ',')
            {
                (void)(Lexer_advance(self));
                Lexer_emit(self, TokenType_COMMA, (TokenValue){ .tag = TokenValue_tv_str_TAG, .tv_str = { .v = "," } });
            }
            else
            if (c == '(')
            {
                ...
                Lexer_emit(self, TokenType_LPAREN, (TokenValue){ .tag = TokenValue_tv_str_TAG, .tv_str = { .v = "(" } });
            }
            else
            if (c == ')')
            {
                ...
                Lexer_emit(self, TokenType_RPAREN, (TokenValue){ .tag = TokenValue_tv_str_TAG, .tv_str = { .v = ")" } });
            }
            else
            if (c == '[')
            {
                (void)(Lexer_advance(self));
                self->paren_depth = (self->paren_depth + 1LL);
                Lexer_emit(self, TokenType_LBRACKET, (TokenValue){ .tag = TokenValue_tv_str_TAG, .tv_str = { .v = "[" } });
            }
            else
            if (c == ']')
            {
                ...
                Lexer_emit(self, TokenType_RBRACKET, (TokenValue){ .tag = TokenValue_tv_str_TAG, .tv_str = { .v = "]" } });
            }
            else
            if (c == '{')
            {
                ...
                Lexer_emit(self, TokenType_LBRACE, (TokenValue){ .tag = TokenValue_tv_str_TAG, .tv_str = { .v = "{" } });
            }
            else
            if (c == '}')
            {
                ...
                Lexer_emit(self, TokenType_RBRACE, (TokenValue){ .tag = TokenValue_tv_str_TAG, .tv_str = { .v = "}" } });
            }
            else
            if (c == '&')
            {
                (void)(Lexer_advance(self));
                Lexer_emit(self, TokenType_AMP, (TokenValue){ .tag = TokenValue_tv_str_TAG, .tv_str = { .v = "&" } });
            }
            else
            if (c == '#')
            {
                (void)(Lexer_advance(self));
                Lexer_emit(self, TokenType_HASH, (TokenValue){ .tag = TokenValue_tv_str_TAG, .tv_str = { .v = "#" } });
            }
            else
            if (c == '!')
            {
                (void)(Lexer_advance(self));
                Lexer_emit(self, TokenType_NOT, (TokenValue){ .tag = TokenValue_tv_str_TAG, .tv_str = { .v = "!" } });
            }
            else
            if (c == '?')
            {
                (void)(Lexer_advance(self));
                Lexer_emit(self, TokenType_QUESTION, (TokenValue){ .tag = TokenValue_tv_str_TAG, .tv_str = { .v = "?" } });
            }
            else
            if (c == '^')
            {
                (void)(Lexer_advance(self));
                Lexer_emit(self, TokenType_BITXOR, (TokenValue){ .tag = TokenValue_tv_str_TAG, .tv_str = { .v = "^" } });
            }
            else
            if (c == '~')
            {
                (void)(Lexer_advance(self));
                Lexer_emit(self, TokenType_BITNOT, (TokenValue){ .tag = TokenValue_tv_str_TAG, .tv_str = { .v = "~" } });
            }
            else
            if (c == '|')
            {
                (void)(Lexer_advance(self));
                Lexer_emit(self, TokenType_PIPE, (TokenValue){ .tag = TokenValue_tv_str_TAG, .tv_str = { .v = "|" } });
            }
            else
            if (c == '.')
            {
                (void)(Lexer_advance(self));
                Lexer_emit(self, TokenType_DOT, (TokenValue){ .tag = TokenValue_tv_str_TAG, .tv_str = { .v = "." } });
            }
            else
            {
                (void)(Lexer_advance(self));
...
int64_t token_precedence(TokenType ttype)
{
    ...
    if (ttype == TokenType_LBRACKET)
    {
        return 9LL;
    }
    else
    if (ttype == TokenType_AS)
    {
        return 8LL;
    }
    else
    if (((ttype == TokenType_MUL) || (ttype == TokenType_DIV)) || (ttype == TokenType_MOD))
    {
        return 7LL;
    }
    else
    if ((ttype == TokenType_PLUS) || (ttype == TokenType_MINUS))
    {
        return 6LL;
    }
    else
    if ((ttype == TokenType_LSHIFT) || (ttype == TokenType_RSHIFT))
    {
        return 5LL;
    }
    else
    if ((((((ttype == TokenType_EQ) || (ttype == TokenType_NE)) || (ttype == TokenType_LT)) || (ttype == TokenType_LE)) || (ttype == TokenType_GT)) || (ttype == TokenType_GE))
    {
        return 4LL;
    }
    else
    if (ttype == TokenType_AMP)
    {
        return 5LL;
    }
    else
    if (ttype == TokenType_BITXOR)
    {
        return 4LL;
    }
    else
    if (ttype == TokenType_PIPE)
    {
        return 3LL;
    }
    else
    if (ttype == TokenType_CATCH)
    {
        return 2LL;
    }
    else
    if (ttype == TokenType_AND)
    {
        return 2LL;
    }
    else
    if (ttype == TokenType_OR)
    {
        return 1LL;
    }
    else
    if ((ttype == TokenType_DOTDOT) || (ttype == TokenType_DOTDOTEQ))
    {
        return 4LL;
    }
    return 0LL;
...
const char* token_op_str(TokenType ttype)
{
    ...
    if (ttype == TokenType_MINUS)
    {
        return "-";
    }
    else
    if (ttype == TokenType_MUL)
    {
        return "*";
    }
    else
    if (ttype == TokenType_DIV)
    {
        return "/";
    }
    else
    if (ttype == TokenType_MOD)
    {
        return "%";
    }
    else
    if (ttype == TokenType_ASSIGN)
    {
        return "=";
    }
    else
    if (ttype == TokenType_PLUS_ASSIGN)
    {
        return "+=";
    }
    else
    if (ttype == TokenType_MINUS_ASSIGN)
    {
        return "-=";
    }
    else
    if (ttype == TokenType_EQ)
    {
        return "==";
    }
    else
    if (ttype == TokenType_NE)
    {
        return "!=";
    }
    else
    if (ttype == TokenType_LT)
    {
        return "<";
    }
    else
    if (ttype == TokenType_LE)
    {
        return "<=";
    }
    else
    ...
    if (ttype == TokenType_LSHIFT)
    {
        return "<<";
    }
    else
    if (ttype == TokenType_RSHIFT)
    {
        return ">>";
    }
    else
    if (ttype == TokenType_DOTDOT)
    {
        return "..";
    }
    else
    if (ttype == TokenType_DOTDOTEQ)
    {
        return "..=";
    }
    else
...
}Token Parser_peek(Parser* self, int64_t offset)
{
    ...
    {
        return (Token){ .tok_type = TokenType_GT, .value = (TokenValue){ .tag = TokenValue_tv_str_TAG, .tv_str = { .v = ">" } }, .line = self->pending_gt_line, .column = self->pending_gt_col };
    }
    int64_t pos = (self->cursor + offset);
...
Token Parser_expect(Parser* self, TokenType ttype)
{
    ...
    if ((ttype == TokenType_GT) && (tok.tok_type == TokenType_RSHIFT))
    {
        ...
        return (Token){ .tok_type = TokenType_GT, .value = (TokenValue){ .tag = TokenValue_tv_str_TAG, .tv_str = { .v = ">" } }, .line = tok.line, .column = tok.column };
    }
...
int64_t Parser_parse_statement(Parser* self)
{
    ...
    if (tok.tok_type == TokenType_ERROR)
    {
        return Parser_parse_error_decl(self);
    }
    else
    if (tok.tok_type == TokenType_FUNC)
    {
    ...
    if (tok.tok_type == TokenType_STRUCT)
    {
    ...
    if (tok.tok_type == TokenType_IMPL)
    {
        return Parser_parse_impl_block(self);
    }
    else
    if (tok.tok_type == TokenType_ENUM)
    {
    ...
    if (tok.tok_type == TokenType_UNSAFE)
    {
        return Parser_parse_unsafe_block(self);
    }
    else
    if (tok.tok_type == TokenType_EXTERN)
    {
...
const char* Parser_parse_base_type(Parser* self)
{
    ...
    if (Parser_match_token(self, TokenType_QUESTION))
    {
        return __kai_std_str_concat_alloc("?", Parser_parse_type(self));
    }
    else
    if (Parser_match_token(self, TokenType_AMP))
    {
        bool is_mut = false;
    ...
    if (Parser_match_token(self, TokenType_MUL))
    {
        bool is_mut = false;
        if (Parser_match_token(self, TokenType_MUT))
        {
    ...
    if (Parser_match_token(self, TokenType_LBRACKET))
    {
...
int64_t Parser_parse_struct_decl(Parser* self)
{
    ...
    while ((Parser_peek(self, 0LL).tok_type != TokenType_RBRACE) && (Parser_peek(self, 0LL).tok_type != TokenType_EOF))
    {
        ...
        if (Parser_peek(self, 0LL).tok_type == TokenType_IMPL)
        {
            (void)(Parser_advance(self));
...
int64_t Parser_parse_pattern(Parser* self)
{
    ...
    if (tok.tok_type == TokenType_ELSE)
    {
        (void)(Parser_advance(self));
        return Parser_add_pattern(self, new_pattern_node(PatternKind_pk_else));
    }
    else
    if (((((tok.tok_type == TokenType_INT_LIT) || (tok.tok_type == TokenType_FLOAT_LIT)) || (tok.tok_type == TokenType_BOOL_LIT)) || (tok.tok_type == TokenType_STRING_LIT)) || (tok.tok_type == TokenType_CHAR_LIT))
    {
        (void)(Parser_advance(self));
...
int64_t Parser_parse_expression(Parser* self, int64_t precedence)
{
    ...
    while (!done)
    {
        ...
        else
        {
            ...
            if (op_tok.tok_type == TokenType_LBRACKET)
            {
            ...
            if ((op_tok.tok_type == TokenType_DOTDOT) || (op_tok.tok_type == TokenType_DOTDOTEQ))
            {
            ...
            if (op_tok.tok_type == TokenType_CATCH)
            {
                const char* var_name = "";
            ...
            if (op_tok.tok_type == TokenType_AS)
            {
...
int64_t Parser_parse_primary(Parser* self)
{
    ...
    if ((((tok.tok_type == TokenType_INT_LIT) || (tok.tok_type == TokenType_FLOAT_LIT)) || (tok.tok_type == TokenType_BOOL_LIT)) || (tok.tok_type == TokenType_CHAR_LIT))
    {
        ...
        if (tok.tok_type == TokenType_FLOAT_LIT)
        {
            vkind = "FLOAT";
        }
        else
        if (tok.tok_type == TokenType_BOOL_LIT)
        {
            vkind = "BOOL";
        }
        else
    ...
    if (tok.tok_type == TokenType_IDENTIFIER)
    {
        ...
        if (Parser_peek(self, 1LL).tok_type == TokenType_LPAREN)
        {
            const char* ident = tv_get_str(Parser_advance(self).value);
            (void)(Parser_advance(self));
            if ((Parser_peek(self, 0LL).tok_type == TokenType_IDENTIFIER) && (Parser_peek(self, 1LL).tok_type == TokenType_COLON))
    ...
    if (tok.tok_type == TokenType_MINUS)
    {
        (void)(Parser_advance(self));
        return Parser_ex_unop(self, "-", Parser_parse_expression(self, 7LL));
    }
    else
    if (tok.tok_type == TokenType_NOT)
    {
        (void)(Parser_advance(self));
        return Parser_ex_unop(self, "!", Parser_parse_expression(self, 7LL));
    }
    else
    if (tok.tok_type == TokenType_BITNOT)
    {
        (void)(Parser_advance(self));
        return Parser_ex_unop(self, "~", Parser_parse_expression(self, 7LL));
    }
    else
    if (tok.tok_type == TokenType_SIZEOF)
    {
        (void)(Parser_advance(self));
        (void)(Parser_expect(self, TokenType_LPAREN));
    ...
    if (tok.tok_type == TokenType_MUL)
    {
        (void)(Parser_advance(self));
        return Parser_ex_deref(self, Parser_parse_expression(self, 8LL));
    }
    else
    if (tok.tok_type == TokenType_LBRACKET)
    {
        (void)(Parser_advance(self));
...
TypeChecker TypeChecker_init(KaiAllocator* allocator, ArrayList_StmtNode* stmt_pool, ArrayList_ExprNode* expr_pool, ArrayList_PatternNode* pattern_pool, const char* source_file, const char* source, ImportResolver* import_resolver)
{
    ...
    self.func_effects = ArrayList_FuncEffect_init(allocator);    return self;
}void TypeChecker_err(TypeChecker* self, const char* code, const char* msg, int64_t line, int64_t col)
{
        ...
        while (i < ArrayList_Int_length(&(stmt.block_stmts)))
        {
            ...
            if (s.kind == StmtKind_sk_impl_block)
            {
                ...
                while (j < ArrayList_Int_length(&(s.impl_methods)))
                {
                    ...
                    if (strcmp(m.func_name, "drop") == 0LL)
                    {
                        has_drop = true;
                    }
                    j = (j + 1LL);
...
bool TypeChecker_has_drop_method(TypeChecker* self, const char* type_name)
{
    ...
    if ((strlen(type_name) > 4LL) && (strcmp(substring(type_name, 0LL, 4LL), "own ") == 0LL))
    {
    ...
    if (expr.lit_value.tag == TokenValue_tv_str_TAG)
    {
        const char* v = expr.lit_value.tv_str.v;
        {
            ...
            while (pos < len)
            {
                ...
                if (strcmp(digit, "2") == 0LL)
                {
                    res = ((res * 10LL) + 2LL);
                }
                else
                if (strcmp(digit, "3") == 0LL)
                {
                    res = ((res * 10LL) + 3LL);
                }
                else
                if (strcmp(digit, "4") == 0LL)
                {
                    res = ((res * 10LL) + 4LL);
                }
                else
                if (strcmp(digit, "5") == 0LL)
                {
                    res = ((res * 10LL) + 5LL);
                }
                else
                if (strcmp(digit, "6") == 0LL)
                {
                    res = ((res * 10LL) + 6LL);
                }
                else
                if (strcmp(digit, "7") == 0LL)
                {
                    res = ((res * 10LL) + 7LL);
                }
                else
                if (strcmp(digit, "8") == 0LL)
                {
                    res = ((res * 10LL) + 8LL);
                }
                else
                if (strcmp(digit, "9") == 0LL)
                {
                    res = ((res * 10LL) + 9LL);
                }
                else
...
PtrRefResult TypeChecker_parse_ptr_ref(TypeChecker* self, const char* type_str)
{
    ...
    if ((strlen(inner) > 5LL) && (strcmp(substring(inner, 0LL, 5LL), "*mut ") == 0LL))
    {
        is_ptr = true;
        is_mut = true;
    ...
    if ((strlen(inner) > 1LL) && (inner[0LL] == ((char)(42LL))))
    {
        is_ptr = true;
        inner = substring(inner, 1LL, strlen(inner));
    }
    ...
    if ((strlen(inner) > 1LL) && (inner[0LL] == ((char)(38LL))))
    {
        is_ptr = true;
        inner = substring(inner, 1LL, strlen(inner));
    }
...
bool TypeChecker_types_compatible(TypeChecker* self, const char* target, const char* source)
{
    const char* t = target;
    const char* s = source;
    if ((strlen(t) > 4LL) && (strcmp(substring(t, 0LL, 4LL), "own ") == 0LL))
    {
        t = substring(t, 4LL, strlen(t));
    }
    if ((strlen(s) > 4LL) && (strcmp(substring(s, 0LL, 4LL), "own ") == 0LL))
    {
    ...
    bool s_is_slice = ((strlen(s) >= 2LL) && (strcmp(__kai_str_sub(s, 0LL, 2LL), "[]") == 0LL));
    if (t_is_slice || s_is_slice)
    {
        ...
        if ((strlen(t) > 0LL) && (t[0LL] == ((char)(42LL))))
        {
        ...
        if ((strlen(s) > 0LL) && (s[0LL] == ((char)(42LL))))
        {
...
int64_t TypeChecker_find_method_decl(TypeChecker* self, const char* struct_name, const char* meth_name)
{
    ...
    clean_struct = clean;
    if ((strlen(clean_struct) > 4LL) && (strcmp(substring(clean_struct, 0LL, 4LL), "mut ") == 0LL))
    {
    ...
    while (idx < ArrayList_StmtNode_length(self->stmt_pool))
    {
        ...
        if (stmt.kind == StmtKind_sk_impl_block)
        {
            ...
            if (strcmp(impl_name, clean_struct) == 0LL)
            {
                int64_t mi = 0LL;
...
const char* TypeChecker_get_expr_type(TypeChecker* self, int64_t expr_idx)
{
    ...
    if (expr.kind == ExprKind_ek_field_access)
    {
        ...
        if (base_node.kind == ExprKind_ek_identifier)
        {
            ...
            {
                StmtNode stmt = ArrayList_StmtNode_get(self->stmt_pool, s_idx);
                if (((stmt.kind == StmtKind_sk_enum_decl) && (strcmp(stmt.enum_name, base_node.ident_name) == 0LL)) || ((stmt.kind == StmtKind_sk_error_decl) && (strcmp(stmt.error_name, base_node.ident_name) == 0LL)))
                {
                    is_static = true;
                }
                s_idx = (s_idx + 1LL);
        ...
        if ((strlen(clean_type) > 4LL) && (strcmp(substring(clean_type, 0LL, 4LL), "mut ") == 0LL))
        {
...
void TypeChecker_check_return_stmt(TypeChecker* self, int64_t stmt_idx)
{
    ...
    if ((strlen(expected_ret) > 0LL) && (strcmp(expected_ret, "<infer>") != 0LL))
    {
...
void TypeChecker_check_stmt(TypeChecker* self, int64_t stmt_idx)
{
    ...
    if (stmt.kind == StmtKind_sk_var_decl)
    {
        ...
        if (TypeChecker_is_integer_type(self, var_type) && TypeChecker_is_integer_literal(self, stmt.vardecl_value))
        {
        ...
        if ((stmt.vardecl_value >= 0LL) && (!TypeChecker_is_copy_type(self, var_type)))
        {
            ...
            while (!done)
            {
                if (((src_expr.kind == ExprKind_ek_func_call) && (strcmp(src_expr.func_name, "as") == 0LL)) && (ArrayList_Int_length(&(src_expr.func_args)) >= 1LL))
                {
    ...
    if (stmt.kind == StmtKind_sk_if)
    {
        ...
        if ((strcmp(cond_type, "Bool") != 0LL) && (strcmp(cond_type, "Void") != 0LL))
        {
    ...
    if (stmt.kind == StmtKind_sk_for)
    {
        ...
        if ((strlen(iter_type) == 0LL) || (strcmp(iter_type, "Void") == 0LL))
        {
            iter_type = "Int";
        }
...
void TypeChecker_check_expr(TypeChecker* self, int64_t expr_idx)
{
    ...
    if (expr.kind == ExprKind_ek_binary_op)
    {
        ...
        if (strcmp(op, "+") == 0LL)
        {
            if (((!TypeChecker_is_numeric_type(self, left_type)) && (strcmp(left_type, "Str") != 0LL)) && (strcmp(left_type, "Void") != 0LL))
            {
            ...
            if (((!TypeChecker_is_numeric_type(self, right_type)) && (strcmp(right_type, "Str") != 0LL)) && (strcmp(right_type, "Void") != 0LL))
            {
        ...
        if ((((strcmp(op, "-") == 0LL) || (strcmp(op, "*") == 0LL)) || (strcmp(op, "/") == 0LL)) || (strcmp(op, "%") == 0LL))
        {
            if ((!TypeChecker_is_numeric_type(self, left_type)) && (strcmp(left_type, "Void") != 0LL))
            {
            ...
            if ((!TypeChecker_is_numeric_type(self, right_type)) && (strcmp(right_type, "Void") != 0LL))
            {
        ...
        {
            if ((strcmp(left_type, "Bool") != 0LL) && (strcmp(left_type, "Void") != 0LL))
            {
            ...
            if ((strcmp(right_type, "Bool") != 0LL) && (strcmp(right_type, "Void") != 0LL))
            {
        ...
        if (((((strcmp(op, "|") == 0LL) || (strcmp(op, "^") == 0LL)) || (strcmp(op, "&") == 0LL)) || (strcmp(op, "<<") == 0LL)) || (strcmp(op, ">>") == 0LL))
        {
            if ((!TypeChecker_is_integer_type(self, left_type)) && (strcmp(left_type, "Void") != 0LL))
            {
            ...
            if ((!TypeChecker_is_integer_type(self, right_type)) && (strcmp(right_type, "Void") != 0LL))
            {
        ...
        if ((((((strcmp(op, "==") == 0LL) || (strcmp(op, "!=") == 0LL)) || (strcmp(op, "<") == 0LL)) || (strcmp(op, ">") == 0LL)) || (strcmp(op, "<=") == 0LL)) || (strcmp(op, ">=") == 0LL))
        {
            if (((strcmp(left_type, "Void") != 0LL) && (strcmp(right_type, "Void") != 0LL)) && (!TypeChecker_types_compatible(self, left_type, right_type)))
            {
    ...
    if (expr.kind == ExprKind_ek_unary_op)
    {
        ...
        if (strcmp(binop, "!") == 0LL)
        {
            if ((strcmp(operand_type, "Bool") != 0LL) && (strcmp(operand_type, "Void") != 0LL))
            {
        ...
        if (strcmp(binop, "-") == 0LL)
        {
            if ((!TypeChecker_is_numeric_type(self, operand_type)) && (strcmp(operand_type, "Void") != 0LL))
            {
        ...
        if (strcmp(binop, "~") == 0LL)
        {
            if ((!TypeChecker_is_integer_type(self, operand_type)) && (strcmp(operand_type, "Void") != 0LL))
            {
    ...
    if (expr.kind == ExprKind_ek_func_call)
    {
        ...
        else
        {
            ...
            while (ei < ArrayList_FuncEffect_length(&(self->func_effects)))
            {
                ...
                if (strcmp(eff.func_name, name) == 0LL)
                {
                    int64_t fi = 0LL;
    ...
    if (expr.kind == ExprKind_ek_method_call)
    {
        ...
        while (i < ArrayList_Int_length(&(expr.meth_args)))
        {
            ...
            TypeChecker_check_expr(self, arg);
            if ((strcmp(expr.meth_name, "free") == 0LL) && (i == 0LL))
            {
    ...
    if (expr.kind == ExprKind_ek_index)
    {
        ...
        if ((strcmp(index_type, "Int") != 0LL) && (strcmp(index_type, "Void") != 0LL))
        {
        ...
        const char* base_type = TypeChecker_get_expr_type(self, expr.idx_expr);
        if ((strcmp(base_type, "Str") != 0LL) && (strcmp(base_type, "Void") != 0LL))
        {
            if ((strlen(base_type) == 0LL) || ((base_type[0LL] != ((char)(42LL))) && (base_type[0LL] != ((char)(38LL)))))
            {
...
const char* Codegen_add_init_return(Codegen* self, const char* body_str, const char* struct_name)
{
    ...
    bool ends_with_return = false;
    {
        ...
        {
            int64_t offset = (((int64_t)(((unsigned long long)(ret_ptr)))) - ((int64_t)(((unsigned long long)(stripped_body)))));
...
Codegen Codegen_init(KaiAllocator* allocator, ArrayList_StmtNode* stmt_pool, ArrayList_ExprNode* expr_pool, ArrayList_PatternNode* pattern_pool, ImportResolver* import_resolver)
{
    ...
    self.func_param_types = ArrayList_StrMapEntry_init(allocator);    return self;
}bool Codegen_is_pointer_type(Codegen* self, const char* t)
{
    if (strlen(t) == 0LL)
    {
...
const char* Codegen_map_type(Codegen* self, const char* type_name)
{
    ...
    {
        if ((strlen(resolved_type) > 5LL) && (strcmp(__kai_str_sub(resolved_type, 0LL, 5LL), "*mut ") == 0LL))
        {
...
ArrayList_Str Codegen_infer_type_args(Codegen* self, int64_t func_stmt_idx, int64_t expr_idx)
{
    ...
    while ((arg_i < ArrayList_Int_length(&(expr.func_args))) && (arg_i < ArrayList_Param_length(&(stmt.func_params))))
    {
        ...
        if ((strlen(ptype) >= 4LL) && (strcmp(__kai_str_sub(ptype, 0LL, 4LL), "mut ") == 0LL))
        {
            ptype = __kai_str_sub(ptype, 4LL, strlen(ptype));
        }
        if ((strlen(atype) >= 4LL) && (strcmp(__kai_str_sub(atype, 0LL, 4LL), "mut ") == 0LL))
        {
...
void Codegen_monomorphize_methods(Codegen* self, const char* base_struct_name, const char* concrete_struct_name)
{
    ...
    {
        StmtNode stmt = ArrayList_StmtNode_get(self->stmt_pool, idx);
        if ((stmt.kind == StmtKind_sk_impl_block) && (strcmp(stmt.impl_struct_name, base_struct_name) == 0LL))
        {
            int64_t j = 0LL;
            while (j < ArrayList_Int_length(&(stmt.impl_methods)))
            {
                ...
                bool is_init = ((((strcmp(method_name, "init") == 0LL) || (strcmp(m_node.func_return_type, base_struct_name) == 0LL)) || (strcmp(m_node.func_return_type, __kai_std_str_concat_alloc("*", base_struct_name)) == 0LL)) || (strcmp(m_node.func_return_type, __kai_std_str_concat_alloc("&", base_struct_name)) == 0LL));
                const char* ret_type = "";
                if (is_init)
                {
    ...
    while (i < ArrayList_StmtNode_length(self->stmt_pool))
    {
        ...
        if (stmt.kind == StmtKind_sk_impl_block)
        {
            ...
            while (j < ArrayList_Int_length(&(stmt.impl_methods)))
            {
                ...
                if (strcmp(m_node.func_name, "init") == 0LL)
                {
                    ret = struct_name;
                }
...
const char* Codegen_get_expr_type(Codegen* self, int64_t expr_idx)
{
    ...
    if (expr.kind == ExprKind_ek_field_access)
    {
        ...
        if (strcmp(__kai_str_sub(clean_type, 0LL, 4LL), "mut ") == 0LL)
        {
        ...
        while (s_idx < ArrayList_StmtNode_length(self->stmt_pool))
        {
            ...
            if (stmt.kind == StmtKind_sk_struct_decl)
            {
                ...
                if (Codegen_str_contains(self, clean_type, ((char)(95LL))))
                {
    ...
    if (expr.kind == ExprKind_ek_method_call)
    {
        ...
        if (strcmp(__kai_str_sub(clean_rec, 0LL, 4LL), "mut ") == 0LL)
        {
        ...
        if (Codegen_str_contains(self, clean_rec, ((char)(60LL))))
        {
            ...
            while (si < ArrayList_StmtNode_length(self->stmt_pool))
            {
                ...
                if ((s.kind == StmtKind_sk_struct_decl) && (strcmp(s.struct_name, base_struct) == 0LL))
                {
                    struct_idx = si;
                }
                si = (si + 1LL);
            ...
            if (struct_idx >= 0LL)
            {
                ...
                while (impl_idx < ArrayList_StmtNode_length(self->stmt_pool))
                {
                    ...
                    if ((s_impl.kind == StmtKind_sk_impl_block) && (strcmp(s_impl.impl_struct_name, base_struct) == 0LL))
                    {
                        int64_t mi = 0LL;
                        while (mi < ArrayList_Int_length(&(s_impl.impl_methods)))
                        {
                            ...
                            if (strcmp(m_node.func_name, method_name) == 0LL)
                            {
...
const char* Codegen_gen_expr_with_expected_type(Codegen* self, int64_t expr_idx, const char* expected_type)
{
    ...
    if ((expr.kind == ExprKind_ek_literal) && (strcmp(expr.lit_vkind, "NONE") == 0LL))
    {
...
const char* Codegen_gen_expr(Codegen* self, int64_t expr_idx)
{
    ...
    if (expr.kind == ExprKind_ek_binary_op)
    {
        ...
        if ((strcmp(op, "==") == 0LL) || (strcmp(op, "!=") == 0LL))
        {
            if (((strlen(lhs_type) > 0LL) && (lhs_type[0LL] == ((char)(63LL)))) && (strcmp(rhs, "NULL") == 0LL))
            {
    ...
    if (expr.kind == ExprKind_ek_field_access)
    {
        ...
        const char* base_type = Codegen_get_expr_type(self, expr.field_expr);
        bool is_ptr = false;
        bool is_self_ptr = (((base_node.kind == ExprKind_ek_identifier) && (strcmp(base_node.ident_name, "self") == 0LL)) && (!self->cur_method_is_init));
    ...
    if (expr.kind == ExprKind_ek_method_call)
    {
        ...
        const char* args_str = "";
        if ((!is_constructor) && (strcmp(method_name, "init") != 0LL))
        {
            const char* rec_val = Codegen_gen_expr(self, receiver_idx);
            const char* rec_inferred = Codegen_get_expr_type(self, receiver_idx);
            bool is_self_ptr = (((receiver_node.kind == ExprKind_ek_identifier) && (strcmp(receiver_node.ident_name, "self") == 0LL)) && (!self->cur_method_is_init));
        ...
        if ((strcmp(method_name, "init") == 0LL) && (!is_constructor))
        {
            const char* rec_val = Codegen_gen_expr(self, receiver_idx);
            const char* rec_inferred = Codegen_get_expr_type(self, receiver_idx);
    ...
    if (expr.kind == ExprKind_ek_catch)
    {
        ...
        if ((strlen(inner_ty) > 0LL) && (inner_ty[0LL] == ((char)(63LL))))
        {
            ...
            if (expr.catch_fallback >= 0LL)
            {
                ...
                if (fb_node.kind == StmtKind_sk_block)
                {
...
const char* Codegen_gen_stmt(Codegen* self, int64_t stmt_idx)
{
    ...
    if (stmt.kind == StmtKind_sk_impl_block)
    {
        ...
        while (idx < ArrayList_Int_length(&(stmt.impl_methods)))
        {
            ...
            bool is_init = ((((strcmp(method_name, "init") == 0LL) || (strcmp(method_node.func_return_type, struct_name) == 0LL)) || (strcmp(method_node.func_return_type, __kai_std_str_concat_alloc("*", struct_name)) == 0LL)) || (strcmp(method_node.func_return_type, __kai_std_str_concat_alloc("&", struct_name)) == 0LL));
            const char* ret_type = "";
            if (is_init)
            {
    ...
    if (stmt.kind == StmtKind_sk_return)
    {
        ...
        if (stmt.return_value >= 0LL)
        {
            ...
            if ((strcmp(val_type, "Void") == 0LL) || (strcmp(val_type, "NoneType") == 0LL))
            {
    ...
    if (stmt.kind == StmtKind_sk_match)
    {
        ...
        while (case_idx < ArrayList_MatchCase_length(&(stmt.match_cases)))
        {
            ...
            if (pat_node.kind == PatternKind_pk_literal)
            {
                ...
                {
                    const char* v = pat_node.lit_value.tv_str.v;
                    {
            ...
            if (pat_node.kind == PatternKind_pk_variant)
            {
                ...
                if (ArrayList_Str_length(&(pat_node.bindings)) > 0LL)
                {
                    ...
                    if (strcmp(bind_name, "_") != 0LL)
                    {
                        ...
                        if (strcmp(var_name, "tv_int") == 0LL)
                        {
                            bind_type = "Int";
                            field_name = "v";
                        }
                        else
                        if (strcmp(var_name, "tv_float") == 0LL)
                        {
                            bind_type = "Float";
                            field_name = "v";
                        }
                        else
                        if (strcmp(var_name, "tv_bool") == 0LL)
                        {
                            bind_type = "Bool";
                            field_name = "v";
                        }
                        else
                        if (strcmp(var_name, "tv_char") == 0LL)
                        {
                            bind_type = "Char";
                            field_name = "v";
                        }
                        else
                        if (strcmp(var_name, "tv_str") == 0LL)
                        {
                            bind_type = "Str";
                            field_name = "v";
                        }
...
const char* Codegen_clean_enum_name(Codegen* self, const char* type_name)
{
    ...
    if (strcmp(__kai_str_sub(base_name, 0LL, 4LL), "mut ") == 0LL)
    {
...
const char* Codegen_generate(Codegen* self, int64_t top_stmt_idx)
{
    ...
    while (ci < ArrayList_Str_length(&(self->import_resolver->cimport_headers)))
    {
        ...
        if (strcmp(hdr, "stdbool.h") == 0LL)
        {
            is_baseline = true;
        }
        else
        if (strcmp(hdr, "stdio.h") == 0LL)
        {
            is_baseline = true;
        }
        else
        if (strcmp(hdr, "stdlib.h") == 0LL)
        {
            is_baseline = true;
        }
        else
        if (strcmp(hdr, "string.h") == 0LL)
        {
            is_baseline = true;
        }
        else
        if (strcmp(hdr, "sys/mman.h") == 0LL)
        {
            is_baseline = true;
        }
        else
        if (strcmp(hdr, "ctype.h") == 0LL)
        {
            is_baseline = true;
        }
        if (!is_baseline)
...
StrBuf StrBuf_init(KaiAllocator* a)
{
    ...
    self.alloc = a;
    self.parts = ArrayList_Str_init(a);    return self;
}void StrBuf_append(StrBuf* self, const char* s)
{
...
const char* CodegenBuilder_add_init_return(CodegenBuilder* self, const char* body_str, const char* struct_name)
{
    ...
    bool ends_with_return = false;
    {
        ...
        if (ret_ptr != ((char*)(((unsigned long long)(0LL)))))
        {
            int64_t offset = (((int64_t)(((unsigned long long)(ret_ptr)))) - ((int64_t)(((unsigned long long)(content)))));
...
const char* CodegenBuilder_get_expr_type(CodegenBuilder* self, int64_t expr_idx)
{
    ...
    if (expr.kind == ExprKind_ek_field_access)
    {
        ...
        while (!done_strip)
        {
            ...
            if ((strlen(clean_base) > 5LL) && (strcmp(__kai_str_sub(clean_base, 0LL, 5LL), "*mut ") == 0LL))
            {
        ...
        while (fi < ArrayList_StmtNode_length(self->stmt_pool))
        {
            ...
            if (s.kind == StmtKind_sk_struct_decl)
            {
                ...
                if (CodegenBuilder_str_contains(self, clean_base, ((char)(95LL))))
                {
...
const char* CodegenBuilder_map_type(CodegenBuilder* self, const char* resolved_type)
{
    ...
    while (changed)
    {
        ...
        if ((strlen(inner) > 0LL) && (inner[0LL] == ((char)(38LL))))
        {
            ptr_count = (ptr_count + 1LL);
            inner = __kai_str_sub(inner, 1LL, strlen(inner));
            changed = true;
        ...
        if ((strlen(inner) >= 2LL) && (strcmp(__kai_str_sub(inner, 0LL, 2LL), "[]") == 0LL))
        {
            ptr_count = (ptr_count + 1LL);
        ...
        if ((strlen(inner) > 5LL) && (strcmp(__kai_str_sub(inner, 0LL, 5LL), "*mut ") == 0LL))
        {
            ptr_count = (ptr_count + 1LL);
    ...
    if ((strcmp(base, "Int") == 0LL) || (strcmp(base, "i64") == 0LL))
    {
        base = "int64_t";
    }
    else
    if (strcmp(base, "i8") == 0LL)
    {
        base = "int8_t";
    }
    else
    if (strcmp(base, "i16") == 0LL)
    {
        base = "int16_t";
    }
    else
    if (strcmp(base, "i32") == 0LL)
    {
        base = "int32_t";
    }
    else
    if (strcmp(base, "u8") == 0LL)
    {
        base = "uint8_t";
    }
    else
    if (strcmp(base, "u16") == 0LL)
    {
        base = "uint16_t";
    }
    else
    if (strcmp(base, "u32") == 0LL)
    {
        base = "uint32_t";
    }
    else
    if (strcmp(base, "u64") == 0LL)
    {
        base = "uint64_t";
    }
    else
    if (strcmp(base, "usize") == 0LL)
    {
        base = "size_t";
    }
    else
    if (strcmp(base, "isize") == 0LL)
    {
        base = "intptr_t";
    }
    else
    if (strcmp(base, "Void") == 0LL)
    {
        base = "void";
    }
    else
    if (strcmp(base, "Bool") == 0LL)
    {
        base = "bool";
    }
    else
    if (strcmp(base, "Char") == 0LL)
    {
        base = "char";
    }
    else
    if (strcmp(base, "Float") == 0LL)
    {
        base = "double";
    }
    else
    if (strcmp(base, "Str") == 0LL)
    {
        base = "const char*";
    }
    else
    if (strcmp(base, "NoneType") == 0LL)
    {
        base = "void";
    }
    else
    if (strcmp(base, "TokenValue") == 0LL)
    {
        base = "TokenValue";
    }
    else
    if (strcmp(base, "TokenType") == 0LL)
    {
        base = "TokenType";
    }
    else
    if (CodegenBuilder_str_contains(self, base, ((char)(33LL))))
    {
    ...
    if (CodegenBuilder_str_contains(self, base, ((char)(63LL))))
    {
    ...
    if (CodegenBuilder_str_contains(self, base, ((char)(60LL))))
    {
...
const char* CodegenBuilder_gen_expr_with_expected_type(CodegenBuilder* self, int64_t expr_idx, const char* expected_type)
{
    ...
    {
        const char* val_type = __kai_str_sub(expected_type, 1LL, strlen(expected_type));
        if ((!CodegenBuilder_is_pointer_type(self, val_type)) && (strcmp(actual_type, val_type) == 0LL))
        {
    ...
    if (excl_pos >= 0LL)
    {
        ...
        if ((strcmp(actual_type, "Void") == 0LL) && (strcmp(val_payload, "Void") != 0LL))
        {
        ...
        if (strcmp(val_payload, "Void") == 0LL)
        {
...
int64_t CodegenBuilder_gen_expr(CodegenBuilder* self, int64_t expr_idx)
{
    ...
    if (expr.kind == ExprKind_ek_func_call)
    {
        ...
        if ((strcmp(name, "cast") == 0LL) || (strcmp(name, "as") == 0LL))
        {
            ...
            if (strlen(target_type) > 0LL)
            {
                ...
                if (CodegenBuilder_is_pointer_type(self, target_type) && (strcmp(src_type, "Int") == 0LL))
                {
        ...
        if ((((strcmp(name, "Int") == 0LL) || (strcmp(name, "Float") == 0LL)) || (strcmp(name, "Bool") == 0LL)) || (strcmp(name, "Char") == 0LL))
        {
            if (ArrayList_Int_length(&(expr.func_args)) >= 1LL)
            {
                ...
                if (strcmp(name, "Float") == 0LL)
                {
                    ctype_str = "double";
                }
                else
                if (strcmp(name, "Bool") == 0LL)
                {
                    ctype_str = "bool";
                }
                else
                if (strcmp(name, "Char") == 0LL)
                {
                    ctype_str = "char";
                }
                const char* src_type = CodegenBuilder_get_expr_type(self, ArrayList_Int_get(&(expr.func_args), 0LL));
    ...
    if (expr.kind == ExprKind_ek_field_access)
    {
        ...
        if (base_node.kind == ExprKind_ek_identifier)
        {
            ...
            while (ei < ArrayList_StmtNode_length(self->stmt_pool))
            {
                ...
                if ((s.kind == StmtKind_sk_enum_decl) && (strcmp(s.enum_name, ident) == 0LL))
                {
                    ...
                    while (vi < ArrayList_Variant_length(&(s.enum_variants)))
                    {
                        ...
                        if ((strcmp(v.vname, var_name) == 0LL) && (ArrayList_Param_length(&(v.params)) > 0LL))
                        {
                            has_payload = true;
                        }
                        vi = (vi + 1LL);
        ...
        if ((strlen(base_type) > 4LL) && (strcmp(__kai_str_sub(base_type, 0LL, 4LL), "*mut ") == 0LL))
        {
            is_arrow = true;
        }
        if (is_arrow)
    ...
    if (expr.kind == ExprKind_ek_method_call)
    {
        ...
        const char* args_str = "";
        if ((!is_constructor) && (strcmp(expr.meth_name, "init") != 0LL))
        {
        ...
        if ((strcmp(expr.meth_name, "init") == 0LL) && (!is_constructor))
        {
            const char* rec_val = CodegenBuilder_gen_expr_str(self, expr.meth_expr);
            const char* rec_inferred = CodegenBuilder_get_expr_type(self, expr.meth_expr);
...
void CodegenBuilder_gen_stmt(CodegenBuilder* self, int64_t stmt_idx)
{
    ...
    if (stmt.kind == StmtKind_sk_var_decl)
    {
        ...
        bool is_discard = ((var_value >= 0LL) && ((strcmp(var_name, "_") == 0LL) || ((strlen(var_type) == 0LL) && ((strcmp(CodegenBuilder_get_expr_type(self, var_value), "Void") == 0LL) || (strcmp(CodegenBuilder_get_expr_type(self, var_value), "NoneType") == 0LL)))));
        if (is_discard)
        {
        ...
        if (stmt.kind == StmtKind_sk_impl_block)
        {
            ...
            if ((cgb_map_find((&self->generic_struct_decls), struct_name) < 0LL) && (cgb_map_find((&self->generic_enum_decls), struct_name) < 0LL))
            {
                ...
                while (j < ArrayList_Int_length(&(stmt.impl_methods)))
                {
                    ...
                    StmtNode m_node = ArrayList_StmtNode_get(self->stmt_pool, m_idx);
                    const char* method_name = m_node.func_name;
                    bool is_init = ((((strcmp(method_name, "init") == 0LL) || (strcmp(m_node.func_return_type, struct_name) == 0LL)) || (strcmp(m_node.func_return_type, __kai_std_str_concat_alloc("*", struct_name)) == 0LL)) || (strcmp(m_node.func_return_type, __kai_std_str_concat_alloc("&", struct_name)) == 0LL));
...
CCodeBuilder CCodeBuilder_init(KaiAllocator* allocator)
{
    ...
    self.indent_level = 0LL;    return self;
}void CCodeBuilder_clear(CCodeBuilder* self)
{
...
int64_t run_patch(int64_t argc, char** argv)
{
    ...
    const char* op_name = operation;
    {
        ...
        if (strcmp(op_name, "setConst") == 0LL)
        {
                ...
                {
                    {
                        ...
                        {
                            if (strcmp(const_name, "") == 0LL)
                            {
                                const_name = a;
                            }
                            else
                            if (strcmp(const_val, "") == 0LL)
                            {
                                const_val = a;
                            }
                        }
        ...
        if (strcmp(op_name, "replaceText") == 0LL)
        {
        ...
        if (strcmp(op_name, "addParam") == 0LL)
        {
            const char* fn_name = op_arg1;
                ...
                {
                    {
                        ...
                        if (((!is_flag) && (strcmp(a, patch_file) != 0LL)) && (strcmp(a, "addParam") != 0LL))
                        {
                            ...
                            if (strcmp(param_name, "") == 0LL)
                            {
                                param_name = a;
                            }
                            else
                            if (strcmp(param_type, "") == 0LL)
                            {
                                param_type = a;
                            }
                        }
        ...
        if (strcmp(op_name, "upsertFunction") == 0LL)
        {
            const char* fn_name = op_arg1;
        ...
        if (strcmp(op_name, "appendStmt") == 0LL)
        {
