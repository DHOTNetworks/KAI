/* Compiled automatically by Kai C Transpiler */
#include <stdint.h>
#include <stdbool.h>
#include <stdio.h>
#include <stdlib.h>
...
/* Built-in Types */
typedef struct Range { int64_t start; int64_t end; bool is_inclusive; } Range;
...
struct Result_Str_Int {
    uint8_t tag;
    union {
        struct ok_Result_Str_Int_payload {
            const char* value;
        } ok;
        struct err_Result_Str_Int_payload {
            int64_t value;
        } err;
    } payload;
};
enum Result_Bool_Int_tags {
...
struct Result_Bool_Int {
    uint8_t tag;
    union {
        struct ok_Result_Bool_Int_payload {
            bool value;
        } ok;
        struct err_Result_Bool_Int_payload {
            int64_t value;
        } err;
    } payload;
};
enum TokenType_tags {
    TokenType_INT_LIT_TAG,
    TokenType_FLOAT_LIT_TAG,
    TokenType_BOOL_LIT_TAG,
    TokenType_CHAR_LIT_TAG,
    TokenType_STRING_LIT_TAG,
    TokenType_IDENTIFIER_TAG,
    TokenType_LET_TAG,
    TokenType_VAR_TAG,
    TokenType_FUNC_TAG,
    TokenType_IF_TAG,
    ...
    TokenType_FOR_TAG,
    TokenType_IN_TAG,
    TokenType_RETURN_TAG,
    TokenType_PRINT_TAG,
    TokenType_STRUCT_TAG,
    TokenType_IMPL_TAG,
    TokenType_MUT_TAG,
    TokenType_UNSAFE_TAG,
    TokenType_EXTERN_TAG,
    TokenType_ENUM_TAG,
    TokenType_MATCH_TAG,
    TokenType_CASE_TAG,
    TokenType_USE_TAG,
    ...
    TokenType_TRAIT_TAG,
    TokenType_PUB_TAG,
    TokenType_IMPORT_TAG,
    TokenType_CIMPORT_TAG,
    TokenType_FROM_TAG,
    TokenType_AS_TAG,
    TokenType_SIZEOF_TAG,
    TokenType_DEFER_TAG,
    TokenType_NONE_TAG,
    TokenType_FN_TAG,
    TokenType_TRY_TAG,
    ...
    TokenType_ERROR_TAG,
    TokenType_ASM_TAG,
    TokenType_VOLATILE_TAG,
    TokenType_PLUS_TAG,
    TokenType_MINUS_TAG,
    TokenType_MUL_TAG,
    TokenType_DIV_TAG,
    TokenType_MOD_TAG,
    TokenType_ASSIGN_TAG,
    TokenType_PLUS_ASSIGN_TAG,
    TokenType_MINUS_ASSIGN_TAG,
    TokenType_AND_TAG,
    TokenType_OR_TAG,
    TokenType_NOT_TAG,
    TokenType_PIPE_TAG,
    TokenType_BITXOR_TAG,
    TokenType_BITNOT_TAG,
    TokenType_LSHIFT_TAG,
    TokenType_RSHIFT_TAG,
    TokenType_EQ_TAG,
    TokenType_NE_TAG,
    TokenType_LT_TAG,
    TokenType_LE_TAG,
    ...
    TokenType_COLON_TAG,
    TokenType_ARROW_TAG,
    TokenType_FAT_ARROW_TAG,
    TokenType_COMMA_TAG,
    TokenType_LPAREN_TAG,
    TokenType_RPAREN_TAG,
    TokenType_LBRACKET_TAG,
    TokenType_RBRACKET_TAG,
    TokenType_LBRACE_TAG,
    TokenType_RBRACE_TAG,
    TokenType_DOTDOT_TAG,
    TokenType_DOTDOTEQ_TAG,
    TokenType_DOT_TAG,
    TokenType_AMP_TAG,
    TokenType_HASH_TAG,
    TokenType_QUESTION_TAG,
    TokenType_SEMICOLON_TAG,
    TokenType_BREAK_TAG,
    TokenType_CONTINUE_TAG,
    TokenType_NEWLINE_TAG,
    TokenType_INDENT_TAG,
    TokenType_DEDENT_TAG,
    TokenType_EOF_TAG,
};
struct TokenType {
    uint8_t tag;
...
struct TokenValue {
    uint8_t tag;
    union {
        struct tv_int_payload {
            int64_t v;
        } tv_int;
        struct tv_float_payload {
            double v;
        } tv_float;
        struct tv_bool_payload {
            bool v;
        } tv_bool;
        struct tv_char_payload {
            char v;
        } tv_char;
        struct tv_str_payload {
            const char* v;
        } tv_str;
    } payload;
};
enum PatternKind_tags {
    PatternKind_pk_variant_TAG,
    PatternKind_pk_literal_TAG,
    PatternKind_pk_else_TAG,
};
struct PatternKind {
    uint8_t tag;
    union {
...
enum ExprKind_tags {
    ExprKind_ek_none_TAG,
    ExprKind_ek_literal_TAG,
    ExprKind_ek_str_interp_TAG,
    ExprKind_ek_identifier_TAG,
    ExprKind_ek_binary_op_TAG,
    ExprKind_ek_unary_op_TAG,
    ExprKind_ek_func_call_TAG,
    ExprKind_ek_struct_init_TAG,
    ExprKind_ek_field_access_TAG,
    ExprKind_ek_method_call_TAG,
    ExprKind_ek_index_TAG,
    ExprKind_ek_check_TAG,
    ExprKind_ek_slice_TAG,
    ExprKind_ek_range_TAG,
    ExprKind_ek_array_TAG,
    ExprKind_ek_tuple_TAG,
    ExprKind_ek_borrow_TAG,
    ExprKind_ek_deref_TAG,
    ExprKind_ek_try_TAG,
    ExprKind_ek_catch_TAG,
    ExprKind_ek_asm_TAG,
};
struct ExprKind {
    uint8_t tag;
...
enum StmtKind_tags {
    StmtKind_sk_none_TAG,
    StmtKind_sk_block_TAG,
    StmtKind_sk_var_decl_TAG,
    StmtKind_sk_assignment_TAG,
    StmtKind_sk_func_decl_TAG,
    StmtKind_sk_struct_decl_TAG,
    StmtKind_sk_impl_block_TAG,
    StmtKind_sk_trait_decl_TAG,
    StmtKind_sk_enum_decl_TAG,
    StmtKind_sk_if_TAG,
    StmtKind_sk_if_let_TAG,
    StmtKind_sk_while_TAG,
    StmtKind_sk_for_TAG,
    StmtKind_sk_return_TAG,
    StmtKind_sk_print_TAG,
    StmtKind_sk_expr_TAG,
    StmtKind_sk_defer_TAG,
    StmtKind_sk_unsafe_TAG,
    StmtKind_sk_extern_TAG,
    StmtKind_sk_import_TAG,
    StmtKind_sk_cimport_TAG,
    StmtKind_sk_match_TAG,
    StmtKind_sk_error_decl_TAG,
    StmtKind_sk_break_TAG,
    StmtKind_sk_continue_TAG,
};
struct StmtKind {
    uint8_t tag;
    union {
...
TokenType keyword_type(const char* ident) {
    if (strcmp(ident, "let") == 0) {
        return (TokenType){ .tag = TokenType_LET_TAG };
    } else if (strcmp(ident, "var") == 0) {
        return (TokenType){ .tag = TokenType_VAR_TAG };
    } else if (strcmp(ident, "func") == 0) {
        return (TokenType){ .tag = TokenType_FUNC_TAG };
    } else if (strcmp(ident, "fn") == 0) {
        return (TokenType){ .tag = TokenType_FUNC_TAG };
    } else if (strcmp(ident, "if") == 0) {
        return (TokenType){ .tag = TokenType_IF_TAG };
    } else if (strcmp(ident, "else") == 0) {
        return (TokenType){ .tag = TokenType_ELSE_TAG };
    } else if (strcmp(ident, "while") == 0) {
        return (TokenType){ .tag = TokenType_WHILE_TAG };
    } else if (strcmp(ident, "for") == 0) {
        return (TokenType){ .tag = TokenType_FOR_TAG };
    } else if (strcmp(ident, "in") == 0) {
        return (TokenType){ .tag = TokenType_IN_TAG };
    } else if (strcmp(ident, "return") == 0) {
        return (TokenType){ .tag = TokenType_RETURN_TAG };
    } else if (strcmp(ident, "true") == 0) {
        return (TokenType){ .tag = TokenType_BOOL_LIT_TAG };
    } else if (strcmp(ident, "false") == 0) {
        return (TokenType){ .tag = TokenType_BOOL_LIT_TAG };
    } else if (strcmp(ident, "struct") == 0) {
        return (TokenType){ .tag = TokenType_STRUCT_TAG };
    } else if (strcmp(ident, "impl") == 0) {
        return (TokenType){ .tag = TokenType_IMPL_TAG };
    } else if (strcmp(ident, "mut") == 0) {
        return (TokenType){ .tag = TokenType_MUT_TAG };
    } else if (strcmp(ident, "unsafe") == 0) {
        return (TokenType){ .tag = TokenType_UNSAFE_TAG };
    } else if (strcmp(ident, "extern") == 0) {
        return (TokenType){ .tag = TokenType_EXTERN_TAG };
    } else if (strcmp(ident, "enum") == 0) {
        return (TokenType){ .tag = TokenType_ENUM_TAG };
    } else if (strcmp(ident, "match") == 0) {
        return (TokenType){ .tag = TokenType_MATCH_TAG };
    } else if (strcmp(ident, "case") == 0) {
        return (TokenType){ .tag = TokenType_CASE_TAG };
    } else if (strcmp(ident, "use") == 0) {
        return (TokenType){ .tag = TokenType_USE_TAG };
    } else if (strcmp(ident, "check") == 0) {
        return (TokenType){ .tag = TokenType_CHECK_TAG };
    } else if (strcmp(ident, "trait") == 0) {
        return (TokenType){ .tag = TokenType_TRAIT_TAG };
    } else if (strcmp(ident, "pub") == 0) {
        return (TokenType){ .tag = TokenType_PUB_TAG };
    } else if (strcmp(ident, "import") == 0) {
        return (TokenType){ .tag = TokenType_IMPORT_TAG };
    } else if (strcmp(ident, "cimport") == 0) {
        return (TokenType){ .tag = TokenType_CIMPORT_TAG };
    } else if (strcmp(ident, "from") == 0) {
        return (TokenType){ .tag = TokenType_FROM_TAG };
    } else if (strcmp(ident, "as") == 0) {
        return (TokenType){ .tag = TokenType_AS_TAG };
    } else if (strcmp(ident, "sizeof") == 0) {
        return (TokenType){ .tag = TokenType_SIZEOF_TAG };
    } else if (strcmp(ident, "defer") == 0) {
        return (TokenType){ .tag = TokenType_DEFER_TAG };
    } else if (strcmp(ident, "none") == 0) {
        return (TokenType){ .tag = TokenType_NONE_TAG };
    } else if (strcmp(ident, "try") == 0) {
        return (TokenType){ .tag = TokenType_TRY_TAG };
    } else if (strcmp(ident, "catch") == 0) {
        return (TokenType){ .tag = TokenType_CATCH_TAG };
    } else if (strcmp(ident, "own") == 0) {
        return (TokenType){ .tag = TokenType_OWN_TAG };
    } else if (strcmp(ident, "error") == 0) {
        return (TokenType){ .tag = TokenType_ERROR_TAG };
    } else if (strcmp(ident, "asm") == 0) {
        return (TokenType){ .tag = TokenType_ASM_TAG };
    } else if (strcmp(ident, "volatile") == 0) {
        return (TokenType){ .tag = TokenType_VOLATILE_TAG };
    } else if (strcmp(ident, "break") == 0) {
        return (TokenType){ .tag = TokenType_BREAK_TAG };
    } else if (strcmp(ident, "continue") == 0) {
        return (TokenType){ .tag = TokenType_CONTINUE_TAG };
    } else {
        return (TokenType){ .tag = TokenType_IDENTIFIER_TAG };
    }
}
TokenValue make_keyword_value(const char* ident, TokenType ttype) {
    if ((ttype).tag == ((TokenType){ .tag = TokenType_BOOL_LIT_TAG }).tag) {
...
void Lexer_lex_identifier(Lexer* self) {
    ...
    if ((ktype).tag == ((TokenType){ .tag = TokenType_IDENTIFIER_TAG }).tag) {
        Lexer_emit(self, (TokenType){ .tag = TokenType_IDENTIFIER_TAG }, (TokenValue){ .tag = TokenValue_tv_str_TAG, .payload = { .tv_str = { .v = ident } } });
    } else if ((ktype).tag == ((TokenType){ .tag = TokenType_BOOL_LIT_TAG }).tag) {
        Lexer_emit(self, (TokenType){ .tag = TokenType_BOOL_LIT_TAG }, make_keyword_value(ident, (TokenType){ .tag = TokenType_BOOL_LIT_TAG }));
    } else {
...
void Lexer_lex_number(Lexer* self) {
    ...
    if ((Lexer_peek(self, 0) == '.') && (Lexer_peek(self, 1) != '.')) {
        ...
        Lexer_emit(self, (TokenType){ .tag = TokenType_FLOAT_LIT_TAG }, (TokenValue){ .tag = TokenValue_tv_str_TAG, .payload = { .tv_str = { .v = num_str } } });
    } else {
        const char* num_str = StringBuilder_to_str(&(sb));
        Lexer_emit(self, (TokenType){ .tag = TokenType_INT_LIT_TAG }, (TokenValue){ .tag = TokenValue_tv_str_TAG, .payload = { .tv_str = { .v = num_str } } });
    }
}
void Lexer_lex_string(Lexer* self) {
    (void)(Lexer_advance(self));
    ...
    Lexer_emit(self, (TokenType){ .tag = TokenType_STRING_LIT_TAG }, (TokenValue){ .tag = TokenValue_tv_str_TAG, .payload = { .tv_str = { .v = s } } });
}
void Lexer_lex_char(Lexer* self) {
    (void)(Lexer_advance(self));
    ...
    (void)(Lexer_advance(self));
    Lexer_emit(self, (TokenType){ .tag = TokenType_CHAR_LIT_TAG }, (TokenValue){ .tag = TokenValue_tv_char_TAG, .payload = { .tv_char = { .v = ch } } });
}
int64_t Lexer_compute_indent(Lexer* self) {
    int64_t indent = 0;
            ...
            if (indent >= 0) {
                if ((self->paren_depth == 0) && (self->brace_depth == 0)) {
                    ...
                    if (indent > current) {
                        ...
                        Lexer_emit(self, (TokenType){ .tag = TokenType_INDENT_TAG }, (TokenValue){ .tag = TokenValue_tv_int_TAG, .payload = { .tv_int = { .v = indent } } });
                        ...
                        while (indent < ArrayList_Int_get(self->indent_stack, (ArrayList_Int_length(self->indent_stack) - 1))) {
                            ...
                            Lexer_emit(self, (TokenType){ .tag = TokenType_DEDENT_TAG }, (TokenValue){ .tag = TokenValue_tv_int_TAG, .payload = { .tv_int = { .v = indent } } });
                        }
            ...
            if (c == '\n') {
                ...
                if (self->paren_depth == 0) {
                    ...
                    if (last > 0) {
                        ...
                        if ((((last_tok.tok_type).tag != ((TokenType){ .tag = TokenType_NEWLINE_TAG }).tag) && ((last_tok.tok_type).tag != ((TokenType){ .tag = TokenType_INDENT_TAG }).tag)) && ((last_tok.tok_type).tag != ((TokenType){ .tag = TokenType_DEDENT_TAG }).tag)) {
                            Lexer_emit(self, (TokenType){ .tag = TokenType_NEWLINE_TAG }, (TokenValue){ .tag = TokenValue_tv_none_TAG });
                        }
                    }
                }
                is_line_start = true;
                ...
                (void)(Lexer_advance(self));
                (void)(Lexer_advance(self));
                Lexer_emit(self, (TokenType){ .tag = TokenType_ARROW_TAG }, (TokenValue){ .tag = TokenValue_tv_str_TAG, .payload = { .tv_str = { .v = "->" } } });
            } else if ((c == '=') && (Lexer_peek(self, 1) == '>')) {
                (void)(Lexer_advance(self));
                (void)(Lexer_advance(self));
                Lexer_emit(self, (TokenType){ .tag = TokenType_FAT_ARROW_TAG }, (TokenValue){ .tag = TokenValue_tv_str_TAG, .payload = { .tv_str = { .v = "=>" } } });
            } else if ((c == '+') && (Lexer_peek(self, 1) == '=')) {
                (void)(Lexer_advance(self));
                (void)(Lexer_advance(self));
                Lexer_emit(self, (TokenType){ .tag = TokenType_PLUS_ASSIGN_TAG }, (TokenValue){ .tag = TokenValue_tv_str_TAG, .payload = { .tv_str = { .v = "+=" } } });
            } else if ((c == '-') && (Lexer_peek(self, 1) == '=')) {
                (void)(Lexer_advance(self));
                (void)(Lexer_advance(self));
                Lexer_emit(self, (TokenType){ .tag = TokenType_MINUS_ASSIGN_TAG }, (TokenValue){ .tag = TokenValue_tv_str_TAG, .payload = { .tv_str = { .v = "-=" } } });
            } else if ((c == '=') && (Lexer_peek(self, 1) == '=')) {
                (void)(Lexer_advance(self));
                (void)(Lexer_advance(self));
                Lexer_emit(self, (TokenType){ .tag = TokenType_EQ_TAG }, (TokenValue){ .tag = TokenValue_tv_str_TAG, .payload = { .tv_str = { .v = "==" } } });
            } else if ((c == '!') && (Lexer_peek(self, 1) == '=')) {
                (void)(Lexer_advance(self));
                (void)(Lexer_advance(self));
                Lexer_emit(self, (TokenType){ .tag = TokenType_NE_TAG }, (TokenValue){ .tag = TokenValue_tv_str_TAG, .payload = { .tv_str = { .v = "!=" } } });
            } else if ((c == '<') && (Lexer_peek(self, 1) == '=')) {
                (void)(Lexer_advance(self));
                (void)(Lexer_advance(self));
                Lexer_emit(self, (TokenType){ .tag = TokenType_LE_TAG }, (TokenValue){ .tag = TokenValue_tv_str_TAG, .payload = { .tv_str = { .v = "<=" } } });
            } else if ((c == '>') && (Lexer_peek(self, 1) == '=')) {
                (void)(Lexer_advance(self));
                (void)(Lexer_advance(self));
                Lexer_emit(self, (TokenType){ .tag = TokenType_GE_TAG }, (TokenValue){ .tag = TokenValue_tv_str_TAG, .payload = { .tv_str = { .v = ">=" } } });
            } else if ((c == '&') && (Lexer_peek(self, 1) == '&')) {
                (void)(Lexer_advance(self));
                (void)(Lexer_advance(self));
                Lexer_emit(self, (TokenType){ .tag = TokenType_AND_TAG }, (TokenValue){ .tag = TokenValue_tv_str_TAG, .payload = { .tv_str = { .v = "&&" } } });
            } else if ((c == '|') && (Lexer_peek(self, 1) == '|')) {
                (void)(Lexer_advance(self));
                (void)(Lexer_advance(self));
                Lexer_emit(self, (TokenType){ .tag = TokenType_OR_TAG }, (TokenValue){ .tag = TokenValue_tv_str_TAG, .payload = { .tv_str = { .v = "||" } } });
            } else if ((c == '<') && (Lexer_peek(self, 1) == '<')) {
                (void)(Lexer_advance(self));
                (void)(Lexer_advance(self));
                Lexer_emit(self, (TokenType){ .tag = TokenType_LSHIFT_TAG }, (TokenValue){ .tag = TokenValue_tv_str_TAG, .payload = { .tv_str = { .v = "<<" } } });
            } else if ((c == '>') && (Lexer_peek(self, 1) == '>')) {
                (void)(Lexer_advance(self));
                (void)(Lexer_advance(self));
                Lexer_emit(self, (TokenType){ .tag = TokenType_RSHIFT_TAG }, (TokenValue){ .tag = TokenValue_tv_str_TAG, .payload = { .tv_str = { .v = ">>" } } });
            } else if (((c == '.') && (Lexer_peek(self, 1) == '.')) && (Lexer_peek(self, 2) == '=')) {
                (void)(Lexer_advance(self));
                (void)(Lexer_advance(self));
                (void)(Lexer_advance(self));
                Lexer_emit(self, (TokenType){ .tag = TokenType_DOTDOTEQ_TAG }, (TokenValue){ .tag = TokenValue_tv_str_TAG, .payload = { .tv_str = { .v = "..=" } } });
            } else if ((c == '.') && (Lexer_peek(self, 1) == '.')) {
                (void)(Lexer_advance(self));
                (void)(Lexer_advance(self));
                Lexer_emit(self, (TokenType){ .tag = TokenType_DOTDOT_TAG }, (TokenValue){ .tag = TokenValue_tv_str_TAG, .payload = { .tv_str = { .v = ".." } } });
            } else if (c == '+') {
                (void)(Lexer_advance(self));
                Lexer_emit(self, (TokenType){ .tag = TokenType_PLUS_TAG }, (TokenValue){ .tag = TokenValue_tv_str_TAG, .payload = { .tv_str = { .v = "+" } } });
            } else if (c == '-') {
                (void)(Lexer_advance(self));
                Lexer_emit(self, (TokenType){ .tag = TokenType_MINUS_TAG }, (TokenValue){ .tag = TokenValue_tv_str_TAG, .payload = { .tv_str = { .v = "-" } } });
            } else if (c == '*') {
                (void)(Lexer_advance(self));
                Lexer_emit(self, (TokenType){ .tag = TokenType_MUL_TAG }, (TokenValue){ .tag = TokenValue_tv_str_TAG, .payload = { .tv_str = { .v = "*" } } });
            } else if (c == '/') {
                (void)(Lexer_advance(self));
                Lexer_emit(self, (TokenType){ .tag = TokenType_DIV_TAG }, (TokenValue){ .tag = TokenValue_tv_str_TAG, .payload = { .tv_str = { .v = "/" } } });
            } else if (c == '%') {
                (void)(Lexer_advance(self));
                Lexer_emit(self, (TokenType){ .tag = TokenType_MOD_TAG }, (TokenValue){ .tag = TokenValue_tv_str_TAG, .payload = { .tv_str = { .v = "%" } } });
            } else if (c == '=') {
                (void)(Lexer_advance(self));
                Lexer_emit(self, (TokenType){ .tag = TokenType_ASSIGN_TAG }, (TokenValue){ .tag = TokenValue_tv_str_TAG, .payload = { .tv_str = { .v = "=" } } });
            } else if (c == '<') {
                (void)(Lexer_advance(self));
                Lexer_emit(self, (TokenType){ .tag = TokenType_LT_TAG }, (TokenValue){ .tag = TokenValue_tv_str_TAG, .payload = { .tv_str = { .v = "<" } } });
            } else if (c == '>') {
                (void)(Lexer_advance(self));
                Lexer_emit(self, (TokenType){ .tag = TokenType_GT_TAG }, (TokenValue){ .tag = TokenValue_tv_str_TAG, .payload = { .tv_str = { .v = ">" } } });
            } else if (c == ':') {
                (void)(Lexer_advance(self));
                Lexer_emit(self, (TokenType){ .tag = TokenType_COLON_TAG }, (TokenValue){ .tag = TokenValue_tv_str_TAG, .payload = { .tv_str = { .v = ":" } } });
            } else if (c == ';') {
                (void)(Lexer_advance(self));
                Lexer_emit(self, (TokenType){ .tag = TokenType_SEMICOLON_TAG }, (TokenValue){ .tag = TokenValue_tv_str_TAG, .payload = { .tv_str = { .v = ";" } } });
            } else if (c == ',') {
                (void)(Lexer_advance(self));
                Lexer_emit(self, (TokenType){ .tag = TokenType_COMMA_TAG }, (TokenValue){ .tag = TokenValue_tv_str_TAG, .payload = { .tv_str = { .v = "," } } });
            } else if (c == '(') {
                (void)(Lexer_advance(self));
                self->paren_depth = (self->paren_depth + 1);
                Lexer_emit(self, (TokenType){ .tag = TokenType_LPAREN_TAG }, (TokenValue){ .tag = TokenValue_tv_str_TAG, .payload = { .tv_str = { .v = "(" } } });
            } else if (c == ')') {
                (void)(Lexer_advance(self));
                if (self->paren_depth > 0) {
                    self->paren_depth = (self->paren_depth - 1);
                }
                Lexer_emit(self, (TokenType){ .tag = TokenType_RPAREN_TAG }, (TokenValue){ .tag = TokenValue_tv_str_TAG, .payload = { .tv_str = { .v = ")" } } });
            } else if (c == '[') {
                (void)(Lexer_advance(self));
                self->paren_depth = (self->paren_depth + 1);
                Lexer_emit(self, (TokenType){ .tag = TokenType_LBRACKET_TAG }, (TokenValue){ .tag = TokenValue_tv_str_TAG, .payload = { .tv_str = { .v = "[" } } });
            } else if (c == ']') {
                (void)(Lexer_advance(self));
                if (self->paren_depth > 0) {
                    self->paren_depth = (self->paren_depth - 1);
                }
                Lexer_emit(self, (TokenType){ .tag = TokenType_RBRACKET_TAG }, (TokenValue){ .tag = TokenValue_tv_str_TAG, .payload = { .tv_str = { .v = "]" } } });
            } else if (c == '{') {
                (void)(Lexer_advance(self));
                self->brace_depth = (self->brace_depth + 1);
                Lexer_emit(self, (TokenType){ .tag = TokenType_LBRACE_TAG }, (TokenValue){ .tag = TokenValue_tv_str_TAG, .payload = { .tv_str = { .v = "{" } } });
            } else if (c == '}') {
                (void)(Lexer_advance(self));
                if (self->brace_depth > 0) {
                    self->brace_depth = (self->brace_depth - 1);
                }
                Lexer_emit(self, (TokenType){ .tag = TokenType_RBRACE_TAG }, (TokenValue){ .tag = TokenValue_tv_str_TAG, .payload = { .tv_str = { .v = "}" } } });
            } else if (c == '&') {
                (void)(Lexer_advance(self));
                Lexer_emit(self, (TokenType){ .tag = TokenType_AMP_TAG }, (TokenValue){ .tag = TokenValue_tv_str_TAG, .payload = { .tv_str = { .v = "&" } } });
            } else if (c == '#') {
                (void)(Lexer_advance(self));
                Lexer_emit(self, (TokenType){ .tag = TokenType_HASH_TAG }, (TokenValue){ .tag = TokenValue_tv_str_TAG, .payload = { .tv_str = { .v = "#" } } });
            } else if (c == '!') {
                (void)(Lexer_advance(self));
                Lexer_emit(self, (TokenType){ .tag = TokenType_NOT_TAG }, (TokenValue){ .tag = TokenValue_tv_str_TAG, .payload = { .tv_str = { .v = "!" } } });
            } else if (c == '?') {
                (void)(Lexer_advance(self));
                Lexer_emit(self, (TokenType){ .tag = TokenType_QUESTION_TAG }, (TokenValue){ .tag = TokenValue_tv_str_TAG, .payload = { .tv_str = { .v = "?" } } });
            } else if (c == '^') {
                (void)(Lexer_advance(self));
                Lexer_emit(self, (TokenType){ .tag = TokenType_BITXOR_TAG }, (TokenValue){ .tag = TokenValue_tv_str_TAG, .payload = { .tv_str = { .v = "^" } } });
            } else if (c == '~') {
                (void)(Lexer_advance(self));
                Lexer_emit(self, (TokenType){ .tag = TokenType_BITNOT_TAG }, (TokenValue){ .tag = TokenValue_tv_str_TAG, .payload = { .tv_str = { .v = "~" } } });
            } else if (c == '|') {
                (void)(Lexer_advance(self));
                Lexer_emit(self, (TokenType){ .tag = TokenType_PIPE_TAG }, (TokenValue){ .tag = TokenValue_tv_str_TAG, .payload = { .tv_str = { .v = "|" } } });
            } else if (c == '.') {
                (void)(Lexer_advance(self));
                Lexer_emit(self, (TokenType){ .tag = TokenType_DOT_TAG }, (TokenValue){ .tag = TokenValue_tv_str_TAG, .payload = { .tv_str = { .v = "." } } });
            }
        }
    }
    while (false) {
        (void)(ArrayList_Int_pop(self->indent_stack));
        Lexer_emit(self, (TokenType){ .tag = TokenType_DEDENT_TAG }, (TokenValue){ .tag = TokenValue_tv_int_TAG, .payload = { .tv_int = { .v = 0 } } });
    }
    Lexer_emit(self, (TokenType){ .tag = TokenType_EOF_TAG }, (TokenValue){ .tag = TokenValue_tv_none_TAG });
}
ArrayList_DropVarEntry empty_dropvarentry_array(void) {
...
int64_t token_precedence(TokenType ttype) {
    if ((ttype).tag == ((TokenType){ .tag = TokenType_DOT_TAG }).tag) {
        return 9;
    } else if ((ttype).tag == ((TokenType){ .tag = TokenType_LBRACKET_TAG }).tag) {
        return 8;
    } else if ((ttype).tag == ((TokenType){ .tag = TokenType_AS_TAG }).tag) {
        return 8;
    } else if ((((ttype).tag == ((TokenType){ .tag = TokenType_MUL_TAG }).tag) || ((ttype).tag == ((TokenType){ .tag = TokenType_DIV_TAG }).tag)) || ((ttype).tag == ((TokenType){ .tag = TokenType_MOD_TAG }).tag)) {
        return 7;
    } else if (((ttype).tag == ((TokenType){ .tag = TokenType_PLUS_TAG }).tag) || ((ttype).tag == ((TokenType){ .tag = TokenType_MINUS_TAG }).tag)) {
        return 6;
    } else if (((ttype).tag == ((TokenType){ .tag = TokenType_LSHIFT_TAG }).tag) || ((ttype).tag == ((TokenType){ .tag = TokenType_RSHIFT_TAG }).tag)) {
        return 5;
    } else if (((((((ttype).tag == ((TokenType){ .tag = TokenType_EQ_TAG }).tag) || ((ttype).tag == ((TokenType){ .tag = TokenType_NE_TAG }).tag)) || ((ttype).tag == ((TokenType){ .tag = TokenType_LT_TAG }).tag)) || ((ttype).tag == ((TokenType){ .tag = TokenType_LE_TAG }).tag)) || ((ttype).tag == ((TokenType){ .tag = TokenType_GT_TAG }).tag)) || ((ttype).tag == ((TokenType){ .tag = TokenType_GE_TAG }).tag)) {
        return 4;
    } else if ((((ttype).tag == ((TokenType){ .tag = TokenType_PIPE_TAG }).tag) || ((ttype).tag == ((TokenType){ .tag = TokenType_BITXOR_TAG }).tag)) || ((ttype).tag == ((TokenType){ .tag = TokenType_AMP_TAG }).tag)) {
        return 3;
    } else if ((ttype).tag == ((TokenType){ .tag = TokenType_CATCH_TAG }).tag) {
        return 3;
    } else if ((ttype).tag == ((TokenType){ .tag = TokenType_AND_TAG }).tag) {
        return 2;
    } else if ((ttype).tag == ((TokenType){ .tag = TokenType_OR_TAG }).tag) {
        return 1;
    } else if (((ttype).tag == ((TokenType){ .tag = TokenType_DOTDOT_TAG }).tag) || ((ttype).tag == ((TokenType){ .tag = TokenType_DOTDOTEQ_TAG }).tag)) {
        return 4;
    }
    return 0;
}
const char* token_op_str(TokenType ttype) {
    if ((ttype).tag == ((TokenType){ .tag = TokenType_PLUS_TAG }).tag) {
        return "+";
    } else if ((ttype).tag == ((TokenType){ .tag = TokenType_MINUS_TAG }).tag) {
        return "-";
    } else if ((ttype).tag == ((TokenType){ .tag = TokenType_MUL_TAG }).tag) {
        return "*";
    } else if ((ttype).tag == ((TokenType){ .tag = TokenType_DIV_TAG }).tag) {
        return "/";
    } else if ((ttype).tag == ((TokenType){ .tag = TokenType_MOD_TAG }).tag) {
        return "%";
    } else if ((ttype).tag == ((TokenType){ .tag = TokenType_ASSIGN_TAG }).tag) {
        return "=";
    } else if ((ttype).tag == ((TokenType){ .tag = TokenType_PLUS_ASSIGN_TAG }).tag) {
        return "+=";
    } else if ((ttype).tag == ((TokenType){ .tag = TokenType_MINUS_ASSIGN_TAG }).tag) {
        return "-=";
    } else if ((ttype).tag == ((TokenType){ .tag = TokenType_EQ_TAG }).tag) {
        return "==";
    } else if ((ttype).tag == ((TokenType){ .tag = TokenType_NE_TAG }).tag) {
        return "!=";
    } else if ((ttype).tag == ((TokenType){ .tag = TokenType_LT_TAG }).tag) {
        return "<";
    } else if ((ttype).tag == ((TokenType){ .tag = TokenType_LE_TAG }).tag) {
        return "<=";
    } else if ((ttype).tag == ((TokenType){ .tag = TokenType_GT_TAG }).tag) {
        return ">";
    } else if ((ttype).tag == ((TokenType){ .tag = TokenType_GE_TAG }).tag) {
        return ">=";
    } else if ((ttype).tag == ((TokenType){ .tag = TokenType_AND_TAG }).tag) {
        return "&&";
    } else if ((ttype).tag == ((TokenType){ .tag = TokenType_OR_TAG }).tag) {
        return "||";
    } else if ((ttype).tag == ((TokenType){ .tag = TokenType_PIPE_TAG }).tag) {
        return "|";
    } else if ((ttype).tag == ((TokenType){ .tag = TokenType_BITXOR_TAG }).tag) {
        return "^";
    } else if ((ttype).tag == ((TokenType){ .tag = TokenType_AMP_TAG }).tag) {
        return "&";
    } else if ((ttype).tag == ((TokenType){ .tag = TokenType_LSHIFT_TAG }).tag) {
        return "<<";
    } else if ((ttype).tag == ((TokenType){ .tag = TokenType_RSHIFT_TAG }).tag) {
        return ">>";
    } else if ((ttype).tag == ((TokenType){ .tag = TokenType_DOTDOT_TAG }).tag) {
        return "..";
    } else if ((ttype).tag == ((TokenType){ .tag = TokenType_DOTDOTEQ_TAG }).tag) {
        return "..=";
    } else if ((ttype).tag == ((TokenType){ .tag = TokenType_DOT_TAG }).tag) {
        return ".";
    }
    return "?";
}
...
Token Parser_peek(Parser* self, int64_t offset) {
    if (self->pending_gt && (offset == 0)) {
        return (Token){ .tok_type = (TokenType){ .tag = TokenType_GT_TAG }, .value = (TokenValue){ .tag = TokenValue_tv_str_TAG, .payload = { .tv_str = { .v = ">" } } }, .line = self->pending_gt_line, .column = self->pending_gt_col };
    }
    int64_t pos = (self->cursor + offset);
...
Token Parser_advance(Parser* self) {
    ...
    if ((tok.tok_type).tag != ((TokenType){ .tag = TokenType_EOF_TAG }).tag) {
        self->cursor = (self->cursor + 1);
    }
    return tok;
}
bool Parser_match_token(Parser* self, TokenType ttype) {
    if ((Parser_peek(self, 0).tok_type).tag == (ttype).tag) {
...
Token Parser_expect(Parser* self, TokenType ttype) {
    if (self->pending_gt) {
        if ((ttype).tag == ((TokenType){ .tag = TokenType_GT_TAG }).tag) {
            self->pending_gt = false;
            return (Token){ .tok_type = (TokenType){ .tag = TokenType_GT_TAG }, .value = (TokenValue){ .tag = TokenValue_tv_str_TAG, .payload = { .tv_str = { .v = ">" } } }, .line = self->pending_gt_line, .column = self->pending_gt_col };
        }
        self->pending_gt = false;
    ...
    Token tok = Parser_peek(self, 0);
    if (((ttype).tag == ((TokenType){ .tag = TokenType_GT_TAG }).tag) && ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_RSHIFT_TAG }).tag)) {
        (void)(Parser_advance(self));
        self->pending_gt = true;
        self->pending_gt_line = tok.line;
        self->pending_gt_col = (tok.column + 1);
        return (Token){ .tok_type = (TokenType){ .tag = TokenType_GT_TAG }, .value = (TokenValue){ .tag = TokenValue_tv_str_TAG, .payload = { .tv_str = { .v = ">" } } }, .line = tok.line, .column = tok.column };
    }
    if ((tok.tok_type).tag == (ttype).tag) {
    ...
    }
    {
        ...
        printf("%s\n", "expected tag:");
        print_int(((int64_t)((ttype).tag)));
        printf("%s\n", "found tag:");
        print_int(((int64_t)((tok.tok_type).tag)));
        if (tok.tok_type.tag == TokenType_INT_LIT_TAG) {
            exit(0);
        }
else if (tok.tok_type.tag == TokenType_FLOAT_LIT_TAG) {
            exit(1);
        }
else if (tok.tok_type.tag == TokenType_BOOL_LIT_TAG) {
            exit(2);
        }
else if (tok.tok_type.tag == TokenType_CHAR_LIT_TAG) {
            exit(3);
        }
else if (tok.tok_type.tag == TokenType_STRING_LIT_TAG) {
            exit(4);
        }
else if (tok.tok_type.tag == TokenType_IDENTIFIER_TAG) {
            exit(5);
        }
else if (tok.tok_type.tag == TokenType_LET_TAG) {
            exit(6);
        }
else if (tok.tok_type.tag == TokenType_VAR_TAG) {
            exit(7);
        }
else if (tok.tok_type.tag == TokenType_FUNC_TAG) {
            exit(8);
        }
else if (tok.tok_type.tag == TokenType_IF_TAG) {
            exit(9);
        }
else if (tok.tok_type.tag == TokenType_ELSE_TAG) {
            exit(10);
        }
else if (tok.tok_type.tag == TokenType_WHILE_TAG) {
            exit(11);
        }
else if (tok.tok_type.tag == TokenType_FOR_TAG) {
            exit(12);
        }
else if (tok.tok_type.tag == TokenType_IN_TAG) {
            exit(13);
        }
else if (tok.tok_type.tag == TokenType_RETURN_TAG) {
            exit(14);
        }
else if (tok.tok_type.tag == TokenType_PRINT_TAG) {
            exit(15);
        }
else if (tok.tok_type.tag == TokenType_STRUCT_TAG) {
            exit(16);
        }
else if (tok.tok_type.tag == TokenType_IMPL_TAG) {
            exit(17);
        }
else if (tok.tok_type.tag == TokenType_MUT_TAG) {
            exit(18);
        }
else if (tok.tok_type.tag == TokenType_UNSAFE_TAG) {
            exit(19);
        }
else if (tok.tok_type.tag == TokenType_EXTERN_TAG) {
            exit(20);
        }
else if (tok.tok_type.tag == TokenType_ENUM_TAG) {
            exit(21);
        }
else if (tok.tok_type.tag == TokenType_MATCH_TAG) {
            exit(22);
        }
else if (tok.tok_type.tag == TokenType_CASE_TAG) {
            exit(23);
        }
else if (tok.tok_type.tag == TokenType_USE_TAG) {
            exit(24);
        }
else if (tok.tok_type.tag == TokenType_CHECK_TAG) {
            exit(25);
        }
else if (tok.tok_type.tag == TokenType_TRAIT_TAG) {
            exit(26);
        }
else if (tok.tok_type.tag == TokenType_PUB_TAG) {
            exit(27);
        }
else if (tok.tok_type.tag == TokenType_IMPORT_TAG) {
            exit(28);
        }
else if (tok.tok_type.tag == TokenType_CIMPORT_TAG) {
            exit(99);
        }
else if (tok.tok_type.tag == TokenType_FROM_TAG) {
            exit(29);
        }
else if (tok.tok_type.tag == TokenType_AS_TAG) {
            exit(30);
        }
else if (tok.tok_type.tag == TokenType_SIZEOF_TAG) {
            exit(31);
        }
else if (tok.tok_type.tag == TokenType_DEFER_TAG) {
            exit(32);
        }
else if (tok.tok_type.tag == TokenType_NONE_TAG) {
            exit(33);
        }
else if (tok.tok_type.tag == TokenType_FN_TAG) {
            exit(34);
        }
else if (tok.tok_type.tag == TokenType_TRY_TAG) {
            exit(35);
        }
else if (tok.tok_type.tag == TokenType_CATCH_TAG) {
            exit(36);
        }
else if (tok.tok_type.tag == TokenType_OWN_TAG) {
            exit(37);
        }
else if (tok.tok_type.tag == TokenType_ERROR_TAG) {
            exit(38);
        }
else if (tok.tok_type.tag == TokenType_ASM_TAG) {
            exit(39);
        }
else if (tok.tok_type.tag == TokenType_VOLATILE_TAG) {
            exit(40);
        }
else if (tok.tok_type.tag == TokenType_PLUS_TAG) {
            exit(41);
        }
else if (tok.tok_type.tag == TokenType_MINUS_TAG) {
            exit(42);
        }
else if (tok.tok_type.tag == TokenType_MUL_TAG) {
            exit(43);
        }
else if (tok.tok_type.tag == TokenType_DIV_TAG) {
            exit(44);
        }
else if (tok.tok_type.tag == TokenType_MOD_TAG) {
            exit(45);
        }
else if (tok.tok_type.tag == TokenType_ASSIGN_TAG) {
            exit(46);
        }
else if (tok.tok_type.tag == TokenType_PLUS_ASSIGN_TAG) {
            exit(47);
        }
else if (tok.tok_type.tag == TokenType_MINUS_ASSIGN_TAG) {
            exit(48);
        }
else if (tok.tok_type.tag == TokenType_AND_TAG) {
            exit(49);
        }
else if (tok.tok_type.tag == TokenType_OR_TAG) {
            exit(50);
        }
else if (tok.tok_type.tag == TokenType_NOT_TAG) {
            exit(51);
        }
else if (tok.tok_type.tag == TokenType_PIPE_TAG) {
            exit(52);
        }
else if (tok.tok_type.tag == TokenType_BITXOR_TAG) {
            exit(53);
        }
else if (tok.tok_type.tag == TokenType_BITNOT_TAG) {
            exit(54);
        }
else if (tok.tok_type.tag == TokenType_LSHIFT_TAG) {
            exit(55);
        }
else if (tok.tok_type.tag == TokenType_RSHIFT_TAG) {
            exit(56);
        }
else if (tok.tok_type.tag == TokenType_EQ_TAG) {
            exit(57);
        }
else if (tok.tok_type.tag == TokenType_NE_TAG) {
            exit(58);
        }
else if (tok.tok_type.tag == TokenType_LT_TAG) {
            exit(59);
        }
else if (tok.tok_type.tag == TokenType_LE_TAG) {
            exit(60);
        }
else if (tok.tok_type.tag == TokenType_GT_TAG) {
            exit(61);
        }
else if (tok.tok_type.tag == TokenType_GE_TAG) {
            exit(62);
        }
else if (tok.tok_type.tag == TokenType_COLON_TAG) {
            exit(63);
        }
else if (tok.tok_type.tag == TokenType_ARROW_TAG) {
            exit(64);
        }
else if (tok.tok_type.tag == TokenType_FAT_ARROW_TAG) {
            exit(65);
        }
else if (tok.tok_type.tag == TokenType_COMMA_TAG) {
            exit(66);
        }
else if (tok.tok_type.tag == TokenType_LPAREN_TAG) {
            exit(67);
        }
else if (tok.tok_type.tag == TokenType_RPAREN_TAG) {
            exit(68);
        }
else if (tok.tok_type.tag == TokenType_LBRACKET_TAG) {
            exit(69);
        }
else if (tok.tok_type.tag == TokenType_RBRACKET_TAG) {
            exit(70);
        }
else if (tok.tok_type.tag == TokenType_LBRACE_TAG) {
            exit(71);
        }
else if (tok.tok_type.tag == TokenType_RBRACE_TAG) {
            exit(72);
        }
else if (tok.tok_type.tag == TokenType_DOTDOT_TAG) {
            exit(73);
        }
else if (tok.tok_type.tag == TokenType_DOTDOTEQ_TAG) {
            exit(74);
        }
else if (tok.tok_type.tag == TokenType_DOT_TAG) {
            exit(75);
        }
else if (tok.tok_type.tag == TokenType_AMP_TAG) {
            exit(76);
        }
else if (tok.tok_type.tag == TokenType_HASH_TAG) {
            exit(77);
        }
else if (tok.tok_type.tag == TokenType_QUESTION_TAG) {
            exit(78);
        }
else if (tok.tok_type.tag == TokenType_SEMICOLON_TAG) {
            exit(85);
        }
else if (tok.tok_type.tag == TokenType_BREAK_TAG) {
            exit(83);
        }
else if (tok.tok_type.tag == TokenType_CONTINUE_TAG) {
            exit(84);
        }
else if (tok.tok_type.tag == TokenType_NEWLINE_TAG) {
            exit(79);
        }
else if (tok.tok_type.tag == TokenType_INDENT_TAG) {
            exit(80);
        }
else if (tok.tok_type.tag == TokenType_DEDENT_TAG) {
            exit(81);
        }
else if (tok.tok_type.tag == TokenType_EOF_TAG) {
            exit(82);
        }
        exit(255);
    }
...
void Parser_consume_newlines(Parser* self) {
    bool done = false;
    while (!done) {
        if (Parser_match_token(self, (TokenType){ .tag = TokenType_NEWLINE_TAG })) {
            done = false;
        } else {
            done = true;
        }
...
void Parser_expect_end_of_statement(Parser* self) {
    Token tok = Parser_peek(self, 0);
    if (((((tok.tok_type).tag == ((TokenType){ .tag = TokenType_RBRACE_TAG }).tag) || ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_DEDENT_TAG }).tag)) || ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_EOF_TAG }).tag)) || ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_LBRACE_TAG }).tag)) {
        return;
    }
    if ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_SEMICOLON_TAG }).tag) {
        (void)(Parser_advance(self));
        return;
    }
    (void)(Parser_expect(self, (TokenType){ .tag = TokenType_NEWLINE_TAG }));
}
bool Parser_is_generic_instantiation(Parser* self) {
    if ((Parser_peek(self, 1).tok_type).tag != ((TokenType){ .tag = TokenType_LT_TAG }).tag) {
        return false;
    }
    int64_t offset = 2;
    int64_t nested = 1;
    ...
    while (!done) {
        ...
        if ((((tok.tok_type).tag == ((TokenType){ .tag = TokenType_EOF_TAG }).tag) || ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_NEWLINE_TAG }).tag)) || ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_SEMICOLON_TAG }).tag)) {
            return false;
        }
        TokenType tt = tok.tok_type;
        if (((((((((tt).tag == ((TokenType){ .tag = TokenType_IDENTIFIER_TAG }).tag) || ((tt).tag == ((TokenType){ .tag = TokenType_MUL_TAG }).tag)) || ((tt).tag == ((TokenType){ .tag = TokenType_AMP_TAG }).tag)) || ((tt).tag == ((TokenType){ .tag = TokenType_LBRACKET_TAG }).tag)) || ((tt).tag == ((TokenType){ .tag = TokenType_RBRACKET_TAG }).tag)) || ((tt).tag == ((TokenType){ .tag = TokenType_COMMA_TAG }).tag)) || ((tt).tag == ((TokenType){ .tag = TokenType_QUESTION_TAG }).tag)) || ((tt).tag == ((TokenType){ .tag = TokenType_MUT_TAG }).tag)) {
            done = false;
        } else if ((tt).tag == ((TokenType){ .tag = TokenType_LT_TAG }).tag) {
            nested = (nested + 1);
        } else if ((tt).tag == ((TokenType){ .tag = TokenType_GT_TAG }).tag) {
            nested = (nested - 1);
            if (nested <= 0) {
                return (((Parser_peek(self, (offset + 1)).tok_type).tag == ((TokenType){ .tag = TokenType_LPAREN_TAG }).tag) || ((Parser_peek(self, (offset + 1)).tok_type).tag == ((TokenType){ .tag = TokenType_DOT_TAG }).tag));
            }
        } else if ((tt).tag == ((TokenType){ .tag = TokenType_RSHIFT_TAG }).tag) {
            nested = (nested - 2);
            if (nested <= 0) {
                return (((Parser_peek(self, (offset + 1)).tok_type).tag == ((TokenType){ .tag = TokenType_LPAREN_TAG }).tag) || ((Parser_peek(self, (offset + 1)).tok_type).tag == ((TokenType){ .tag = TokenType_DOT_TAG }).tag));
            }
...
int64_t Parser_ex_literal(Parser* self, TokenValue val, const char* vkind) {
    ExprNode node = new_expr_node((ExprKind){ .tag = ExprKind_ek_literal_TAG });
    node.lit_value = val;
...
int64_t Parser_ex_ident(Parser* self, const char* name) {
    ExprNode node = new_expr_node((ExprKind){ .tag = ExprKind_ek_identifier_TAG });
...
int64_t Parser_ex_binop(Parser* self, const char* op, int64_t left, int64_t right) {
    ExprNode node = new_expr_node((ExprKind){ .tag = ExprKind_ek_binary_op_TAG });
    node.binop_op = op;
...
int64_t Parser_ex_unop(Parser* self, const char* op, int64_t operand) {
    ExprNode node = new_expr_node((ExprKind){ .tag = ExprKind_ek_unary_op_TAG });
    node.unop_op = op;
...
int64_t Parser_ex_call(Parser* self, const char* name, ArrayList_Int args) {
    ExprNode node = new_expr_node((ExprKind){ .tag = ExprKind_ek_func_call_TAG });
    node.func_name = name;
    node.func_args = args;
    ArrayList_ExprNode_push(self->expr_pool, node);
    return (ArrayList_ExprNode_length(self->expr_pool) - 1);
...
int64_t Parser_ex_struct_init(Parser* self, const char* name, ArrayList_FieldInit fields) {
    ExprNode node = new_expr_node((ExprKind){ .tag = ExprKind_ek_struct_init_TAG });
...
int64_t Parser_ex_field(Parser* self, int64_t expr, const char* field) {
    ExprNode node = new_expr_node((ExprKind){ .tag = ExprKind_ek_field_access_TAG });
...
int64_t Parser_ex_method(Parser* self, int64_t expr, const char* method, ArrayList_Int args) {
    ExprNode node = new_expr_node((ExprKind){ .tag = ExprKind_ek_method_call_TAG });
    node.meth_expr = expr;
...
int64_t Parser_ex_index(Parser* self, int64_t expr, int64_t idx) {
    ExprNode node = new_expr_node((ExprKind){ .tag = ExprKind_ek_index_TAG });
    node.idx_expr = expr;
    node.idx_index = idx;
    ArrayList_ExprNode_push(self->expr_pool, node);
    return (ArrayList_ExprNode_length(self->expr_pool) - 1);
...
int64_t Parser_ex_check(Parser* self, int64_t expr) {
    ExprNode node = new_expr_node((ExprKind){ .tag = ExprKind_ek_check_TAG });
    node.check_expr = expr;
    ArrayList_ExprNode_push(self->expr_pool, node);
    return (ArrayList_ExprNode_length(self->expr_pool) - 1);
}
int64_t Parser_ex_slice(Parser* self, int64_t expr, int64_t lower, int64_t upper, bool is_inclusive) {
    ExprNode node = new_expr_node((ExprKind){ .tag = ExprKind_ek_slice_TAG });
...
int64_t Parser_ex_range(Parser* self, int64_t start, int64_t end, bool is_inclusive) {
    ExprNode node = new_expr_node((ExprKind){ .tag = ExprKind_ek_range_TAG });
...
int64_t Parser_ex_array(Parser* self, ArrayList_Int elements) {
    ExprNode node = new_expr_node((ExprKind){ .tag = ExprKind_ek_array_TAG });
    node.arr_elements = elements;
    ArrayList_ExprNode_push(self->expr_pool, node);
    return (ArrayList_ExprNode_length(self->expr_pool) - 1);
}
int64_t Parser_ex_tuple(Parser* self, ArrayList_Int elements) {
    ExprNode node = new_expr_node((ExprKind){ .tag = ExprKind_ek_tuple_TAG });
    node.tup_elements = elements;
    ArrayList_ExprNode_push(self->expr_pool, node);
    return (ArrayList_ExprNode_length(self->expr_pool) - 1);
}
int64_t Parser_ex_borrow(Parser* self, int64_t expr, bool is_mut) {
    ExprNode node = new_expr_node((ExprKind){ .tag = ExprKind_ek_borrow_TAG });
...
int64_t Parser_ex_deref(Parser* self, int64_t expr) {
    ExprNode node = new_expr_node((ExprKind){ .tag = ExprKind_ek_deref_TAG });
    node.deref_expr = expr;
    ArrayList_ExprNode_push(self->expr_pool, node);
    return (ArrayList_ExprNode_length(self->expr_pool) - 1);
}
int64_t Parser_ex_try(Parser* self, int64_t expr) {
    ExprNode node = new_expr_node((ExprKind){ .tag = ExprKind_ek_try_TAG });
    node.try_expr = expr;
    ArrayList_ExprNode_push(self->expr_pool, node);
    return (ArrayList_ExprNode_length(self->expr_pool) - 1);
}
int64_t Parser_ex_catch(Parser* self, int64_t expr, const char* var_name, int64_t fallback) {
    ExprNode node = new_expr_node((ExprKind){ .tag = ExprKind_ek_catch_TAG });
...
int64_t Parser_ex_asm(Parser* self, const char* code, bool is_volatile, ArrayList_AsmOutput outputs, ArrayList_AsmInput inputs, ArrayList_Str clobbers) {
    ExprNode node = new_expr_node((ExprKind){ .tag = ExprKind_ek_asm_TAG });
    node.asm_code = code;
...
int64_t Parser_st_block(Parser* self, ArrayList_Int stmts) {
    StmtNode node = new_stmt_node((StmtKind){ .tag = StmtKind_sk_block_TAG });
    node.block_stmts = stmts;
    ArrayList_StmtNode_push(self->stmt_pool, node);
    return (ArrayList_StmtNode_length(self->stmt_pool) - 1);
}
int64_t Parser_st_error(Parser* self, const char* name, ArrayList_Str variants) {
    StmtNode node = new_stmt_node((StmtKind){ .tag = StmtKind_sk_error_decl_TAG });
...
int64_t Parser_st_var_decl(Parser* self, const char* name, const char* type_ann, int64_t value, bool is_mut) {
    StmtNode node = new_stmt_node((StmtKind){ .tag = StmtKind_sk_var_decl_TAG });
...
int64_t Parser_st_assign(Parser* self, int64_t target, int64_t value, const char* op) {
    StmtNode node = new_stmt_node((StmtKind){ .tag = StmtKind_sk_assignment_TAG });
...
int64_t Parser_st_func(Parser* self, const char* name, ArrayList_Param params, const char* ret_type, int64_t body, const char* cap, ArrayList_Str tp) {
    StmtNode node = new_stmt_node((StmtKind){ .tag = StmtKind_sk_func_decl_TAG });
    node.func_name = name;
...
int64_t Parser_st_struct(Parser* self, const char* name, ArrayList_StructField fields, ArrayList_Str tp, ArrayList_Int methods, ArrayList_Int impls) {
    StmtNode node = new_stmt_node((StmtKind){ .tag = StmtKind_sk_struct_decl_TAG });
    node.struct_name = name;
    node.struct_fields = fields;
...
int64_t Parser_st_impl(Parser* self, const char* struct_name, const char* trait_name, ArrayList_Int methods) {
    StmtNode node = new_stmt_node((StmtKind){ .tag = StmtKind_sk_impl_block_TAG });
...
int64_t Parser_st_trait(Parser* self, const char* name, ArrayList_Int methods) {
    StmtNode node = new_stmt_node((StmtKind){ .tag = StmtKind_sk_trait_decl_TAG });
...
int64_t Parser_st_enum(Parser* self, const char* name, ArrayList_Variant variants, ArrayList_Str tp) {
    StmtNode node = new_stmt_node((StmtKind){ .tag = StmtKind_sk_enum_decl_TAG });
    node.enum_name = name;
...
int64_t Parser_st_match(Parser* self, int64_t expr, ArrayList_MatchCase cases) {
    StmtNode node = new_stmt_node((StmtKind){ .tag = StmtKind_sk_match_TAG });
...
int64_t Parser_st_unsafe(Parser* self, int64_t body) {
    StmtNode node = new_stmt_node((StmtKind){ .tag = StmtKind_sk_unsafe_TAG });
    node.unsafe_body = body;
    ArrayList_StmtNode_push(self->stmt_pool, node);
    return (ArrayList_StmtNode_length(self->stmt_pool) - 1);
}
int64_t Parser_st_extern(Parser* self, const char* name, ArrayList_Param params, const char* ret) {
    StmtNode node = new_stmt_node((StmtKind){ .tag = StmtKind_sk_extern_TAG });
...
int64_t Parser_st_if(Parser* self, int64_t cond, int64_t then_b, int64_t else_b) {
    StmtNode node = new_stmt_node((StmtKind){ .tag = StmtKind_sk_if_TAG });
    node.if_cond = cond;
    node.if_then = then_b;
    node.if_else = else_b;
    ArrayList_StmtNode_push(self->stmt_pool, node);
...
int64_t Parser_st_if_let(Parser* self, const char* vname, int64_t expr, int64_t then_b, int64_t else_b) {
    StmtNode node = new_stmt_node((StmtKind){ .tag = StmtKind_sk_if_let_TAG });
...
int64_t Parser_st_while(Parser* self, int64_t cond, int64_t body) {
    StmtNode node = new_stmt_node((StmtKind){ .tag = StmtKind_sk_while_TAG });
...
int64_t Parser_st_for(Parser* self, const char* var_name, int64_t start, int64_t end, bool inc, int64_t body) {
    StmtNode node = new_stmt_node((StmtKind){ .tag = StmtKind_sk_for_TAG });
...
int64_t Parser_st_return(Parser* self, int64_t value) {
    StmtNode node = new_stmt_node((StmtKind){ .tag = StmtKind_sk_return_TAG });
    node.return_value = value;
    ArrayList_StmtNode_push(self->stmt_pool, node);
    return (ArrayList_StmtNode_length(self->stmt_pool) - 1);
}
int64_t Parser_st_print(Parser* self, int64_t value) {
    StmtNode node = new_stmt_node((StmtKind){ .tag = StmtKind_sk_print_TAG });
    node.print_value = value;
    ArrayList_StmtNode_push(self->stmt_pool, node);
    return (ArrayList_StmtNode_length(self->stmt_pool) - 1);
}
int64_t Parser_st_expr(Parser* self, int64_t expr) {
    StmtNode node = new_stmt_node((StmtKind){ .tag = StmtKind_sk_expr_TAG });
    node.expr_stmt = expr;
    ArrayList_StmtNode_push(self->stmt_pool, node);
    return (ArrayList_StmtNode_length(self->stmt_pool) - 1);
}
int64_t Parser_st_defer(Parser* self, int64_t body) {
    StmtNode node = new_stmt_node((StmtKind){ .tag = StmtKind_sk_defer_TAG });
    node.defer_body = body;
    ArrayList_StmtNode_push(self->stmt_pool, node);
    return (ArrayList_StmtNode_length(self->stmt_pool) - 1);
}
int64_t Parser_st_break(Parser* self) {
    StmtNode node = new_stmt_node((StmtKind){ .tag = StmtKind_sk_break_TAG });
    ArrayList_StmtNode_push(self->stmt_pool, node);
    return (ArrayList_StmtNode_length(self->stmt_pool) - 1);
}
int64_t Parser_st_continue(Parser* self) {
    StmtNode node = new_stmt_node((StmtKind){ .tag = StmtKind_sk_continue_TAG });
    ArrayList_StmtNode_push(self->stmt_pool, node);
    return (ArrayList_StmtNode_length(self->stmt_pool) - 1);
}
int64_t Parser_st_import(Parser* self, ArrayList_Str path, const char* alias) {
    StmtNode node = new_stmt_node((StmtKind){ .tag = StmtKind_sk_import_TAG });
...
int64_t Parser_st_cimport(Parser* self, const char* header, const char* alias) {
    StmtNode node = new_stmt_node((StmtKind){ .tag = StmtKind_sk_cimport_TAG });
...
int64_t Parser_parse_program(Parser* self) {
    ...
    while ((Parser_peek(self, 0).tok_type).tag != ((TokenType){ .tag = TokenType_EOF_TAG }).tag) {
...
int64_t Parser_parse_statement(Parser* self) {
    ...
    if ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_PUB_TAG }).tag) {
        (void)(Parser_advance(self));
        is_public = true;
        tok = Parser_peek(self, 0);
    }
    if ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_LET_TAG }).tag) {
        return Parser_parse_var_decl(self, false);
    } else if ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_VAR_TAG }).tag) {
        return Parser_parse_var_decl(self, true);
    } else if ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_ERROR_TAG }).tag) {
        return Parser_parse_error_decl(self);
    } else if ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_FUNC_TAG }).tag) {
        ...
        return idx;
    } else if ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_STRUCT_TAG }).tag) {
        ...
        return idx;
    } else if ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_IMPL_TAG }).tag) {
        return Parser_parse_impl_block(self);
    } else if ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_ENUM_TAG }).tag) {
        ...
        return idx;
    } else if ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_MATCH_TAG }).tag) {
        return Parser_parse_match_stmt(self);
    } else if ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_UNSAFE_TAG }).tag) {
        return Parser_parse_unsafe_block(self);
    } else if ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_EXTERN_TAG }).tag) {
        return Parser_parse_extern_decl(self);
    } else if ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_IF_TAG }).tag) {
        return Parser_parse_if_stmt(self);
    } else if ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_WHILE_TAG }).tag) {
        return Parser_parse_while_stmt(self);
    } else if ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_FOR_TAG }).tag) {
        return Parser_parse_for_stmt(self);
    } else if ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_RETURN_TAG }).tag) {
        return Parser_parse_return_stmt(self);
    } else if ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_PRINT_TAG }).tag) {
        return Parser_parse_print_stmt(self);
    } else if ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_DEFER_TAG }).tag) {
        return Parser_parse_defer_stmt(self);
    } else if ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_BREAK_TAG }).tag) {
        return Parser_parse_break_stmt(self);
    } else if ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_CONTINUE_TAG }).tag) {
        return Parser_parse_continue_stmt(self);
    } else if ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_USE_TAG }).tag) {
        return Parser_parse_import_stmt(self);
    } else if ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_IMPORT_TAG }).tag) {
        return Parser_parse_import_stmt_new(self);
    } else if ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_CIMPORT_TAG }).tag) {
        return Parser_parse_cimport_stmt(self);
    } else if ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_TRAIT_TAG }).tag) {
...
const char* Parser_parse_type(Parser* self) {
    ...
    if (Parser_match_token(self, (TokenType){ .tag = TokenType_NOT_TAG })) {
...
const char* Parser_parse_base_type(Parser* self) {
    if (Parser_match_token(self, (TokenType){ .tag = TokenType_OWN_TAG })) {
  ...
  buf;
    ...
    } else if (Parser_match_token(self, (TokenType){ .tag = TokenType_QUESTION_TAG })) {
        return /* Str concat */ ({
  ...
  buf;
    ...
    } else if (Parser_match_token(self, (TokenType){ .tag = TokenType_AMP_TAG })) {
        bool is_mut = false;
        if (Parser_match_token(self, (TokenType){ .tag = TokenType_MUT_TAG })) {
            is_mut = true;
        }
        const char* inner = Parser_parse_type(self);
        if (is_mut) {
  ...
  buf;
    ...
    } else if (Parser_match_token(self, (TokenType){ .tag = TokenType_MUL_TAG })) {
        bool is_mut = false;
        if (Parser_match_token(self, (TokenType){ .tag = TokenType_MUT_TAG })) {
            is_mut = true;
        }
  ...
  buf;
    ...
    } else if (Parser_match_token(self, (TokenType){ .tag = TokenType_LBRACKET_TAG })) {
        (void)(Parser_expect(self, (TokenType){ .tag = TokenType_RBRACKET_TAG }));
        return /* Str concat */ ({
  const char* const _tmp_l = "[]";
  const char* const _tmp_r = Parser_parse_type(self);
  size_t l1 = strlen(_tmp_l);
  ...
  buf;
    ...
    } else if (Parser_match_token(self, (TokenType){ .tag = TokenType_LPAREN_TAG })) {
        ArrayList_Str types = ArrayList_Str_init(self->allocator);
        if ((Parser_peek(self, 0).tok_type).tag != ((TokenType){ .tag = TokenType_RPAREN_TAG }).tag) {
            bool done = false;
            while (!done) {
                ArrayList_Str_push(&(types), Parser_parse_type(self));
                if (!Parser_match_token(self, (TokenType){ .tag = TokenType_COMMA_TAG })) {
                    done = true;
                }
            }
        }
        (void)(Parser_expect(self, (TokenType){ .tag = TokenType_RPAREN_TAG }));
        return /* Str concat */ ({
  const char* const _tmp_l = /* Str concat */ ({
  const char* const _tmp_l = "(";
  ...
  buf;
        ...
        const char* name = tv_get_str(Parser_expect(self, (TokenType){ .tag = TokenType_IDENTIFIER_TAG }).value);
        if ((Parser_peek(self, 0).tok_type).tag == ((TokenType){ .tag = TokenType_LT_TAG }).tag) {
            (void)(Parser_advance(self));
            ...
            (void)(Parser_expect(self, (TokenType){ .tag = TokenType_GT_TAG }));
            return /* Str concat */ ({
  const char* const _tmp_l = /* Str concat */ ({
  const char* const _tmp_l = /* Str concat */ ({
...
ArrayList_Str Parser_parse_generic_params(Parser* self) {
    ...
    if ((Parser_peek(self, 0).tok_type).tag == ((TokenType){ .tag = TokenType_LT_TAG }).tag) {
        ...
        bool done = false;
        while (!done) {
            const char* tp_name = tv_get_str(Parser_expect(self, (TokenType){ .tag = TokenType_IDENTIFIER_TAG }).value);
            if (Parser_match_token(self, (TokenType){ .tag = TokenType_COLON_TAG })) {
  ...
  const char* const _tmp_r = tv_get_str(Parser_expect(self, (TokenType){ .tag = TokenType_IDENTIFIER_TAG }).value);
  size_t l1 = strlen(_tmp_l);
  size_t l2 = strlen(_tmp_r);
  char* buf = malloc(l1 + l2 + 1);
  strcpy(buf, _tmp_l);
...
int64_t Parser_parse_var_decl(Parser* self, bool is_mutable) {
    (void)(Parser_advance(self));
    if ((Parser_peek(self, 0).tok_type).tag == ((TokenType){ .tag = TokenType_LPAREN_TAG }).tag) {
        (void)(Parser_advance(self));
        ArrayList_Str names = ArrayList_Str_init(self->allocator);
        bool done = false;
        while (!done) {
            ArrayList_Str_push(&(names), tv_get_str(Parser_expect(self, (TokenType){ .tag = TokenType_IDENTIFIER_TAG }).value));
            if (!Parser_match_token(self, (TokenType){ .tag = TokenType_COMMA_TAG })) {
                done = true;
            }
        }
        (void)(Parser_expect(self, (TokenType){ .tag = TokenType_RPAREN_TAG }));
        (void)(Parser_expect(self, (TokenType){ .tag = TokenType_ASSIGN_TAG }));
...
int64_t Parser_parse_func_decl(Parser* self) {
    ...
    (void)(Parser_expect(self, (TokenType){ .tag = TokenType_LPAREN_TAG }));
    ArrayList_Param params = ArrayList_Param_init(self->allocator);
    if ((Parser_peek(self, 0).tok_type).tag != ((TokenType){ .tag = TokenType_RPAREN_TAG }).tag) {
        bool done = false;
        while (!done) {
            const char* param_name = tv_get_str(Parser_expect(self, (TokenType){ .tag = TokenType_IDENTIFIER_TAG }).value);
            const char* param_type = "";
            if ((strcmp(param_name, "self") == 0) && ((Parser_peek(self, 0).tok_type).tag != ((TokenType){ .tag = TokenType_COLON_TAG }).tag)) {
                param_type = "self";
            } else {
                (void)(Parser_expect(self, (TokenType){ .tag = TokenType_COLON_TAG }));
    ...
    if (Parser_match_token(self, (TokenType){ .tag = TokenType_ARROW_TAG })) {
        return_type = Parser_parse_type(self);
    } else {
        Token next_tok = Parser_peek(self, 0);
        if ((((((next_tok.tok_type).tag == ((TokenType){ .tag = TokenType_IDENTIFIER_TAG }).tag) || ((next_tok.tok_type).tag == ((TokenType){ .tag = TokenType_LPAREN_TAG }).tag)) || ((next_tok.tok_type).tag == ((TokenType){ .tag = TokenType_MUL_TAG }).tag)) || ((next_tok.tok_type).tag == ((TokenType){ .tag = TokenType_AMP_TAG }).tag)) || ((next_tok.tok_type).tag == ((TokenType){ .tag = TokenType_LBRACKET_TAG }).tag)) {
            return_type = Parser_parse_type(self);
        }
    }
    const char* capability = "";
    if (Parser_match_token(self, (TokenType){ .tag = TokenType_HASH_TAG })) {
        capability = tv_get_str(Parser_expect(self, (TokenType){ .tag = TokenType_IDENTIFIER_TAG }).value);
    }
    Parser_expect_end_of_statement(self);
...
int64_t Parser_parse_struct_decl(Parser* self) {
    ...
    ArrayList_Str type_params = Parser_parse_generic_params(self);
    Parser_expect_end_of_statement(self);
    (void)(Parser_expect(self, (TokenType){ .tag = TokenType_LBRACE_TAG }));
    ...
    Parser_consume_newlines(self);
    while (((Parser_peek(self, 0).tok_type).tag != ((TokenType){ .tag = TokenType_RBRACE_TAG }).tag) && ((Parser_peek(self, 0).tok_type).tag != ((TokenType){ .tag = TokenType_EOF_TAG }).tag)) {
        if ((Parser_peek(self, 0).tok_type).tag == ((TokenType){ .tag = TokenType_FUNC_TAG }).tag) {
            ArrayList_Int_push(&(methods), Parser_parse_func_decl(self));
        } else if ((Parser_peek(self, 0).tok_type).tag == ((TokenType){ .tag = TokenType_IMPL_TAG }).tag) {
            (void)(Parser_advance(self));
            const char* trait_name = tv_get_str(Parser_expect(self, (TokenType){ .tag = TokenType_IDENTIFIER_TAG }).value);
            Parser_expect_end_of_statement(self);
            (void)(Parser_expect(self, (TokenType){ .tag = TokenType_LBRACE_TAG }));
            ...
            (void)(Parser_expect(self, (TokenType){ .tag = TokenType_RBRACE_TAG }));
            ArrayList_Int_push(&(trait_impls), Parser_st_impl(self, name, trait_name, impl_methods));
        } else {
            const char* fname = tv_get_str(Parser_expect(self, (TokenType){ .tag = TokenType_IDENTIFIER_TAG }).value);
            (void)(Parser_expect(self, (TokenType){ .tag = TokenType_COLON_TAG }));
...
int64_t Parser_parse_impl_block(Parser* self) {
    (void)(Parser_advance(self));
    const char* first_name = tv_get_str(Parser_expect(self, (TokenType){ .tag = TokenType_IDENTIFIER_TAG }).value);
    const char* struct_name = "";
    const char* trait_name = "";
    if ((Parser_peek(self, 0).tok_type).tag == ((TokenType){ .tag = TokenType_FOR_TAG }).tag) {
        (void)(Parser_advance(self));
        trait_name = first_name;
        struct_name = tv_get_str(Parser_expect(self, (TokenType){ .tag = TokenType_IDENTIFIER_TAG }).value);
    } else {
...
int64_t Parser_parse_enum_decl(Parser* self) {
    ...
    Parser_consume_newlines(self);
    while (((Parser_peek(self, 0).tok_type).tag != ((TokenType){ .tag = TokenType_RBRACE_TAG }).tag) && ((Parser_peek(self, 0).tok_type).tag != ((TokenType){ .tag = TokenType_EOF_TAG }).tag)) {
        (void)(Parser_expect(self, (TokenType){ .tag = TokenType_CASE_TAG }));
        const char* v_name = tv_get_str(Parser_expect(self, (TokenType){ .tag = TokenType_IDENTIFIER_TAG }).value);
        ArrayList_Param v_params = ArrayList_Param_init(self->allocator);
        int64_t unnamed_count = 0;
        if (Parser_match_token(self, (TokenType){ .tag = TokenType_LPAREN_TAG })) {
            if ((Parser_peek(self, 0).tok_type).tag != ((TokenType){ .tag = TokenType_RPAREN_TAG }).tag) {
                bool done = false;
                while (!done) {
                    const char* pname_or_type = tv_get_str(Parser_expect(self, (TokenType){ .tag = TokenType_IDENTIFIER_TAG }).value);
                    if ((Parser_peek(self, 0).tok_type).tag == ((TokenType){ .tag = TokenType_COLON_TAG }).tag) {
                        (void)(Parser_advance(self));
...
int64_t Parser_parse_error_decl(Parser* self) {
    ...
    Parser_consume_newlines(self);
    while (((Parser_peek(self, 0).tok_type).tag != ((TokenType){ .tag = TokenType_RBRACE_TAG }).tag) && ((Parser_peek(self, 0).tok_type).tag != ((TokenType){ .tag = TokenType_EOF_TAG }).tag)) {
        if (Parser_match_token(self, (TokenType){ .tag = TokenType_CASE_TAG })) {
            (void)(0);
        }
        const char* v_name = tv_get_str(Parser_expect(self, (TokenType){ .tag = TokenType_IDENTIFIER_TAG }).value);
...
int64_t Parser_parse_match_stmt(Parser* self) {
    ...
    while (((Parser_peek(self, 0).tok_type).tag != ((TokenType){ .tag = TokenType_RBRACE_TAG }).tag) && ((Parser_peek(self, 0).tok_type).tag != ((TokenType){ .tag = TokenType_EOF_TAG }).tag)) {
        ...
        (void)(Parser_expect(self, (TokenType){ .tag = TokenType_FAT_ARROW_TAG }));
        Parser_consume_newlines(self);
        int64_t body = (-1);
        if ((Parser_peek(self, 0).tok_type).tag == ((TokenType){ .tag = TokenType_LBRACE_TAG }).tag) {
...
int64_t Parser_parse_pattern(Parser* self) {
    Token tok = Parser_peek(self, 0);
    if ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_DOT_TAG }).tag) {
        (void)(Parser_advance(self));
        const char* v_name = tv_get_str(Parser_expect(self, (TokenType){ .tag = TokenType_IDENTIFIER_TAG }).value);
        ...
        if (Parser_match_token(self, (TokenType){ .tag = TokenType_LPAREN_TAG })) {
            if ((Parser_peek(self, 0).tok_type).tag != ((TokenType){ .tag = TokenType_RPAREN_TAG }).tag) {
                bool done = false;
                while (!done) {
                    ArrayList_Str_push(&(bindings), tv_get_str(Parser_expect(self, (TokenType){ .tag = TokenType_IDENTIFIER_TAG }).value));
                    if (!Parser_match_token(self, (TokenType){ .tag = TokenType_COMMA_TAG })) {
                        done = true;
                    }
                }
        ...
        PatternNode node = new_pattern_node((PatternKind){ .tag = PatternKind_pk_variant_TAG });
        node.variant_name = v_name;
        node.bindings = bindings;
        return Parser_add_pattern(self, node);
    } else if ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_ELSE_TAG }).tag) {
        (void)(Parser_advance(self));
        return Parser_add_pattern(self, new_pattern_node((PatternKind){ .tag = PatternKind_pk_else_TAG }));
    } else if ((((((tok.tok_type).tag == ((TokenType){ .tag = TokenType_INT_LIT_TAG }).tag) || ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_FLOAT_LIT_TAG }).tag)) || ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_BOOL_LIT_TAG }).tag)) || ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_STRING_LIT_TAG }).tag)) || ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_CHAR_LIT_TAG }).tag)) {
        (void)(Parser_advance(self));
        PatternNode node = new_pattern_node((PatternKind){ .tag = PatternKind_pk_literal_TAG });
...
int64_t Parser_parse_extern_decl(Parser* self) {
    (void)(Parser_advance(self));
    (void)(Parser_expect(self, (TokenType){ .tag = TokenType_FUNC_TAG }));
    const char* name = tv_get_str(Parser_expect(self, (TokenType){ .tag = TokenType_IDENTIFIER_TAG }).value);
    (void)(Parser_expect(self, (TokenType){ .tag = TokenType_LPAREN_TAG }));
    ArrayList_Param params = ArrayList_Param_init(self->allocator);
    if ((Parser_peek(self, 0).tok_type).tag != ((TokenType){ .tag = TokenType_RPAREN_TAG }).tag) {
...
int64_t Parser_parse_if_stmt(Parser* self) {
    (void)(Parser_advance(self));
    if ((Parser_peek(self, 0).tok_type).tag == ((TokenType){ .tag = TokenType_LET_TAG }).tag) {
        (void)(Parser_advance(self));
        const char* var_name = tv_get_str(Parser_expect(self, (TokenType){ .tag = TokenType_IDENTIFIER_TAG }).value);
        (void)(Parser_expect(self, (TokenType){ .tag = TokenType_ASSIGN_TAG }));
        ...
        Parser_consume_newlines(self);
        if ((Parser_peek(self, 0).tok_type).tag == ((TokenType){ .tag = TokenType_ELSE_TAG }).tag) {
            (void)(Parser_advance(self));
            if ((Parser_peek(self, 0).tok_type).tag == ((TokenType){ .tag = TokenType_IF_TAG }).tag) {
                ArrayList_Int stmts = ArrayList_Int_init(self->allocator);
...
int64_t Parser_parse_for_stmt(Parser* self) {
    (void)(Parser_advance(self));
    const char* var_name = tv_get_str(Parser_expect(self, (TokenType){ .tag = TokenType_IDENTIFIER_TAG }).value);
    (void)(Parser_expect(self, (TokenType){ .tag = TokenType_IN_TAG }));
    int64_t expr = Parser_parse_expression(self, 0);
    ExprNode expr_node = ArrayList_ExprNode_get(self->expr_pool, expr);
    int64_t range_start = (-1);
    int64_t range_end = (-1);
    bool is_inclusive = false;
    if ((expr_node.kind).tag == ((ExprKind){ .tag = ExprKind_ek_range_TAG }).tag) {
...
int64_t Parser_parse_return_stmt(Parser* self) {
    ...
    if (((((next.tok_type).tag != ((TokenType){ .tag = TokenType_NEWLINE_TAG }).tag) && ((next.tok_type).tag != ((TokenType){ .tag = TokenType_RBRACE_TAG }).tag)) && ((next.tok_type).tag != ((TokenType){ .tag = TokenType_DEDENT_TAG }).tag)) && ((next.tok_type).tag != ((TokenType){ .tag = TokenType_EOF_TAG }).tag)) {
...
int64_t Parser_parse_defer_stmt(Parser* self) {
    (void)(Parser_advance(self));
    int64_t body = (-1);
    if ((Parser_peek(self, 0).tok_type).tag == ((TokenType){ .tag = TokenType_NEWLINE_TAG }).tag) {
        Parser_expect_end_of_statement(self);
        body = Parser_parse_block(self);
    } else {
...
int64_t Parser_parse_expr_or_assignment_stmt(Parser* self) {
    int64_t expr = Parser_parse_expression(self, 0);
    Token next = Parser_peek(self, 0);
    if ((((next.tok_type).tag == ((TokenType){ .tag = TokenType_ASSIGN_TAG }).tag) || ((next.tok_type).tag == ((TokenType){ .tag = TokenType_PLUS_ASSIGN_TAG }).tag)) || ((next.tok_type).tag == ((TokenType){ .tag = TokenType_MINUS_ASSIGN_TAG }).tag)) {
...
int64_t Parser_parse_block(Parser* self) {
    ...
    if ((Parser_peek(self, 0).tok_type).tag == ((TokenType){ .tag = TokenType_EOF_TAG }).tag) {
        {
...
int64_t Parser_parse_import_stmt(Parser* self) {
    ...
    bool done = false;
    while (!done) {
        ArrayList_Str_push(&(path), tv_get_str(Parser_expect(self, (TokenType){ .tag = TokenType_IDENTIFIER_TAG }).value));
        if (!Parser_match_token(self, (TokenType){ .tag = TokenType_DOT_TAG })) {
            done = true;
        }
    }
    Parser_expect_end_of_statement(self);
...
int64_t Parser_parse_import_stmt_new(Parser* self) {
    (void)(Parser_advance(self));
    const char* first_name = tv_get_str(Parser_expect(self, (TokenType){ .tag = TokenType_IDENTIFIER_TAG }).value);
    if ((Parser_peek(self, 0).tok_type).tag == ((TokenType){ .tag = TokenType_FROM_TAG }).tag) {
        (void)(Parser_advance(self));
        ArrayList_Str path = ArrayList_Str_init(self->allocator);
        bool done = false;
        while (!done) {
        ...
        const char* alias = "";
        if ((Parser_peek(self, 0).tok_type).tag == ((TokenType){ .tag = TokenType_AS_TAG }).tag) {
            (void)(Parser_advance(self));
            alias = tv_get_str(Parser_expect(self, (TokenType){ .tag = TokenType_IDENTIFIER_TAG }).value);
        }
        Parser_expect_end_of_statement(self);
        ...
        while (Parser_match_token(self, (TokenType){ .tag = TokenType_DOT_TAG })) {
            ArrayList_Str_push(&(path), tv_get_str(Parser_expect(self, (TokenType){ .tag = TokenType_IDENTIFIER_TAG }).value));
        }
        const char* alias = "";
        if ((Parser_peek(self, 0).tok_type).tag == ((TokenType){ .tag = TokenType_AS_TAG }).tag) {
...
int64_t Parser_parse_cimport_stmt(Parser* self) {
    (void)(Parser_advance(self));
    Token header_tok = Parser_expect(self, (TokenType){ .tag = TokenType_STRING_LIT_TAG });
...
int64_t Parser_parse_expression(Parser* self, int64_t precedence) {
    ...
    while (!done) {
        ...
        if ((op_prec == 0) || (op_prec <= precedence)) {
            ...
            (void)(Parser_advance(self));
            if ((op_tok.tok_type).tag == ((TokenType){ .tag = TokenType_DOT_TAG }).tag) {
                const char* member_name = tv_get_str(Parser_expect(self, (TokenType){ .tag = TokenType_IDENTIFIER_TAG }).value);
                if ((Parser_peek(self, 0).tok_type).tag == ((TokenType){ .tag = TokenType_LPAREN_TAG }).tag) {
                    (void)(Parser_advance(self));
                    if (((Parser_peek(self, 0).tok_type).tag == ((TokenType){ .tag = TokenType_IDENTIFIER_TAG }).tag) && ((Parser_peek(self, 1).tok_type).tag == ((TokenType){ .tag = TokenType_COLON_TAG }).tag)) {
                        ArrayList_FieldInit fields = ArrayList_FieldInit_init(self->allocator);
                        if ((Parser_peek(self, 0).tok_type).tag != ((TokenType){ .tag = TokenType_RPAREN_TAG }).tag) {
                            bool fields_done = false;
                            while (!fields_done) {
                                const char* f_name = tv_get_str(Parser_expect(self, (TokenType){ .tag = TokenType_IDENTIFIER_TAG }).value);
                                (void)(Parser_expect(self, (TokenType){ .tag = TokenType_COLON_TAG }));
                        ...
                        if ((left_node.kind).tag == ((ExprKind){ .tag = ExprKind_ek_identifier_TAG }).tag) {
  ...
  buf;
            ...
            } else if ((op_tok.tok_type).tag == ((TokenType){ .tag = TokenType_LBRACKET_TAG }).tag) {
                if (((Parser_peek(self, 0).tok_type).tag == ((TokenType){ .tag = TokenType_DOTDOT_TAG }).tag) || ((Parser_peek(self, 0).tok_type).tag == ((TokenType){ .tag = TokenType_DOTDOTEQ_TAG }).tag)) {
                    int64_t lower = (-1);
                    int64_t upper = (-1);
                    Token slice_tok = Parser_advance(self);
                    bool is_inclusive = ((slice_tok.tok_type).tag == ((TokenType){ .tag = TokenType_DOTDOTEQ_TAG }).tag);
                    if ((Parser_peek(self, 0).tok_type).tag != ((TokenType){ .tag = TokenType_RBRACKET_TAG }).tag) {
                    ...
                    if ((lower_node.kind).tag == ((ExprKind){ .tag = ExprKind_ek_range_TAG }).tag) {
                        left = Parser_ex_slice(self, left, lower_node.range_start, lower_node.range_end, lower_node.range_inclusive);
                    } else if (((Parser_peek(self, 0).tok_type).tag == ((TokenType){ .tag = TokenType_DOTDOT_TAG }).tag) || ((Parser_peek(self, 0).tok_type).tag == ((TokenType){ .tag = TokenType_DOTDOTEQ_TAG }).tag)) {
                        Token slice_tok = Parser_advance(self);
                        bool is_inclusive = ((slice_tok.tok_type).tag == ((TokenType){ .tag = TokenType_DOTDOTEQ_TAG }).tag);
                        int64_t upper = (-1);
                        if ((Parser_peek(self, 0).tok_type).tag != ((TokenType){ .tag = TokenType_RBRACKET_TAG }).tag) {
                ...
                (void)(Parser_expect(self, (TokenType){ .tag = TokenType_RBRACKET_TAG }));
            } else if (((op_tok.tok_type).tag == ((TokenType){ .tag = TokenType_DOTDOT_TAG }).tag) || ((op_tok.tok_type).tag == ((TokenType){ .tag = TokenType_DOTDOTEQ_TAG }).tag)) {
                bool is_inclusive = ((op_tok.tok_type).tag == ((TokenType){ .tag = TokenType_DOTDOTEQ_TAG }).tag);
                int64_t right = (-1);
                Token next = Parser_peek(self, 0);
                if ((((((((next.tok_type).tag != ((TokenType){ .tag = TokenType_RBRACKET_TAG }).tag) && ((next.tok_type).tag != ((TokenType){ .tag = TokenType_COMMA_TAG }).tag)) && ((next.tok_type).tag != ((TokenType){ .tag = TokenType_NEWLINE_TAG }).tag)) && ((next.tok_type).tag != ((TokenType){ .tag = TokenType_SEMICOLON_TAG }).tag)) && ((next.tok_type).tag != ((TokenType){ .tag = TokenType_RBRACE_TAG }).tag)) && ((next.tok_type).tag != ((TokenType){ .tag = TokenType_DEDENT_TAG }).tag)) && ((next.tok_type).tag != ((TokenType){ .tag = TokenType_EOF_TAG }).tag)) {
                    right = Parser_parse_expression(self, op_prec);
                }
                left = Parser_ex_range(self, left, right, is_inclusive);
            } else if ((op_tok.tok_type).tag == ((TokenType){ .tag = TokenType_CATCH_TAG }).tag) {
                const char* var_name = "";
                if (Parser_match_token(self, (TokenType){ .tag = TokenType_PIPE_TAG })) {
                    var_name = tv_get_str(Parser_expect(self, (TokenType){ .tag = TokenType_IDENTIFIER_TAG }).value);
                    (void)(Parser_expect(self, (TokenType){ .tag = TokenType_PIPE_TAG }));
                }
                int64_t fallback = (-1);
                Token next = Parser_peek(self, 0);
                if ((next.tok_type).tag == ((TokenType){ .tag = TokenType_NEWLINE_TAG }).tag) {
                    fallback = Parser_parse_block(self);
                } else if ((next.tok_type).tag == ((TokenType){ .tag = TokenType_RETURN_TAG }).tag) {
                    (void)(Parser_advance(self));
                    int64_t ret_val = (-1);
                    Token follow = Parser_peek(self, 0);
                    if ((((((follow.tok_type).tag != ((TokenType){ .tag = TokenType_NEWLINE_TAG }).tag) && ((follow.tok_type).tag != ((TokenType){ .tag = TokenType_SEMICOLON_TAG }).tag)) && ((follow.tok_type).tag != ((TokenType){ .tag = TokenType_RBRACE_TAG }).tag)) && ((follow.tok_type).tag != ((TokenType){ .tag = TokenType_DEDENT_TAG }).tag)) && ((follow.tok_type).tag != ((TokenType){ .tag = TokenType_EOF_TAG }).tag)) {
                ...
                } else if ((next.tok_type).tag == ((TokenType){ .tag = TokenType_PRINT_TAG }).tag) {
                    (void)(Parser_advance(self));
            ...
            } else if ((op_tok.tok_type).tag == ((TokenType){ .tag = TokenType_AS_TAG }).tag) {
...
int64_t Parser_parse_primary(Parser* self) {
    Token tok = Parser_peek(self, 0);
    if (((((tok.tok_type).tag == ((TokenType){ .tag = TokenType_INT_LIT_TAG }).tag) || ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_FLOAT_LIT_TAG }).tag)) || ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_BOOL_LIT_TAG }).tag)) || ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_CHAR_LIT_TAG }).tag)) {
        (void)(Parser_advance(self));
        const char* vkind = "";
        if ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_INT_LIT_TAG }).tag) {
            vkind = "INT";
        } else if ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_FLOAT_LIT_TAG }).tag) {
            vkind = "FLOAT";
        } else if ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_BOOL_LIT_TAG }).tag) {
            vkind = "BOOL";
        } else {
            vkind = "CHAR";
        }
        return Parser_ex_literal(self, tok.value, vkind);
    } else if ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_NONE_TAG }).tag) {
        (void)(Parser_advance(self));
        return Parser_ex_literal(self, (TokenValue){ .tag = TokenValue_tv_none_TAG }, "NONE");
    } else if ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_STRING_LIT_TAG }).tag) {
        (void)(Parser_advance(self));
        return Parser_ex_literal(self, tok.value, "STRING");
    } else if ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_CHECK_TAG }).tag) {
        (void)(Parser_advance(self));
        return Parser_ex_check(self, Parser_parse_expression(self, 5));
    } else if ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_TRY_TAG }).tag) {
        (void)(Parser_advance(self));
        return Parser_ex_try(self, Parser_parse_expression(self, 5));
    } else if ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_OWN_TAG }).tag) {
        (void)(Parser_advance(self));
        return Parser_ex_unop(self, "own", Parser_parse_expression(self, 5));
    } else if ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_ASM_TAG }).tag) {
        (void)(Parser_advance(self));
        bool is_volatile = false;
        if (Parser_match_token(self, (TokenType){ .tag = TokenType_VOLATILE_TAG })) {
            is_volatile = true;
        }
        (void)(Parser_expect(self, (TokenType){ .tag = TokenType_LPAREN_TAG }));
        const char* asm_code = tv_get_str(Parser_expect(self, (TokenType){ .tag = TokenType_STRING_LIT_TAG }).value);
        ...
        if (Parser_match_token(self, (TokenType){ .tag = TokenType_COLON_TAG })) {
            ...
            while (!done) {
                ...
                if ((((next_tt).tag == ((TokenType){ .tag = TokenType_COLON_TAG }).tag) || ((next_tt).tag == ((TokenType){ .tag = TokenType_RPAREN_TAG }).tag)) || ((next_tt).tag == ((TokenType){ .tag = TokenType_EOF_TAG }).tag)) {
                    done = true;
                } else {
                    (void)(Parser_expect(self, (TokenType){ .tag = TokenType_LBRACKET_TAG }));
                    const char* out_name = tv_get_str(Parser_expect(self, (TokenType){ .tag = TokenType_IDENTIFIER_TAG }).value);
                    (void)(Parser_expect(self, (TokenType){ .tag = TokenType_RBRACKET_TAG }));
                    const char* constraint = tv_get_str(Parser_expect(self, (TokenType){ .tag = TokenType_STRING_LIT_TAG }).value);
                    (void)(Parser_expect(self, (TokenType){ .tag = TokenType_LPAREN_TAG }));
                    const char* type_name = "";
                    int64_t expr_idx = (-1);
                    if (Parser_match_token(self, (TokenType){ .tag = TokenType_ARROW_TAG })) {
        ...
        if (Parser_match_token(self, (TokenType){ .tag = TokenType_COLON_TAG })) {
            ...
            while (!done) {
                ...
                if ((((next_tt).tag == ((TokenType){ .tag = TokenType_COLON_TAG }).tag) || ((next_tt).tag == ((TokenType){ .tag = TokenType_RPAREN_TAG }).tag)) || ((next_tt).tag == ((TokenType){ .tag = TokenType_EOF_TAG }).tag)) {
                    ...
                    (void)(Parser_expect(self, (TokenType){ .tag = TokenType_LBRACKET_TAG }));
                    const char* in_name = tv_get_str(Parser_expect(self, (TokenType){ .tag = TokenType_IDENTIFIER_TAG }).value);
                    (void)(Parser_expect(self, (TokenType){ .tag = TokenType_RBRACKET_TAG }));
                    const char* constraint = tv_get_str(Parser_expect(self, (TokenType){ .tag = TokenType_STRING_LIT_TAG }).value);
                    (void)(Parser_expect(self, (TokenType){ .tag = TokenType_LPAREN_TAG }));
        ...
        if (Parser_match_token(self, (TokenType){ .tag = TokenType_COLON_TAG })) {
            ...
            while (!done) {
                TokenType next_tt = Parser_peek(self, 0).tok_type;
                if (((next_tt).tag == ((TokenType){ .tag = TokenType_RPAREN_TAG }).tag) || ((next_tt).tag == ((TokenType){ .tag = TokenType_EOF_TAG }).tag)) {
                    done = true;
                } else {
                    const char* clobber = tv_get_str(Parser_expect(self, (TokenType){ .tag = TokenType_STRING_LIT_TAG }).value);
    ...
    } else if ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_IDENTIFIER_TAG }).tag) {
  ...
  buf;
            ...
            ExprNode id_node = new_expr_node((ExprKind){ .tag = ExprKind_ek_identifier_TAG });
            id_node.ident_name = ident;
            id_node.ident_type_args = id_type_args;
            ArrayList_ExprNode_push(self->expr_pool, id_node);
            return (ArrayList_ExprNode_length(self->expr_pool) - 1);
        } else if ((Parser_peek(self, 1).tok_type).tag == ((TokenType){ .tag = TokenType_LPAREN_TAG }).tag) {
            const char* ident = tv_get_str(Parser_advance(self).value);
            (void)(Parser_advance(self));
            if (((Parser_peek(self, 0).tok_type).tag == ((TokenType){ .tag = TokenType_IDENTIFIER_TAG }).tag) && ((Parser_peek(self, 1).tok_type).tag == ((TokenType){ .tag = TokenType_COLON_TAG }).tag)) {
                ArrayList_FieldInit fields = ArrayList_FieldInit_init(self->allocator);
    ...
    } else if ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_MINUS_TAG }).tag) {
        (void)(Parser_advance(self));
        return Parser_ex_unop(self, "-", Parser_parse_expression(self, 7));
    } else if ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_NOT_TAG }).tag) {
        (void)(Parser_advance(self));
        return Parser_ex_unop(self, "!", Parser_parse_expression(self, 7));
    } else if ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_BITNOT_TAG }).tag) {
        (void)(Parser_advance(self));
        return Parser_ex_unop(self, "~", Parser_parse_expression(self, 7));
    } else if ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_SIZEOF_TAG }).tag) {
        (void)(Parser_advance(self));
        (void)(Parser_expect(self, (TokenType){ .tag = TokenType_LPAREN_TAG }));
    ...
    } else if ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_AMP_TAG }).tag) {
        (void)(Parser_advance(self));
        bool is_mut = false;
        if (Parser_match_token(self, (TokenType){ .tag = TokenType_MUT_TAG })) {
            is_mut = true;
    ...
    } else if ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_MUL_TAG }).tag) {
        (void)(Parser_advance(self));
        return Parser_ex_deref(self, Parser_parse_expression(self, 8));
    } else if ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_LBRACKET_TAG }).tag) {
        (void)(Parser_advance(self));
    ...
    } else if ((tok.tok_type).tag == ((TokenType){ .tag = TokenType_LPAREN_TAG }).tag) {
        (void)(Parser_advance(self));
        int64_t first = Parser_parse_expression(self, 0);
        if ((Parser_peek(self, 0).tok_type).tag == ((TokenType){ .tag = TokenType_COMMA_TAG }).tag) {
            ArrayList_Int elements = ArrayList_Int_init(self->allocator);
            ArrayList_Int_push(&(elements), first);
            while (Parser_match_token(self, (TokenType){ .tag = TokenType_COMMA_TAG })) {
                if ((Parser_peek(self, 0).tok_type).tag != ((TokenType){ .tag = TokenType_RPAREN_TAG }).tag) {
                    ArrayList_Int_push(&(elements), Parser_parse_expression(self, 0));
                }
            }
...
void TypeChecker_register_struct_info(TypeChecker* self, int64_t top_stmt_idx) {
    ...
    if ((stmt.kind).tag == ((StmtKind){ .tag = StmtKind_sk_block_TAG }).tag) {
        int64_t i = 0;
        while (i < ArrayList_Int_length(&(stmt.block_stmts))) {
            ...
            if ((s.kind).tag == ((StmtKind){ .tag = StmtKind_sk_impl_block_TAG }).tag) {
                bool has_drop = false;
                int64_t j = 0;
...
bool TypeChecker_has_drop_method(TypeChecker* self, const char* type_name) {
    ...
    if ((length(type_name) > 4) && (strcmp(substring(type_name, 0, 4), "own ") == 0)) {
...
void TypeChecker_mark_expr_moved(TypeChecker* self, int64_t expr_idx) {
    ...
    if ((expr.kind).tag == ((ExprKind){ .tag = ExprKind_ek_identifier_TAG }).tag) {
...
const char* TypeChecker_get_expr_type(TypeChecker* self, int64_t expr_idx) {
    ...
    ExprNode expr = ArrayList_ExprNode_get(self->expr_pool, expr_idx);
    if ((expr.kind).tag == ((ExprKind){ .tag = ExprKind_ek_literal_TAG }).tag) {
    ...
    if ((expr.kind).tag == ((ExprKind){ .tag = ExprKind_ek_binary_op_TAG }).tag) {
    ...
    if ((expr.kind).tag == ((ExprKind){ .tag = ExprKind_ek_unary_op_TAG }).tag) {
    ...
    if ((expr.kind).tag == ((ExprKind){ .tag = ExprKind_ek_func_call_TAG }).tag) {
        ...
        while (s_idx < ArrayList_StmtNode_length(self->stmt_pool)) {
            ...
            if (((stmt.kind).tag == ((StmtKind){ .tag = StmtKind_sk_struct_decl_TAG }).tag) && (strcmp(stmt.struct_name, name) == 0)) {
                is_struct = true;
            }
            s_idx = (s_idx + 1);
        }
  ...
  buf;
    ...
    if ((expr.kind).tag == ((ExprKind){ .tag = ExprKind_ek_field_access_TAG }).tag) {
  ...
  buf;
        ...
        if ((length(clean_type) > 4) && (strcmp(substring(clean_type, 0, 4), "mut ") == 0)) {
            clean_type = substring(clean_type, 4, length(clean_type));
        }
        int64_t s_idx = 0;
        while (s_idx < ArrayList_StmtNode_length(self->stmt_pool)) {
            StmtNode stmt = ArrayList_StmtNode_get(self->stmt_pool, s_idx);
            if ((stmt.kind).tag == ((StmtKind){ .tag = StmtKind_sk_struct_decl_TAG }).tag) {
    ...
    if ((expr.kind).tag == ((ExprKind){ .tag = ExprKind_ek_index_TAG }).tag) {
    ...
    if ((expr.kind).tag == ((ExprKind){ .tag = ExprKind_ek_borrow_TAG }).tag) {
  ...
  buf;
    ...
    if ((expr.kind).tag == ((ExprKind){ .tag = ExprKind_ek_deref_TAG }).tag) {
        const char* base_type = TypeChecker_get_expr_type(self, expr.deref_expr);
        if ((length(base_type) > 5) && (strcmp(substring(base_type, 0, 5), "*mut ") == 0)) {
    ...
    if ((expr.kind).tag == ((ExprKind){ .tag = ExprKind_ek_struct_init_TAG }).tag) {
...
void TypeChecker_check_return_stmt(TypeChecker* self, int64_t stmt_idx) {
    ...
    if (stmt.return_value >= 0) {
        ...
        if ((expr.kind).tag == ((ExprKind){ .tag = ExprKind_ek_borrow_TAG }).tag) {
            ...
            if ((borrowed.kind).tag == ((ExprKind){ .tag = ExprKind_ek_identifier_TAG }).tag) {
...
void TypeChecker_check_stmt(TypeChecker* self, int64_t stmt_idx) {
    ...
    if ((stmt.kind).tag == ((StmtKind){ .tag = StmtKind_sk_var_decl_TAG }).tag) {
    ...
    if ((stmt.kind).tag == ((StmtKind){ .tag = StmtKind_sk_assignment_TAG }).tag) {
        ...
        if (stmt.assign_target >= 0) {
            ...
            if ((target_expr.kind).tag == ((ExprKind){ .tag = ExprKind_ek_identifier_TAG }).tag) {
                SymbolTable table = ArrayList_SymbolTable_get(&(self->symbol_tables), self->current_table_idx);
    ...
    if ((stmt.kind).tag == ((StmtKind){ .tag = StmtKind_sk_func_decl_TAG }).tag) {
    ...
    if ((stmt.kind).tag == ((StmtKind){ .tag = StmtKind_sk_while_TAG }).tag) {
        TypeChecker_check_expr(self, stmt.while_cond);
        TypeChecker_check_stmt(self, stmt.while_body);
        return;
    }
    if ((stmt.kind).tag == ((StmtKind){ .tag = StmtKind_sk_for_TAG }).tag) {
    ...
    if ((stmt.kind).tag == ((StmtKind){ .tag = StmtKind_sk_return_TAG }).tag) {
        TypeChecker_check_return_stmt(self, stmt_idx);
        return;
    }
    if ((stmt.kind).tag == ((StmtKind){ .tag = StmtKind_sk_print_TAG }).tag) {
        TypeChecker_check_expr(self, stmt.print_value);
        return;
    }
    if ((stmt.kind).tag == ((StmtKind){ .tag = StmtKind_sk_expr_TAG }).tag) {
        TypeChecker_check_expr(self, stmt.expr_stmt);
        return;
    }
    if ((stmt.kind).tag == ((StmtKind){ .tag = StmtKind_sk_unsafe_TAG }).tag) {
        TypeChecker_check_stmt(self, stmt.unsafe_body);
        return;
    }
    if ((stmt.kind).tag == ((StmtKind){ .tag = StmtKind_sk_match_TAG }).tag) {
        ...
        while (i < ArrayList_MatchCase_length(&(stmt.match_cases))) {
            ...
            if ((pat.kind).tag == ((PatternKind){ .tag = PatternKind_pk_variant_TAG }).tag) {
                int64_t bi = 0;
    ...
    if ((stmt.kind).tag == ((StmtKind){ .tag = StmtKind_sk_impl_block_TAG }).tag) {
        int64_t i = 0;
...
void TypeChecker_check_expr(TypeChecker* self, int64_t expr_idx) {
    ...
    if ((expr.kind).tag == ((ExprKind){ .tag = ExprKind_ek_method_call_TAG }).tag) {
...
const char* Codegen_map_type(Codegen* self, const char* type_name) {
    ...
    if (strcmp(substring(resolved_type, 0, 2), "[]") == 0) {
        const char* inner = substring(resolved_type, 2, length(resolved_type));
        return /* Str concat */ ({
  ...
  buf;
    ...
    if (resolved_type[0] == ((char)(42))) {
        if ((length(resolved_type) > 5) && (strcmp(substring(resolved_type, 0, 5), "*mut ") == 0)) {
            const char* inner = substring(resolved_type, 5, length(resolved_type));
  ...
  buf;
            ...
            const char* inner = substring(resolved_type, 1, length(resolved_type));
            if (strcmp(inner, "Void") == 0) {
                return "void*";
            }
            return /* Str concat */ ({
  ...
  buf;
    ...
    if (Codegen_str_contains(self, resolved_type, ((char)(60)))) {
        ...
        const char* args_str = substring(resolved_type, (lt_pos + 1), (length(resolved_type) - 1));
        ...
        ArrayList_Str_push(&(args), Codegen_trim_spaces(self, substring(args_str, start, length(args_str))));
...
const char* Codegen_substitute_generic_type(Codegen* self, const char* type_name) {
    ...
    if (type_name[0] == ((char)(42))) {
        return /* Str concat */ ({
  const char* const _tmp_l = "*";
  const char* const _tmp_r = Codegen_substitute_generic_type(self, substring(type_name, 1, length(type_name)));
  size_t l1 = strlen(_tmp_l);
  size_t l2 = strlen(_tmp_r);
  char* buf = malloc(l1 + l2 + 1);
  strcpy(buf, _tmp_l);
  ...
  buf;
    ...
    if (type_name[0] == ((char)(38))) {
        if (strcmp(substring(type_name, 0, 5), "&mut ") == 0) {
            return /* Str concat */ ({
  const char* const _tmp_l = "&mut ";
  const char* const _tmp_r = Codegen_substitute_generic_type(self, substring(type_name, 5, length(type_name)));
  size_t l1 = strlen(_tmp_l);
  size_t l2 = strlen(_tmp_r);
  char* buf = malloc(l1 + l2 + 1);
  strcpy(buf, _tmp_l);
  ...
  buf;
    ...
    if (Codegen_str_contains(self, type_name, ((char)(60)))) {
        ...
        const char* inner = substring(type_name, (lt_pos + 1), (length(type_name) - 1));
  ...
  buf;
        ...
        const char* arg = Codegen_trim_spaces(self, substring(inner, start, length(inner)));
        if (arg_count > 0) {
            res = /* Str concat */ ({
  const char* const _tmp_l = res;
  const char* const _tmp_r = ", ";
...
void Codegen_monomorphize_methods(Codegen* self, const char* base_struct_name, const char* concrete_struct_name) {
    ...
    while (idx < ArrayList_StmtNode_length(self->stmt_pool)) {
        ...
        if (((stmt.kind).tag == ((StmtKind){ .tag = StmtKind_sk_impl_block_TAG }).tag) && (strcmp(stmt.impl_struct_name, base_struct_name) == 0)) {
            int64_t j = 0;
  ...
  buf;
                    ...
                    int64_t body_len = length(body_str);
                    body_str = /* Str concat */ ({
  const char* const _tmp_l = /* Str concat */ ({
  const char* const _tmp_l = /* Str concat */ ({
  const char* const _tmp_l = "{\n";
...
void Codegen_build_func_types(Codegen* self) {
    ...
    while (i < ArrayList_StmtNode_length(self->stmt_pool)) {
        ...
        if ((stmt.kind).tag == ((StmtKind){ .tag = StmtKind_sk_extern_TAG }).tag) {
...
const char* Codegen_get_expr_type(Codegen* self, int64_t expr_idx) {
  ...
  buf;
        ...
        if ((receiver_node.kind).tag == ((ExprKind){ .tag = ExprKind_ek_identifier_TAG }).tag) {
  ...
  buf;
        ...
        if (Codegen_str_contains(self, clean_rec, ((char)(60)))) {
            ...
            const char* args_str = substring(clean_rec, (lt_pos + 1), (length(clean_rec) - 1));
            ArrayList_Str args = ArrayList_Str_init(self->allocator);
            int64_t start = 0;
            int64_t ai = 0;
            ...
            while (si < ArrayList_StmtNode_length(self->stmt_pool)) {
                ...
                if (((s.kind).tag == ((StmtKind){ .tag = StmtKind_sk_struct_decl_TAG }).tag) && (strcmp(s.struct_name, base_struct) == 0)) {
                    struct_idx = si;
                }
                si = (si + 1);
            }
            if (struct_idx >= 0) {
                ...
                while (impl_idx < ArrayList_StmtNode_length(self->stmt_pool)) {
                    ...
                    if (((s_impl.kind).tag == ((StmtKind){ .tag = StmtKind_sk_impl_block_TAG }).tag) && (strcmp(s_impl.impl_struct_name, base_struct) == 0)) {
                        int64_t mi = 0;
    ...
    if ((expr.kind).tag == ((ExprKind){ .tag = ExprKind_ek_range_TAG }).tag) {
        return "Range";
    }
    if ((expr.kind).tag == ((ExprKind){ .tag = ExprKind_ek_slice_TAG }).tag) {
        return expr.inferred_type;
    }
    if ((expr.kind).tag == ((ExprKind){ .tag = ExprKind_ek_array_TAG }).tag) {
        return expr.inferred_type;
    }
    if ((expr.kind).tag == ((ExprKind){ .tag = ExprKind_ek_tuple_TAG }).tag) {
        return expr.inferred_type;
    }
    if ((expr.kind).tag == ((ExprKind){ .tag = ExprKind_ek_asm_TAG }).tag) {
        return expr.inferred_type;
    }
    return "Void";
}
const char* Codegen_gen_expr(Codegen* self, int64_t expr_idx) {
  ...
  buf;
    ...
    if ((expr.kind).tag == ((ExprKind){ .tag = ExprKind_ek_field_access_TAG }).tag) {
        ...
        if (((base_node.kind).tag == ((ExprKind){ .tag = ExprKind_ek_identifier_TAG }).tag) && Codegen_is_enum_type(self, base_node.ident_name)) {
  ...
  buf;
        ...
        const char* base_type = Codegen_get_expr_type(self, expr.field_expr);
        bool is_ptr = false;
        bool is_self_ptr = ((((base_node.kind).tag == ((ExprKind){ .tag = ExprKind_ek_identifier_TAG }).tag) && (strcmp(base_node.ident_name, "self") == 0)) && (!self->cur_method_is_init));
        ...
        bool is_complex = ((((base_node.kind).tag == ((ExprKind){ .tag = ExprKind_ek_func_call_TAG }).tag) || ((base_node.kind).tag == ((ExprKind){ .tag = ExprKind_ek_index_TAG }).tag)) || ((base_node.kind).tag == ((ExprKind){ .tag = ExprKind_ek_deref_TAG }).tag));
  ...
  buf;
    ...
    if ((expr.kind).tag == ((ExprKind){ .tag = ExprKind_ek_check_TAG }).tag) {
        return Codegen_gen_expr(self, expr.check_expr);
    }
    if ((expr.kind).tag == ((ExprKind){ .tag = ExprKind_ek_try_TAG }).tag) {
  ...
  buf;
    ...
    if ((expr.kind).tag == ((ExprKind){ .tag = ExprKind_ek_array_TAG }).tag) {
        ...
        if ((length(expr.inferred_type) > 2) && (strcmp(substring(expr.inferred_type, 0, 2), "[]") == 0)) {
  ...
  buf;
    ...
    if ((expr.kind).tag == ((ExprKind){ .tag = ExprKind_ek_struct_init_TAG }).tag) {
        bool is_enum = ((length(expr.struct_name) > 0) && Codegen_str_contains(self, expr.struct_name, ((char)(46))));
        if (is_enum) {
            int64_t dot_pos = Codegen_str_find(self, expr.struct_name, ((char)(46)));
            const char* enum_part = substring(expr.struct_name, 0, dot_pos);
            const char* variant_name = substring(expr.struct_name, (dot_pos + 1), length(expr.struct_name));
  ...
  buf;
        ...
        if ((!is_constructor) && (strcmp(method_name, "init") != 0)) {
            ...
            bool is_self_ptr = ((((receiver_node.kind).tag == ((ExprKind){ .tag = ExprKind_ek_identifier_TAG }).tag) && (strcmp(receiver_node.ident_name, "self") == 0)) && (!self->cur_method_is_init));
...
const char* Codegen_gen_stmt(Codegen* self, int64_t stmt_idx) {
  ...
  buf;
    ...
    if ((stmt.kind).tag == ((StmtKind){ .tag = StmtKind_sk_enum_decl_TAG }).tag) {
  ...
  buf;
    ...
    if ((stmt.kind).tag == ((StmtKind){ .tag = StmtKind_sk_impl_block_TAG }).tag) {
        const char* struct_name = stmt.impl_struct_name;
        bool has_generic_struct = ((length(type_map_get(&(self->generic_struct_decls), struct_name)) > 0) || (length(type_map_get(&(self->generic_enum_decls), struct_name)) > 0));
  ...
  buf;
        ...
        if (stmt.if_else >= 0) {
            ...
            if (((else_node.kind).tag == ((StmtKind){ .tag = StmtKind_sk_block_TAG }).tag) && (ArrayList_Int_length(&(else_node.block_stmts)) == 1)) {
                ...
                if ((single_stmt.kind).tag == ((StmtKind){ .tag = StmtKind_sk_if_TAG }).tag) {
                    if_str = /* Str concat */ ({
  const char* const _tmp_l = /* Str concat */ ({
  ...
  buf;
    ...
    if ((stmt.kind).tag == ((StmtKind){ .tag = StmtKind_sk_cimport_TAG }).tag) {
    ...
    if ((stmt.kind).tag == ((StmtKind){ .tag = StmtKind_sk_import_TAG }).tag) {
  ...
  buf;
    ...
    if ((stmt.kind).tag == ((StmtKind){ .tag = StmtKind_sk_break_TAG }).tag) {
  ...
  buf;
    ...
    if ((stmt.kind).tag == ((StmtKind){ .tag = StmtKind_sk_continue_TAG }).tag) {
        ArrayList_Str drop_calls = Codegen__collect_loop_drops(self);
        if (ArrayList_Str_length(&(drop_calls)) == 0) {
            return "continue;";
        }
  ...
  buf;
    ...
    if ((stmt.kind).tag == ((StmtKind){ .tag = StmtKind_sk_match_TAG }).tag) {
        ...
        bool is_self_ptr = ((((expr_node.kind).tag == ((ExprKind){ .tag = ExprKind_ek_identifier_TAG }).tag) && (strcmp(expr_node.ident_name, "self") == 0)) && (!self->cur_method_is_init));
        bool is_ptr = false;
        ...
        while (case_idx < ArrayList_MatchCase_length(&(stmt.match_cases))) {
            ...
            if ((pat_node.kind).tag == ((PatternKind){ .tag = PatternKind_pk_literal_TAG }).tag) {
                const char* lit_str = "";
  ...
  buf;
            ...
            } else if ((pat_node.kind).tag == ((PatternKind){ .tag = PatternKind_pk_variant_TAG }).tag) {
  ...
  buf;
            ...
            } else if ((pat_node.kind).tag == ((PatternKind){ .tag = PatternKind_pk_else_TAG }).tag) {
                cond = "true";
            }
            const char* prefix = "";
            if (case_idx == 0) {
  ...
  buf;
            ...
            if (length(bindings_str) > 0) {
                int64_t body_len = length(block_str);
