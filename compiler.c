...
} else if (((((c == ((char)(60LL))) || (c == ((char)(62LL)))) || (c == ((char)(44LL)))) || (c == ((char)(33LL)))) || (c == ((char)(63LL)))) {
    result = __kai_std_str_concat_alloc(result, "_");
} else {
...
} else if (strcmp(stmt.extern_name, "__kai_std_str_concat_alloc") == 0LL) {
} else {
    const char* params_str = "";
    int64_t pi3 = 0LL;
