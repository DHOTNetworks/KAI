...
void* LLVMCodegen_gen_expr_address(LLVMCodegen* self, int64_t expr_idx);
...
int main(int argc, char** argv) {
    ...
    if ((fix_file ? strlen(fix_file) : 0) == 0LL) {
    ...
    if ((input_file ? strlen(input_file) : 0) == 0LL) {
    printf("Error: No input file specified\n");
    return 1LL;
}
    ...
    if ((output_bin ? strlen(output_bin) : 0) > 0LL) {
    bin_name = output_bin;
}
    ...
    const char* ll_file = concatAlloc(base, ".ll");
    if (use_builder) {
    ll_file = concatAlloc("CC", ll_file);
}
    bool emit_ok = LLVMCodegen_generate(&(llvm_gen), program_idx, ll_file);
    if (!emit_ok) {
    return 5LL;
}
    if (emit_c_only) {
...
void parser_err(const char* source_file, const char* source, const char* code, const char* msg, int64_t line, int64_t col) {
    ...
    const char* caret = "    ";
    int64_t ci = 0LL;
    while ((ci < col) && (ci < (line_text ? strlen(line_text) : 0))) {
...
const char* get_source_line(const char* source, int64_t line_num) {
    ...
    int64_t i = 0LL;
    int64_t len = (source ? strlen(source) : 0);
...
int64_t find_last(const char* path, char c) {
    int64_t i = ((path ? strlen(path) : 0) - 1LL);
    while (i >= 0LL) {
    if ((path)[i] == c) {
    return i;
}
...
const char* str_replace(const char* s, const char* old, const char* new_val) {
    int64_t s_len = (s ? strlen(s) : 0);
    int64_t old_len = (old ? strlen(old) : 0);
    if (old_len == 0LL) {
    return s;
}
    const char* result = "";
...
void TypeChecker_detect_imports(TypeChecker* self, int64_t top_stmt_idx) {
    ...
    if ((s.import_alias ? strlen(s.import_alias) : 0) > 0LL) {
...
bool TypeChecker_has_drop_method(TypeChecker* self, const char* type_name) {
    ...
    if (((type_name ? strlen(type_name) : 0) > 4LL) && (strcmp(substring(type_name, 0LL, 4LL), "own ") == 0)) {
    clean_type = substring(type_name, 4LL, (type_name ? strlen(type_name) : 0));
}
    if (((clean_type ? strlen(clean_type) : 0) > 0LL) && ((((clean_type)[0LL] == ((char)(38LL))) || ((clean_type)[0LL] == ((char)(42LL)))) || ((clean_type)[0LL] == ((char)(63LL))))) {
    return false;
}
    int64_t i = 0LL;
...
int64_t TypeChecker_int_literal_value(TypeChecker* self, ExprNode expr) {
    ...
    int64_t len = (sval ? strlen(sval) : 0);
    int64_t res = 0LL;
    int64_t pos = 0LL;
    while (pos < len) {
...
bool TypeChecker_is_copy_type(TypeChecker* self, const char* type_name) {
    ...
    if (((type_name ? strlen(type_name) : 0) > 0LL) && (((type_name)[0LL] == ((char)(42LL))) || ((type_name)[0LL] == ((char)(38LL))))) {
    return true;
}
    return false;
}
PtrRefResult TypeChecker_parse_ptr_ref(TypeChecker* self, const char* type_str) {
    ...
    if (((inner ? strlen(inner) : 0) > 0LL) && ((inner)[0LL] == ((char)(63LL)))) {
    inner = substring(inner, 1LL, (inner ? strlen(inner) : 0));
}
    if (((inner ? strlen(inner) : 0) > 5LL) && (strcmp(substring(inner, 0LL, 5LL), "*mut ") == 0)) {
    is_ptr = true;
    is_mut = true;
    inner = substring(inner, 5LL, (inner ? strlen(inner) : 0));
} else if (((inner ? strlen(inner) : 0) > 1LL) && ((inner)[0LL] == ((char)(42LL)))) {
    is_ptr = true;
    inner = substring(inner, 1LL, (inner ? strlen(inner) : 0));
} else if (((inner ? strlen(inner) : 0) > 5LL) && (strcmp(substring(inner, 0LL, 5LL), "&mut ") == 0)) {
    is_ptr = true;
    is_mut = true;
    inner = substring(inner, 5LL, (inner ? strlen(inner) : 0));
} else if (((inner ? strlen(inner) : 0) > 1LL) && ((inner)[0LL] == ((char)(38LL)))) {
    is_ptr = true;
    inner = substring(inner, 1LL, (inner ? strlen(inner) : 0));
}
...
bool TypeChecker_types_compatible(TypeChecker* self, const char* target, const char* source) {
    const char* t = target;
    const char* s = source;
    if (((t ? strlen(t) : 0) > 4LL) && (strcmp(substring(t, 0LL, 4LL), "own ") == 0)) {
    t = substring(t, 4LL, (t ? strlen(t) : 0));
}
    if (((s ? strlen(s) : 0) > 4LL) && (strcmp(substring(s, 0LL, 4LL), "own ") == 0)) {
    s = substring(s, 4LL, (s ? strlen(s) : 0));
}
    ...
    if (((((t ? strlen(t) : 0) > 0LL) && ((t)[0LL] == ((char)(40LL)))) && ((s ? strlen(s) : 0) > 0LL)) && ((s)[0LL] == ((char)(40LL)))) {
    const char* t_inner = __kai_str_sub(t, 1LL, ((t ? strlen(t) : 0) - 1LL));
    ArrayList_Str t_list = ArrayList_Str_init(self->allocator);
    int64_t start = 0LL;
    int64_t i = 0LL;
    while (i < (t_inner ? strlen(t_inner) : 0)) {
    ...
    int64_t ts_start = start;
    while ((ts_start < (t_inner ? strlen(t_inner) : 0)) && ((t_inner)[ts_start] == ((char)(32LL)))) {
    ts_start = (ts_start + 1LL);
}
    int64_t ts_end = (t_inner ? strlen(t_inner) : 0);
    while ((ts_end > ts_start) && ((t_inner)[(ts_end - 1LL)] == ((char)(32LL)))) {
    ts_end = (ts_end - 1LL);
}
    ArrayList_Str_push(&(t_list), __kai_str_sub(t_inner, ts_start, ts_end));
    const char* s_inner = __kai_str_sub(s, 1LL, ((s ? strlen(s) : 0) - 1LL));
    ArrayList_Str s_list = ArrayList_Str_init(self->allocator);
    start = 0LL;
    i = 0LL;
    while (i < (s_inner ? strlen(s_inner) : 0)) {
    ...
    ts_start = start;
    while ((ts_start < (s_inner ? strlen(s_inner) : 0)) && ((s_inner)[ts_start] == ((char)(32LL)))) {
    ts_start = (ts_start + 1LL);
}
    ts_end = (s_inner ? strlen(s_inner) : 0);
    while ((ts_end > ts_start) && ((s_inner)[(ts_end - 1LL)] == ((char)(32LL)))) {
    ts_end = (ts_end - 1LL);
}
    ArrayList_Str_push(&(s_list), __kai_str_sub(s_inner, ts_start, ts_end));
    ...
    if (((t ? strlen(t) : 0) > 0LL) && ((t)[0LL] == ((char)(63LL)))) {
    if (strcmp(s, "NoneType") == 0) {
    return true;
}
    const char* t_inner = substring(t, 1LL, (t ? strlen(t) : 0));
    const char* s_inner = s;
    if (((s ? strlen(s) : 0) > 0LL) && ((s)[0LL] == ((char)(63LL)))) {
    s_inner = substring(s, 1LL, (s ? strlen(s) : 0));
}
    return TypeChecker_types_compatible(self, t_inner, s_inner);
}
    int64_t excl_t = (-1LL);
    int64_t i = 0LL;
    while (i < (t ? strlen(t) : 0)) {
    if ((t)[i] == ((char)(33LL))) {
    excl_t = i;
}
    i = (i + 1LL);
    ...
    const char* target_err = substring(t, (excl_t + 1LL), (t ? strlen(t) : 0));
    int64_t excl_s = (-1LL);
    i = 0LL;
    ...
    const char* source_err = substring(s, (excl_s + 1LL), (s ? strlen(s) : 0));
    ...
    bool t_is_slice = (((t ? strlen(t) : 0) >= 2LL) && (strcmp(__kai_str_sub(t, 0LL, 2LL), "[]") == 0));
    bool s_is_slice = (((s ? strlen(s) : 0) >= 2LL) && (strcmp(__kai_str_sub(s, 0LL, 2LL), "[]") == 0));
    if (t_is_slice || s_is_slice) {
    const char* t_inner = t;
    if (t_is_slice) {
    t_inner = __kai_str_sub(t, 2LL, (t ? strlen(t) : 0));
} else if (((t ? strlen(t) : 0) > 0LL) && ((t)[0LL] == ((char)(42LL)))) {
    t_inner = __kai_str_sub(t, 1LL, (t ? strlen(t) : 0));
}
    const char* s_inner = s;
    if (s_is_slice) {
    s_inner = __kai_str_sub(s, 2LL, (s ? strlen(s) : 0));
} else if (((s ? strlen(s) : 0) > 0LL) && ((s)[0LL] == ((char)(42LL)))) {
    s_inner = __kai_str_sub(s, 1LL, (s ? strlen(s) : 0));
}
    return TypeChecker_types_compatible(self, t_inner, s_inner);
}
...
int64_t TypeChecker_find_method_decl(TypeChecker* self, const char* struct_name, const char* meth_name) {
    ...
    int64_t i = 0LL;
    const char* clean = "";
    while (i < (clean_struct ? strlen(clean_struct) : 0)) {
    ...
    clean_struct = clean;
    if (((clean_struct ? strlen(clean_struct) : 0) > 4LL) && (strcmp(substring(clean_struct, 0LL, 4LL), "mut ") == 0)) {
    clean_struct = substring(clean_struct, 4LL, (clean_struct ? strlen(clean_struct) : 0));
}
    int64_t lt_pos = (-1LL);
    i = 0LL;
    while (i < (clean_struct ? strlen(clean_struct) : 0)) {
    ...
    int64_t impl_lt = (-1LL);
    int64_t j = 0LL;
    while (j < (impl_name ? strlen(impl_name) : 0)) {
...
void TypeChecker_mark_expr_freed(TypeChecker* self, int64_t expr_idx) {
    ...
    if ((sym.name ? strlen(sym.name) : 0) > 0LL) {
    if (sym.freed) {
...
const char* TypeChecker_get_expr_type(TypeChecker* self, int64_t expr_idx) {
    ...
    if (((base_type ? strlen(base_type) : 0) > 0LL) && ((base_type)[0LL] == ((char)(40LL)))) {
    const char* field_name = expr.field_name;
    if (((field_name ? strlen(field_name) : 0) > 1LL) && ((field_name)[0LL] == ((char)(102LL)))) {
    int64_t idx_val = 0LL;
    int64_t fi = 1LL;
    bool valid = true;
    while (fi < (field_name ? strlen(field_name) : 0)) {
    ...
    if (valid) {
    const char* inner_types = __kai_str_sub(base_type, 1LL, ((base_type ? strlen(base_type) : 0) - 1LL));
    ArrayList_Str types_list = ArrayList_Str_init(self->allocator);
    int64_t start = 0LL;
    int64_t i = 0LL;
    while (i < (inner_types ? strlen(inner_types) : 0)) {
    ...
    int64_t ts_start = start;
    while ((ts_start < (inner_types ? strlen(inner_types) : 0)) && ((inner_types)[ts_start] == ((char)(32LL)))) {
    ts_start = (ts_start + 1LL);
}
    int64_t ts_end = (inner_types ? strlen(inner_types) : 0);
    while ((ts_end > ts_start) && ((inner_types)[(ts_end - 1LL)] == ((char)(32LL)))) {
    ts_end = (ts_end - 1LL);
}
    ArrayList_Str_push(&(types_list), __kai_str_sub(inner_types, ts_start, ts_end));
    ...
    int64_t i = 0LL;
    while (i < (base_type ? strlen(base_type) : 0)) {
    char c = (base_type)[i];
    if ((c != ((char)(42LL))) && (c != ((char)(38LL)))) {
    ...
    if (((clean_type ? strlen(clean_type) : 0) > 4LL) && (strcmp(substring(clean_type, 0LL, 4LL), "mut ") == 0)) {
    clean_type = substring(clean_type, 4LL, (clean_type ? strlen(clean_type) : 0));
}
    int64_t s_idx = 0LL;
    while (s_idx < ArrayList_StmtNode_length(self->stmt_pool)) {
    StmtNode stmt = ArrayList_StmtNode_get(self->stmt_pool, s_idx);
    ...
    if (((base_type ? strlen(base_type) : 0) > 0LL) && ((base_type)[0LL] == ((char)(42LL)))) {
    return substring(base_type, 1LL, (base_type ? strlen(base_type) : 0));
}
    return "Void";
}
    ...
    if (((base_type ? strlen(base_type) : 0) > 5LL) && (strcmp(substring(base_type, 0LL, 5LL), "*mut ") == 0)) {
    return substring(base_type, 5LL, (base_type ? strlen(base_type) : 0));
}
    if (((base_type ? strlen(base_type) : 0) > 5LL) && (strcmp(substring(base_type, 0LL, 5LL), "&mut ") == 0)) {
    return substring(base_type, 5LL, (base_type ? strlen(base_type) : 0));
}
    if (((base_type ? strlen(base_type) : 0) > 0LL) && (((base_type)[0LL] == ((char)(42LL))) || ((base_type)[0LL] == ((char)(38LL))))) {
    return substring(base_type, 1LL, (base_type ? strlen(base_type) : 0));
}
    return "Void";
}
    ...
    const char* clean = "";
    int64_t i = 0LL;
    while (i < (recv_type ? strlen(recv_type) : 0)) {
    char c = (recv_type)[i];
    if ((c != ((char)(42LL))) && (c != ((char)(38LL)))) {
    clean = concatAlloc(clean, char_to_str(c));
}
    ...
    if (((clean ? strlen(clean) : 0) > 4LL) && (strcmp(substring(clean, 0LL, 4LL), "mut ") == 0)) {
    clean = substring(clean, 4LL, (clean ? strlen(clean) : 0));
}
    int64_t lt_pos = (-1LL);
    i = 0LL;
    while (i < (clean ? strlen(clean) : 0)) {
    ...
    if ((((ret_type ? strlen(ret_type) : 0) == 1LL) && ((ret_type)[0LL] >= ((char)(65LL)))) && ((ret_type)[0LL] <= ((char)(90LL)))) {
    int64_t gt_pos = (-1LL);
    int64_t gi = 0LL;
    while (gi < (recv_type ? strlen(recv_type) : 0)) {
    ...
    if (gt_pos >= 0LL) {
    int64_t end_pos = (recv_type ? strlen(recv_type) : 0);
    gi = (gt_pos + 1LL);
    while (gi < (recv_type ? strlen(recv_type) : 0)) {
    if ((recv_type)[gi] == ((char)(62LL))) {
    end_pos = gi;
    gi = (recv_type ? strlen(recv_type) : 0);
}
    gi = (gi + 1LL);
}
    ...
    int64_t i = 0LL;
    while (i < (inner_ty ? strlen(inner_ty) : 0)) {
    ...
    if (((inner_ty ? strlen(inner_ty) : 0) > 0LL) && ((inner_ty)[0LL] == ((char)(63LL)))) {
    return substring(inner_ty, 1LL, (inner_ty ? strlen(inner_ty) : 0));
}
    int64_t excl_pos = (-1LL);
    int64_t i = 0LL;
    while (i < (inner_ty ? strlen(inner_ty) : 0)) {
...
void TypeChecker_check_field_access(TypeChecker* self, int64_t expr_idx) {
    ...
    if (((recv_type ? strlen(recv_type) : 0) > 0LL) && ((recv_type)[0LL] == ((char)(63LL)))) {
...
void TypeChecker_check_return_stmt(TypeChecker* self, int64_t stmt_idx) {
    ...
    if (((expected_ret ? strlen(expected_ret) : 0) > 0LL) && (strcmp(expected_ret, "<infer>") != 0)) {
...
void TypeChecker_check_stmt(TypeChecker* self, int64_t stmt_idx) {
    ...
    if ((var_type ? strlen(var_type) : 0) == 0LL) {
    var_type = val_type;
    ...
    if ((src_sym.name ? strlen(src_sym.name) : 0) > 0LL) {
    if (src_sym.freed) {
    ...
    if ((rsym.name ? strlen(rsym.name) : 0) > 0LL) {
    if (rsym.moved) {
    ...
    if (((sym.name ? strlen(sym.name) : 0) > 0LL) && sym.freed) {
    ...
    if (((opt_type ? strlen(opt_type) : 0) > 0LL) && ((opt_type)[0LL] == ((char)(63LL)))) {
    unwrapped_type = substring(opt_type, 1LL, (opt_type ? strlen(opt_type) : 0));
}
    ArrayList_SymTrackState snapshot = TypeChecker_capture_tracking_state(self);
    TypeChecker_enter_scope(self);
    ...
    if (((iter_type ? strlen(iter_type) : 0) == 0LL) || (strcmp(iter_type, "Void") == 0)) {
    iter_type = "Int";
}
    ...
    int64_t suffix_len = (expected_suffix ? strlen(expected_suffix) : 0);
    int64_t pat_len = (pat.variant_name ? strlen(pat.variant_name) : 0);
...
void TypeChecker_check_expr_inner(TypeChecker* self, int64_t expr_idx) {
    ...
    bool is_generic_param = ((((ptype ? strlen(ptype) : 0) == 1LL) && ((ptype)[0LL] >= ((char)(65LL)))) && ((ptype)[0LL] <= ((char)(90LL))));
    ...
    if ((((name ? strlen(name) : 0) > (iname ? strlen(iname) : 0)) && (strcmp(__kai_str_sub(name, 0LL, (iname ? strlen(iname) : 0)), iname) == 0)) && ((name)[(iname ? strlen(iname) : 0)] == ((char)(95LL)))) {
    ...
    if (((base_type ? strlen(base_type) : 0) == 0LL) || (((base_type)[0LL] != ((char)(42LL))) && ((base_type)[0LL] != ((char)(38LL))))) {
    if (!(((base_type ? strlen(base_type) : 0) >= 2LL) && (strcmp(__kai_str_sub(base_type, 0LL, 2LL), "[]") == 0))) {
    ...
    int64_t dot_pos = (-1LL);
    int64_t j = 0LL;
    while (j < (struct_name ? strlen(struct_name) : 0)) {
    ...
    const char* var_name = substring(struct_name, (dot_pos + 1LL), (struct_name ? strlen(struct_name) : 0));
    ...
    const char* error_set = substring(inner_ty, (excl_pos + 1LL), (inner_ty ? strlen(inner_ty) : 0));
    const char* expected_ret = self->current_func_ret_type;
    int64_t func_excl = (-1LL);
    i = 0LL;
    while (i < (expected_ret ? strlen(expected_ret) : 0)) {
    ...
    const char* func_err = substring(expected_ret, (func_excl + 1LL), (expected_ret ? strlen(expected_ret) : 0));
    ...
    if (strcmp(inner_ty, "Void") == 0) {
    TypeChecker_enter_scope(self);
    if ((expr.catch_var ? strlen(expr.catch_var) : 0) > 0LL) {
    ...
    if (((inner_ty ? strlen(inner_ty) : 0) > 0LL) && ((inner_ty)[0LL] == ((char)(63LL)))) {
    const char* val_type = substring(inner_ty, 1LL, (inner_ty ? strlen(inner_ty) : 0));
    TypeChecker_enter_scope(self);
    if ((expr.catch_var ? strlen(expr.catch_var) : 0) > 0LL) {
    TypeChecker_define_symbol(self, expr.catch_var, "Void", false, "var", (-1LL));
}
...
int64_t TypeChecker_map_type_to_id(TypeChecker* self, const char* type_name) {
    if ((strcmp(type_name, "Void") == 0) || ((type_name ? strlen(type_name) : 0) == 0LL)) {
    return 0LL;
}
    if (strcmp(type_name, "Int") == 0) {
    return 1LL;
    ...
    if (((type_name ? strlen(type_name) : 0) > 0LL) && ((type_name)[0LL] == ((char)(42LL)))) {
    const char* element = __kai_str_sub(type_name, 1LL, (type_name ? strlen(type_name) : 0));
...
void ImportResolver_resolve_import(ImportResolver* self, int64_t stmt_idx, ArrayList_StmtNode* stmt_pool, ArrayList_ExprNode* expr_pool, ArrayList_PatternNode* pattern_pool) {
    ...
    if (s2.tag == 0LL) {
    if ((s2.value ? strlen(s2.value) : 0) > 0LL) {
    source = s2.value;
    has_source = true;
    ...
    if (s3.tag == 0LL) {
    if ((s3.value ? strlen(s3.value) : 0) > 0LL) {
    source = s3.value;
    has_source = true;
    ...
    if (s4.tag == 0LL) {
    if ((s4.value ? strlen(s4.value) : 0) > 0LL) {
    source = s4.value;
    has_source = true;
...
const char* Codegen_add_init_return(Codegen* self, const char* body_str, const char* struct_name) {
    ...
    int64_t body_len = (body_str ? strlen(body_str) : 0);
    ...
    if (offset >= ((stripped_body ? strlen(stripped_body) : 0) - 20LL)) {
...
bool Codegen_is_pointer_type(Codegen* self, const char* t) {
    ...
    if (((t ? strlen(t) : 0) >= 2LL) && (strcmp(__kai_str_sub(t, 0LL, 2LL), "[]") == 0)) {
    return true;
}
    return false;
}
const char* Codegen_strip_module_prefix(Codegen* self, const char* name) {
    ...
    if (last_dot >= 0LL) {
    return __kai_str_sub(name, (last_dot + 1LL), (name ? strlen(name) : 0));
}
    return name;
}
const char* Codegen_map_type(Codegen* self, const char* type_name) {
    if ((type_name ? strlen(type_name) : 0) == 0LL) {
    return "void";
}
    ...
    if (((resolved_type ? strlen(resolved_type) : 0) > 0LL) && ((resolved_type)[0LL] == ((char)(40LL)))) {
    ...
    const char* inner_types = __kai_str_sub(resolved_type, 1LL, ((resolved_type ? strlen(resolved_type) : 0) - 1LL));
    ArrayList_Str types_list = ArrayList_Str_init(self->allocator);
    int64_t start = 0LL;
    int64_t i = 0LL;
    while (i < (inner_types ? strlen(inner_types) : 0)) {
    ...
    ArrayList_Str_push(&(types_list), Codegen_trim_spaces(self, __kai_str_sub(inner_types, start, (inner_types ? strlen(inner_types) : 0))));
    ...
    if (((resolved_type ? strlen(resolved_type) : 0) > 0LL) && ((resolved_type)[0LL] == ((char)(63LL)))) {
    const char* val_type = __kai_str_sub(resolved_type, 1LL, (resolved_type ? strlen(resolved_type) : 0));
    ...
    const char* err_type = __kai_str_sub(resolved_type, (excl_pos + 1LL), (resolved_type ? strlen(resolved_type) : 0));
    const char* clean_val = Codegen_clean_type_for_mangling(self, val_type);
    ...
    const char* inner = __kai_str_sub(resolved_type, 2LL, (resolved_type ? strlen(resolved_type) : 0));
    return concatAlloc(Codegen_map_type(self, inner), "*");
}
    if ((resolved_type)[0LL] == ((char)(42LL))) {
    if (((resolved_type ? strlen(resolved_type) : 0) > 5LL) && (strcmp(__kai_str_sub(resolved_type, 0LL, 5LL), "*mut ") == 0)) {
    const char* inner = __kai_str_sub(resolved_type, 5LL, (resolved_type ? strlen(resolved_type) : 0));
    if (strcmp(inner, "Void") == 0) {
    return "void*";
}
    return concatAlloc(Codegen_map_type(self, inner), "*");
} else {
    const char* inner = __kai_str_sub(resolved_type, 1LL, (resolved_type ? strlen(resolved_type) : 0));
    if (strcmp(inner, "Void") == 0) {
    return "void*";
}
    return concatAlloc(Codegen_map_type(self, inner), "*");
    ...
    const char* args_str = __kai_str_sub(resolved_type, (lt_pos + 1LL), ((resolved_type ? strlen(resolved_type) : 0) - 1LL));
    ArrayList_Str args = ArrayList_Str_init(self->allocator);
    int64_t start = 0LL;
    int64_t i = 0LL;
    while (i < (args_str ? strlen(args_str) : 0)) {
    char c = (args_str)[i];
    if (c == ((char)(44LL))) {
    ...
    ArrayList_Str_push(&(args), Codegen_trim_spaces(self, __kai_str_sub(args_str, start, (args_str ? strlen(args_str) : 0))));
    ...
    if ((struct_idx_str ? strlen(struct_idx_str) : 0) > 0LL) {
    ...
    if ((enum_idx_str ? strlen(enum_idx_str) : 0) > 0LL) {
    if (strlist_find(&(self->monomorphized_types), concrete_name) < 0LL) {
    ArrayList_Str_push(&(self->monomorphized_types), concrete_name);
...
const char* Codegen_substitute_generic_type(Codegen* self, const char* type_name) {
    ...
    if ((mapped ? strlen(mapped) : 0) > 0LL) {
    return mapped;
}
    if ((type_name)[0LL] == ((char)(42LL))) {
    return concatAlloc("*", Codegen_substitute_generic_type(self, __kai_str_sub(type_name, 1LL, (type_name ? strlen(type_name) : 0))));
}
    if ((type_name)[0LL] == ((char)(38LL))) {
    if (strcmp(__kai_str_sub(type_name, 0LL, 5LL), "&mut ") == 0) {
    return concatAlloc("&mut ", Codegen_substitute_generic_type(self, __kai_str_sub(type_name, 5LL, (type_name ? strlen(type_name) : 0))));
}
    return concatAlloc("&", Codegen_substitute_generic_type(self, __kai_str_sub(type_name, 1LL, (type_name ? strlen(type_name) : 0))));
}
    ...
    const char* inner = __kai_str_sub(type_name, (lt_pos + 1LL), ((type_name ? strlen(type_name) : 0) - 1LL));
    const char* res = concatAlloc(base, "<");
    int64_t start = 0LL;
    int64_t i = 0LL;
    int64_t arg_count = 0LL;
    while (i < (inner ? strlen(inner) : 0)) {
    char c = (inner)[i];
    if (c == ((char)(44LL))) {
    ...
    const char* arg = Codegen_trim_spaces(self, __kai_str_sub(inner, start, (inner ? strlen(inner) : 0)));
    if (arg_count > 0LL) {
    res = concatAlloc(res, ", ");
}
    res = concatAlloc(res, Codegen_substitute_generic_type(self, arg));
...
const char* Codegen_trim_spaces(Codegen* self, const char* s) {
    int64_t start = 0LL;
    while ((start < (s ? strlen(s) : 0)) && ((s)[start] == ((char)(32LL)))) {
    start = (start + 1LL);
}
    int64_t end = (s ? strlen(s) : 0);
...
ArrayList_Str Codegen_infer_type_args(Codegen* self, int64_t func_stmt_idx, int64_t expr_idx) {
    ...
    bool done = false;
    while (!done) {
    if (((ptype ? strlen(ptype) : 0) > 0LL) && (((ptype)[0LL] == ((char)(42LL))) || ((ptype)[0LL] == ((char)(38LL))))) {
    ptype = __kai_str_sub(ptype, 1LL, (ptype ? strlen(ptype) : 0));
} else {
    done = true;
}
}
    ...
    while (!done) {
    if (((atype ? strlen(atype) : 0) > 0LL) && (((atype)[0LL] == ((char)(42LL))) || ((atype)[0LL] == ((char)(38LL))))) {
    atype = __kai_str_sub(atype, 1LL, (atype ? strlen(atype) : 0));
} else {
    done = true;
}
}
    if (((ptype ? strlen(ptype) : 0) >= 4LL) && (strcmp(__kai_str_sub(ptype, 0LL, 4LL), "mut ") == 0)) {
    ptype = __kai_str_sub(ptype, 4LL, (ptype ? strlen(ptype) : 0));
}
    if (((atype ? strlen(atype) : 0) >= 4LL) && (strcmp(__kai_str_sub(atype, 0LL, 4LL), "mut ") == 0)) {
    atype = __kai_str_sub(atype, 4LL, (atype ? strlen(atype) : 0));
}
    bool is_param = false;
    if ((((ptype ? strlen(ptype) : 0) == 1LL) && ((ptype)[0LL] >= ((char)(65LL)))) && ((ptype)[0LL] <= ((char)(90LL)))) {
    is_param = true;
}
    if (is_param) {
    int64_t tp_i = 0LL;
    ...
    if ((ArrayList_Str_get(&(type_args), i) ? strlen(ArrayList_Str_get(&(type_args), i)) : 0) == 0LL) {
...
void Codegen_monomorphize_methods(Codegen* self, const char* base_struct_name, const char* concrete_struct_name) {
    ...
    if ((params_str ? strlen(params_str) : 0) > 0LL) {
...
const char* Codegen_get_expr_type(Codegen* self, int64_t expr_idx) {
    ...
    if ((var_t ? strlen(var_t) : 0) > 0LL) {
    return var_t;
}
    const char* fn_t = type_map_get(&(self->func_types), name);
    if ((fn_t ? strlen(fn_t) : 0) > 0LL) {
    return fn_t;
}
    ...
    if ((gf_idx_str ? strlen(gf_idx_str) : 0) > 0LL) {
    ...
    clean_type = __kai_str_sub(clean_type, 4LL, (clean_type ? strlen(clean_type) : 0));
}
    int64_t s_idx = 0LL;
    while (s_idx < ArrayList_StmtNode_length(self->stmt_pool)) {
    StmtNode stmt = ArrayList_StmtNode_get(self->stmt_pool, s_idx);
    ...
    if (((base_type ? strlen(base_type) : 0) >= 2LL) && (strcmp(__kai_str_sub(base_type, 0LL, 2LL), "[]") == 0)) {
    return __kai_str_sub(base_type, 2LL, (base_type ? strlen(base_type) : 0));
}
    if (((base_type ? strlen(base_type) : 0) > 0LL) && ((base_type)[0LL] == ((char)(42LL)))) {
    return __kai_str_sub(base_type, 1LL, (base_type ? strlen(base_type) : 0));
}
    return "Void";
}
    if (expr.kind == ExprKind_ek_borrow) {
    ...
    if (((base_type ? strlen(base_type) : 0) > 5LL) && (strcmp(__kai_str_sub(base_type, 0LL, 5LL), "*mut ") == 0)) {
    return __kai_str_sub(base_type, 5LL, (base_type ? strlen(base_type) : 0));
}
    if (((base_type ? strlen(base_type) : 0) > 5LL) && (strcmp(__kai_str_sub(base_type, 0LL, 5LL), "&mut ") == 0)) {
    return __kai_str_sub(base_type, 5LL, (base_type ? strlen(base_type) : 0));
}
    ...
    const char* clean_type = "";
    int64_t i = 0LL;
    while (i < (rec_type ? strlen(rec_type) : 0)) {
    char c = (rec_type)[i];
    if ((c != ((char)(42LL))) && (c != ((char)(38LL)))) {
    clean_type = concatAlloc(clean_type, char_to_str(c));
}
    ...
    if ((ret ? strlen(ret) : 0) > 0LL) {
    return ret;
}
    const char* clean_rec = rec_type;
    bool done = false;
    while (!done) {
    if (((clean_rec ? strlen(clean_rec) : 0) > 0LL) && (((clean_rec)[0LL] == ((char)(42LL))) || ((clean_rec)[0LL] == ((char)(38LL))))) {
    clean_rec = __kai_str_sub(clean_rec, 1LL, (clean_rec ? strlen(clean_rec) : 0));
} else {
    done = true;
}
}
    if (strcmp(__kai_str_sub(clean_rec, 0LL, 4LL), "mut ") == 0) {
    clean_rec = __kai_str_sub(clean_rec, 4LL, (clean_rec ? strlen(clean_rec) : 0));
}
    ...
    const char* args_str = __kai_str_sub(clean_rec, (lt_pos + 1LL), ((clean_rec ? strlen(clean_rec) : 0) - 1LL));
    ArrayList_Str args = ArrayList_Str_init(self->allocator);
    int64_t start = 0LL;
    int64_t ai = 0LL;
    while (ai < (args_str ? strlen(args_str) : 0)) {
    char c = (args_str)[ai];
    if (c == ((char)(44LL))) {
    ...
    if (expr.kind == ExprKind_ek_slice) {
    if ((expr.inferred_type ? strlen(expr.inferred_type) : 0) > 0LL) {
    ...
    if (((inner_ty ? strlen(inner_ty) : 0) > 0LL) && ((inner_ty)[0LL] == ((char)(63LL)))) {
    return __kai_str_sub(inner_ty, 1LL, (inner_ty ? strlen(inner_ty) : 0));
}
    int64_t excl_pos = Codegen_str_find(self, inner_ty, ((char)(33LL)));
    if (excl_pos >= 0LL) {
    return __kai_str_sub(inner_ty, 0LL, excl_pos);
...
const char* Codegen_gen_expr_with_expected_type(Codegen* self, int64_t expr_idx, const char* expected_type) {
    ...
    if (((expected_type ? strlen(expected_type) : 0) > 0LL) && ((expected_type)[0LL] == ((char)(63LL)))) {
    const char* val_type = __kai_str_sub(expected_type, 1LL, (expected_type ? strlen(expected_type) : 0));
    if (Codegen_is_pointer_type(self, val_type)) {
    return "NULL";
}
...
const char* Codegen_gen_expr(Codegen* self, int64_t expr_idx) {
    ...
    if ((((lhs_type ? strlen(lhs_type) : 0) > 0LL) && ((lhs_type)[0LL] == ((char)(63LL)))) && (strcmp(rhs, "NULL") == 0)) {
    const char* val_type = __kai_str_sub(lhs_type, 1LL, (lhs_type ? strlen(lhs_type) : 0));
    if (Codegen_is_pointer_type(self, val_type)) {
    ...
    if ((((rhs_type ? strlen(rhs_type) : 0) > 0LL) && ((rhs_type)[0LL] == ((char)(63LL)))) && (strcmp(lhs, "NULL") == 0)) {
    const char* val_type = __kai_str_sub(rhs_type, 1LL, (rhs_type ? strlen(rhs_type) : 0));
    if (Codegen_is_pointer_type(self, val_type)) {
    ...
    bool is_target_ptr = ((((target_type ? strlen(target_type) : 0) > 0LL) && (((target_type)[0LL] == ((char)(42LL))) || ((target_type)[0LL] == ((char)(38LL))))) || (strcmp(target_type, "Str") == 0LL));
    ...
    if (((base_type ? strlen(base_type) : 0) >= 2LL) && (strcmp(__kai_str_sub(base_type, 0LL, 2LL), "[]") == 0)) {
    const char* inner_type = __kai_str_sub(base_type, 2LL, (base_type ? strlen(base_type) : 0));
    ...
    if ((elems_str ? strlen(elems_str) : 0) == 0LL) {
    elems_str = "0";
}
    const char* inner_ty = "Int";
    if (((expr.inferred_type ? strlen(expr.inferred_type) : 0) > 2LL) && (strcmp(__kai_str_sub(expr.inferred_type, 0LL, 2LL), "[]") == 0)) {
    inner_ty = __kai_str_sub(expr.inferred_type, 2LL, (expr.inferred_type ? strlen(expr.inferred_type) : 0));
}
    ...
    if ((out.type_name ? strlen(out.type_name) : 0) > 0LL) {
    ...
    int64_t c_idx = 0LL;
    while (c_idx < (expr.asm_code ? strlen(expr.asm_code) : 0)) {
    ...
    if ((out0.type_name ? strlen(out0.type_name) : 0) > 0LL) {
    ...
    if (expr.kind == ExprKind_ek_struct_init) {
    bool is_enum = (((expr.struct_name ? strlen(expr.struct_name) : 0) > 0LL) && Codegen_str_contains(self, expr.struct_name, ((char)(46LL))));
    if (is_enum) {
    ...
    const char* variant_name = __kai_str_sub(expr.struct_name, (dot_pos + 1LL), (expr.struct_name ? strlen(expr.struct_name) : 0));
    ...
    if ((fields_str ? strlen(fields_str) : 0) > 0LL) {
    ...
    if ((args_str ? strlen(args_str) : 0) > 0LL) {
    args_str = concatAlloc(args_str, ", ");
}
    ...
    const char* inner_ty = Codegen_get_expr_type(self, expr.catch_expr);
    if (((inner_ty ? strlen(inner_ty) : 0) > 0LL) && ((inner_ty)[0LL] == ((char)(63LL)))) {
    const char* val_type = __kai_str_sub(inner_ty, 1LL, (inner_ty ? strlen(inner_ty) : 0));
...
const char* Codegen_gen_stmt(Codegen* self, int64_t stmt_idx) {
    ...
    if ((var_type_name ? strlen(var_type_name) : 0) == 0LL) {
    ...
    const char* op = "=";
    if ((stmt.assign_op ? strlen(stmt.assign_op) : 0) > 0LL) {
    op = stmt.assign_op;
}
    ...
    if (stmt.kind == StmtKind_sk_impl_block) {
    const char* struct_name = stmt.impl_struct_name;
    bool has_generic_struct = (((type_map_get(&(self->generic_struct_decls), struct_name) ? strlen(type_map_get(&(self->generic_struct_decls), struct_name)) : 0) > 0LL) || ((type_map_get(&(self->generic_enum_decls), struct_name) ? strlen(type_map_get(&(self->generic_enum_decls), struct_name)) : 0) > 0LL));
    ...
    const char* cond_str = "";
    if ((((cond_val ? strlen(cond_val) : 0) > 1LL) && ((cond_val)[0LL] == ((char)(40LL)))) && ((cond_val)[((cond_val ? strlen(cond_val) : 0) - 1LL)] == ((char)(41LL)))) {
    cond_str = cond_val;
} else {
    ...
    const char* unwrapped_type = __kai_str_sub(cond_type, 1LL, (cond_type ? strlen(cond_type) : 0));
    ...
    const char* err_type = __kai_str_sub(self->cur_return_type, (ret_excl_pos + 1LL), (self->cur_return_type ? strlen(self->cur_return_type) : 0));
    ...
    if (((base_type ? strlen(base_type) : 0) > 0LL) && (((base_type)[((base_type ? strlen(base_type) : 0) - 1LL)] == ((char)(42LL))) || ((base_type)[((base_type ? strlen(base_type) : 0) - 1LL)] == ((char)(38LL))))) {
    base_type = __kai_str_sub(base_type, 0LL, ((base_type ? strlen(base_type) : 0) - 1LL));
}
    if (((base_type ? strlen(base_type) : 0) > 0LL) && ((base_type)[0LL] == ((char)(42LL)))) {
    base_type = __kai_str_sub(base_type, 1LL, (base_type ? strlen(base_type) : 0));
}
    ...
    while (!done_clean) {
    if (((clean_enum_name ? strlen(clean_enum_name) : 0) > 0LL) && (((clean_enum_name)[0LL] == ((char)(42LL))) || ((clean_enum_name)[0LL] == ((char)(38LL))))) {
    clean_enum_name = __kai_str_sub(clean_enum_name, 1LL, (clean_enum_name ? strlen(clean_enum_name) : 0));
} else {
    done_clean = true;
}
}
    ...
    if ((bindings_str ? strlen(bindings_str) : 0) > 0LL) {
    int64_t body_len = (block_str ? strlen(block_str) : 0);
...
const char* Codegen_clean_enum_name(Codegen* self, const char* type_name) {
    ...
    base_name = __kai_str_sub(base_name, 4LL, (base_name ? strlen(base_name) : 0));
}
    bool done = false;
    while (!done) {
    if (((base_name ? strlen(base_name) : 0) > 0LL) && (((base_name)[0LL] == ((char)(42LL))) || ((base_name)[0LL] == ((char)(38LL))))) {
    base_name = __kai_str_sub(base_name, 1LL, (base_name ? strlen(base_name) : 0));
} else {
    done = true;
}
}
    ...
    while (!done) {
    int64_t l = (base_name ? strlen(base_name) : 0);
...
bool Codegen_is_enum_type(Codegen* self, const char* type_name) {
    ...
    return ((type_map_get(&(self->enum_decls), clean_name) ? strlen(type_map_get(&(self->enum_decls), clean_name)) : 0) > 0LL);
}
bool Codegen_enum_has_payload(Codegen* self, const char* enum_name) {
    const char* clean_name = Codegen_clean_enum_name(self, enum_name);
    const char* idx_str = type_map_get(&(self->enum_decls), clean_name);
    if ((idx_str ? strlen(idx_str) : 0) == 0LL) {
    return false;
}
...
void Codegen_emit_struct_body_with_deps(Codegen* self, int64_t stmt_idx, ArrayList_Str* emitted) {
    ...
    const char* ftype = f.ftype;
    {
    if ((((ftype ? strlen(ftype) : 0) > 0LL) && ((ftype)[0LL] != ((char)(42LL)))) && ((ftype)[0LL] != ((char)(38LL)))) {
    int64_t si = 0LL;
    while (si < ArrayList_StmtNode_length(self->stmt_pool)) {
...
const char* Codegen_generate(Codegen* self, int64_t top_stmt_idx) {
    ...
    if ((hdr ? strlen(hdr) : 0) > 0LL) {
    int64_t hi = 0LL;
    while (hi < (hdr ? strlen(hdr) : 0)) {
    if ((hdr)[hi] == ((char)(47LL))) {
    has_slash = true;
}
    hi = (hi + 1LL);
...
int64_t CodegenBuilder_gen_expr(CodegenBuilder* self, int64_t expr_idx) {
    ...
    int64_t arg_idx = CodegenBuilder_gen_expr_with_expected_type(self, ArrayList_Int_get(&(expr.func_args), ai), expected_type);
    ...
    int64_t val_idx = CodegenBuilder_gen_expr_with_expected_type(self, f.value, field_type);
    ArrayList_Str_push(&(fields), concatAlloc(concatAlloc(concatAlloc(".", f.name), " = "), CodegenBuilder_expr_to_str(self, val_idx)));
    i = (i + 1LL);
}
    ...
    const char* inner_ty = CodegenBuilder_get_expr_type(self, expr.try_expr);
    int64_t excl_pos = CodegenBuilder_str_find(self, inner_ty, ((char)(33LL)));
    int64_t inner_idx = CodegenBuilder_gen_expr(self, expr.try_expr);
    if (excl_pos < 0LL) {
    return inner_idx;
}
    const char* val_type = __kai_str_sub(inner_ty, 0LL, excl_pos);
    const char* result_mapped = CodegenBuilder_map_type(self, inner_ty);
    const char* ret_mapped = CodegenBuilder_map_type(self, self->cur_return_type);
    CType res_ct = ctype_new(result_mapped, 0LL, false, false);
    CType ret_ct = ctype_new(ret_mapped, 0LL, false, false);
    int64_t res_ident = CodegenBuilder_push_expr(self, cexpr_new_ident("_kai_res"));
    int64_t err_ident = CodegenBuilder_push_expr(self, cexpr_new_ident("_kai_err"));
    int64_t res_decl = CodegenBuilder_push_c_stmt(self, cstmt_new_var_decl(res_ct, "_kai_res", inner_idx));
    int64_t tag_field = CodegenBuilder_push_expr(self, cexpr_new_field(res_ident, "tag"));
    int64_t zero = CodegenBuilder_push_expr(self, cexpr_new_int("0"));
    int64_t cond = CodegenBuilder_push_expr(self, cexpr_new_binary(tag_field, "!=", zero));
    int64_t err_decl = CodegenBuilder_push_c_stmt(self, cstmt_new_var_decl(ret_ct, "_kai_err", (-1LL)));
    int64_t err_tag = CodegenBuilder_push_expr(self, cexpr_new_field(err_ident, "tag"));
    int64_t tag_assign = CodegenBuilder_push_expr(self, cexpr_new_assign(err_tag, tag_field, "="));
    int64_t tag_assign_stmt = CodegenBuilder_push_c_stmt(self, cstmt_new_expr(tag_assign));
    int64_t ret_stmt = CodegenBuilder_push_c_stmt(self, cstmt_new_return(err_ident));
    ArrayList_Int then_stmts = ArrayList_Int_init(self->allocator);
    ArrayList_Int_push(&(then_stmts), err_decl);
    ArrayList_Int_push(&(then_stmts), tag_assign_stmt);
    ArrayList_Int_push(&(then_stmts), ret_stmt);
    int64_t then_block = CodegenBuilder_push_c_stmt(self, cstmt_new_block(then_stmts));
    int64_t if_stmt = CodegenBuilder_push_c_stmt(self, cstmt_new_if(cond, then_block, (-1LL)));
    int64_t result_expr = CodegenBuilder_push_expr(self, cexpr_new_field(res_ident, "value"));
    if (strcmp(val_type, "Void") == 0) {
    result_expr = CodegenBuilder_push_expr(self, cexpr_new_int("0"));
}
    ...
    if (expr.kind == ExprKind_ek_catch) {
    const char* inner_type = CodegenBuilder_get_expr_type(self, expr.catch_expr);
    int64_t inner_idx = CodegenBuilder_gen_expr(self, expr.catch_expr);
    int64_t fb_expr = (-1LL);
    const char* fb_raw = "";
    bool fb_is_stmt = false;
    if (expr.catch_fallback >= 0LL) {
    StmtNode fb_node = ArrayList_StmtNode_get(self->stmt_pool, expr.catch_fallback);
    if (fb_node.kind == StmtKind_sk_expr) {
    fb_expr = CodegenBuilder_gen_expr(self, fb_node.expr_stmt);
} else if ((fb_node.kind == StmtKind_sk_block) && (ArrayList_Int_length(&(fb_node.block_stmts)) == 1LL)) {
    StmtNode single = ArrayList_StmtNode_get(self->stmt_pool, ArrayList_Int_get(&(fb_node.block_stmts), 0LL));
    if (single.kind == StmtKind_sk_expr) {
    fb_expr = CodegenBuilder_gen_expr(self, single.expr_stmt);
}
}
    if (fb_expr < 0LL) {
    ...
    fb_raw = CCodeBuilder_to_str(&(self->builder));
    self->builder = saved;
    fb_is_stmt = true;
}
}
    ...
    const char* val_ctype_str = CodegenBuilder_map_type(self, val_type);
    const char* opt_ctype_str = CodegenBuilder_map_type(self, inner_type);
    CType opt_ct = ctype_new(opt_ctype_str, 0LL, false, false);
    CType val_ct = ctype_new(val_ctype_str, 0LL, false, false);
    ...
    int64_t opt_decl = CodegenBuilder_push_c_stmt(self, cstmt_new_var_decl(opt_ct, "_kai_opt", inner_idx));
    int64_t cv_decl = CodegenBuilder_push_c_stmt(self, cstmt_new_var_decl(val_ct, "_kai_cv", (-1LL)));
    int64_t cond = (-1LL);
    int64_t then_val = (-1LL);
    if (CodegenBuilder_is_pointer_type(self, val_type)) {
    int64_t null_idx = CodegenBuilder_push_expr(self, cexpr_new_ident("NULL"));
    cond = CodegenBuilder_push_expr(self, cexpr_new_binary(opt_ident, "!=", null_idx));
    then_val = opt_ident;
} else {
    cond = CodegenBuilder_push_expr(self, cexpr_new_field(opt_ident, "has_value"));
    then_val = CodegenBuilder_push_expr(self, cexpr_new_field(opt_ident, "value"));
}
    ArrayList_Int then_stmts_arr = ArrayList_Int_init(self->allocator);
    int64_t then_assign = CodegenBuilder_push_expr(self, cexpr_new_assign(cv_ident, then_val, "="));
    ...
    int64_t else_assign = CodegenBuilder_push_expr(self, cexpr_new_assign(cv_ident, fb_val, "="));
    ArrayList_Int_push(&(else_stmts_arr), CodegenBuilder_push_c_stmt(self, cstmt_new_expr(else_assign)));
}
    int64_t then_block = CodegenBuilder_push_c_stmt(self, cstmt_new_block(then_stmts_arr));
    int64_t else_block = CodegenBuilder_push_c_stmt(self, cstmt_new_block(else_stmts_arr));
    int64_t if_stmt = CodegenBuilder_push_c_stmt(self, cstmt_new_if(cond, then_block, else_block));
    ArrayList_Int stmts = ArrayList_Int_init(self->allocator);
    ArrayList_Int_push(&(stmts), opt_decl);
    ...
    int64_t excl_pos = CodegenBuilder_str_find(self, inner_type, ((char)(33LL)));
    if (excl_pos >= 0LL) {
    const char* val_type = __kai_str_sub(inner_type, 0LL, excl_pos);
    const char* result_ctype_str = CodegenBuilder_map_type(self, inner_type);
    const char* val_ctype_str = CodegenBuilder_map_type(self, val_type);
    CType result_ct = ctype_new(result_ctype_str, 0LL, false, false);
    CType val_ct = ctype_new(val_ctype_str, 0LL, false, false);
    int64_t cr_ident = CodegenBuilder_push_expr(self, cexpr_new_ident("_kai_cr"));
    int64_t zero = CodegenBuilder_push_expr(self, cexpr_new_int("0"));
    int64_t tag_field = CodegenBuilder_push_expr(self, cexpr_new_field(cr_ident, "tag"));
    int64_t cr_decl = CodegenBuilder_push_c_stmt(self, cstmt_new_var_decl(result_ct, "_kai_cr", inner_idx));
    int64_t cond = CodegenBuilder_push_expr(self, cexpr_new_binary(tag_field, "!=", zero));
    if (strcmp(val_type, "Void") == 0) {
    ArrayList_Int then_stmts_arr = ArrayList_Int_init(self->allocator);
    if (strlen(expr.catch_var) > 0LL) {
    CType err_ct = ctype_new("int64_t", 0LL, false, false);
    ...
    ArrayList_Int_push(&(then_stmts_arr), CodegenBuilder_push_c_stmt(self, cstmt_new_expr(fb_val)));
}
    int64_t then_block = CodegenBuilder_push_c_stmt(self, cstmt_new_block(then_stmts_arr));
    int64_t if_stmt = CodegenBuilder_push_c_stmt(self, cstmt_new_if(cond, then_block, (-1LL)));
    ArrayList_Int stmts = ArrayList_Int_init(self->allocator);
    ...
    int64_t cv_ident = CodegenBuilder_push_expr(self, cexpr_new_ident("_kai_cv"));
    int64_t cv_decl = CodegenBuilder_push_c_stmt(self, cstmt_new_var_decl(val_ct, "_kai_cv", (-1LL)));
    int64_t value_field = CodegenBuilder_push_expr(self, cexpr_new_field(cr_ident, "value"));
    ArrayList_Int then_stmts_arr = ArrayList_Int_init(self->allocator);
    if (strlen(expr.catch_var) > 0LL) {
    CType err_ct = ctype_new("int64_t", 0LL, false, false);
    ArrayList_Int_push(&(then_stmts_arr), CodegenBuilder_push_c_stmt(self, cstmt_new_var_decl(err_ct, expr.catch_var, tag_field)));
    ...
    int64_t then_assign = CodegenBuilder_push_expr(self, cexpr_new_assign(cv_ident, fb_val, "="));
    ArrayList_Int_push(&(then_stmts_arr), CodegenBuilder_push_c_stmt(self, cstmt_new_expr(then_assign)));
}
    ArrayList_Int else_stmts_arr = ArrayList_Int_init(self->allocator);
    int64_t else_assign = CodegenBuilder_push_expr(self, cexpr_new_assign(cv_ident, value_field, "="));
    ArrayList_Int_push(&(else_stmts_arr), CodegenBuilder_push_c_stmt(self, cstmt_new_expr(else_assign)));
    int64_t else_block = CodegenBuilder_push_c_stmt(self, cstmt_new_block(else_stmts_arr));
    int64_t then_block = CodegenBuilder_push_c_stmt(self, cstmt_new_block(then_stmts_arr));
    int64_t if_stmt = CodegenBuilder_push_c_stmt(self, cstmt_new_if(cond, then_block, else_block));
    ...
    CType zero_ct = ctype_new(CodegenBuilder_map_type(self, val_type), 0LL, false, false);
    ArrayList_Str zero_fields = ArrayList_Str_init(self->allocator);
...
LLVMCodegen LLVMCodegen_init(KaiAllocator* allocator, ArrayList_StmtNode* stmt_pool, ArrayList_ExprNode* expr_pool, ArrayList_PatternNode* pattern_pool, ImportResolver* import_resolver, StringPool* pool) {
    ...
    self.global_decls = ArrayList_Int_init(allocator);
...
void LLVMCodegen_build_func_types(LLVMCodegen* self) {
    ...
    bool is_init = ((((strcmp(method_stmt.func_name, "init") == 0) || (strcmp(method_stmt.func_return_type, stmt.impl_struct_name) == 0)) || (strcmp(method_stmt.func_return_type, concatAlloc("*", stmt.impl_struct_name)) == 0)) || (strcmp(method_stmt.func_return_type, concatAlloc("&", stmt.impl_struct_name)) == 0));
    if (is_init) {
...
const char* LLVMCodegen_resolve_mangled_func_name(LLVMCodegen* self, const char* name) {
    ...
    {
    if ((void*)(self->cur_func_name) != (void*)(unsigned long long)(0LL)) {
    if (strlen(self->cur_func_name) > 0LL) {
    has_func_name = true;
}
}
}
    if (has_func_name) {
    int64_t underscore_pos = LLVMCodegen_str_find(self, self->cur_func_name, ((char)(95LL)));
    if (underscore_pos > 0LL) {
    prefix = __kai_str_sub(self->cur_func_name, 0LL, (underscore_pos + 1LL));
}
}
    if (strlen(prefix) > 0LL) {
    i = 0LL;
    while (i < ArrayList_Str_length(&(self->func_type_names))) {
    const char* f_name = ArrayList_Str_get(&(self->func_type_names), i);
    if (LLVMCodegen_decl_name_matches(self, f_name, name)) {
    if ((strlen(f_name) >= strlen(prefix)) && (strcmp(__kai_str_sub(f_name, 0LL, strlen(prefix)), prefix) == 0)) {
    return f_name;
}
}
    i = (i + 1LL);
...
const char* LLVMCodegen_get_func_return_type(LLVMCodegen* self, const char* name) {
    const char* rname = LLVMCodegen_resolve_mangled_func_name(self, name);
    int64_t i = 0LL;
    while (i < ArrayList_Str_length(&(self->func_type_names))) {
    ...
    const char* resolved = LLVMCodegen_get_generic_mangled_name(self, rname);
    if (strcmp(resolved, rname) != 0) {
    i = 0LL;
    while (i < ArrayList_Str_length(&(self->func_type_names))) {
...
void LLVMCodegen_emit_runtime_helpers(LLVMCodegen* self) {
    ...
    void* kai_os_get_exe_dir_ty = kai_func_type_2(self->int64_type, self->ptr_type, self->int64_type, false);
    void* kai_os_get_exe_dir_fn = LLVMAddFunction(self->module, "kai_os_get_exe_dir", kai_os_get_exe_dir_ty);
    void* get_exe_dir_ty = kai_func_type_2(self->int64_type, self->ptr_type, self->int64_type, false);
    void* get_exe_dir_fn = LLVMAddFunction(self->module, "get_exe_dir", get_exe_dir_ty);
    void* b_get_exe = LLVMAppendBasicBlockInContext(self->ctx, get_exe_dir_fn, "entry");
    LLVMPositionBuilderAtEnd(self->builder, b_get_exe);
    void* get_exe_buf = LLVMGetParam(get_exe_dir_fn, 0LL);
    void* get_exe_max = LLVMGetParam(get_exe_dir_fn, 1LL);
    void* get_exe_ret = kai_build_call_2(self->builder, kai_os_get_exe_dir_ty, kai_os_get_exe_dir_fn, get_exe_buf, get_exe_max, "");
...
bool LLVMCodegen_generate(LLVMCodegen* self, int64_t top_stmt_idx, const char* obj_path) {
    StmtNode program = ArrayList_StmtNode_get(self->stmt_pool, top_stmt_idx);
    int64_t di = 0LL;
    while (di < ArrayList_Int_length(&(program.block_stmts))) {
    ArrayList_Int_push(&(self->global_decls), ArrayList_Int_get(&(program.block_stmts), di));
    di = (di + 1LL);
}
...
void LLVMCodegen_emit_func_body(LLVMCodegen* self, int64_t stmt_idx, void* fn_val, const char* struct_name) {
    ...
    self->loop_cond_block = (void*)(unsigned long long)(0LL);
    self->loop_merge_block = (void*)(unsigned long long)(0LL);
    bool is_init = (((((strcmp(stmt.func_name, "init") == 0) || (strcmp(stmt.func_return_type, struct_name) == 0)) || (strcmp(stmt.func_return_type, concatAlloc("*", struct_name)) == 0)) || (strcmp(stmt.func_return_type, concatAlloc("&", struct_name)) == 0)) && (strlen(struct_name) > 0LL));
    self->cur_method_is_init = is_init;
...
void* LLVMCodegen_coerce_return_value(LLVMCodegen* self, void* val, const char* ret_type_str, const char* actual_type_str) {
    ...
    const char* val_payload = concatAlloc(__kai_str_sub(ret_type_str, 0LL, excl_pos), "");
    const char* err_type = concatAlloc(__kai_str_sub(ret_type_str, (excl_pos + 1LL), strlen(ret_type_str)), "");
    ...
    void* payload_llvm_ty = LLVMCodegen_map_type(self, val_payload);
    if ((payload_llvm_ty != (void*)(unsigned long long)(0LL)) && (payload_llvm_ty != self->void_type)) {
    ...
    void* null_struct = LLVMConstNull(mapped_type);
    void* with_tag = kai_LLVMBuildInsertValue(self->builder, null_struct, tag_val, 0LL, ".tag");
...
void* LLVMCodegen_map_type(LLVMCodegen* self, const char* type_name) {
    ...
    const char* val_type = concatAlloc(__kai_str_sub(resolved_type, 0LL, excl_pos), "");
    const char* err_type = concatAlloc(__kai_str_sub(resolved_type, (excl_pos + 1LL), strlen(resolved_type)), "");
...
void LLVMCodegen_gen_stmt(LLVMCodegen* self, int64_t stmt_idx) {
    ...
    if (stmt.vardecl_value >= 0LL) {
    ExprNode init_expr = ArrayList_ExprNode_get(self->expr_pool, stmt.vardecl_value);
    if ((init_expr.kind == ExprKind_ek_literal) && (strcmp(init_expr.lit_vkind, "NONE") == 0)) {
...
} else if (stmt.vardecl_value >= 0LL) {
    ExprNode init_expr = ArrayList_ExprNode_get(self->expr_pool, stmt.vardecl_value);
    if ((init_expr.kind == ExprKind_ek_literal) && (strcmp(init_expr.lit_vkind, "NONE") == 0)) {
    LLVMBuildStore(self->builder, LLVMConstNull(var_type), alloca_val);
}
    ...
    bool is_error_union = LLVMCodegen_str_contains(self, clean_type, ((char)(33LL)));
    if (is_error_union) {
    int64_t excl_pos = LLVMCodegen_str_find(self, clean_type, ((char)(33LL)));
    const char* val_type = concatAlloc(__kai_str_sub(clean_type, 0LL, excl_pos), "");
    const char* err_type = concatAlloc(__kai_str_sub(clean_type, (excl_pos + 1LL), strlen(clean_type)), "");
    void* loaded_struct = match_expr_val;
    int64_t type_kind = LLVMGetTypeKind(LLVMTypeOf(match_expr_val));
    if (type_kind == LLVMPointerTypeKind) {
    loaded_struct = LLVMBuildLoad2(self->builder, llvm_match_type, match_expr_val, ".match_val");
}
    void* tag_val = kai_LLVMBuildExtractValue(self->builder, loaded_struct, 0LL, ".tag");
    int64_t target_tag = 0LL;
    const char* payload_type = "";
    if (strcmp(pat_node.variant_name, "ok") == 0) {
    target_tag = 0LL;
    payload_type = val_type;
} else if (strcmp(pat_node.variant_name, "err") == 0) {
    target_tag = 1LL;
    payload_type = err_type;
}
    void* expected_tag = LLVMConstInt(self->int64_type, target_tag, false);
    void* cmp = LLVMBuildICmp(self->builder, LLVMIntEQ, tag_val, expected_tag, "");
    LLVMBuildCondBr(self->builder, cmp, then_block, merge_block);
    LLVMPositionBuilderAtEnd(self->builder, then_block);
    self->last_was_term = false;
    if (ArrayList_Str_length(&(pat_node.bindings)) > 0LL) {
    void* payload_llvm_ty = LLVMCodegen_map_type(self, payload_type);
    void* ext_val = kai_LLVMBuildExtractValue(self->builder, loaded_struct, 1LL, ".val");
    void* coerced_val = LLVMCodegen_gen_cast(self, ext_val, payload_llvm_ty);
    const char* bind_name = ArrayList_Str_get(&(pat_node.bindings), 0LL);
    if (((strcmp(bind_name, "_") != 0) && (payload_llvm_ty != (void*)(unsigned long long)(0LL))) && (payload_llvm_ty != self->void_type)) {
    void* bind_alloca = LLVMBuildAlloca(self->builder, payload_llvm_ty, bind_name);
    ...
    ArrayList_Int_push(&(self->local_alloca_types), (int64_t)(payload_llvm_ty));
    ArrayList_Str_push(&(self->local_alloca_type_strs), payload_type);
    ArrayList_Int_push(&(self->local_alloca_decls), stmt_idx);
}
}
} else {
    ...
    int64_t ei = 0LL;
    while (ei < ArrayList_Str_length(&(self->enum_cache_names))) {
    if (llvm_str_eq(ArrayList_Str_get(&(self->enum_cache_names), ei), stripped_clean_type) && ArrayList_Bool_get(&(self->enum_has_payload), ei)) {
...
const char* LLVMCodegen_get_expr_type(LLVMCodegen* self, int64_t expr_idx) {
    ...
    while (vi >= 0LL) {
    if (llvm_str_eq(ArrayList_Str_get(&(self->local_alloca_names), vi), expr.ident_name)) {
...
void* LLVMCodegen_gen_expr(LLVMCodegen* self, int64_t expr_idx) {
    ...
    int64_t si = 0LL;
    while (si < ArrayList_StmtNode_length(self->stmt_pool)) {
    StmtNode stmt = ArrayList_StmtNode_get(self->stmt_pool, si);
    if (stmt.kind == StmtKind_sk_var_decl) {
    ...
    if (strcmp(name, "strlen") == 0) {
    if (ArrayList_Int_length(&(expr.func_args)) > 0LL) {
    void* s_val = LLVMCodegen_gen_expr(self, ArrayList_Int_get(&(expr.func_args), 0LL));
    ...
    lhs_i64 = zero;
} else if (LLVMTypeOf(lhs) != self->int64_type) {
    lhs_i64 = LLVMBuildSExt(self->builder, lhs, self->int64_type, "");
}
    if (rhs == (void*)(unsigned long long)(0LL)) {
    rhs_i64 = zero;
} else if (LLVMTypeOf(rhs) != self->int64_type) {
    ...
    void* ptr_int = LLVMBuildPtrToInt(self->builder, ptr_val, self->int64_type, "");
    void* zero = LLVMConstInt(self->int64_type, 0LL, false);
    if (strcmp(op, "==") == 0) {
    ...
    if (llvm_str_eq(ArrayList_Str_get(&(self->enum_cache_names), ei_chk), stripped_enum_part)) {
    ...
    if (LLVMCodegen_is_error_type(self, base_expr.ident_name)) {
    is_enum_member_ref = true;
}
}
    ...
    if ((stmt.kind == StmtKind_sk_error_decl) && (strcmp(stmt.error_name, enum_name) == 0)) {
    int64_t vi = 0LL;
    while (vi < ArrayList_Str_length(&(stmt.error_variants))) {
    if (strcmp(ArrayList_Str_get(&(stmt.error_variants), vi), variant_name) == 0) {
    tag_idx = vi;
    found_tag = true;
}
    vi = (vi + 1LL);
    ...
    int64_t ei_chk = 0LL;
    while (ei_chk < ArrayList_Str_length(&(self->enum_cache_names))) {
    if (llvm_str_eq(ArrayList_Str_get(&(self->enum_cache_names), ei_chk), stripped_enum_name)) {
    has_payload = ArrayList_Bool_get(&(self->enum_has_payload), ei_chk);
}
    ei_chk = (ei_chk + 1LL);
}
    ...
    void* field_llvm_type = LLVMStructGetTypeAtIndex(struct_ty, field_idx);
    bool is_aggregate = false;
    ...
    bool is_init = ((((strcmp(expr.meth_name, "init") == 0) || (strcmp(ret_ty, clean_type) == 0)) || (strcmp(ret_ty, concatAlloc("*", clean_type)) == 0)) || (strcmp(ret_ty, concatAlloc("&", clean_type)) == 0));
...
bool LLVMCodegen_emit_object(LLVMCodegen* self, const char* obj_path) {
    ...
    kai_fflush(stdout);
    Result_Bool_IoError write_res = write_string(obj_path, (const char*)(ir_str));
...
int64_t LLVMCodegen_find_error_decl(LLVMCodegen* self, const char* clean_name) {
    ...
    while (si < ArrayList_StmtNode_length(self->stmt_pool)) {
    StmtNode s = ArrayList_StmtNode_get(self->stmt_pool, si);
    if (s.kind == StmtKind_sk_error_decl) {
    const char* decl_name = LLVMCodegen_strip_module_prefix(self, s.error_name);
    if (strcmp(decl_name, stripped_clean) == 0) {
    return si;
}
}
...
void LLVMCodegen_emit_func_body_mono(LLVMCodegen* self, int64_t stmt_idx, void* fn_val, const char* struct_name, ArrayList_Str* param_names, ArrayList_Str* type_args) {
    ...
    self->loop_cond_block = (void*)(unsigned long long)(0LL);
    self->loop_merge_block = (void*)(unsigned long long)(0LL);
    bool is_init = ((((strcmp(stmt.func_name, "init") == 0) || (strcmp(stmt.func_return_type, struct_name) == 0)) || (strcmp(stmt.func_return_type, concatAlloc("*", struct_name)) == 0)) || (strcmp(stmt.func_return_type, concatAlloc("&", struct_name)) == 0));
    self->cur_method_is_init = is_init;
    self->cur_self_alloca = (void*)(unsigned long long)(0LL);
    self->cur_struct_type = (void*)(unsigned long long)(0LL);
    if (is_init) {
...
void* LLVMCodegen_gen_expr_address(LLVMCodegen* self, int64_t expr_idx) {
    ...
    if (expr.kind == ExprKind_ek_identifier) {
    const char* name = expr.ident_name;
    void* alloca = LLVMCodegen_find_alloca(self, name);
    if (alloca == (void*)(unsigned long long)(0LL)) {
    ...
    if ((strlen(clean_base_type) >= 4LL) && (strcmp(__kai_str_sub(clean_base_type, 0LL, 4LL), "mut ") == 0)) {
    clean_base_type = __kai_str_sub(clean_base_type, 4LL, strlen(clean_base_type));
}
    void* struct_ty = LLVMCodegen_map_type(self, clean_base_type);
    if ((struct_ty == (void*)(unsigned long long)(0LL)) || (struct_ty == self->void_type)) {
    return (void*)(unsigned long long)(0LL);
    ...
    const char* el_type_str = LLVMCodegen_get_expr_type(self, expr.idx_expr);
    void* el_ty = LLVMCodegen_map_type(self, el_type_str);
    while ((strlen(el_type_str) > 0LL) && (((el_type_str)[0LL] == ((char)(42LL))) || ((el_type_str)[0LL] == ((char)(38LL))))) {
...
bool LLVMCodegen_decl_name_matches(LLVMCodegen* self, const char* decl_name, const char* ident_name) {
    int64_t dl = strlen(decl_name);
    int64_t il = strlen(ident_name);
    if (dl < il) {
    return false;
}
    if (dl == il) {
...
int64_t run_fix(const char* fix_mode, const char* fix_file, bool json) {
    ...
    int64_t src_len_val = (source ? strlen(source) : 0);
    if (!json) {
    ...
    if ((old_line_text ? strlen(old_line_text) : 0) > 0LL) {
...
const char* diag_format_location(char* buffer, const char* path, int64_t line, int64_t column) {
    int64_t offset = 0LL;
    int64_t wrote_path = diag_write_span(buffer, offset, path);
    if (wrote_path < 0LL) {
    return "";
}
    offset = wrote_path;
...
int64_t run_patch(int64_t argc, char** argv) {
    ...
    if ((patch_file ? strlen(patch_file) : 0) == 0LL) {
    printf("Error: No input file specified\n");
    return 1LL;
}
    if ((operation ? strlen(operation) : 0) == 0LL) {
    ...
    if ((fn_name ? strlen(fn_name) : 0) == 0LL) {
    int64_t j = 3LL;
    while (j < argc) {
    {
    ...
    if (((const_name ? strlen(const_name) : 0) == 0LL) || ((const_val ? strlen(const_val) : 0) == 0LL)) {
    int64_t j = 3LL;
    while (j < argc) {
    {
    const char* a = (const char*)((argv)[j]);
    ...
    int64_t pattern_len = (pattern ? strlen(pattern) : 0);
    int64_t src_len = (source ? strlen(source) : 0);
    ...
    if ((op_arg1 ? strlen(op_arg1) : 0) == 0LL) {
    printf("Error: replaceText requires --old <text>\n");
    return 1LL;
}
    if ((op_arg2 ? strlen(op_arg2) : 0) == 0LL) {
    ...
    const char* param_type = "";
    if (((fn_name ? strlen(fn_name) : 0) == 0LL) || ((param_name ? strlen(param_name) : 0) == 0LL)) {
    int64_t j = 3LL;
    while (j < argc) {
    {
    const char* a = (const char*)((argv)[j]);
    ...
    if ((param_type ? strlen(param_type) : 0) == 0LL) {
    param_type = "Int";
}
    const char* search = concatAlloc(concatAlloc("fn ", fn_name), "(");
    int64_t search_len = (search ? strlen(search) : 0);
    int64_t src_len = (source ? strlen(source) : 0);
    bool found_fn = false;
    int64_t pos = 0LL;
    ...
    int64_t pi = 0LL;
    while (pi < (params_section ? strlen(params_section) : 0)) {
    ...
    if (((fn_name ? strlen(fn_name) : 0) == 0LL) || ((ret_type ? strlen(ret_type) : 0) == 0LL)) {
    int64_t j = 3LL;
    while (j < argc) {
    {
    const char* a = (const char*)((argv)[j]);
    ...
    if ((ret_type ? strlen(ret_type) : 0) == 0LL) {
    ret_type = "Void";
}
    const char* search = concatAlloc(concatAlloc("fn ", fn_name), "(");
    int64_t search_len = (search ? strlen(search) : 0);
    ...
    if ((stmt_text ? strlen(stmt_text) : 0) == 0LL) {
    int64_t j = 3LL;
    while (j < argc) {
    {
    const char* a = (const char*)((argv)[j]);
...
int64_t run_graph(int64_t argc, char** argv) {
    ...
    if ((graph_file ? strlen(graph_file) : 0) == 0LL) {
    printf("Error: No input file specified\n");
    return 1LL;
}
    ...
    if ((stmt.func_name ? strlen(stmt.func_name) : 0) > 0LL) {
    printf(",\"name\":\"%s\"", stmt.func_name);
}
    if ((stmt.struct_name ? strlen(stmt.struct_name) : 0) > 0LL) {
    printf(",\"name\":\"%s\"", stmt.struct_name);
}
    if ((stmt.enum_name ? strlen(stmt.enum_name) : 0) > 0LL) {
    printf(",\"name\":\"%s\"", stmt.enum_name);
}
    if ((stmt.vardecl_name ? strlen(stmt.vardecl_name) : 0) > 0LL) {
    printf(",\"var\":\"%s\"", stmt.vardecl_name);
}
    if ((stmt.vardecl_type ? strlen(stmt.vardecl_type) : 0) > 0LL) {
    printf(",\"type\":\"%s\"", stmt.vardecl_type);
}
    if ((stmt.func_return_type ? strlen(stmt.func_return_type) : 0) > 0LL) {
    ...
    if ((expr.ident_name ? strlen(expr.ident_name) : 0) > 0LL) {
    printf(",\"name\":\"%s\"", expr.ident_name);
}
    if ((expr.func_name ? strlen(expr.func_name) : 0) > 0LL) {
    printf(",\"func\":\"%s\"", expr.func_name);
}
    if ((expr.struct_name ? strlen(expr.struct_name) : 0) > 0LL) {
    printf(",\"struct\":\"%s\"", expr.struct_name);
}
    if ((expr.inferred_type ? strlen(expr.inferred_type) : 0) > 0LL) {
    printf(",\"type\":\"%s\"", expr.inferred_type);
}
    if ((expr.binop_op ? strlen(expr.binop_op) : 0) > 0LL) {
    printf(",\"op\":\"%s\"", expr.binop_op);
}
    if ((expr.unop_op ? strlen(expr.unop_op) : 0) > 0LL) {
    ...
    if ((graph_fn ? strlen(graph_fn) : 0) > 0LL) {
    bool found = false;
    int64_t si2 = 0LL;
