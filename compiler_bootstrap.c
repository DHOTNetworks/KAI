...
char *CAlloc_realloc(CAlloc *self, char *ptr, int64_t old_size,
...
char *KaiAllocator_realloc(KaiAllocator *self, char *ptr, int64_t old_size,
                           int64_t new_size, int64_t align);
...
void ArrayList_StrInterpPart_push(ArrayList_StrInterpPart *self,
                                  StrInterpPart item);
StrInterpPart ArrayList_StrInterpPart_get(ArrayList_StrInterpPart *self,
                                          int64_t index);
void ArrayList_StrInterpPart_set(ArrayList_StrInterpPart *self, int64_t index,
                                 StrInterpPart item);
...
void ArrayList_FieldInit_set(ArrayList_FieldInit *self, int64_t index,
                             FieldInit item);
...
void ArrayList_AsmOutput_set(ArrayList_AsmOutput *self, int64_t index,
                             AsmOutput item);
...
void ArrayList_AsmInput_set(ArrayList_AsmInput *self, int64_t index,
                            AsmInput item);
...
StructField ArrayList_StructField_get(ArrayList_StructField *self,
                                      int64_t index);
void ArrayList_StructField_set(ArrayList_StructField *self, int64_t index,
                               StructField item);
...
void ArrayList_Variant_set(ArrayList_Variant *self, int64_t index,
                           Variant item);
...
void ArrayList_DropVarEntry_push(ArrayList_DropVarEntry *self,
                                 DropVarEntry item);
DropVarEntry ArrayList_DropVarEntry_get(ArrayList_DropVarEntry *self,
                                        int64_t index);
void ArrayList_DropVarEntry_set(ArrayList_DropVarEntry *self, int64_t index,
                                DropVarEntry item);
...
void ArrayList_MatchCase_set(ArrayList_MatchCase *self, int64_t index,
                             MatchCase item);
...
void ArrayList_ExprNode_set(ArrayList_ExprNode *self, int64_t index,
                            ExprNode item);
...
void ArrayList_StmtNode_set(ArrayList_StmtNode *self, int64_t index,
                            StmtNode item);
...
PatternNode ArrayList_PatternNode_get(ArrayList_PatternNode *self,
                                      int64_t index);
void ArrayList_PatternNode_set(ArrayList_PatternNode *self, int64_t index,
                               PatternNode item);
...
Parser Parser_init_with_pools(KaiAllocator *allocator, ArrayList_Token *tokens,
                              ArrayList_ExprNode *expr_pool,
                              ArrayList_StmtNode *stmt_pool,
                              ArrayList_PatternNode *pattern_pool);
...
int64_t Parser_ex_ident_with(Parser *self, const char *name,
                             ArrayList_Str targs);
int64_t Parser_ex_binop(Parser *self, const char *op, int64_t left,
                        int64_t right);
...
int64_t Parser_ex_call_with(Parser *self, const char *name, ArrayList_Int args,
                            ArrayList_Str targs);
int64_t Parser_ex_struct_init(Parser *self, const char *name,
                              ArrayList_FieldInit fields);
int64_t Parser_ex_field(Parser *self, int64_t expr, const char *field);
int64_t Parser_ex_method(Parser *self, int64_t expr, const char *method,
                         ArrayList_Int args);
int64_t Parser_ex_index(Parser *self, int64_t expr, int64_t idx);
int64_t Parser_ex_check(Parser *self, int64_t expr);
int64_t Parser_ex_slice(Parser *self, int64_t expr, int64_t lower,
                        int64_t upper, bool is_inclusive);
int64_t Parser_ex_range(Parser *self, int64_t start, int64_t end,
                        bool is_inclusive);
...
int64_t Parser_ex_catch(Parser *self, int64_t expr, const char *var_name,
                        int64_t fallback);
int64_t Parser_ex_asm(Parser *self, const char *code, bool is_volatile,
                      ArrayList_AsmOutput outputs, ArrayList_AsmInput inputs,
                      ArrayList_Str clobbers);
...
int64_t Parser_st_var_decl(Parser *self, const char *name, const char *type_ann,
                           int64_t value, bool is_mut);
int64_t Parser_st_assign(Parser *self, int64_t target, int64_t value,
                         const char *op);
int64_t Parser_st_func(Parser *self, const char *name, ArrayList_Param params,
                       const char *ret_type, int64_t body, const char *cap,
                       ArrayList_Str tp);
int64_t Parser_st_struct(Parser *self, const char *name,
                         ArrayList_StructField fields, ArrayList_Str tp,
                         ArrayList_Int methods, ArrayList_Int impls);
int64_t Parser_st_impl(Parser *self, const char *struct_name,
                       const char *trait_name, ArrayList_Int methods);
int64_t Parser_st_trait(Parser *self, const char *name, ArrayList_Int methods);
int64_t Parser_st_enum(Parser *self, const char *name,
                       ArrayList_Variant variants, ArrayList_Str tp);
...
int64_t Parser_st_extern(Parser *self, const char *name, ArrayList_Param params,
                         const char *ret);
int64_t Parser_st_if(Parser *self, int64_t cond, int64_t then_b,
                     int64_t else_b);
int64_t Parser_st_if_let(Parser *self, const char *vname, int64_t expr,
                         int64_t then_b, int64_t else_b);
int64_t Parser_st_while(Parser *self, int64_t cond, int64_t body);
int64_t Parser_st_for(Parser *self, const char *var_name, int64_t start,
                      int64_t end, bool inc, int64_t body);
...
void SymbolTable_define(SymbolTable *self, const char *name,
                        const char *type_name, bool is_mutable,
                        const char *kind, const char *llvm_value);
...
SymbolTable ArrayList_SymbolTable_get(ArrayList_SymbolTable *self,
                                      int64_t index);
void ArrayList_SymbolTable_set(ArrayList_SymbolTable *self, int64_t index,
                               SymbolTable item);
...
int64_t SymbolTable_lookup(SymbolTable *self, const char *name,
                           ArrayList_SymbolTable *tables);
Symbol SymbolTable_lookup_symbol(SymbolTable *self, const char *name,
                                 ArrayList_SymbolTable *tables);
void SymbolTable_mark_moved(SymbolTable *self, const char *name,
                            ArrayList_SymbolTable *tables);
...
void ArrayList_StructInfo_set(ArrayList_StructInfo *self, int64_t index,
                              StructInfo item);
...
TypeChecker TypeChecker_init(KaiAllocator *allocator,
                             ArrayList_StmtNode *stmt_pool,
                             ArrayList_ExprNode *expr_pool,
                             ArrayList_PatternNode *pattern_pool);
void TypeChecker_enter_scope(TypeChecker *self);
void TypeChecker_exit_scope(TypeChecker *self);
void TypeChecker_define_symbol(TypeChecker *self, const char *name,
                               const char *type_name, bool is_mutable,
                               const char *kind);
...
bool TypeChecker_types_compatible(TypeChecker *self, const char *target,
                                  const char *source);
int64_t TypeChecker_find_func_decl(TypeChecker *self, const char *name);
int64_t TypeChecker_find_method_decl(TypeChecker *self, const char *struct_name,
                                     const char *meth_name);
int64_t TypeChecker_find_struct_decl(TypeChecker *self, const char *name);
const char *TypeChecker_get_block_yield_type(TypeChecker *self,
                                             int64_t stmt_idx);
...
StrMapEntry ArrayList_StrMapEntry_get(ArrayList_StrMapEntry *self,
                                      int64_t index);
void ArrayList_StrMapEntry_set(ArrayList_StrMapEntry *self, int64_t index,
                               StrMapEntry item);
...
void type_map_put(ArrayList_StrMapEntry *arr, const char *key,
                  const char *value);
int64_t strlist_find(ArrayList_Str *arr, const char *key);
Codegen Codegen_init(KaiAllocator *allocator, ArrayList_StmtNode *stmt_pool,
                     ArrayList_ExprNode *expr_pool,
                     ArrayList_PatternNode *pattern_pool);
bool Codegen_is_pointer_type(Codegen *self, const char *t);
const char *Codegen_map_type(Codegen *self, const char *type_name);
const char *Codegen_substitute_generic_type(Codegen *self,
                                            const char *type_name);
...
ArrayList_Str Codegen_infer_type_args(Codegen *self, int64_t func_stmt_idx,
                                      int64_t expr_idx);
void Codegen_setup_current_type_map(Codegen *self, ArrayList_Str *type_params,
                                    ArrayList_Str *type_args);
void Codegen_monomorphize_struct(Codegen *self, int64_t stmt_idx,
                                 const char *concrete_name,
                                 ArrayList_Str *type_args);
void Codegen_monomorphize_enum(Codegen *self, int64_t stmt_idx,
                               const char *concrete_name,
                               ArrayList_Str *type_args);
void Codegen_monomorphize_methods(Codegen *self, const char *base_struct_name,
                                  const char *concrete_struct_name);
void Codegen_monomorphize_func(Codegen *self, int64_t func_stmt_idx,
                               const char *mangled_name,
                               ArrayList_Str *type_args);
const char *Codegen_extract_first_type_arg(Codegen *self,
                                           const char *type_name);
void Codegen_build_func_types(Codegen *self);
const char *Codegen_get_expr_type(Codegen *self, int64_t expr_idx);
const char *Codegen_gen_expr_with_expected_type(Codegen *self, int64_t expr_idx,
...
extern void LLVMInitializeAllTargetInfos(void);
extern void LLVMInitializeAllTargets(void);
extern void LLVMInitializeAllTargetMCs(void);
extern void LLVMInitializeAllAsmPrinters(void);
extern void LLVMInitializeAllAsmParsers(void);
extern int64_t LLVMInitializeNativeTarget(void);
extern int64_t LLVMInitializeNativeAsmPrinter(void);
extern int64_t LLVMInitializeNativeAsmParser(void);
extern void *LLVMContextCreate(void);
extern void LLVMContextDispose(void *ctx);
extern void *LLVMModuleCreateWithNameInContext(const char *name, void *ctx);
extern void LLVMDisposeModule(void *m);
extern char *LLVMPrintModuleToString(void *m);
extern int64_t LLVMWriteBitcodeToFile(void *m, const char *path);
extern void *LLVMCreateBuilderInContext(void *ctx);
extern void LLVMDisposeBuilder(void *b);
extern void *LLVMAppendBasicBlockInContext(void *ctx, void *f,
                                           const char *name);
extern void LLVMPositionBuilderAtEnd(void *b, void *block);
extern void *LLVMGetInsertBlock(void *b);
extern void *LLVMInt1TypeInContext(void *ctx);
extern void *LLVMInt8TypeInContext(void *ctx);
extern void *LLVMInt16TypeInContext(void *ctx);
extern void *LLVMInt32TypeInContext(void *ctx);
extern void *LLVMInt64TypeInContext(void *ctx);
extern void *LLVMFloatTypeInContext(void *ctx);
extern void *LLVMDoubleTypeInContext(void *ctx);
extern void *LLVMVoidTypeInContext(void *ctx);
extern void *LLVMPointerType(void *ty, int64_t addr_space);
extern void *LLVMFunctionType(void *ret_type, void *param_types,
                              int64_t param_count, bool is_var_arg);
extern void *LLVMConstInt(void *ty, int64_t val, bool sign_extend);
extern void *LLVMConstReal(void *ty, double val);
extern void *LLVMConstStringInContext(void *ctx, char *s, int64_t len,
                                      bool dont_null_terminate);
extern void *LLVMAddFunction(void *m, const char *name, void *ty);
extern void *LLVMGetNamedFunction(void *m, const char *name);
extern void *LLVMGetParam(void *f, int64_t index);
extern void *LLVMBuildRetVoid(void *b);
extern void *LLVMBuildRet(void *b, void *val);
extern void *LLVMBuildBr(void *b, void *dest_block);
extern void *LLVMBuildCondBr(void *b, void *cond, void *then_block,
                             void *else_block);
extern void *LLVMBuildAdd(void *b, void *lhs, void *rhs, const char *name);
extern void *LLVMBuildSub(void *b, void *lhs, void *rhs, const char *name);
extern void *LLVMBuildMul(void *b, void *lhs, void *rhs, const char *name);
extern void *LLVMBuildSDiv(void *b, void *lhs, void *rhs, const char *name);
extern void *LLVMBuildUDiv(void *b, void *lhs, void *rhs, const char *name);
extern void *LLVMBuildFAdd(void *b, void *lhs, void *rhs, const char *name);
extern void *LLVMBuildFSub(void *b, void *lhs, void *rhs, const char *name);
extern void *LLVMBuildFMul(void *b, void *lhs, void *rhs, const char *name);
extern void *LLVMBuildFDiv(void *b, void *lhs, void *rhs, const char *name);
extern void *LLVMBuildAlloca(void *b, void *ty, const char *name);
extern void *LLVMBuildLoad2(void *b, void *ty, void *val_ptr, const char *name);
extern void *LLVMBuildStore(void *b, void *val, void *val_ptr);
extern void *LLVMBuildICmp(void *b, int64_t op, void *lhs, void *rhs,
                           const char *name);
extern void *LLVMBuildFCmp(void *b, int64_t op, void *lhs, void *rhs,
                           const char *name);
extern void *LLVMBuildZExt(void *b, void *val, void *dest_type,
                           const char *name);
extern void *LLVMBuildSExt(void *b, void *val, void *dest_type,
                           const char *name);
extern void *LLVMBuildTrunc(void *b, void *val, void *dest_type,
                            const char *name);
extern void *LLVMBuildFPToSI(void *b, void *val, void *dest_type,
                             const char *name);
extern void *LLVMBuildSIToFP(void *b, void *val, void *dest_type,
                             const char *name);
extern void *LLVMBuildCall2(void *b, void *fn_ty, void *fn_val, void *args,
                            int64_t num_args, const char *name);
extern void *LLVMBuildStructGEP2(void *b, void *struct_ty, void *pointer_val,
                                 int64_t idx, const char *name);
extern int64_t LLVMVerifyModule(void *m, int64_t action, void *out_msg);
extern char *LLVMGetDefaultTargetTriple(void);
extern int64_t LLVMGetTargetFromTriple(const char *triple, void *out_target,
                                       void *out_error);
extern void *LLVMCreateTargetMachine(void *target, const char *triple,
                                     const char *cpu, const char *features,
                                     int64_t opt_level, int64_t reloc,
                                     int64_t code_model);
extern void LLVMDisposeTargetMachine(void *tm);
extern int64_t LLVMTargetMachineEmitToFile(void *tm, void *m, char *path,
                                           int64_t codegen, void *out_error);
extern void *LLVMStructTypeInContext(void *ctx, void *element_types,
                                     int64_t element_count, bool packed);
extern void *LLVMStructCreateNamed(void *ctx, const char *name);
extern void LLVMStructSetBody(void *struct_type, void *element_types,
                              int64_t element_count, bool packed);
extern void *LLVMArrayType(void *element_type, int64_t count);
extern void *LLVMBuildGEP2(void *b, void *ty, void *pointer_val, void *indices,
                           int64_t num_indices, const char *name);
extern void *LLVMBuildGlobalStringPtr(void *b, const char *s, const char *name);
extern void *LLVMBuildBitCast(void *b, void *val, void *dest_ty,
                              const char *name);
extern void *LLVMBuildIntToPtr(void *b, void *val, void *dest_ty,
                               const char *name);
extern void *LLVMBuildSRem(void *b, void *lhs, void *rhs, const char *name);
extern void *LLVMBuildAnd(void *b, void *lhs, void *rhs, const char *name);
extern void *LLVMBuildOr(void *b, void *lhs, void *rhs, const char *name);
extern void *LLVMBuildXor(void *b, void *lhs, void *rhs, const char *name);
extern void *LLVMBuildShl(void *b, void *lhs, void *rhs, const char *name);
extern void *LLVMBuildAShr(void *b, void *lhs, void *rhs, const char *name);
extern void *LLVMBuildLShr(void *b, void *lhs, void *rhs, const char *name);
extern void *LLVMBuildSelect(void *b, void *cond, void *then_val,
                             void *else_val, const char *name);
extern int64_t get_exe_dir(char *buf, int64_t max_len);
LLVMCodegen LLVMCodegen_init(KaiAllocator *allocator,
                             ArrayList_StmtNode *stmt_pool,
                             ArrayList_ExprNode *expr_pool,
                             ArrayList_PatternNode *pattern_pool);
void LLVMCodegen_sym_reset(LLVMCodegen *self);
void LLVMCodegen_sym_store(LLVMCodegen *self, const char *name, void *val,
                           const char *ktype);
...
const char *LLVMCodegen_clean_type_for_mangling(LLVMCodegen *self,
                                                const char *s);
...
void *LLVMCodegen_get_or_declare_func(LLVMCodegen *self, const char *fname,
                                      const char *ret_ktype, const char *p1,
...
void LLVMCodegen_register_all_decls(LLVMCodegen *self);
void *LLVMCodegen_register_func_decl(LLVMCodegen *self, int64_t stmt_idx,
                                     const char *struct_name, bool is_init);
void LLVMCodegen_register_extern_decl(LLVMCodegen *self, int64_t stmt_idx);
void LLVMCodegen_gen_func_body(LLVMCodegen *self, int64_t stmt_idx,
                               const char *struct_name);
void LLVMCodegen_gen_stmt(LLVMCodegen *self, int64_t stmt_idx);
void *LLVMCodegen_gen_expr(LLVMCodegen *self, int64_t idx);
void *LLVMCodegen_cast_to_i64(LLVMCodegen *self, void *val, const char *ktype);
void *LLVMCodegen_gen_cast(LLVMCodegen *self, int64_t src_idx,
                           const char *target_type);
void LLVMCodegen_emit_print_call(LLVMCodegen *self, const char *ktype,
                                 void *val);
...
const char *LLVMCodegen_get_field_type(LLVMCodegen *self,
                                       const char *struct_name,
                                       const char *field_name);
int64_t LLVMCodegen_get_field_index(LLVMCodegen *self, const char *struct_name,
                                    const char *field_name);
bool LLVMCodegen_enum_has_payload(LLVMCodegen *self, const char *enum_name);
const char *LLVMCodegen_get_variant_param_type(LLVMCodegen *self,
                                               const char *enum_name,
                                               const char *variant_name,
                                               int64_t param_idx);
...
void CAlloc_deinit(CAlloc *self) {}
int64_t class_obj_size(int64_t idx) { return (8 << idx); }
int64_t class_for(int64_t sz) {
  if (sz <= 8) {
    return 0;
  }
...
bool is_small(int64_t sz) { return (sz <= 16384); }
int64_t page_align_up(int64_t n) { return ((n + 4095) & (-4096)); }
KaiAllocator KaiAllocator_init(void) {
...
Result_Str_Int read_to_string(KaiAllocator *allocator, const char *path) {
  {
    ...
    if ((char *)(file) == NULL) {
      return (Result_Str_Int){.tag = Result_Str_Int_err_TAG,
                              .payload = {.err = {.value = 1}}};
    }
    fseek(file, 0, 2);
    ...
    fclose(file);
    return (Result_Str_Int){.tag = Result_Str_Int_ok_TAG,
                            .payload = {.ok = {.value = (const char *)(buf)}}};
  }
}
bool Result_Bool_Int_is_ok(Result_Bool_Int *self) {
...
Result_Bool_Int write_string(const char *path, const char *content) {
  {
    ...
    if ((char *)(file) == NULL) {
      return (Result_Bool_Int){.tag = Result_Bool_Int_err_TAG,
                               .payload = {.err = {.value = 1}}};
    }
    int64_t len = strlen(content);
    int64_t bytes_written = fwrite((char *)(content), 1, len, file);
    fclose(file);
    return (Result_Bool_Int){.tag = Result_Bool_Int_ok_TAG,
                             .payload = {.ok = {.value = true}}};
  }
}
char char_at(const char *s, int64_t i) { return (s)[i]; }
bool is_digit(char c) {
  {
    return isdigit(c);
  }
...
StringBuilder StringBuilder_init(KaiAllocator *allocator) {
  ...
  {
    self.data =
        (char *)(KaiAllocator_alloc(allocator, (self.cap * sizeof(char)), 1));
  }
  return self;
}
void StringBuilder_append_char(StringBuilder *self, char c) {
  if ((self->len + 1) >= self->cap) {
    ...
    {
      char *new_data = (char *)(KaiAllocator_alloc(
          self->allocator, (new_cap * sizeof(char)), 1));
      int64_t i = 0;
      while (i < self->len) {
...
TokenValue make_keyword_value(const char *ident, TokenType ttype) {
  if (ttype == TokenType_BOOL_LIT) {
    if (strcmp(ident, "true") == 0) {
      return (TokenValue){.tag = TokenValue_tv_bool_TAG,
                          .payload = {.tv_bool = {.v = true}}};
    }
    return (TokenValue){.tag = TokenValue_tv_bool_TAG,
                        .payload = {.tv_bool = {.v = false}}};
  }
  return (TokenValue){.tag = TokenValue_tv_str_TAG,
                      .payload = {.tv_str = {.v = ident}}};
}
ArrayList_Token ArrayList_Token_init(KaiAllocator *allocator) {
  ...
  {
    self.data =
        (Token *)(KaiAllocator_alloc(allocator, (self.cap * sizeof(Token)), 1));
  }
  return self;
}
void ArrayList_Token_push(ArrayList_Token *self, Token item) {
  if (self->len == self->cap) {
    int64_t new_cap = (self->cap * 2);
    {
      Token *new_data = (Token *)(KaiAllocator_alloc(
          self->allocator, (new_cap * sizeof(Token)), 1));
      int64_t i = 0;
      while (i < self->len) {
        (new_data)[i] = (self->data)[i];
        i = (i + 1);
...
int64_t ArrayList_Token_length(ArrayList_Token *self) { return self->len; }
void ArrayList_Token_deinit(ArrayList_Token *self) {
  {
    KaiAllocator_free(self->allocator, (char *)(self->data));
  }
...
ArrayList_Int ArrayList_Int_init(KaiAllocator *allocator) {
  ...
  self.allocator = allocator;
  {
    self.data = (int64_t *)(KaiAllocator_alloc(
        allocator, (self.cap * sizeof(int64_t)), 1));
  }
  return self;
}
void ArrayList_Int_push(ArrayList_Int *self, int64_t item) {
  if (self->len == self->cap) {
    int64_t new_cap = (self->cap * 2);
    {
      int64_t *new_data = (int64_t *)(KaiAllocator_alloc(
          self->allocator, (new_cap * sizeof(int64_t)), 1));
      int64_t i = 0;
      while (i < self->len) {
        (new_data)[i] = (self->data)[i];
        i = (i + 1);
...
int64_t ArrayList_Int_length(ArrayList_Int *self) { return self->len; }
void ArrayList_Int_deinit(ArrayList_Int *self) {
  {
    KaiAllocator_free(self->allocator, (char *)(self->data));
  }
...
Lexer Lexer_init(KaiAllocator *allocator, const char *source) {
  ...
  {
    self.tokens = (ArrayList_Token *)(KaiAllocator_alloc(
        allocator, sizeof(ArrayList_Token), 1));
    self.indent_stack = (ArrayList_Int *)(KaiAllocator_alloc(
        allocator, sizeof(ArrayList_Int), 1));
  }
...
void Lexer_emit(Lexer *self, TokenType ttype, TokenValue value) {
  ArrayList_Token_push(self->tokens, (Token){.tok_type = ttype,
                                             .value = value,
                                             .line = self->line,
                                             .column = self->column});
}
void Lexer_lex_error(Lexer *self) { self->has_error = true; }
void Lexer_skip_line_comment(Lexer *self) {
...
void Lexer_lex_identifier(Lexer *self) {
  ...
  if (ktype == TokenType_IDENTIFIER) {
    Lexer_emit(self, TokenType_IDENTIFIER,
               (TokenValue){.tag = TokenValue_tv_str_TAG,
                            .payload = {.tv_str = {.v = ident}}});
  } else if (ktype == TokenType_BOOL_LIT) {
    Lexer_emit(self, TokenType_BOOL_LIT,
               make_keyword_value(ident, TokenType_BOOL_LIT));
  } else {
    Lexer_emit(self, ktype,
               (TokenValue){.tag = TokenValue_tv_str_TAG,
                            .payload = {.tv_str = {.v = ident}}});
  }
}
void Lexer_lex_number(Lexer *self) {
  ...
  if ((Lexer_peek(self, 0) == '.') && (Lexer_peek(self, 1) != '.')) {
    ...
    Lexer_emit(self, TokenType_FLOAT_LIT,
               (TokenValue){.tag = TokenValue_tv_str_TAG,
                            .payload = {.tv_str = {.v = num_str}}});
  } else {
    const char *num_str = StringBuilder_to_str(&(sb));
    Lexer_emit(self, TokenType_INT_LIT,
               (TokenValue){.tag = TokenValue_tv_str_TAG,
                            .payload = {.tv_str = {.v = num_str}}});
  }
}
void Lexer_lex_string(Lexer *self) {
  ...
  Lexer_emit(self, TokenType_STRING_LIT,
             (TokenValue){.tag = TokenValue_tv_str_TAG,
                          .payload = {.tv_str = {.v = s}}});
}
void Lexer_lex_char(Lexer *self) {
  ...
  (void)(Lexer_advance(self));
  Lexer_emit(self, TokenType_CHAR_LIT,
             (TokenValue){.tag = TokenValue_tv_char_TAG,
                          .payload = {.tv_char = {.v = ch}}});
}
int64_t Lexer_compute_indent(Lexer *self) {
  int64_t indent = 0;
  ...
  while ((temp < self->source_len) && (!done)) {
    ...
    if (c == ' ') {
      ...
      indent = 0;
      temp = (temp + 1);
    } else if (((c == '/') && ((temp + 1) < self->source_len)) &&
               ((self->source)[(temp + 1)] == '/')) {
      ...
      indent = 0;
               ...
               ((self->source)[(temp + 1)] == '*')) {
      temp = (temp + 2);
      while ((temp < self->source_len) &&
             (!((((temp + 1) < self->source_len) &&
                 ((self->source)[temp] == '*')) &&
                ((self->source)[(temp + 1)] == '/')))) {
        if ((self->source)[temp] == '\n') {
          indent = 0;
    ...
    if (false) {
      ...
      if (indent >= 0) {
        if ((self->paren_depth == 0) && (self->brace_depth == 0)) {
          int64_t current =
              ArrayList_Int_get(self->indent_stack,
                                (ArrayList_Int_length(self->indent_stack) - 1));
          if (indent > current) {
            ArrayList_Int_push(self->indent_stack, indent);
            Lexer_emit(self, TokenType_INDENT,
                       (TokenValue){.tag = TokenValue_tv_int_TAG,
                                    .payload = {.tv_int = {.v = indent}}});
            ...
            while (indent <
              ...
              Lexer_emit(self, TokenType_DEDENT,
                         (TokenValue){.tag = TokenValue_tv_int_TAG,
                                      .payload = {.tv_int = {.v = indent}}});
            }
            if (indent != ArrayList_Int_get(
                              self->indent_stack,
                              (ArrayList_Int_length(self->indent_stack) - 1))) {
              self->has_error = true;
            }
      ...
      if (c == '\n') {
        ...
        if (self->paren_depth == 0) {
          ...
          if (last > 0) {
            ...
            if (((last_tok.tok_type != TokenType_NEWLINE) &&
                 (last_tok.tok_type != TokenType_INDENT)) &&
                (last_tok.tok_type != TokenType_DEDENT)) {
              Lexer_emit(self, TokenType_NEWLINE,
                         (TokenValue){.tag = TokenValue_tv_none_TAG});
            }
          }
        }
        is_line_start = true;
        ...
        (void)(Lexer_advance(self));
        (void)(Lexer_advance(self));
        Lexer_emit(self, TokenType_ARROW,
                   (TokenValue){.tag = TokenValue_tv_str_TAG,
                                .payload = {.tv_str = {.v = "->"}}});
      } else if ((c == '=') && (Lexer_peek(self, 1) == '>')) {
        (void)(Lexer_advance(self));
        (void)(Lexer_advance(self));
        Lexer_emit(self, TokenType_FAT_ARROW,
                   (TokenValue){.tag = TokenValue_tv_str_TAG,
                                .payload = {.tv_str = {.v = "=>"}}});
      } else if ((c == '+') && (Lexer_peek(self, 1) == '=')) {
        (void)(Lexer_advance(self));
        (void)(Lexer_advance(self));
        Lexer_emit(self, TokenType_PLUS_ASSIGN,
                   (TokenValue){.tag = TokenValue_tv_str_TAG,
                                .payload = {.tv_str = {.v = "+="}}});
      } else if ((c == '-') && (Lexer_peek(self, 1) == '=')) {
        (void)(Lexer_advance(self));
        (void)(Lexer_advance(self));
        Lexer_emit(self, TokenType_MINUS_ASSIGN,
                   (TokenValue){.tag = TokenValue_tv_str_TAG,
                                .payload = {.tv_str = {.v = "-="}}});
      } else if ((c == '=') && (Lexer_peek(self, 1) == '=')) {
        (void)(Lexer_advance(self));
        (void)(Lexer_advance(self));
        Lexer_emit(self, TokenType_EQ,
                   (TokenValue){.tag = TokenValue_tv_str_TAG,
                                .payload = {.tv_str = {.v = "=="}}});
      } else if ((c == '!') && (Lexer_peek(self, 1) == '=')) {
        (void)(Lexer_advance(self));
        (void)(Lexer_advance(self));
        Lexer_emit(self, TokenType_NE,
                   (TokenValue){.tag = TokenValue_tv_str_TAG,
                                .payload = {.tv_str = {.v = "!="}}});
      } else if ((c == '<') && (Lexer_peek(self, 1) == '=')) {
        (void)(Lexer_advance(self));
        (void)(Lexer_advance(self));
        Lexer_emit(self, TokenType_LE,
                   (TokenValue){.tag = TokenValue_tv_str_TAG,
                                .payload = {.tv_str = {.v = "<="}}});
      } else if ((c == '>') && (Lexer_peek(self, 1) == '=')) {
        (void)(Lexer_advance(self));
        (void)(Lexer_advance(self));
        Lexer_emit(self, TokenType_GE,
                   (TokenValue){.tag = TokenValue_tv_str_TAG,
                                .payload = {.tv_str = {.v = ">="}}});
      } else if ((c == '&') && (Lexer_peek(self, 1) == '&')) {
        (void)(Lexer_advance(self));
        (void)(Lexer_advance(self));
        Lexer_emit(self, TokenType_AND,
                   (TokenValue){.tag = TokenValue_tv_str_TAG,
                                .payload = {.tv_str = {.v = "&&"}}});
      } else if ((c == '|') && (Lexer_peek(self, 1) == '|')) {
        (void)(Lexer_advance(self));
        (void)(Lexer_advance(self));
        Lexer_emit(self, TokenType_OR,
                   (TokenValue){.tag = TokenValue_tv_str_TAG,
                                .payload = {.tv_str = {.v = "||"}}});
      } else if ((c == '<') && (Lexer_peek(self, 1) == '<')) {
        (void)(Lexer_advance(self));
        (void)(Lexer_advance(self));
        Lexer_emit(self, TokenType_LSHIFT,
                   (TokenValue){.tag = TokenValue_tv_str_TAG,
                                .payload = {.tv_str = {.v = "<<"}}});
      } else if ((c == '>') && (Lexer_peek(self, 1) == '>')) {
        (void)(Lexer_advance(self));
        (void)(Lexer_advance(self));
        Lexer_emit(self, TokenType_RSHIFT,
                   (TokenValue){.tag = TokenValue_tv_str_TAG,
                                .payload = {.tv_str = {.v = ">>"}}});
      } else if (((c == '.') && (Lexer_peek(self, 1) == '.')) &&
                 (Lexer_peek(self, 2) == '=')) {
        ...
        (void)(Lexer_advance(self));
        (void)(Lexer_advance(self));
        Lexer_emit(self, TokenType_DOTDOTEQ,
                   (TokenValue){.tag = TokenValue_tv_str_TAG,
                                .payload = {.tv_str = {.v = "..="}}});
      } else if ((c == '.') && (Lexer_peek(self, 1) == '.')) {
        (void)(Lexer_advance(self));
        (void)(Lexer_advance(self));
        Lexer_emit(self, TokenType_DOTDOT,
                   (TokenValue){.tag = TokenValue_tv_str_TAG,
                                .payload = {.tv_str = {.v = ".."}}});
      } else if (c == '+') {
        (void)(Lexer_advance(self));
        Lexer_emit(self, TokenType_PLUS,
                   (TokenValue){.tag = TokenValue_tv_str_TAG,
                                .payload = {.tv_str = {.v = "+"}}});
      } else if (c == '-') {
        (void)(Lexer_advance(self));
        Lexer_emit(self, TokenType_MINUS,
                   (TokenValue){.tag = TokenValue_tv_str_TAG,
                                .payload = {.tv_str = {.v = "-"}}});
      } else if (c == '*') {
        (void)(Lexer_advance(self));
        Lexer_emit(self, TokenType_MUL,
                   (TokenValue){.tag = TokenValue_tv_str_TAG,
                                .payload = {.tv_str = {.v = "*"}}});
      } else if (c == '/') {
        (void)(Lexer_advance(self));
        Lexer_emit(self, TokenType_DIV,
                   (TokenValue){.tag = TokenValue_tv_str_TAG,
                                .payload = {.tv_str = {.v = "/"}}});
      } else if (c == '%') {
        (void)(Lexer_advance(self));
        Lexer_emit(self, TokenType_MOD,
                   (TokenValue){.tag = TokenValue_tv_str_TAG,
                                .payload = {.tv_str = {.v = "%"}}});
      } else if (c == '=') {
        (void)(Lexer_advance(self));
        Lexer_emit(self, TokenType_ASSIGN,
                   (TokenValue){.tag = TokenValue_tv_str_TAG,
                                .payload = {.tv_str = {.v = "="}}});
      } else if (c == '<') {
        (void)(Lexer_advance(self));
        Lexer_emit(self, TokenType_LT,
                   (TokenValue){.tag = TokenValue_tv_str_TAG,
                                .payload = {.tv_str = {.v = "<"}}});
      } else if (c == '>') {
        (void)(Lexer_advance(self));
        Lexer_emit(self, TokenType_GT,
                   (TokenValue){.tag = TokenValue_tv_str_TAG,
                                .payload = {.tv_str = {.v = ">"}}});
      } else if (c == ':') {
        (void)(Lexer_advance(self));
        Lexer_emit(self, TokenType_COLON,
                   (TokenValue){.tag = TokenValue_tv_str_TAG,
                                .payload = {.tv_str = {.v = ":"}}});
      } else if (c == ';') {
        (void)(Lexer_advance(self));
        Lexer_emit(self, TokenType_SEMICOLON,
                   (TokenValue){.tag = TokenValue_tv_str_TAG,
                                .payload = {.tv_str = {.v = ";"}}});
      } else if (c == ',') {
        (void)(Lexer_advance(self));
        Lexer_emit(self, TokenType_COMMA,
                   (TokenValue){.tag = TokenValue_tv_str_TAG,
                                .payload = {.tv_str = {.v = ","}}});
      } else if (c == '(') {
        (void)(Lexer_advance(self));
        self->paren_depth = (self->paren_depth + 1);
        Lexer_emit(self, TokenType_LPAREN,
                   (TokenValue){.tag = TokenValue_tv_str_TAG,
                                .payload = {.tv_str = {.v = "("}}});
      } else if (c == ')') {
        (void)(Lexer_advance(self));
        ...
        Lexer_emit(self, TokenType_RPAREN,
                   (TokenValue){.tag = TokenValue_tv_str_TAG,
                                .payload = {.tv_str = {.v = ")"}}});
      } else if (c == '[') {
        (void)(Lexer_advance(self));
        self->paren_depth = (self->paren_depth + 1);
        Lexer_emit(self, TokenType_LBRACKET,
                   (TokenValue){.tag = TokenValue_tv_str_TAG,
                                .payload = {.tv_str = {.v = "["}}});
      } else if (c == ']') {
        (void)(Lexer_advance(self));
        ...
        Lexer_emit(self, TokenType_RBRACKET,
                   (TokenValue){.tag = TokenValue_tv_str_TAG,
                                .payload = {.tv_str = {.v = "]"}}});
      } else if (c == '{') {
        (void)(Lexer_advance(self));
        self->brace_depth = (self->brace_depth + 1);
        Lexer_emit(self, TokenType_LBRACE,
                   (TokenValue){.tag = TokenValue_tv_str_TAG,
                                .payload = {.tv_str = {.v = "{"}}});
      } else if (c == '}') {
        (void)(Lexer_advance(self));
        ...
        Lexer_emit(self, TokenType_RBRACE,
                   (TokenValue){.tag = TokenValue_tv_str_TAG,
                                .payload = {.tv_str = {.v = "}"}}});
      } else if (c == '&') {
        (void)(Lexer_advance(self));
        Lexer_emit(self, TokenType_AMP,
                   (TokenValue){.tag = TokenValue_tv_str_TAG,
                                .payload = {.tv_str = {.v = "&"}}});
      } else if (c == '#') {
        (void)(Lexer_advance(self));
        Lexer_emit(self, TokenType_HASH,
                   (TokenValue){.tag = TokenValue_tv_str_TAG,
                                .payload = {.tv_str = {.v = "#"}}});
      } else if (c == '!') {
        (void)(Lexer_advance(self));
        Lexer_emit(self, TokenType_NOT,
                   (TokenValue){.tag = TokenValue_tv_str_TAG,
                                .payload = {.tv_str = {.v = "!"}}});
      } else if (c == '?') {
        (void)(Lexer_advance(self));
        Lexer_emit(self, TokenType_QUESTION,
                   (TokenValue){.tag = TokenValue_tv_str_TAG,
                                .payload = {.tv_str = {.v = "?"}}});
      } else if (c == '^') {
        (void)(Lexer_advance(self));
        Lexer_emit(self, TokenType_BITXOR,
                   (TokenValue){.tag = TokenValue_tv_str_TAG,
                                .payload = {.tv_str = {.v = "^"}}});
      } else if (c == '~') {
        (void)(Lexer_advance(self));
        Lexer_emit(self, TokenType_BITNOT,
                   (TokenValue){.tag = TokenValue_tv_str_TAG,
                                .payload = {.tv_str = {.v = "~"}}});
      } else if (c == '|') {
        (void)(Lexer_advance(self));
        Lexer_emit(self, TokenType_PIPE,
                   (TokenValue){.tag = TokenValue_tv_str_TAG,
                                .payload = {.tv_str = {.v = "|"}}});
      } else if (c == '.') {
        (void)(Lexer_advance(self));
        Lexer_emit(self, TokenType_DOT,
                   (TokenValue){.tag = TokenValue_tv_str_TAG,
                                .payload = {.tv_str = {.v = "."}}});
      }
    }
...
ArrayList_Param ArrayList_Param_init(KaiAllocator *allocator) {
  ...
  {
    self.data =
        (Param *)(KaiAllocator_alloc(allocator, (self.cap * sizeof(Param)), 1));
  }
  return self;
}
void ArrayList_Param_push(ArrayList_Param *self, Param item) {
  if (self->len == self->cap) {
    int64_t new_cap = (self->cap * 2);
    {
      Param *new_data = (Param *)(KaiAllocator_alloc(
          self->allocator, (new_cap * sizeof(Param)), 1));
      int64_t i = 0;
      while (i < self->len) {
        (new_data)[i] = (self->data)[i];
        i = (i + 1);
...
int64_t ArrayList_Param_length(ArrayList_Param *self) { return self->len; }
void ArrayList_Param_deinit(ArrayList_Param *self) {
  {
    KaiAllocator_free(self->allocator, (char *)(self->data));
  }
...
ArrayList_Str ArrayList_Str_init(KaiAllocator *allocator) {
  ...
  self.allocator = allocator;
  {
    self.data = (const char **)(KaiAllocator_alloc(
        allocator, (self.cap * sizeof(const char *)), 1));
  }
  return self;
}
void ArrayList_Str_push(ArrayList_Str *self, const char *item) {
  if (self->len == self->cap) {
    int64_t new_cap = (self->cap * 2);
    {
      const char **new_data = (const char **)(KaiAllocator_alloc(
          self->allocator, (new_cap * sizeof(const char *)), 1));
      int64_t i = 0;
      while (i < self->len) {
        (new_data)[i] = (self->data)[i];
        i = (i + 1);
...
int64_t ArrayList_Str_length(ArrayList_Str *self) { return self->len; }
void ArrayList_Str_deinit(ArrayList_Str *self) {
  {
    KaiAllocator_free(self->allocator, (char *)(self->data));
  }
...
ArrayList_StrInterpPart ArrayList_StrInterpPart_init(KaiAllocator *allocator) {
  ...
  self.allocator = allocator;
  {
    self.data = (StrInterpPart *)(KaiAllocator_alloc(
        allocator, (self.cap * sizeof(StrInterpPart)), 1));
  }
  return self;
}
void ArrayList_StrInterpPart_push(ArrayList_StrInterpPart *self,
  ...
  if (self->len == self->cap) {
    int64_t new_cap = (self->cap * 2);
    {
      StrInterpPart *new_data = (StrInterpPart *)(KaiAllocator_alloc(
          self->allocator, (new_cap * sizeof(StrInterpPart)), 1));
      int64_t i = 0;
      while (i < self->len) {
        (new_data)[i] = (self->data)[i];
        i = (i + 1);
...
ArrayList_FieldInit ArrayList_FieldInit_init(KaiAllocator *allocator) {
  ...
  self.allocator = allocator;
  {
    self.data = (FieldInit *)(KaiAllocator_alloc(
        allocator, (self.cap * sizeof(FieldInit)), 1));
  }
  return self;
}
void ArrayList_FieldInit_push(ArrayList_FieldInit *self, FieldInit item) {
  if (self->len == self->cap) {
    int64_t new_cap = (self->cap * 2);
    {
      FieldInit *new_data = (FieldInit *)(KaiAllocator_alloc(
          self->allocator, (new_cap * sizeof(FieldInit)), 1));
      int64_t i = 0;
      while (i < self->len) {
        (new_data)[i] = (self->data)[i];
        i = (i + 1);
...
ArrayList_AsmOutput ArrayList_AsmOutput_init(KaiAllocator *allocator) {
  ...
  self.allocator = allocator;
  {
    self.data = (AsmOutput *)(KaiAllocator_alloc(
        allocator, (self.cap * sizeof(AsmOutput)), 1));
  }
  return self;
}
void ArrayList_AsmOutput_push(ArrayList_AsmOutput *self, AsmOutput item) {
  if (self->len == self->cap) {
    int64_t new_cap = (self->cap * 2);
    {
      AsmOutput *new_data = (AsmOutput *)(KaiAllocator_alloc(
          self->allocator, (new_cap * sizeof(AsmOutput)), 1));
      int64_t i = 0;
      while (i < self->len) {
        (new_data)[i] = (self->data)[i];
        i = (i + 1);
...
ArrayList_AsmInput ArrayList_AsmInput_init(KaiAllocator *allocator) {
  ...
  self.allocator = allocator;
  {
    self.data = (AsmInput *)(KaiAllocator_alloc(
        allocator, (self.cap * sizeof(AsmInput)), 1));
  }
  return self;
}
void ArrayList_AsmInput_push(ArrayList_AsmInput *self, AsmInput item) {
  if (self->len == self->cap) {
    int64_t new_cap = (self->cap * 2);
    {
      AsmInput *new_data = (AsmInput *)(KaiAllocator_alloc(
          self->allocator, (new_cap * sizeof(AsmInput)), 1));
      int64_t i = 0;
      while (i < self->len) {
        (new_data)[i] = (self->data)[i];
        i = (i + 1);
...
ArrayList_StructField ArrayList_StructField_init(KaiAllocator *allocator) {
  ...
  self.allocator = allocator;
  {
    self.data = (StructField *)(KaiAllocator_alloc(
        allocator, (self.cap * sizeof(StructField)), 1));
  }
  return self;
}
void ArrayList_StructField_push(ArrayList_StructField *self, StructField item) {
  if (self->len == self->cap) {
    int64_t new_cap = (self->cap * 2);
    {
      StructField *new_data = (StructField *)(KaiAllocator_alloc(
          self->allocator, (new_cap * sizeof(StructField)), 1));
      int64_t i = 0;
      while (i < self->len) {
        (new_data)[i] = (self->data)[i];
        i = (i + 1);
...
ArrayList_Variant ArrayList_Variant_init(KaiAllocator *allocator) {
  ...
  self.allocator = allocator;
  {
    self.data = (Variant *)(KaiAllocator_alloc(
        allocator, (self.cap * sizeof(Variant)), 1));
  }
  return self;
}
void ArrayList_Variant_push(ArrayList_Variant *self, Variant item) {
  if (self->len == self->cap) {
    int64_t new_cap = (self->cap * 2);
    {
      Variant *new_data = (Variant *)(KaiAllocator_alloc(
          self->allocator, (new_cap * sizeof(Variant)), 1));
      int64_t i = 0;
      while (i < self->len) {
        (new_data)[i] = (self->data)[i];
        i = (i + 1);
...
int64_t ArrayList_Variant_length(ArrayList_Variant *self) { return self->len; }
void ArrayList_Variant_deinit(ArrayList_Variant *self) {
  {
    KaiAllocator_free(self->allocator, (char *)(self->data));
  }
...
ArrayList_DropVarEntry ArrayList_DropVarEntry_init(KaiAllocator *allocator) {
  ...
  self.allocator = allocator;
  {
    self.data = (DropVarEntry *)(KaiAllocator_alloc(
        allocator, (self.cap * sizeof(DropVarEntry)), 1));
  }
  return self;
}
void ArrayList_DropVarEntry_push(ArrayList_DropVarEntry *self,
  ...
  if (self->len == self->cap) {
    int64_t new_cap = (self->cap * 2);
    {
      DropVarEntry *new_data = (DropVarEntry *)(KaiAllocator_alloc(
          self->allocator, (new_cap * sizeof(DropVarEntry)), 1));
      int64_t i = 0;
      while (i < self->len) {
        (new_data)[i] = (self->data)[i];
        i = (i + 1);
...
ArrayList_MatchCase ArrayList_MatchCase_init(KaiAllocator *allocator) {
  ...
  self.allocator = allocator;
  {
    self.data = (MatchCase *)(KaiAllocator_alloc(
        allocator, (self.cap * sizeof(MatchCase)), 1));
  }
  return self;
}
void ArrayList_MatchCase_push(ArrayList_MatchCase *self, MatchCase item) {
  if (self->len == self->cap) {
    int64_t new_cap = (self->cap * 2);
    {
      MatchCase *new_data = (MatchCase *)(KaiAllocator_alloc(
          self->allocator, (new_cap * sizeof(MatchCase)), 1));
      int64_t i = 0;
      while (i < self->len) {
        (new_data)[i] = (self->data)[i];
        i = (i + 1);
...
ArrayList_DropVarEntry empty_dropvarentry_array(void) {
  return (ArrayList_DropVarEntry){.data = (DropVarEntry *)(0),
                                  .len = 0,
                                  .cap = 0,
                                  .allocator = (KaiAllocator *)(0)};
}
ArrayList_Str empty_str_array(void) {
  return (ArrayList_Str){.data = (const char **)(0),
                         .len = 0,
                         .cap = 0,
                         .allocator = (KaiAllocator *)(0)};
}
ArrayList_Int empty_int_array(void) {
  return (ArrayList_Int){.data = (int64_t *)(0),
                         .len = 0,
                         .cap = 0,
                         .allocator = (KaiAllocator *)(0)};
}
ArrayList_FieldInit empty_fieldinit_array(void) {
  return (ArrayList_FieldInit){.data = (FieldInit *)(0),
                               .len = 0,
                               .cap = 0,
                               .allocator = (KaiAllocator *)(0)};
}
ArrayList_Param empty_param_array(void) {
  return (ArrayList_Param){.data = (Param *)(0),
                           .len = 0,
                           .cap = 0,
                           .allocator = (KaiAllocator *)(0)};
}
ArrayList_StructField empty_structfield_array(void) {
  return (ArrayList_StructField){.data = (StructField *)(0),
                                 .len = 0,
                                 .cap = 0,
                                 .allocator = (KaiAllocator *)(0)};
}
ArrayList_Variant empty_variant_array(void) {
  return (ArrayList_Variant){.data = (Variant *)(0),
                             .len = 0,
                             .cap = 0,
                             .allocator = (KaiAllocator *)(0)};
}
ArrayList_MatchCase empty_matchcase_array(void) {
  return (ArrayList_MatchCase){.data = (MatchCase *)(0),
                               .len = 0,
                               .cap = 0,
                               .allocator = (KaiAllocator *)(0)};
}
ArrayList_StrInterpPart empty_strinterp_array(void) {
  return (ArrayList_StrInterpPart){.data = (StrInterpPart *)(0),
                                   .len = 0,
                                   .cap = 0,
                                   .allocator = (KaiAllocator *)(0)};
}
ArrayList_AsmOutput empty_asmoutput_array(void) {
  return (ArrayList_AsmOutput){.data = (AsmOutput *)(0),
                               .len = 0,
                               .cap = 0,
                               .allocator = (KaiAllocator *)(0)};
}
ArrayList_AsmInput empty_asminput_array(void) {
  return (ArrayList_AsmInput){.data = (AsmInput *)(0),
                              .len = 0,
                              .cap = 0,
                              .allocator = (KaiAllocator *)(0)};
}
ExprNode new_expr_node(ExprKind kind) {
  ExprNode node =
      (ExprNode){.kind = kind,
                 .inferred_type = "",
                 .lit_value = (TokenValue){.tag = TokenValue_tv_none_TAG},
                 .lit_vkind = "",
...
StmtNode new_stmt_node(StmtKind kind) {
  StmtNode node = (StmtNode){.kind = kind,
...
int64_t token_precedence(TokenType ttype) {
  if (ttype == TokenType_DOT) {
    ...
    return 8;
  } else if (((ttype == TokenType_MUL) || (ttype == TokenType_DIV)) ||
             (ttype == TokenType_MOD)) {
    return 7;
    ...
    return 5;
  } else if ((((((ttype == TokenType_EQ) || (ttype == TokenType_NE)) ||
                (ttype == TokenType_LT)) ||
               (ttype == TokenType_LE)) ||
              (ttype == TokenType_GT)) ||
             (ttype == TokenType_GE)) {
    return 4;
  } else if (((ttype == TokenType_PIPE) || (ttype == TokenType_BITXOR)) ||
             (ttype == TokenType_AMP)) {
    return 3;
...
const char *str_array_join(ArrayList_Str arr, const char *sep) {
  ...
  while (i < ArrayList_Str_length(&(arr))) {
    result = _kai_str_concat(_kai_str_concat(result, sep),
                             ArrayList_Str_get(&(arr), i));
    i = (i + 1);
  }
  return result;
}
ArrayList_ExprNode ArrayList_ExprNode_init(KaiAllocator *allocator) {
  ...
  self.allocator = allocator;
  {
    self.data = (ExprNode *)(KaiAllocator_alloc(
        allocator, (self.cap * sizeof(ExprNode)), 1));
  }
  return self;
}
void ArrayList_ExprNode_push(ArrayList_ExprNode *self, ExprNode item) {
  if (self->len == self->cap) {
    int64_t new_cap = (self->cap * 2);
    {
      ExprNode *new_data = (ExprNode *)(KaiAllocator_alloc(
          self->allocator, (new_cap * sizeof(ExprNode)), 1));
      int64_t i = 0;
      while (i < self->len) {
        (new_data)[i] = (self->data)[i];
        i = (i + 1);
...
ArrayList_StmtNode ArrayList_StmtNode_init(KaiAllocator *allocator) {
  ...
  self.allocator = allocator;
  {
    self.data = (StmtNode *)(KaiAllocator_alloc(
        allocator, (self.cap * sizeof(StmtNode)), 1));
  }
  return self;
}
void ArrayList_StmtNode_push(ArrayList_StmtNode *self, StmtNode item) {
  if (self->len == self->cap) {
    int64_t new_cap = (self->cap * 2);
    {
      StmtNode *new_data = (StmtNode *)(KaiAllocator_alloc(
          self->allocator, (new_cap * sizeof(StmtNode)), 1));
      int64_t i = 0;
      while (i < self->len) {
        (new_data)[i] = (self->data)[i];
        i = (i + 1);
...
ArrayList_PatternNode ArrayList_PatternNode_init(KaiAllocator *allocator) {
  ...
  self.allocator = allocator;
  {
    self.data = (PatternNode *)(KaiAllocator_alloc(
        allocator, (self.cap * sizeof(PatternNode)), 1));
  }
  return self;
}
void ArrayList_PatternNode_push(ArrayList_PatternNode *self, PatternNode item) {
  if (self->len == self->cap) {
    int64_t new_cap = (self->cap * 2);
    {
      PatternNode *new_data = (PatternNode *)(KaiAllocator_alloc(
          self->allocator, (new_cap * sizeof(PatternNode)), 1));
      int64_t i = 0;
      while (i < self->len) {
        (new_data)[i] = (self->data)[i];
        i = (i + 1);
...
Parser Parser_init(KaiAllocator *allocator, ArrayList_Token *tokens) {
  ...
  self.pending_gt_col = 0;
  {
    self.expr_pool = (ArrayList_ExprNode *)(KaiAllocator_alloc(
        allocator, sizeof(ArrayList_ExprNode), 8));
    self.stmt_pool = (ArrayList_StmtNode *)(KaiAllocator_alloc(
        allocator, sizeof(ArrayList_StmtNode), 8));
    self.pattern_pool = (ArrayList_PatternNode *)(KaiAllocator_alloc(
        allocator, sizeof(ArrayList_PatternNode), 8));
  }
...
Token Parser_peek(Parser *self, int64_t offset) {
  if (self->pending_gt && (offset == 0)) {
    return (Token){.tok_type = TokenType_GT,
                   .value = (TokenValue){.tag = TokenValue_tv_str_TAG,
                                         .payload = {.tv_str = {.v = ">"}}},
                   .line = self->pending_gt_line,
                   .column = self->pending_gt_col};
  }
  int64_t pos = (self->cursor + offset);
  if (pos >= ArrayList_Token_length(self->tokens)) {
    return ArrayList_Token_get(self->tokens,
                               (ArrayList_Token_length(self->tokens) - 1));
  }
...
void Parser_expect_end_of_statement(Parser *self) {
  Token tok = Parser_peek(self, 0);
  if ((((tok.tok_type == TokenType_RBRACE) ||
        (tok.tok_type == TokenType_DEDENT)) ||
       (tok.tok_type == TokenType_EOF)) ||
      (tok.tok_type == TokenType_LBRACE)) {
    return;
  }
...
bool Parser_is_generic_instantiation(Parser *self) {
  ...
  while (!done) {
    ...
    if (((tok.tok_type == TokenType_EOF) ||
         (tok.tok_type == TokenType_NEWLINE)) ||
        (tok.tok_type == TokenType_SEMICOLON)) {
      return false;
    }
    TokenType tt = tok.tok_type;
    if ((((((((tt == TokenType_IDENTIFIER) || (tt == TokenType_MUL)) ||
             (tt == TokenType_AMP)) ||
            (tt == TokenType_LBRACKET)) ||
           (tt == TokenType_RBRACKET)) ||
          (tt == TokenType_COMMA)) ||
         (tt == TokenType_QUESTION)) ||
        (tt == TokenType_MUT)) {
      done = false;
      ...
      if (nested <= 0) {
        return (
            (Parser_peek(self, (offset + 1)).tok_type == TokenType_LPAREN) ||
            (Parser_peek(self, (offset + 1)).tok_type == TokenType_DOT));
      }
...
int64_t Parser_st_error(Parser *self, const char *name,
                        ArrayList_Str variants) {
...
const char *Parser_parse_base_type(Parser *self) {
  if (Parser_match_token(self, TokenType_OWN)) {
    ...
    const char *name =
        tv_get_str(Parser_expect(self, TokenType_IDENTIFIER).value);
    if (Parser_peek(self, 0).tok_type == TokenType_LT) {
      ...
      return _kai_str_concat(_kai_str_concat(_kai_str_concat(name, "<"),
                                             str_array_join(type_args, ", ")),
                             ">");
    }
    return name;
  }
...
int64_t Parser_parse_var_decl(Parser *self, bool is_mutable) {
  ...
  if (Parser_peek(self, 0).tok_type == TokenType_LPAREN) {
    ...
    return Parser_st_var_decl(self, str_array_join(names, ","), "", val_expr,
                              is_mutable);
  }
  const char *name =
      tv_get_str(Parser_expect(self, TokenType_IDENTIFIER).value);
...
int64_t Parser_parse_func_decl(Parser *self) {
  ...
  if (Parser_peek(self, 0).tok_type != TokenType_RPAREN) {
    ...
    while (!done) {
      ...
      if ((strcmp(param_name, "self") == 0) &&
          (Parser_peek(self, 0).tok_type != TokenType_COLON)) {
        param_type = "self";
      } else {
        (void)(Parser_expect(self, TokenType_COLON));
        param_type = Parser_parse_type(self);
      }
      ArrayList_Param_push(&(params),
                           (Param){.name = param_name, .ptype = param_type});
      if (!Parser_match_token(self, TokenType_COMMA)) {
        done = true;
      }
    }
  ...
  if (Parser_match_token(self, TokenType_ARROW)) {
    ...
    if (((((next_tok.tok_type == TokenType_IDENTIFIER) ||
           (next_tok.tok_type == TokenType_LPAREN)) ||
          (next_tok.tok_type == TokenType_MUL)) ||
         (next_tok.tok_type == TokenType_AMP)) ||
        (next_tok.tok_type == TokenType_LBRACKET)) {
      return_type = Parser_parse_type(self);
    }
  }
  ...
  return Parser_st_func(self, name, params, return_type, body, capability,
                        type_params);
}
int64_t Parser_parse_struct_decl(Parser *self) {
  (void)(Parser_advance(self));
  ...
  Parser_consume_newlines(self);
  while ((Parser_peek(self, 0).tok_type != TokenType_RBRACE) &&
         (Parser_peek(self, 0).tok_type != TokenType_EOF)) {
    if (Parser_peek(self, 0).tok_type == TokenType_FUNC) {
      ...
      ArrayList_Int_push(&(trait_impls),
                         Parser_st_impl(self, name, trait_name, impl_methods));
    } else {
      const char *fname =
          tv_get_str(Parser_expect(self, TokenType_IDENTIFIER).value);
      (void)(Parser_expect(self, TokenType_COLON));
      ArrayList_StructField_push(
          &(fields),
          (StructField){.name = fname, .ftype = Parser_parse_type(self)});
      Parser_expect_end_of_statement(self);
    }
    Parser_consume_newlines(self);
  }
  (void)(Parser_expect(self, TokenType_RBRACE));
  return Parser_st_struct(self, name, fields, type_params, methods,
                          trait_impls);
}
int64_t Parser_parse_impl_block(Parser *self) {
  (void)(Parser_advance(self));
  ...
  while ((Parser_peek(self, 0).tok_type != TokenType_RBRACE) &&
    ...
    if (Parser_match_token(self, TokenType_LPAREN)) {
      if (Parser_peek(self, 0).tok_type != TokenType_RPAREN) {
        bool done = false;
        while (!done) {
          const char *pname_or_type =
              tv_get_str(Parser_expect(self, TokenType_IDENTIFIER).value);
          if (Parser_peek(self, 0).tok_type == TokenType_COLON) {
            (void)(Parser_advance(self));
            ArrayList_Param_push(&(v_params),
                                 (Param){.name = pname_or_type,
                                         .ptype = Parser_parse_type(self)});
          } else {
            ...
            ArrayList_Param_push(
                &(v_params), (Param){.name = pname, .ptype = pname_or_type});
          }
          if (!Parser_match_token(self, TokenType_COMMA)) {
            done = true;
          }
    ...
    ArrayList_Variant_push(&(variants),
                           (Variant){.vname = v_name, .params = v_params});
    Parser_expect_end_of_statement(self);
    Parser_consume_newlines(self);
  }
  (void)(Parser_expect(self, TokenType_RBRACE));
...
int64_t Parser_parse_match_stmt(Parser *self) {
  ...
  while ((Parser_peek(self, 0).tok_type != TokenType_RBRACE) &&
    ...
    ArrayList_MatchCase_push(&(cases),
                             (MatchCase){.pattern = pattern, .body = body});
    Parser_consume_newlines(self);
  }
  (void)(Parser_expect(self, TokenType_RBRACE));
...
int64_t Parser_parse_pattern(Parser *self) {
  ...
  } else if (((((tok.tok_type == TokenType_INT_LIT) ||
                (tok.tok_type == TokenType_FLOAT_LIT)) ||
               (tok.tok_type == TokenType_BOOL_LIT)) ||
              (tok.tok_type == TokenType_STRING_LIT)) ||
             (tok.tok_type == TokenType_CHAR_LIT)) {
    (void)(Parser_advance(self));
...
int64_t Parser_parse_extern_decl(Parser *self) {
  ...
  if (Parser_peek(self, 0).tok_type != TokenType_RPAREN) {
    ...
    while (!done) {
      ...
      ArrayList_Param_push(
          &(params),
          (Param){.name = param_name, .ptype = Parser_parse_type(self)});
      if (!Parser_match_token(self, TokenType_COMMA)) {
        done = true;
      }
    }
...
int64_t Parser_parse_if_stmt(Parser *self) {
  ...
  if (Parser_peek(self, 0).tok_type == TokenType_LET) {
    ...
    return Parser_st_if_let(self, var_name, cond_expr, then_branch,
                            else_branch);
  }
  int64_t cond_expr = Parser_parse_expression(self, 0);
  Parser_expect_end_of_statement(self);
...
int64_t Parser_parse_for_stmt(Parser *self) {
  ...
  Parser_expect_end_of_statement(self);
  return Parser_st_for(self, var_name, range_start, range_end, is_inclusive,
...
int64_t Parser_parse_return_stmt(Parser *self) {
  ...
  if ((((next.tok_type != TokenType_NEWLINE) &&
        (next.tok_type != TokenType_RBRACE)) &&
       (next.tok_type != TokenType_DEDENT)) &&
      (next.tok_type != TokenType_EOF)) {
...
int64_t Parser_parse_defer_stmt(Parser *self) {
  ...
  if ((Parser_peek(self, 0).tok_type == TokenType_NEWLINE) ||
      (Parser_peek(self, 0).tok_type == TokenType_LBRACE)) {
    if (Parser_peek(self, 0).tok_type == TokenType_NEWLINE) {
      Parser_expect_end_of_statement(self);
    }
    body = Parser_parse_block(self);
...
int64_t Parser_parse_expr_or_assignment_stmt(Parser *self) {
  int64_t expr = Parser_parse_expression(self, 0);
  Token next = Parser_peek(self, 0);
  if (((next.tok_type == TokenType_ASSIGN) ||
       (next.tok_type == TokenType_PLUS_ASSIGN)) ||
      (next.tok_type == TokenType_MINUS_ASSIGN)) {
    Token op_tok = Parser_advance(self);
    int64_t val_expr = Parser_parse_expression(self, 0);
    Parser_expect_end_of_statement(self);
    return Parser_st_assign(self, expr, val_expr,
                            token_op_str(op_tok.tok_type));
  }
  Parser_expect_end_of_statement(self);
...
int64_t Parser_parse_import_stmt(Parser *self) {
  ...
  while (!done) {
    ArrayList_Str_push(
        &(path), tv_get_str(Parser_expect(self, TokenType_IDENTIFIER).value));
  ...
  while (!done) {
    ...
    if ((op_prec == 0) || (op_prec <= precedence)) {
      ...
      if (op_tok.tok_type == TokenType_DOT) {
        ...
        if (Parser_peek(self, 0).tok_type == TokenType_LPAREN) {
          (void)(Parser_advance(self));
          if ((Parser_peek(self, 0).tok_type == TokenType_IDENTIFIER) &&
              (Parser_peek(self, 1).tok_type == TokenType_COLON)) {
            ArrayList_FieldInit fields =
                ArrayList_FieldInit_init(self->allocator);
            if (Parser_peek(self, 0).tok_type != TokenType_RPAREN) {
              ...
              while (!fields_done) {
                const char *f_name =
                    tv_get_str(Parser_expect(self, TokenType_IDENTIFIER).value);
                (void)(Parser_expect(self, TokenType_COLON));
                ArrayList_FieldInit_push(
                    &(fields),
                    (FieldInit){.name = f_name,
                                .value = Parser_parse_expression(self, 0)});
                if (!Parser_match_token(self, TokenType_COMMA)) {
                  fields_done = true;
                }
              }
            ...
            if (left_node.kind == ExprKind_ek_identifier) {
              ...
              if (ArrayList_Str_length(&(left_node.ident_type_args)) > 0) {
                full_name = _kai_str_concat(
                    _kai_str_concat(
                        _kai_str_concat(full_name, "<"),
                        str_array_join(left_node.ident_type_args, ", ")),
                    ">");
              }
            }
            left = Parser_ex_struct_init(
                self,
                _kai_str_concat(_kai_str_concat(full_name, "."), member_name),
                fields);
          } else {
        ...
        if ((Parser_peek(self, 0).tok_type == TokenType_DOTDOT) ||
            (Parser_peek(self, 0).tok_type == TokenType_DOTDOTEQ)) {
          int64_t lower = (-1);
          int64_t upper = (-1);
          ...
          if (lower_node.kind == ExprKind_ek_range) {
            left = Parser_ex_slice(self, left, lower_node.range_start,
                                   lower_node.range_end,
                                   lower_node.range_inclusive);
          } else if ((Parser_peek(self, 0).tok_type == TokenType_DOTDOT) ||
                     (Parser_peek(self, 0).tok_type == TokenType_DOTDOTEQ)) {
            Token slice_tok = Parser_advance(self);
            bool is_inclusive = (slice_tok.tok_type == TokenType_DOTDOTEQ);
            int64_t upper = (-1);
        ...
        (void)(Parser_expect(self, TokenType_RBRACKET));
      } else if ((op_tok.tok_type == TokenType_DOTDOT) ||
                 (op_tok.tok_type == TokenType_DOTDOTEQ)) {
        bool is_inclusive = (op_tok.tok_type == TokenType_DOTDOTEQ);
        int64_t right = (-1);
        Token next = Parser_peek(self, 0);
        if (((((((next.tok_type != TokenType_RBRACKET) &&
                 (next.tok_type != TokenType_COMMA)) &&
                (next.tok_type != TokenType_NEWLINE)) &&
               (next.tok_type != TokenType_SEMICOLON)) &&
              (next.tok_type != TokenType_RBRACE)) &&
             (next.tok_type != TokenType_DEDENT)) &&
            (next.tok_type != TokenType_EOF)) {
        ...
        if (next.tok_type == TokenType_NEWLINE) {
          ...
          if (((((follow.tok_type != TokenType_NEWLINE) &&
                 (follow.tok_type != TokenType_SEMICOLON)) &&
                (follow.tok_type != TokenType_RBRACE)) &&
               (follow.tok_type != TokenType_DEDENT)) &&
              (follow.tok_type != TokenType_EOF)) {
        ...
        left =
            Parser_ex_binop(self, token_op_str(op_tok.tok_type), left, right);
      }
    }
  }
  return left;
...
int64_t Parser_parse_primary(Parser *self) {
  ...
  if ((((tok.tok_type == TokenType_INT_LIT) ||
    ...
    (void)(Parser_advance(self));
    return Parser_ex_literal(self, (TokenValue){.tag = TokenValue_tv_none_TAG},
                             "NONE");
  } else if (tok.tok_type == TokenType_STRING_LIT) {
    (void)(Parser_advance(self));
    ...
    (void)(Parser_expect(self, TokenType_LPAREN));
    const char *asm_code =
        tv_get_str(Parser_expect(self, TokenType_STRING_LIT).value);
    ...
    if (Parser_match_token(self, TokenType_COLON)) {
      ...
      while (!done) {
        ...
        if (((next_tt == TokenType_COLON) || (next_tt == TokenType_RPAREN)) ||
            (next_tt == TokenType_EOF)) {
          done = true;
        } else {
          ...
          (void)(Parser_expect(self, TokenType_RPAREN));
          ArrayList_AsmOutput_push(&(outputs),
                                   (AsmOutput){.name = out_name,
    ...
    if (Parser_match_token(self, TokenType_COLON)) {
      ...
      while (!done) {
        ...
        if (((next_tt == TokenType_COLON) || (next_tt == TokenType_RPAREN)) ||
          ...
          (void)(Parser_expect(self, TokenType_RPAREN));
          ArrayList_AsmInput_push(&(inputs),
                                  (AsmInput){.name = in_name,
                                             .constraint = constraint,
                                             .expr_idx = expr_idx});
          if (!Parser_match_token(self, TokenType_COMMA)) {
            done = true;
    ...
    (void)(Parser_expect(self, TokenType_RPAREN));
    return Parser_ex_asm(self, asm_code, is_volatile, outputs, inputs,
                         clobbers);
  } else if (tok.tok_type == TokenType_IDENTIFIER) {
    if (Parser_is_generic_instantiation(self)) {
      ...
      while (ci < ArrayList_Str_length(&(type_args))) {
        ArrayList_Str_push(&(id_type_args),
                           ArrayList_Str_get(&(type_args), ci));
        ci = (ci + 1);
      }
      if (Parser_peek(self, 0).tok_type == TokenType_LPAREN) {
        (void)(Parser_advance(self));
        if ((Parser_peek(self, 0).tok_type == TokenType_IDENTIFIER) &&
          ...
          while (cj < ArrayList_Str_length(&(type_args))) {
            ArrayList_Str_push(&(sa_type_args),
                               ArrayList_Str_get(&(type_args), cj));
            cj = (cj + 1);
          }
          const char *type_args_str = str_array_join(sa_type_args, ", ");
          return Parser_ex_struct_init(
              self,
              _kai_str_concat(
                  _kai_str_concat(_kai_str_concat(ident, "<"), type_args_str),
                  ">"),
              fields);
        }
        ArrayList_Int args = ArrayList_Int_init(self->allocator);
    ...
    return Parser_ex_call_with(self, "size_of",
                               ArrayList_Int_init(self->allocator), targs);
  } else if (tok.tok_type == TokenType_AMP) {
    (void)(Parser_advance(self));
    bool is_mut = false;
    if (Parser_match_token(self, TokenType_MUT)) {
...
ArrayList_Symbol ArrayList_Symbol_init(KaiAllocator *allocator) {
  ...
  self.allocator = allocator;
  {
    self.data = (Symbol *)(KaiAllocator_alloc(allocator,
                                              (self.cap * sizeof(Symbol)), 1));
  }
  return self;
}
void ArrayList_Symbol_push(ArrayList_Symbol *self, Symbol item) {
  if (self->len == self->cap) {
    int64_t new_cap = (self->cap * 2);
    {
      Symbol *new_data = (Symbol *)(KaiAllocator_alloc(
          self->allocator, (new_cap * sizeof(Symbol)), 1));
      int64_t i = 0;
      while (i < self->len) {
        (new_data)[i] = (self->data)[i];
        i = (i + 1);
...
int64_t ArrayList_Symbol_length(ArrayList_Symbol *self) { return self->len; }
void ArrayList_Symbol_deinit(ArrayList_Symbol *self) {
  {
    KaiAllocator_free(self->allocator, (char *)(self->data));
  }
...
void SymbolTable_define(SymbolTable *self, const char *name,
                        const char *type_name, bool is_mutable,
                        const char *kind, const char *llvm_value) {
  ArrayList_Symbol_push(&(self->entries), (Symbol){.name = name,
                                                   .type_name = type_name,
...
ArrayList_SymbolTable ArrayList_SymbolTable_init(KaiAllocator *allocator) {
  ...
  self.allocator = allocator;
  {
    self.data = (SymbolTable *)(KaiAllocator_alloc(
        allocator, (self.cap * sizeof(SymbolTable)), 1));
  }
  return self;
}
void ArrayList_SymbolTable_push(ArrayList_SymbolTable *self, SymbolTable item) {
  if (self->len == self->cap) {
    int64_t new_cap = (self->cap * 2);
    {
      SymbolTable *new_data = (SymbolTable *)(KaiAllocator_alloc(
          self->allocator, (new_cap * sizeof(SymbolTable)), 1));
      int64_t i = 0;
      while (i < self->len) {
        (new_data)[i] = (self->data)[i];
        i = (i + 1);
...
ArrayList_StructInfo ArrayList_StructInfo_init(KaiAllocator *allocator) {
  ...
  self.allocator = allocator;
  {
    self.data = (StructInfo *)(KaiAllocator_alloc(
        allocator, (self.cap * sizeof(StructInfo)), 1));
  }
  return self;
}
void ArrayList_StructInfo_push(ArrayList_StructInfo *self, StructInfo item) {
  if (self->len == self->cap) {
    int64_t new_cap = (self->cap * 2);
    {
      StructInfo *new_data = (StructInfo *)(KaiAllocator_alloc(
          self->allocator, (new_cap * sizeof(StructInfo)), 1));
      int64_t i = 0;
      while (i < self->len) {
        (new_data)[i] = (self->data)[i];
        i = (i + 1);
...
void TypeChecker_enter_scope(TypeChecker *self) {
  SymbolTable new_table =
      (SymbolTable){.entries = ArrayList_Symbol_init(self->allocator),
                    .parent_idx = self->current_table_idx,
  ...
  self->current_table_idx =
      (ArrayList_SymbolTable_length(&(self->symbol_tables)) - 1);
}
void TypeChecker_exit_scope(TypeChecker *self) {
  if (self->current_table_idx >= 0) {
    SymbolTable table = ArrayList_SymbolTable_get(&(self->symbol_tables),
                                                  self->current_table_idx);
...
void TypeChecker_define_symbol(TypeChecker *self, const char *name,
  ...
  if (self->current_table_idx >= 0) {
    ...
    ArrayList_SymbolTable_set(&(self->symbol_tables), self->current_table_idx,
                              table);
  }
}
bool TypeChecker_check_program(TypeChecker *self, int64_t top_stmt_idx) {
  ...
  if (stmt.kind == StmtKind_sk_block) {
    ...
    while (i < ArrayList_Int_length(&(stmt.block_stmts))) {
      ...
      if (s.kind == StmtKind_sk_impl_block) {
        ...
        ArrayList_StructInfo_push(
            &(self->struct_info),
            (StructInfo){.name = s.impl_struct_name, .has_drop = has_drop});
      }
      i = (i + 1);
    }
  }
...
bool TypeChecker_has_drop_method(TypeChecker *self, const char *type_name) {
  ...
  if ((strlen(type_name) > 4) &&
      (strcmp(substring(type_name, 0, 4), "own ") == 0)) {
    clean_type = substring(type_name, 4, strlen(type_name));
  }
  if ((strlen(clean_type) > 0) && ((((clean_type)[0] == ((char)(38))) ||
                                    ((clean_type)[0] == ((char)(42)))) ||
                                   ((clean_type)[0] == ((char)(63))))) {
    return false;
  }
  int64_t i = 0;
...
void TypeChecker_collect_block_drops(TypeChecker *self, int64_t stmt_idx) {
  ...
  SymbolTable table = ArrayList_SymbolTable_get(&(self->symbol_tables),
                                                self->current_table_idx);
  ArrayList_DropVarEntry drop_vars =
      ArrayList_DropVarEntry_init(self->allocator);
  ...
  while (i >= 0) {
    ...
    if (((strcmp(sym.kind, "var") == 0) || (strcmp(sym.kind, "param") == 0)) &&
      ...
      if (TypeChecker_has_drop_method(self, base_type)) {
        ArrayList_DropVarEntry_push(
            &(drop_vars),
            (DropVarEntry){.name = sym.name, .base_type = base_type});
      }
    }
    i = (i - 1);
  }
...
bool TypeChecker_is_copy_type(TypeChecker *self, const char *type_name) {
  ...
  if ((strlen(type_name) > 0) &&
      (((type_name)[0] == ((char)(42))) || ((type_name)[0] == ((char)(38))))) {
    return true;
  }
  return false;
}
PtrRefResult TypeChecker_parse_ptr_ref(TypeChecker *self,
                                       const char *type_str) {
  bool is_ptr = false;
  bool is_mut = false;
  ...
  if ((strlen(inner) > 5) && (strcmp(substring(inner, 0, 5), "*mut ") == 0)) {
    ...
    is_ptr = true;
    inner = substring(inner, 1, strlen(inner));
  } else if ((strlen(inner) > 5) &&
             (strcmp(substring(inner, 0, 5), "&mut ") == 0)) {
    is_ptr = true;
    is_mut = true;
    inner = substring(inner, 5, strlen(inner));
...
bool TypeChecker_types_compatible(TypeChecker *self, const char *target,
  ...
  if ((strcmp(t, "Allocator") == 0) &&
      ((strcmp(s, "KaiAllocator") == 0) || (strcmp(s, "CAlloc") == 0))) {
    return true;
  }
  if (strcmp(t, s) == 0) {
    return true;
  ...
  if (excl_t >= 0) {
    ...
    if (excl_s >= 0) {
      ...
      return (TypeChecker_types_compatible(self, target_val, source_val) &&
              TypeChecker_types_compatible(self, target_err, source_err));
    }
...
int64_t TypeChecker_find_method_decl(TypeChecker *self, const char *struct_name,
  ...
  clean_struct = clean;
  if ((strlen(clean_struct) > 4) &&
      (strcmp(substring(clean_struct, 0, 4), "mut ") == 0)) {
...
int64_t TypeChecker_find_struct_decl(TypeChecker *self, const char *name) {
  ...
  while (idx < ArrayList_StmtNode_length(self->stmt_pool)) {
    ...
    if ((stmt.kind == StmtKind_sk_struct_decl) &&
        (strcmp(stmt.struct_name, name) == 0)) {
      return idx;
    }
    idx = (idx + 1);
  }
...
const char *TypeChecker_get_block_yield_type(TypeChecker *self,
  ...
  if (stmt.kind == StmtKind_sk_block) {
    ...
    int64_t last_idx = ArrayList_Int_get(
        &(stmt.block_stmts), (ArrayList_Int_length(&(stmt.block_stmts)) - 1));
...
const char *TypeChecker_get_expr_type(TypeChecker *self, int64_t expr_idx) {
  ...
  if (expr.kind == ExprKind_ek_identifier) {
    ...
    SymbolTable table = ArrayList_SymbolTable_get(&(self->symbol_tables),
                                                  self->current_table_idx);
    Symbol sym =
        SymbolTable_lookup_symbol(&(table), name, &(self->symbol_tables));
  ...
  if (expr.kind == ExprKind_ek_func_call) {
    ...
    if ((((strcmp(name, "Char") == 0) || (strcmp(name, "Int") == 0)) ||
         (strcmp(name, "Float") == 0)) ||
        (strcmp(name, "Bool") == 0)) {
      return name;
    }
    ...
    if (((strcmp(name, "ArrayList") == 0) || (strcmp(name, "HashMap") == 0)) ||
        (strcmp(name, "StringBuilder") == 0)) {
      is_struct = true;
    }
    if (is_struct) {
      if (ArrayList_Str_length(&(expr.func_type_args)) > 0) {
        return _kai_str_concat(
            _kai_str_concat(_kai_str_concat(name, "<"),
                            str_array_join(expr.func_type_args, ", ")),
            ">");
      }
      return name;
    }
  ...
  if (expr.kind == ExprKind_ek_field_access) {
    ExprNode base_node =
        ArrayList_ExprNode_get(self->expr_pool, expr.field_expr);
    if (base_node.kind == ExprKind_ek_identifier) {
      ...
      while (s_idx < ArrayList_StmtNode_length(self->stmt_pool)) {
        ...
        if (((stmt.kind == StmtKind_sk_enum_decl) &&
             (strcmp(stmt.enum_name, base_node.ident_name) == 0)) ||
            ((stmt.kind == StmtKind_sk_error_decl) &&
             (strcmp(stmt.error_name, base_node.ident_name) == 0))) {
          is_static = true;
        }
        s_idx = (s_idx + 1);
      }
    ...
    if ((strlen(clean_type) > 4) &&
        (strcmp(substring(clean_type, 0, 4), "mut ") == 0)) {
      ...
      if (stmt.kind == StmtKind_sk_struct_decl) {
        if (strcmp(stmt.struct_name, clean_type) == 0) {
          ...
          while (f_idx < ArrayList_StructField_length(&(stmt.struct_fields))) {
            StructField f =
                ArrayList_StructField_get(&(stmt.struct_fields), f_idx);
  ...
  if (expr.kind == ExprKind_ek_deref) {
    ...
    if ((strlen(base_type) > 5) &&
        (strcmp(substring(base_type, 0, 5), "*mut ") == 0)) {
...
bool TypeChecker_expr_is_mutable(TypeChecker *self, int64_t expr_idx) {
  ...
  if (expr.kind == ExprKind_ek_identifier) {
    SymbolTable table = ArrayList_SymbolTable_get(&(self->symbol_tables),
                                                  self->current_table_idx);
    Symbol sym = SymbolTable_lookup_symbol(&(table), expr.ident_name,
                                           &(self->symbol_tables));
    if (strlen(sym.name) > 0) {
...
void TypeChecker_check_return_stmt(TypeChecker *self, int64_t stmt_idx) {
  ...
  if (stmt.return_value >= 0) {
    ...
    if (expr.kind == ExprKind_ek_borrow) {
      ExprNode borrowed =
          ArrayList_ExprNode_get(self->expr_pool, expr.borrow_expr);
      if (borrowed.kind == ExprKind_ek_identifier) {
        ...
        Symbol sym =
            SymbolTable_lookup_symbol(&(table), name, &(self->symbol_tables));
        if ((strcmp(sym.kind, "var") == 0) ||
            (strcmp(sym.kind, "param") == 0)) {
          printf("%s\n",
...
void TypeChecker_check_stmt(TypeChecker *self, int64_t stmt_idx) {
  ...
  if (stmt.kind == StmtKind_sk_var_decl) {
    ...
    TypeChecker_define_symbol(self, stmt.vardecl_name, var_type,
                              stmt.vardecl_mut, "var");
  ...
  if (stmt.kind == StmtKind_sk_assignment) {
    ...
    if (stmt.assign_target >= 0) {
      ...
      ExprNode target_expr =
          ArrayList_ExprNode_get(self->expr_pool, stmt.assign_target);
      if (target_expr.kind == ExprKind_ek_identifier) {
        SymbolTable table = ArrayList_SymbolTable_get(&(self->symbol_tables),
                                                      self->current_table_idx);
        Symbol sym = SymbolTable_lookup_symbol(&(table), target_expr.ident_name,
                                               &(self->symbol_tables));
  ...
  if (stmt.kind == StmtKind_sk_func_decl) {
    ...
    TypeChecker_define_symbol(self, stmt.func_name, stmt.func_return_type,
                              false, "func");
  ...
  if (stmt.kind == StmtKind_sk_if_let) {
    ...
    TypeChecker_enter_scope(self);
    TypeChecker_define_symbol(self, stmt.iflet_var, unwrapped_type, false,
                              "var");
  ...
  if (stmt.kind == StmtKind_sk_match) {
    ...
    while (i < ArrayList_MatchCase_length(&(stmt.match_cases))) {
      ...
      TypeChecker_enter_scope(self);
      PatternNode pat =
          ArrayList_PatternNode_get(self->pattern_pool, mc.pattern);
      if (pat.kind == PatternKind_pk_variant) {
        int64_t bi = 0;
        while (bi < ArrayList_Str_length(&(pat.bindings))) {
          TypeChecker_define_symbol(self,
                                    ArrayList_Str_get(&(pat.bindings), bi),
                                    "Void", false, "var");
          bi = (bi + 1);
        }
      }
  ...
  if (stmt.kind == StmtKind_sk_impl_block) {
    ...
    while (i < ArrayList_Int_length(&(stmt.impl_methods))) {
      ...
      StmtNode m = ArrayList_StmtNode_get(self->stmt_pool, m_idx);
      const char *mangled_name = _kai_str_concat(
          _kai_str_concat(stmt.impl_struct_name, "_"), m.func_name);
      TypeChecker_define_symbol(self, mangled_name, m.func_return_type, false,
                                "func");
      const char *old_ret = self->current_func_ret_type;
      self->current_func_ret_type = m.func_return_type;
      TypeChecker_enter_scope(self);
      TypeChecker_define_symbol(self, "self", stmt.impl_struct_name, true,
                                "param");
      int64_t pi = 1;
...
void TypeChecker_check_expr(TypeChecker *self, int64_t expr_idx) {
  ...
  if (expr.kind == ExprKind_ek_func_call) {
    ...
    if (func_idx >= 0) {
      ...
      if (ArrayList_Param_length(&(decl.func_params)) !=
          ArrayList_Int_length(&(expr.func_args))) {
        ...
        while (arg_i < ArrayList_Int_length(&(expr.func_args))) {
          ...
          bool is_generic_param =
              (((strlen(ptype) == 1) && ((ptype)[0] >= ((char)(65)))) &&
               ((ptype)[0] <= ((char)(90))));
          if ((!is_generic_param) &&
              (!TypeChecker_types_compatible(self, ptype, arg_type))) {
            printf("%s\n",
  ...
  if (expr.kind == ExprKind_ek_method_call) {
    ...
    if (meth_idx >= 0) {
      ...
      if (ArrayList_Param_length(&(decl.func_params)) !=
          (ArrayList_Int_length(&(expr.meth_args)) + 1)) {
    ...
    if (struct_idx >= 0) {
      ...
      while (fi < ArrayList_FieldInit_length(&(expr.struct_fields))) {
        ...
        while (dfi < ArrayList_StructField_length(&(decl.struct_fields))) {
          StructField df =
              ArrayList_StructField_get(&(decl.struct_fields), dfi);
  ...
  if (expr.kind == ExprKind_ek_try) {
    ...
    if (excl_pos < 0) {
      ...
      const char *error_set =
          substring(inner_ty, (excl_pos + 1), strlen(inner_ty));
      const char *expected_ret = self->current_func_ret_type;
      int64_t func_excl = (-1);
      i = 0;
      ...
      if (func_excl < 0) {
        printf("%s\n", "error[E0001]: Cannot use 'try' in a function that "
                       "returns non-error union type '");
        printf("%s\n", expected_ret);
        printf("%s\n", "'\n");
        self->has_error = true;
      } else {
        const char *func_err =
            substring(expected_ret, (func_excl + 1), strlen(expected_ret));
        if (!TypeChecker_types_compatible(self, func_err, error_set)) {
          printf("%s\n", "error[E0001]: Error set '");
          printf("%s\n", error_set);
          printf("%s\n", "' of try expression is not compatible with function "
                         "error set '");
          printf("%s\n", func_err);
          printf("%s\n", "'\n");
          self->has_error = true;
  ...
  if (expr.kind == ExprKind_ek_catch) {
    ...
    if ((strlen(inner_ty) > 0) && ((inner_ty)[0] == ((char)(63)))) {
      ...
      TypeChecker_exit_scope(self);
      const char *fallback_yields =
          TypeChecker_get_block_yield_type(self, expr.catch_fallback);
    ...
    if (excl_pos < 0) {
      ...
      TypeChecker_enter_scope(self);
      if (strlen(expr.catch_var) > 0) {
        TypeChecker_define_symbol(self, expr.catch_var, error_set, false,
                                  "var");
      }
      TypeChecker_check_stmt(self, expr.catch_fallback);
      TypeChecker_exit_scope(self);
...
ArrayList_StrMapEntry ArrayList_StrMapEntry_init(KaiAllocator *allocator) {
  ...
  self.allocator = allocator;
  {
    self.data = (StrMapEntry *)(KaiAllocator_alloc(
        allocator, (self.cap * sizeof(StrMapEntry)), 1));
  }
  return self;
}
void ArrayList_StrMapEntry_push(ArrayList_StrMapEntry *self, StrMapEntry item) {
  if (self->len == self->cap) {
    int64_t new_cap = (self->cap * 2);
    {
      StrMapEntry *new_data = (StrMapEntry *)(KaiAllocator_alloc(
          self->allocator, (new_cap * sizeof(StrMapEntry)), 1));
      int64_t i = 0;
      while (i < self->len) {
        (new_data)[i] = (self->data)[i];
        i = (i + 1);
...
const char *Codegen_map_type(Codegen *self, const char *type_name) {
  ...
  if ((strlen(resolved_type) > 0) && ((resolved_type)[0] == ((char)(63)))) {
    ...
    if (strlist_find(&(self->result_definitions), concrete_name) < 0) {
      ...
      const char *struct_str = _kai_str_concat(
          _kai_str_concat(
              _kai_str_concat(_kai_str_concat("typedef struct ", concrete_name),
                              " "),
              concrete_name),
          ";\n");
      struct_str = _kai_str_concat(
          _kai_str_concat(_kai_str_concat(struct_str, "struct "),
                          concrete_name),
          " {\n");
      struct_str = _kai_str_concat(struct_str, "    bool has_value;\n");
      struct_str =
          _kai_str_concat(_kai_str_concat(_kai_str_concat(struct_str, "    "),
                                          Codegen_map_type(self, val_type)),
                          " value;\n");
  ...
  if (Codegen_str_contains(self, resolved_type, ((char)(33)))) {
    ...
    const char *err_type =
        substring(resolved_type, (excl_pos + 1), strlen(resolved_type));
    const char *clean_val = Codegen_clean_type_for_mangling(self, val_type);
    const char *clean_err = Codegen_clean_type_for_mangling(self, err_type);
    const char *concrete_name = _kai_str_concat(
        _kai_str_concat(_kai_str_concat("Result_", clean_val), "_"), clean_err);
    if (strlist_find(&(self->result_definitions), concrete_name) < 0) {
      ArrayList_Str_push(&(self->result_definitions), concrete_name);
      const char *struct_str = _kai_str_concat(
          _kai_str_concat(
  ...
  if ((resolved_type)[0] == ((char)(42))) {
    if ((strlen(resolved_type) > 5) &&
        (strcmp(substring(resolved_type, 0, 5), "*mut ") == 0)) {
  ...
  if (Codegen_str_contains(self, resolved_type, ((char)(60)))) {
    ...
    const char *args_str =
        substring(resolved_type, (lt_pos + 1), (strlen(resolved_type) - 1));
    ...
    while (i < strlen(args_str)) {
      ...
      if (c == ((char)(44))) {
        ArrayList_Str_push(
            &(args), Codegen_trim_spaces(self, substring(args_str, start, i)));
        start = (i + 1);
      }
      i = (i + 1);
    }
    ArrayList_Str_push(&(args),
                       Codegen_trim_spaces(
                           self, substring(args_str, start, strlen(args_str))));
    ...
    while (ai < ArrayList_Str_length(&(args))) {
      ...
      concrete_name =
          _kai_str_concat(_kai_str_concat(concrete_name, "_"), clean_arg);
      ai = (ai + 1);
    }
    const char *struct_idx_str =
        type_map_get(&(self->generic_struct_decls), base_name);
    if (strlen(struct_idx_str) > 0) {
      if (strlist_find(&(self->monomorphized_types), concrete_name) < 0) {
        ...
        Codegen_monomorphize_struct(self,
                                    Codegen_str_to_int(self, struct_idx_str),
                                    concrete_name, &(args));
      }
      return concrete_name;
    }
    const char *enum_idx_str =
        type_map_get(&(self->generic_enum_decls), base_name);
    if (strlen(enum_idx_str) > 0) {
      if (strlist_find(&(self->monomorphized_types), concrete_name) < 0) {
        ArrayList_Str_push(&(self->monomorphized_types), concrete_name);
        Codegen_monomorphize_enum(self, Codegen_str_to_int(self, enum_idx_str),
                                  concrete_name, &(args));
      }
      return concrete_name;
    }
...
const char *Codegen_substitute_generic_type(Codegen *self,
  ...
  if ((type_name)[0] == ((char)(42))) {
    return _kai_str_concat(
        "*", Codegen_substitute_generic_type(
                 self, substring(type_name, 1, strlen(type_name))));
  }
  if ((type_name)[0] == ((char)(38))) {
    if (strcmp(substring(type_name, 0, 5), "&mut ") == 0) {
      return _kai_str_concat(
          "&mut ", Codegen_substitute_generic_type(
                       self, substring(type_name, 5, strlen(type_name))));
    }
    return _kai_str_concat(
        "&", Codegen_substitute_generic_type(
                 self, substring(type_name, 1, strlen(type_name))));
  ...
  if (Codegen_str_contains(self, type_name, ((char)(60)))) {
    ...
    const char *inner =
        substring(type_name, (lt_pos + 1), (strlen(type_name) - 1));
    ...
    const char *arg =
        Codegen_trim_spaces(self, substring(inner, start, strlen(inner)));
    if (arg_count > 0) {
      res = _kai_str_concat(res, ", ");
    }
    res = _kai_str_concat(res, Codegen_substitute_generic_type(self, arg));
...
ArrayList_Str Codegen_infer_type_args(Codegen *self, int64_t func_stmt_idx,
  ...
  int64_t arg_i = 0;
  while ((arg_i < ArrayList_Int_length(&(expr.func_args))) &&
         (arg_i < ArrayList_Param_length(&(stmt.func_params)))) {
    int64_t arg = ArrayList_Int_get(&(expr.func_args), arg_i);
    ...
    while (!done) {
      if ((strlen(ptype) > 0) &&
          (((ptype)[0] == ((char)(42))) || ((ptype)[0] == ((char)(38))))) {
    ...
    while (!done) {
      if ((strlen(atype) > 0) &&
          (((atype)[0] == ((char)(42))) || ((atype)[0] == ((char)(38))))) {
    ...
    bool is_param = false;
    if (((strlen(ptype) == 1) && ((ptype)[0] >= ((char)(65)))) &&
        ((ptype)[0] <= ((char)(90)))) {
      is_param = true;
    }
    if (is_param) {
...
void Codegen_setup_current_type_map(Codegen *self, ArrayList_Str *type_params,
  ...
  while (i < ArrayList_Str_length(type_params)) {
    const char *param_name =
        Codegen_trim_spaces(self, ArrayList_Str_get(type_params, i));
    const char *arg_name =
        Codegen_trim_spaces(self, ArrayList_Str_get(type_args, i));
...
void Codegen_monomorphize_struct(Codegen *self, int64_t stmt_idx,
  ...
  const char *typedef_str = _kai_str_concat(
      _kai_str_concat(
          _kai_str_concat(_kai_str_concat("typedef struct ", concrete_name),
                          " "),
          concrete_name),
  ...
  const char *body =
      _kai_str_concat(_kai_str_concat("struct ", concrete_name), " {\n");
  int64_t i = 0;
  while (i < ArrayList_StructField_length(&(stmt.struct_fields))) {
    ...
    body = _kai_str_concat(
        _kai_str_concat(
            _kai_str_concat(
                _kai_str_concat(_kai_str_concat(body, "    "), f_type), " "),
            f.name),
        ";\n");
    i = (i + 1);
  }
...
void Codegen_monomorphize_enum(Codegen *self, int64_t stmt_idx,
  ...
  while (i < ArrayList_Variant_length(&(stmt.enum_variants))) {
    ...
    tags_str = _kai_str_concat(
        _kai_str_concat(
            _kai_str_concat(_kai_str_concat(_kai_str_concat(tags_str, "    "),
                                            concrete_name),
                            "_"),
            v.vname),
        "_TAG,\n");
  ...
  tags_str = _kai_str_concat(
      _kai_str_concat(_kai_str_concat(tags_str, "} "), tags_name), ";\n");
    ...
    if (ArrayList_Param_length(&(v.params)) > 0) {
      ...
      while (p_idx < ArrayList_Param_length(&(v.params))) {
        ...
        body = _kai_str_concat(
            _kai_str_concat(
                _kai_str_concat(
                    _kai_str_concat(_kai_str_concat(body, "            "),
                                    Codegen_map_type(self, p.ptype)),
                    " "),
                p.name),
            ";\n");
        p_idx = (p_idx + 1);
      ...
      body = _kai_str_concat(
          _kai_str_concat(_kai_str_concat(body, "        } "), v.vname), ";\n");
    }
    i = (i + 1);
  }
...
void Codegen_monomorphize_methods(Codegen *self, const char *base_struct_name,
  ...
  while (idx < ArrayList_StmtNode_length(self->stmt_pool)) {
    StmtNode stmt = ArrayList_StmtNode_get(self->stmt_pool, idx);
    if ((stmt.kind == StmtKind_sk_impl_block) &&
        (strcmp(stmt.impl_struct_name, base_struct_name) == 0)) {
      int64_t j = 0;
      while (j < ArrayList_Int_length(&(stmt.impl_methods))) {
        ...
        bool is_init =
            ((((strcmp(method_name, "init") == 0) ||
               (strcmp(m_node.func_return_type, base_struct_name) == 0)) ||
              (strcmp(m_node.func_return_type,
                      _kai_str_concat("*", base_struct_name)) == 0)) ||
             (strcmp(m_node.func_return_type,
                     _kai_str_concat("&", base_struct_name)) == 0));
        const char *ret_type = "";
        if (is_init) {
        ...
        while (p_idx < ArrayList_Param_length(&(m_node.func_params))) {
          ...
          if (strcmp(p.name, "self") != 0) {
            ...
            params_str = _kai_str_concat(
                _kai_str_concat(_kai_str_concat(params_str, Codegen_map_type(
                                                                self, p.ptype)),
                                " "),
                p.name);
          }
        ...
        const char *mangled_fn_name = _kai_str_concat(
            _kai_str_concat(concrete_struct_name, "_"), method_name);
        ...
        if (is_init) {
          ...
          type_map_put(&(self->var_types), "self",
                       _kai_str_concat("*", concrete_struct_name));
        }
        int64_t p_idx2 = 0;
        ...
        if (is_init) {
          const char *self_decl = _kai_str_concat(
              _kai_str_concat(
                  _kai_str_concat(_kai_str_concat("    ", concrete_struct_name),
                                  " self = ("),
                  concrete_struct_name),
              "){0};\n");
          const char *self_ret = "    return self;\n}";
          int64_t body_len = strlen(body_str);
          body_str = _kai_str_concat(
              _kai_str_concat(_kai_str_concat("{\n", self_decl),
                              substring(body_str, 2, (body_len - 1))),
              self_ret);
        }
        const char *proto = _kai_str_concat(
            _kai_str_concat(
                _kai_str_concat(_kai_str_concat(_kai_str_concat(ret_type, " "),
                                                mangled_fn_name),
                                "("),
                params_str),
            ");\n");
        const char *impl_str = _kai_str_concat(
            _kai_str_concat(
                _kai_str_concat(
                    _kai_str_concat(
                        _kai_str_concat(
                            _kai_str_concat(_kai_str_concat(ret_type, " "),
                                            mangled_fn_name),
                            "("),
                        params_str),
                    ") "),
...
void Codegen_monomorphize_func(Codegen *self, int64_t func_stmt_idx,
  ...
  const char *concrete_ret_type =
      Codegen_substitute_generic_type(self, stmt.func_return_type);
  ...
  while (p_idx < ArrayList_Param_length(&(stmt.func_params))) {
    ...
    params_str = _kai_str_concat(
        _kai_str_concat(
            _kai_str_concat(params_str, Codegen_map_type(self, concrete_ptype)),
            " "),
        p.name);
    p_idx = (p_idx + 1);
  }
  ...
  const char *proto = _kai_str_concat(
      _kai_str_concat(
          _kai_str_concat(
              _kai_str_concat(_kai_str_concat(mapped_ret, " "), mangled_name),
              "("),
          params_str),
      ");\n");
  const char *impl_str = _kai_str_concat(
      _kai_str_concat(
          _kai_str_concat(
              _kai_str_concat(
                  _kai_str_concat(
                      _kai_str_concat(_kai_str_concat(mapped_ret, " "),
                                      mangled_name),
                      "("),
                  params_str),
              ") "),
  ...
  while (i < ArrayList_StmtNode_length(self->stmt_pool)) {
    ...
    if (stmt.kind == StmtKind_sk_func_decl) {
      ...
      while (p_i < ArrayList_Param_length(&(stmt.func_params))) {
        ...
        const char *p_key = _kai_str_concat(
            _kai_str_concat(stmt.func_name, "_param_"), int_to_str(p_i));
    ...
    if (stmt.kind == StmtKind_sk_extern) {
      ...
      while (p_i < ArrayList_Param_length(&(stmt.extern_params))) {
        ...
        const char *p_key = _kai_str_concat(
            _kai_str_concat(stmt.extern_name, "_param_"), int_to_str(p_i));
        type_map_put(&(self->func_param_types), p_key, p.ptype);
        p_i = (p_i + 1);
      }
    }
    if (stmt.kind == StmtKind_sk_impl_block) {
      ...
      while (j < ArrayList_Int_length(&(stmt.impl_methods))) {
        int64_t m_idx = ArrayList_Int_get(&(stmt.impl_methods), j);
        StmtNode m_node = ArrayList_StmtNode_get(self->stmt_pool, m_idx);
        const char *key = _kai_str_concat(_kai_str_concat(struct_name, "_"),
                                          m_node.func_name);
        ...
        while (p_i < ArrayList_Param_length(&(m_node.func_params))) {
          ...
          const char *p_key =
              _kai_str_concat(_kai_str_concat(key, "_param_"), int_to_str(p_i));
          type_map_put(&(self->func_param_types), p_key, p.ptype);
          p_i = (p_i + 1);
        }
        j = (j + 1);
    ...
    if (stmt.kind == StmtKind_sk_struct_decl) {
      ...
      while (ti < ArrayList_Int_length(&(stmt.struct_trait_impls))) {
        ...
        while (j < ArrayList_Int_length(&(impl_node.impl_methods))) {
          ...
          while (p_i < ArrayList_Param_length(&(m_node.func_params))) {
            Param p = ArrayList_Param_get(&(m_node.func_params), p_i);
            const char *p_key = _kai_str_concat(_kai_str_concat(key, "_param_"),
                                                int_to_str(p_i));
            type_map_put(&(self->func_param_types), p_key, p.ptype);
            p_i = (p_i + 1);
          }
...
const char *Codegen_get_expr_type(Codegen *self, int64_t expr_idx) {
    ...
    if ((first_char >= ((char)(65))) && (first_char <= ((char)(90)))) {
      if (ArrayList_Str_length(&(expr.ident_type_args)) > 0) {
        ...
        while (tai < ArrayList_Str_length(&(expr.ident_type_args))) {
          ...
          full_name = _kai_str_concat(
              full_name, ArrayList_Str_get(&(expr.ident_type_args), tai));
          tai = (tai + 1);
        }
        full_name = _kai_str_concat(full_name, ">");
        return full_name;
    ...
    if (strlen(gf_idx_str) > 0) {
      ...
      if (ArrayList_Str_length(&(expr.func_type_args)) > 0) {
        ...
        while (j < ArrayList_Str_length(&(expr.func_type_args))) {
          ArrayList_Str_push(&(type_args),
                             ArrayList_Str_get(&(expr.func_type_args), j));
          j = (j + 1);
        }
      } else {
      ...
      ArrayList_StrMapEntry old_type_map = self->current_type_map;
      self->current_type_map = ArrayList_StrMapEntry_init(self->allocator);
      Codegen_setup_current_type_map(self, &(stmt.func_type_params),
                                     &(type_args));
      const char *ret_t =
          Codegen_substitute_generic_type(self, stmt.func_return_type);
      self->current_type_map = old_type_map;
      ...
      if (stmt.kind == StmtKind_sk_struct_decl) {
        ...
        if (strcmp(stmt.struct_name, clean_type) == 0) {
          ...
          if (ArrayList_Str_length(&(stmt.struct_type_params)) > 0) {
            int64_t underscore_pos =
                Codegen_str_find(self, clean_type, ((char)(95)));
  ...
  if (expr.kind == ExprKind_ek_method_call) {
    ExprNode receiver_node =
        ArrayList_ExprNode_get(self->expr_pool, expr.meth_expr);
    ...
    const char *key =
        _kai_str_concat(_kai_str_concat(clean_type, "_"), method_name);
    ...
    bool done = false;
    while (!done) {
      if ((strlen(clean_rec) > 0) && (((clean_rec)[0] == ((char)(42))) ||
                                      ((clean_rec)[0] == ((char)(38))))) {
    ...
    if (Codegen_str_contains(self, clean_rec, ((char)(60)))) {
      ...
      const char *args_str =
          substring(clean_rec, (lt_pos + 1), (strlen(clean_rec) - 1));
      ArrayList_Str args = ArrayList_Str_init(self->allocator);
      int64_t start = 0;
      int64_t ai = 0;
      while (ai < strlen(args_str)) {
        ...
        if (c == ((char)(44))) {
          ArrayList_Str_push(
              &(args),
              Codegen_trim_spaces(self, substring(args_str, start, ai)));
          start = (ai + 1);
        }
        ai = (ai + 1);
      }
      ArrayList_Str_push(
          &(args), Codegen_trim_spaces(
                       self, substring(args_str, start, strlen(args_str))));
      ...
      while (si < ArrayList_StmtNode_length(self->stmt_pool)) {
        ...
        if ((s.kind == StmtKind_sk_struct_decl) &&
            (strcmp(s.struct_name, base_struct) == 0)) {
          struct_idx = si;
        }
        si = (si + 1);
      }
      if (struct_idx >= 0) {
        ...
        ArrayList_StrMapEntry temp_map =
            ArrayList_StrMapEntry_init(self->allocator);
        int64_t pi = 0;
        while (pi < ArrayList_Str_length(&(s_decl.struct_type_params))) {
          const char *p_name = Codegen_trim_spaces(
              self, ArrayList_Str_get(&(s_decl.struct_type_params), pi));
        ...
        while (impl_idx < ArrayList_StmtNode_length(self->stmt_pool)) {
          ...
          if ((s_impl.kind == StmtKind_sk_impl_block) &&
              (strcmp(s_impl.impl_struct_name, base_struct) == 0)) {
            int64_t mi = 0;
            while (mi < ArrayList_Int_length(&(s_impl.impl_methods))) {
              StmtNode m_node = ArrayList_StmtNode_get(
                  self->stmt_pool,
                  ArrayList_Int_get(&(s_impl.impl_methods), mi));
...
const char *Codegen_gen_expr_with_expected_type(Codegen *self, int64_t expr_idx,
  ...
  if ((expr.kind == ExprKind_ek_literal) &&
    ...
    if ((strlen(expected_type) > 0) && ((expected_type)[0] == ((char)(63)))) {
      ...
      return _kai_str_concat(
          _kai_str_concat("(", Codegen_map_type(self, expected_type)), "){0}");
    }
    return "NULL";
  }
  ...
  if ((strlen(expected_type) > 0) && ((expected_type)[0] == ((char)(63)))) {
    const char *val_type = substring(expected_type, 1, strlen(expected_type));
    if ((!Codegen_is_pointer_type(self, val_type)) &&
        (strcmp(actual_type, val_type) == 0)) {
      return _kai_str_concat(
          _kai_str_concat(
              _kai_str_concat(
                  _kai_str_concat("(", Codegen_map_type(self, expected_type)),
...
const char *Codegen_gen_expr(Codegen *self, int64_t expr_idx) {
  ...
  if (expr.kind == ExprKind_ek_try) {
    ...
    const char *try_code = _kai_str_concat(
        _kai_str_concat(_kai_str_concat(_kai_str_concat("({ ", result_ctype),
                                        " _kai_res = ("),
                        inner),
        "); ");
    try_code = _kai_str_concat(try_code, "if (_kai_res.tag != 0) { ");
    try_code = _kai_str_concat(_kai_str_concat(try_code, ret_ctype),
                               " _kai_err_ret; _kai_err_ret.tag = "
                               "_kai_res.tag; return _kai_err_ret; } ");
    if (strcmp(val_type, "Void") == 0) {
  ...
  if (expr.kind == ExprKind_ek_literal) {
    ...
    if (strcmp(vkind, "STRING") == 0) {
      if (expr.lit_value.tag == TokenValue_tv_str_TAG) {
        ...
        return _kai_str_concat(
            _kai_str_concat("\"", Codegen_escape_string(self, v)), "\"");
      } else {
        return "\"\"";
      }
    }
  ...
  if (expr.kind == ExprKind_ek_str_interp) {
    ...
    while (i < ArrayList_StrInterpPart_length(&(expr.interp_parts))) {
      ...
      const char *part_str = "";
      if (part.kind == 0) {
        part_str = _kai_str_concat(
            _kai_str_concat("\"", Codegen_escape_string(self, part.str_val)),
            "\"");
      } else {
        ...
        if (strcmp(expr_type, "Int") == 0) {
          part_str =
              _kai_str_concat(_kai_str_concat("int_to_str(", expr_val), ")");
        } else if (strcmp(expr_type, "Char") == 0) {
          part_str =
              _kai_str_concat(_kai_str_concat("char_to_str(", expr_val), ")");
        } else if (strcmp(expr_type, "Bool") == 0) {
          part_str = _kai_str_concat(_kai_str_concat("((", expr_val),
                                     ") ? \"true\" : \"false\")");
      ...
      if (i == 0) {
        ...
        result = _kai_str_concat(
            _kai_str_concat(
                _kai_str_concat(_kai_str_concat("_kai_str_concat(", result),
                                ", "),
                part_str),
            ")");
      }
  ...
  if (expr.kind == ExprKind_ek_binary_op) {
    ...
    if ((strcmp(op, "==") == 0) || (strcmp(op, "!=") == 0)) {
      if (((strlen(lhs_type) > 0) && ((lhs_type)[0] == ((char)(63)))) &&
          (strcmp(rhs, "NULL") == 0)) {
        const char *val_type = substring(lhs_type, 1, strlen(lhs_type));
        if (Codegen_is_pointer_type(self, val_type)) {
          return _kai_str_concat(
              _kai_str_concat(_kai_str_concat(_kai_str_concat("(", lhs), " "),
                              op),
              " NULL)");
        }
        if (strcmp(op, "==") == 0) {
      ...
      if (((strlen(rhs_type) > 0) && ((rhs_type)[0] == ((char)(63)))) &&
          (strcmp(lhs, "NULL") == 0)) {
        const char *val_type = substring(rhs_type, 1, strlen(rhs_type));
        if (Codegen_is_pointer_type(self, val_type)) {
          return _kai_str_concat(
              _kai_str_concat(
                  _kai_str_concat(_kai_str_concat("(NULL ", op), " "), rhs),
              ")");
        }
        if (strcmp(op, "==") == 0) {
    ...
    ExprNode lhs_node =
        ArrayList_ExprNode_get(self->expr_pool, expr.binop_left);
    if (strcmp(lhs_type, "Str") == 0) {
      ...
      if (strcmp(op, "==") == 0) {
        return _kai_str_concat(
            _kai_str_concat(
                _kai_str_concat(_kai_str_concat("(strcmp(", lhs), ", "), rhs),
            ") == 0)");
      }
      if (strcmp(op, "!=") == 0) {
        return _kai_str_concat(
    ...
    if (((strcmp(op, "==") == 0) || (strcmp(op, "!=") == 0)) &&
        Codegen_is_enum_type(self, lhs_type)) {
      if (Codegen_enum_has_payload(self, lhs_type)) {
        bool is_ptr = false;
        if (((lhs_type)[0] == ((char)(42))) ||
            ((lhs_type)[0] == ((char)(38)))) {
          is_ptr = true;
        }
        const char *tag_op = ".";
  ...
  if (expr.kind == ExprKind_ek_func_call) {
          ...
          _kai_str_concat(
              _kai_str_concat(
                  _kai_str_concat(
                      "(",
                      Codegen_map_type(
                          self, ArrayList_Str_get(&(expr.func_type_args), 0))),
                  ")("),
              Codegen_gen_expr(self, ArrayList_Int_get(&(expr.func_args), 0))),
          ")");
    }
    if (strcmp(name, "size_of") == 0) {
      return _kai_str_concat(
          _kai_str_concat("sizeof(", Codegen_map_type(
                                         self, ArrayList_Str_get(
                                                   &(expr.func_type_args), 0))),
          ")");
    }
    if ((((strcmp(name, "Char") == 0) || (strcmp(name, "Int") == 0)) ||
         (strcmp(name, "Float") == 0)) ||
      ...
      const char *arg_val =
          Codegen_gen_expr(self, ArrayList_Int_get(&(expr.func_args), 0));
      return _kai_str_concat(
          _kai_str_concat(_kai_str_concat(_kai_str_concat("((", ctype), ")("),
                          arg_val),
          "))");
    }
    ...
    if (strcmp(name, "print") == 0) {
      ...
      if (strcmp(arg_type, "Int") == 0) {
        return _kai_str_concat(
            _kai_str_concat("printf(\"%lld\\n\", (long long)(", val), "))");
      }
      if (strcmp(arg_type, "Float") == 0) {
        return _kai_str_concat(
            _kai_str_concat("printf(\"%f\\n\", (double)(", val), "))");
      }
      if (strcmp(arg_type, "Char") == 0) {
        return _kai_str_concat(
            _kai_str_concat("printf(\"%c\\n\", (char)(", val), "))");
      }
    ...
    if (strlen(gf_idx_str) > 0) {
      ...
      while (j < ArrayList_Str_length(&(type_args))) {
        fn_name =
            _kai_str_concat(_kai_str_concat(fn_name, "_"),
                            Codegen_clean_type_for_mangling(
                                self, ArrayList_Str_get(&(type_args), j)));
        j = (j + 1);
      }
      ...
      int64_t j = 0;
      while (j < ArrayList_Str_length(&(expr.func_type_args))) {
        fn_name = _kai_str_concat(
            _kai_str_concat(fn_name, "_"),
            Codegen_clean_type_for_mangling(
                self, ArrayList_Str_get(&(expr.func_type_args), j)));
        j = (j + 1);
      }
    }
    if (is_struct) {
    ...
    while (i < ArrayList_Int_length(&(expr.func_args))) {
      ...
      const char *p_key = _kai_str_concat(_kai_str_concat(fn_name, "_param_"),
                                          int_to_str(p_idx));
      const char *expected_type =
          type_map_get(&(self->func_param_types), p_key);
      args_str = _kai_str_concat(
          args_str,
          Codegen_gen_expr_with_expected_type(
              self, ArrayList_Int_get(&(expr.func_args), i), expected_type));
      i = (i + 1);
    }
    return _kai_str_concat(
        _kai_str_concat(_kai_str_concat(fn_name, "("), args_str), ")");
  }
  if (expr.kind == ExprKind_ek_field_access) {
    ExprNode base_node =
        ArrayList_ExprNode_get(self->expr_pool, expr.field_expr);
    if ((base_node.kind == ExprKind_ek_identifier) &&
        Codegen_is_enum_type(self, base_node.ident_name)) {
      const char *enum_name =
          Codegen_map_type(self, Codegen_get_expr_type(self, expr.field_expr));
      ...
      if (Codegen_enum_has_payload(self, base_node.ident_name)) {
        return _kai_str_concat(
            _kai_str_concat(
                _kai_str_concat(
                    _kai_str_concat(
                        _kai_str_concat(_kai_str_concat("(", enum_name),
                                        "){ .tag = "),
                        enum_name),
                    "_"),
                var_name),
    ...
    const char *base_type = Codegen_get_expr_type(self, expr.field_expr);
    bool is_ptr = false;
    bool is_self_ptr = (((base_node.kind == ExprKind_ek_identifier) &&
                         (strcmp(base_node.ident_name, "self") == 0)) &&
                        (!self->cur_method_is_init));
    if ((((base_type)[0] == ((char)(42))) ||
         ((base_type)[0] == ((char)(38)))) ||
        is_self_ptr) {
      is_ptr = true;
    ...
    bool is_complex = (((base_node.kind == ExprKind_ek_func_call) ||
                        (base_node.kind == ExprKind_ek_index)) ||
                       (base_node.kind == ExprKind_ek_deref));
    if (is_ptr && is_complex) {
      return _kai_str_concat(
          _kai_str_concat(_kai_str_concat(_kai_str_concat("(", base_val), ")"),
                          op),
          expr.field_name);
    }
  ...
  if (expr.kind == ExprKind_ek_borrow) {
    return _kai_str_concat(
        _kai_str_concat("&(", Codegen_gen_expr(self, expr.borrow_expr)), ")");
  }
  if (expr.kind == ExprKind_ek_deref) {
    return _kai_str_concat(
        _kai_str_concat("*(", Codegen_gen_expr(self, expr.deref_expr)), ")");
  }
    ...
    return _kai_str_concat(
        _kai_str_concat(
            _kai_str_concat(
                _kai_str_concat(
                    _kai_str_concat(
                        _kai_str_concat("(Range){ .start = ", start),
                        ", .end = "),
                    end),
                ", .is_inclusive = "),
            incl),
  ...
  if (expr.kind == ExprKind_ek_array) {
    ...
    while (i < ArrayList_Int_length(&(expr.arr_elements))) {
      ArrayList_Str_push(
          &(elems),
          Codegen_gen_expr(self, ArrayList_Int_get(&(expr.arr_elements), i)));
      i = (i + 1);
    }
  ...
  if (expr.kind == ExprKind_ek_tuple) {
    if (strlen(expr.inferred_type) > 0) {
      ...
      while (i < ArrayList_Int_length(&(expr.tup_elements))) {
        ArrayList_Str_push(
            &(elems),
            Codegen_gen_expr(self, ArrayList_Int_get(&(expr.tup_elements), i)));
        i = (i + 1);
      }
      return _kai_str_concat(
          _kai_str_concat(
              _kai_str_concat(_kai_str_concat("(", mapped_ty), "){ "),
              str_array_join(elems, ", ")),
          " }");
    }
    return "NULL";
  }
  if (expr.kind == ExprKind_ek_asm) {
    ...
    while (i < ArrayList_AsmOutput_length(&(expr.asm_outputs))) {
      ...
      if (strlen(out.type_name) > 0) {
        ...
        ArrayList_Str_push(
            &(decls),
            _kai_str_concat(
                _kai_str_concat(_kai_str_concat(mapped_type, " "), var_name),
                ";"));
        ArrayList_Str_push(
            &(out_ops),
            _kai_str_concat(
                _kai_str_concat(
                    _kai_str_concat(
                        _kai_str_concat(
                            _kai_str_concat(_kai_str_concat("[", out.name),
                                            "] \""),
                            out.constraint),
                        "\" ("),
                    var_name),
      ...
      ArrayList_Str_push(
          ...
          _kai_str_concat(
              _kai_str_concat(
                  _kai_str_concat(
                      _kai_str_concat(
                          _kai_str_concat(_kai_str_concat("[", inp.name),
                                          "] \""),
                          inp.constraint),
                      "\" ("),
                  val_str),
    ...
    while (k < ArrayList_Str_length(&(expr.asm_clobbers))) {
      ArrayList_Str_push(
          &(clobs),
          _kai_str_concat(
              _kai_str_concat("\"", ArrayList_Str_get(&(expr.asm_clobbers), k)),
              "\""));
      k = (k + 1);
    }
    ...
    const char *asm_stmt = _kai_str_concat(
        _kai_str_concat(
            _kai_str_concat(_kai_str_concat("__asm__ ", volatile_prefix),
                            " (\""),
            escaped_asm),
        "\"");
    if (((ArrayList_Str_length(&(out_ops)) > 0) ||
         (ArrayList_Str_length(&(in_ops)) > 0)) ||
        (ArrayList_Str_length(&(clobs)) > 0)) {
      asm_stmt = _kai_str_concat(_kai_str_concat(asm_stmt, " : "),
                                 str_array_join(out_ops, ", "));
    }
    if ((ArrayList_Str_length(&(in_ops)) > 0) ||
        (ArrayList_Str_length(&(clobs)) > 0)) {
      asm_stmt = _kai_str_concat(_kai_str_concat(asm_stmt, " : "),
                                 str_array_join(in_ops, ", "));
    }
    if (ArrayList_Str_length(&(clobs)) > 0) {
      asm_stmt = _kai_str_concat(_kai_str_concat(asm_stmt, " : "),
                                 str_array_join(clobs, ", "));
    }
    asm_stmt = _kai_str_concat(asm_stmt, ");");
    const char *res = "({\n";
    int64_t d_idx = 0;
    while (d_idx < ArrayList_Str_length(&(decls))) {
      res = _kai_str_concat(_kai_str_concat(_kai_str_concat(res, "    "),
                                            ArrayList_Str_get(&(decls), d_idx)),
                            "\n");
      d_idx = (d_idx + 1);
    }
    res = _kai_str_concat(
        _kai_str_concat(_kai_str_concat(res, "    "), asm_stmt), "\n");
    if (ArrayList_AsmOutput_length(&(expr.asm_outputs)) == 1) {
      ...
      if (all_typed) {
        const char *tuple_type = _kai_str_concat(
            _kai_str_concat("(", str_array_join(types, ", ")), ")");
        ...
        while (vi < ArrayList_AsmOutput_length(&(expr.asm_outputs))) {
          ArrayList_Str_push(&(vals),
                             _kai_str_concat("asm_ret_", int_to_str(vi)));
          vi = (vi + 1);
        }
        res = _kai_str_concat(
            _kai_str_concat(
                _kai_str_concat(_kai_str_concat(_kai_str_concat(res, "    ("),
                                                mapped_tuple),
                                "){ "),
                str_array_join(vals, ", ")),
            " };\n");
  ...
  if (expr.kind == ExprKind_ek_struct_init) {
    bool is_enum = ((strlen(expr.struct_name) > 0) &&
                    Codegen_str_contains(self, expr.struct_name, ((char)(46))));
    if (is_enum) {
      int64_t dot_pos = Codegen_str_find(self, expr.struct_name, ((char)(46)));
      const char *enum_part = substring(expr.struct_name, 0, dot_pos);
      const char *variant_name =
          substring(expr.struct_name, (dot_pos + 1), strlen(expr.struct_name));
      ...
      while (i < ArrayList_FieldInit_length(&(expr.struct_fields))) {
        ...
        fields_str = _kai_str_concat(
            _kai_str_concat(
                _kai_str_concat(_kai_str_concat(fields_str, "."), f.name),
                " = "),
            Codegen_gen_expr(self, f.value));
        i = (i + 1);
      }
      const char *payload_str = "";
      if (strlen(fields_str) > 0) {
        payload_str = _kai_str_concat(
            _kai_str_concat(
                _kai_str_concat(
                    _kai_str_concat(", .payload = { .", variant_name), " = { "),
                fields_str),
            " } }");
      }
      return _kai_str_concat(
      ...
      while (i < ArrayList_FieldInit_length(&(expr.struct_fields))) {
        ...
        while (si < ArrayList_StmtNode_length(self->stmt_pool)) {
          StmtNode s = ArrayList_StmtNode_get(self->stmt_pool, si);
          if ((s.kind == StmtKind_sk_struct_decl) &&
              (strcmp(s.struct_name, expr.struct_name) == 0)) {
            int64_t fi = 0;
            while (fi < ArrayList_StructField_length(&(s.struct_fields))) {
              StructField sf =
                  ArrayList_StructField_get(&(s.struct_fields), fi);
        ...
        fields_str = _kai_str_concat(
            _kai_str_concat(
                _kai_str_concat(_kai_str_concat(fields_str, "."), f.name),
                " = "),
            Codegen_gen_expr_with_expected_type(self, f.value, field_type));
        i = (i + 1);
      }
      return _kai_str_concat(
          _kai_str_concat(
              _kai_str_concat(_kai_str_concat("(", struct_name), "){ "),
              fields_str),
          " }");
    }
  }
  if (expr.kind == ExprKind_ek_method_call) {
    ...
    ExprNode receiver_node =
        ArrayList_ExprNode_get(self->expr_pool, receiver_idx);
    const char *method_name = expr.meth_name;
    const char *rec_type = Codegen_get_expr_type(self, expr.meth_expr);
    const char *clean_type = "";
    int64_t i = 0;
    ...
    if ((!is_constructor) && (strcmp(method_name, "init") != 0)) {
      ...
      bool is_self_ptr = (((receiver_node.kind == ExprKind_ek_identifier) &&
                           (strcmp(receiver_node.ident_name, "self") == 0)) &&
                          (!self->cur_method_is_init));
      if ((((rec_inferred)[0] == ((char)(42))) ||
           ((rec_inferred)[0] == ((char)(38)))) ||
          is_self_ptr) {
        args_str = rec_val;
      } else {
        bool is_complex = ((receiver_node.kind == ExprKind_ek_func_call) ||
                           (receiver_node.kind == ExprKind_ek_method_call));
        if (is_complex) {
          const char *tmp_type = Codegen_map_type(self, rec_inferred);
          args_str = _kai_str_concat(
              _kai_str_concat(_kai_str_concat(_kai_str_concat("({ ", tmp_type),
                                              " __tmp_recv = "),
                              rec_val),
              "; &__tmp_recv; })");
        } else {
    ...
    while (ai < ArrayList_Int_length(&(expr.meth_args))) {
      ...
      const char *p_key = _kai_str_concat(_kai_str_concat(func_name, "_param_"),
                                          int_to_str((ai + 1)));
      const char *expected_type =
          type_map_get(&(self->func_param_types), p_key);
      args_str = _kai_str_concat(
          args_str,
          Codegen_gen_expr_with_expected_type(
              self, ArrayList_Int_get(&(expr.meth_args), ai), expected_type));
      ai = (ai + 1);
    }
    if ((strcmp(method_name, "init") == 0) && (!is_constructor)) {
      ...
      if (((rec_inferred)[0] == ((char)(42))) ||
        ...
        return _kai_str_concat(
            _kai_str_concat(
                _kai_str_concat(
                    _kai_str_concat(
                        _kai_str_concat(_kai_str_concat("*(", rec_val), ") = "),
                        func_name),
                    "("),
                args_str),
            ")");
      ...
      return _kai_str_concat(
          _kai_str_concat(
              _kai_str_concat(
                  _kai_str_concat(_kai_str_concat(rec_val, " = "), func_name),
                  "("),
              args_str),
          ")");
    }
    return _kai_str_concat(
        _kai_str_concat(_kai_str_concat(func_name, "("), args_str), ")");
  }
  if (expr.kind == ExprKind_ek_catch) {
    ...
    if ((strlen(inner_ty) > 0) && ((inner_ty)[0] == ((char)(63)))) {
      ...
      if (expr.catch_fallback >= 0) {
        StmtNode fb_node =
            ArrayList_StmtNode_get(self->stmt_pool, expr.catch_fallback);
        if (fb_node.kind == StmtKind_sk_expr) {
          ...
          fallback_code = _kai_str_concat(
              _kai_str_concat("(", Codegen_gen_stmt(self, expr.catch_fallback)),
              ")");
        } else {
      ...
      if (Codegen_is_pointer_type(self, val_type)) {
        catch_code = _kai_str_concat(
            _kai_str_concat(
                _kai_str_concat(_kai_str_concat(catch_code, val_ctype),
                                " _kai_opt = ("),
                inner),
            "); ");
        catch_code = _kai_str_concat(_kai_str_concat(catch_code, val_ctype),
                                     " _kai_cv; ");
        catch_code = _kai_str_concat(
            catch_code, "if (_kai_opt != NULL) { _kai_cv = _kai_opt; } ");
        catch_code = _kai_str_concat(
            _kai_str_concat(_kai_str_concat(catch_code, "else { _kai_cv = ("),
                            fallback_code),
            "); } _kai_cv; })");
      } else {
        catch_code = _kai_str_concat(
            _kai_str_concat(
                _kai_str_concat(_kai_str_concat(catch_code, cond_ctype),
                                " _kai_opt = ("),
                inner),
            "); ");
        catch_code = _kai_str_concat(_kai_str_concat(catch_code, val_ctype),
        ...
        catch_code = _kai_str_concat(
            catch_code,
            "if (_kai_opt.has_value) { _kai_cv = _kai_opt.value; } ");
        catch_code = _kai_str_concat(
            _kai_str_concat(_kai_str_concat(catch_code, "else { _kai_cv = ("),
                            fallback_code),
            "); } _kai_cv; })");
    ...
    const char *catch_code = _kai_str_concat(
        _kai_str_concat(_kai_str_concat(_kai_str_concat("({ ", result_ctype),
                                        " _kai_cr = ("),
                        inner),
        "); ");
    if (strcmp(val_type, "Void") == 0) {
      ...
      if (strlen(expr.catch_var) > 0) {
        catch_code = _kai_str_concat(
            _kai_str_concat(_kai_str_concat(catch_code, "int64_t "),
                            expr.catch_var),
            " = _kai_cr.tag; ");
      }
      catch_code = _kai_str_concat(_kai_str_concat(catch_code, fallback_code),
                                   " } 0; })");
    } else {
      catch_code =
          _kai_str_concat(_kai_str_concat(catch_code, val_ctype), " _kai_cv; ");
      catch_code = _kai_str_concat(catch_code, "if (_kai_cr.tag != 0) { ");
      if (strlen(expr.catch_var) > 0) {
        catch_code = _kai_str_concat(
            _kai_str_concat(_kai_str_concat(catch_code, "int64_t "),
      ...
      catch_code = _kai_str_concat(
          _kai_str_concat(_kai_str_concat(catch_code, "_kai_cv = ("),
                          fallback_code),
          "); ");
      catch_code = _kai_str_concat(
          catch_code, "} else { _kai_cv = _kai_cr.value; } _kai_cv; })");
    }
    return catch_code;
  }
  return "0";
...
const char *Codegen_gen_stmt(Codegen *self, int64_t stmt_idx) {
  ...
  if (stmt.kind == StmtKind_sk_block) {
    ...
    ArrayList_Int_push(&(self->defer_depths),
                       ArrayList_Int_length(&(self->defer_stack)));
    const char *block_str = "{\n";
    int64_t i = 0;
    while (i < ArrayList_Int_length(&(stmt.block_stmts))) {
      const char *s =
          Codegen_gen_stmt(self, ArrayList_Int_get(&(stmt.block_stmts), i));
      if (strlen(s) > 0) {
        block_str = _kai_str_concat(
            _kai_str_concat(_kai_str_concat(block_str, "    "), s), "\n");
      }
      i = (i + 1);
    }
    ...
    while (di < ArrayList_DropVarEntry_length(&(stmt.block_drop_vars))) {
      DropVarEntry entry =
          ArrayList_DropVarEntry_get(&(stmt.block_drop_vars), di);
      block_str = _kai_str_concat(
          _kai_str_concat(
              _kai_str_concat(
                  _kai_str_concat(_kai_str_concat(block_str, "    "),
                                  entry.base_type),
                  "_drop(&"),
              entry.name),
          ");\n");
  ...
  if (stmt.kind == StmtKind_sk_var_decl) {
    ...
    const char *init_val = Codegen_gen_expr_with_expected_type(
        self, stmt.vardecl_value, var_type_name);
    if (strcmp(name, "_") == 0) {
    ...
    return _kai_str_concat(
        _kai_str_concat(
            _kai_str_concat(
                _kai_str_concat(_kai_str_concat(var_type, " "), name), " = "),
            init_val),
        ";");
  }
  if (stmt.kind == StmtKind_sk_assignment) {
    ...
    const char *rhs =
        Codegen_gen_expr_with_expected_type(self, stmt.assign_value, lhs_type);
    const char *op = "=";
    ...
    return _kai_str_concat(
        _kai_str_concat(
            _kai_str_concat(_kai_str_concat(_kai_str_concat(lhs, " "), op),
                            " "),
            rhs),
        ";");
  }
  if (stmt.kind == StmtKind_sk_func_decl) {
    if (ArrayList_Str_length(&(stmt.func_type_params)) > 0) {
      type_map_put(&(self->generic_func_decls), stmt.func_name,
                   int_to_str(stmt_idx));
      return "";
    }
    ...
    while (i < ArrayList_Param_length(&(stmt.func_params))) {
      ...
      params_str = _kai_str_concat(
          _kai_str_concat(
              _kai_str_concat(params_str, Codegen_map_type(self, p.ptype)),
              " "),
          p.name);
      i = (i + 1);
    }
    ...
    if (strcmp(name, "main") == 0) {
      ...
      proto = _kai_str_concat(
          _kai_str_concat(
              _kai_str_concat(
                  _kai_str_concat(_kai_str_concat(ret_type, " "), name), "("),
              params_str),
          ");\n");
      impl_str = _kai_str_concat(
          _kai_str_concat(
              _kai_str_concat(
                  _kai_str_concat(
                      _kai_str_concat(
  ...
  if (stmt.kind == StmtKind_sk_struct_decl) {
    if (ArrayList_Str_length(&(stmt.struct_type_params)) > 0) {
      type_map_put(&(self->generic_struct_decls), stmt.struct_name,
                   int_to_str(stmt_idx));
      return "";
    }
    ...
    const char *struct_str = _kai_str_concat(
        _kai_str_concat(
            _kai_str_concat(_kai_str_concat("typedef struct ", name), " "),
            name),
        ";\n");
    struct_str = _kai_str_concat(
        _kai_str_concat(_kai_str_concat(struct_str, "struct "), name), " {\n");
    int64_t i = 0;
    while (i < ArrayList_StructField_length(&(stmt.struct_fields))) {
      StructField f = ArrayList_StructField_get(&(stmt.struct_fields), i);
      struct_str = _kai_str_concat(
          _kai_str_concat(
              _kai_str_concat(
                  _kai_str_concat(_kai_str_concat(struct_str, "    "),
                                  Codegen_map_type(self, f.ftype)),
                  " "),
              f.name),
          ";\n");
      i = (i + 1);
  ...
  if (stmt.kind == StmtKind_sk_trait_decl) {
    ...
    while (mi < ArrayList_Int_length(&(stmt.trait_methods))) {
      StmtNode m_node = ArrayList_StmtNode_get(
          self->stmt_pool, ArrayList_Int_get(&(stmt.trait_methods), mi));
      if (mi > 0) {
    ...
    const char *comment = _kai_str_concat(
        _kai_str_concat(
            _kai_str_concat(_kai_str_concat("/* trait ", stmt.trait_name),
                            ": "),
            method_names),
        " */\n");
  ...
  if (stmt.kind == StmtKind_sk_error_decl) {
    ...
    while (j < ArrayList_Str_length(&(stmt.error_variants))) {
      ...
      enum_str = _kai_str_concat(
          _kai_str_concat(
              _kai_str_concat(
                  _kai_str_concat(
                      _kai_str_concat(
                          _kai_str_concat(_kai_str_concat(enum_str, "    "),
                                          name),
                          "_"),
                      vname),
                  " = "),
    ...
    enum_str = _kai_str_concat(
        _kai_str_concat(_kai_str_concat(enum_str, "} "), name), ";\n");
  ...
  if (stmt.kind == StmtKind_sk_enum_decl) {
    ...
    if (ArrayList_Str_length(&(stmt.enum_type_params)) > 0) {
      type_map_put(&(self->generic_enum_decls), stmt.enum_name,
                   int_to_str(stmt_idx));
      return "";
    }
    ...
    if (!has_payload) {
      ...
      enum_str = _kai_str_concat(
          _kai_str_concat(_kai_str_concat(enum_str, "} "), tags_name), ";\n");
      enum_str = _kai_str_concat(
          _kai_str_concat(
              _kai_str_concat(
                  _kai_str_concat(_kai_str_concat(enum_str, "typedef struct "),
                                  name),
                  " "),
              name),
          ";\n");
      enum_str = _kai_str_concat(
          _kai_str_concat(_kai_str_concat(enum_str, "struct "), name), " {\n");
      ...
      while (k < ArrayList_Variant_length(&(stmt.enum_variants))) {
        ...
        if (ArrayList_Param_length(&(v.params)) > 0) {
          ...
          enum_str = _kai_str_concat(
              _kai_str_concat(_kai_str_concat(enum_str, "        } "), v.vname),
              ";\n");
        }
        k = (k + 1);
      }
  ...
  if (stmt.kind == StmtKind_sk_impl_block) {
    const char *struct_name = stmt.impl_struct_name;
    bool has_generic_struct =
        ((strlen(type_map_get(&(self->generic_struct_decls), struct_name)) >
          0) ||
         (strlen(type_map_get(&(self->generic_enum_decls), struct_name)) > 0));
    if (has_generic_struct ||
        Codegen_str_contains(self, struct_name, ((char)(60)))) {
      type_map_put(&(self->generic_impl_blocks), struct_name,
                   int_to_str(stmt_idx));
      return "";
    }
    ...
    while (idx < ArrayList_Int_length(&(stmt.impl_methods))) {
      ...
      StmtNode method_node =
          ArrayList_StmtNode_get(self->stmt_pool, method_stmt_idx);
      const char *method_name = method_node.func_name;
      bool is_init =
          ((((strcmp(method_name, "init") == 0) ||
             (strcmp(method_node.func_return_type, struct_name) == 0)) ||
            (strcmp(method_node.func_return_type,
                    _kai_str_concat("*", struct_name)) == 0)) ||
           (strcmp(method_node.func_return_type,
                   _kai_str_concat("&", struct_name)) == 0));
      const char *ret_type = "";
      if (is_init) {
      ...
      const char *mangled_fn_name = _kai_str_concat(
          _kai_str_concat(mapped_struct_name, "_"), method_name);
      const char *old_fn = self->cur_func_name;
      const char *old_ret = self->cur_return_type;
      bool old_init = self->cur_method_is_init;
      self->cur_func_name = mangled_fn_name;
      ...
      if (is_init) {
        const char *self_decl = _kai_str_concat(
            _kai_str_concat(
                _kai_str_concat(_kai_str_concat("    ", mapped_struct_name),
                                " self = ("),
                mapped_struct_name),
            "){0};\n");
        const char *self_ret = "    return self;\n}";
  ...
  if (stmt.kind == StmtKind_sk_if) {
    ...
    const char *cond_str = "";
    if (((strlen(cond_val) > 1) && ((cond_val)[0] == ((char)(40)))) &&
        ((cond_val)[(strlen(cond_val) - 1)] == ((char)(41)))) {
      cond_str = cond_val;
    } else {
      cond_str = _kai_str_concat(_kai_str_concat("(", cond_val), ")");
    }
    const char *if_str =
        _kai_str_concat(_kai_str_concat(_kai_str_concat("if ", cond_str), " "),
                        Codegen_gen_stmt(self, stmt.if_then));
    if (stmt.if_else >= 0) {
      StmtNode else_node =
          ArrayList_StmtNode_get(self->stmt_pool, stmt.if_else);
      if ((else_node.kind == StmtKind_sk_block) &&
          (ArrayList_Int_length(&(else_node.block_stmts)) == 1)) {
        int64_t single_stmt_idx =
            ArrayList_Int_get(&(else_node.block_stmts), 0);
        StmtNode single_stmt =
            ArrayList_StmtNode_get(self->stmt_pool, single_stmt_idx);
        if (single_stmt.kind == StmtKind_sk_if) {
          if_str = _kai_str_concat(_kai_str_concat(if_str, " else "),
                                   Codegen_gen_stmt(self, single_stmt_idx));
        } else {
          if_str = _kai_str_concat(_kai_str_concat(if_str, " else "),
                                   Codegen_gen_stmt(self, stmt.if_else));
        }
      } else {
        if_str = _kai_str_concat(_kai_str_concat(if_str, " else "),
                                 Codegen_gen_stmt(self, stmt.if_else));
  ...
  if (stmt.kind == StmtKind_sk_if_let) {
    ...
    if (stmt.iflet_else >= 0) {
      StmtNode else_node =
          ArrayList_StmtNode_get(self->stmt_pool, stmt.iflet_else);
      if ((else_node.kind == StmtKind_sk_block) &&
          (ArrayList_Int_length(&(else_node.block_stmts)) == 1)) {
        int64_t single_stmt_idx =
            ArrayList_Int_get(&(else_node.block_stmts), 0);
        ...
        if (single_stmt.kind == StmtKind_sk_if_let) {
          else_str = _kai_str_concat(" else ",
                                     Codegen_gen_stmt(self, single_stmt_idx));
        } else {
          else_str = _kai_str_concat(" else ",
                                     Codegen_gen_stmt(self, stmt.iflet_else));
        }
      } else {
        else_str =
            _kai_str_concat(" else ", Codegen_gen_stmt(self, stmt.iflet_else));
      }
    }
    while (ArrayList_StrMapEntry_length(&(self->var_types)) > old_var_len) {
      (void)(ArrayList_StrMapEntry_pop(&(self->var_types)));
    ...
    if (Codegen_is_pointer_type(self, unwrapped_type)) {
      if_code =
          _kai_str_concat(_kai_str_concat("if ((", cond_val), ") != NULL) {\n");
      if_code = _kai_str_concat(
          _kai_str_concat(
              _kai_str_concat(
                  _kai_str_concat(
                      _kai_str_concat(
                          _kai_str_concat(_kai_str_concat(if_code, "    "),
                                          unwrapped_ctype),
                          " "),
                      stmt.iflet_var),
                  " = "),
          ...
          ";\n");
      if_code = _kai_str_concat(
          _kai_str_concat(_kai_str_concat(if_code, "    "), then_str), "\n");
      ...
      if_code = _kai_str_concat(
          _kai_str_concat(
              _kai_str_concat(
                  _kai_str_concat(_kai_str_concat(if_code, "    "), cond_ctype),
                  " _kai_opt = "),
              cond_val),
          ";\n");
      ...
      if_code = _kai_str_concat(
          ...
          "\n");
      if_code = _kai_str_concat(
          _kai_str_concat(_kai_str_concat(if_code, "    }"), else_str), "\n");
  ...
  if (stmt.kind == StmtKind_sk_while) {
    ...
    if (stmt.while_body >= 0) {
      StmtNode body_stmt =
          ArrayList_StmtNode_get(self->stmt_pool, stmt.while_body);
      body_stmt.block_is_loop_body = true;
      ArrayList_StmtNode_set(self->stmt_pool, stmt.while_body, body_stmt);
    }
    return _kai_str_concat(
        _kai_str_concat(_kai_str_concat("while ", cond_str), " "),
        Codegen_gen_stmt(self, stmt.while_body));
  }
  if (stmt.kind == StmtKind_sk_for) {
    ...
    if (stmt.for_body >= 0) {
      StmtNode body_stmt =
          ArrayList_StmtNode_get(self->stmt_pool, stmt.for_body);
      body_stmt.block_is_loop_body = true;
    ...
    const char *for_str = _kai_str_concat(
        _kai_str_concat(
            _kai_str_concat(_kai_str_concat("for (int64_t ", iter_var), " = "),
            start),
        "; ");
    for_str = _kai_str_concat(
        _kai_str_concat(
            _kai_str_concat(
                _kai_str_concat(
                    _kai_str_concat(
  ...
  if (stmt.kind == StmtKind_sk_return) {
    ...
    while (bi >= 0) {
      ...
      while (di < ArrayList_DropVarEntry_length(&(b_node.block_drop_vars))) {
        DropVarEntry entry =
            ArrayList_DropVarEntry_get(&(b_node.block_drop_vars), di);
        ArrayList_Str_push(
            &(drop_calls),
            _kai_str_concat(
                _kai_str_concat(_kai_str_concat(entry.base_type, "_drop(&"),
                                entry.name),
                ");"));
        di = (di + 1);
      }
    ...
    if (ArrayList_Str_length(&(drop_calls)) == 0) {
      if (stmt.return_value >= 0) {
        int64_t ret_excl_pos =
            Codegen_str_find(self, self->cur_return_type, ((char)(33)));
        if (ret_excl_pos >= 0) {
          const char *result_ctype =
              Codegen_map_type(self, self->cur_return_type);
          const char *val_payload_type =
              substring(self->cur_return_type, 0, ret_excl_pos);
          const char *err_type =
              substring(self->cur_return_type, (ret_excl_pos + 1),
                        strlen(self->cur_return_type));
          ExprNode ret_node =
              ArrayList_ExprNode_get(self->expr_pool, stmt.return_value);
          bool is_error_variant = false;
          if (ret_node.kind == ExprKind_ek_field_access) {
            ExprNode base_node =
                ArrayList_ExprNode_get(self->expr_pool, ret_node.field_expr);
            if (base_node.kind == ExprKind_ek_identifier) {
          ...
          if (is_error_variant) {
            return _kai_str_concat(
                _kai_str_concat(
                    _kai_str_concat(_kai_str_concat("return (", result_ctype),
                                    "){ .tag = "),
                    val_str),
                " };");
          }
          if (strcmp(val_payload_type, "Void") == 0) {
            return _kai_str_concat(_kai_str_concat("return (", result_ctype),
                                   "){ .tag = 0 };");
          }
          return _kai_str_concat(
              _kai_str_concat(
        ...
        return _kai_str_concat(
            _kai_str_concat(
                "return ", Codegen_gen_expr_with_expected_type(
                               self, stmt.return_value, self->cur_return_type)),
            ";");
      }
      return "return;";
    }
    if (stmt.return_value >= 0) {
      const char *val_str = Codegen_gen_expr_with_expected_type(
          self, stmt.return_value, self->cur_return_type);
      const char *val_type = Codegen_get_expr_type(self, stmt.return_value);
      if ((strcmp(val_type, "Void") == 0) ||
          (strcmp(val_type, "NoneType") == 0)) {
        const char *res = _kai_str_concat(val_str, "; ");
        int64_t ci = 0;
        while (ci < ArrayList_Str_length(&(drop_calls))) {
          res = _kai_str_concat(
              _kai_str_concat(res, ArrayList_Str_get(&(drop_calls), ci)), " ");
          ci = (ci + 1);
        }
      ...
      if (ret_excl_pos >= 0) {
        ...
        if (expr_excl_pos >= 0) {
          ...
          ret_expr = _kai_str_concat(
              _kai_str_concat(_kai_str_concat(_kai_str_concat("(", mapped_type),
                                              "){ .tag = "),
                              raw_val),
              " }");
        } else if (strcmp(val_payload_type, "Void") == 0) {
          ret_expr = _kai_str_concat(_kai_str_concat("(", mapped_type),
                                     "){ .tag = 0 }");
        } else {
          ret_expr = _kai_str_concat(
              _kai_str_concat(_kai_str_concat(_kai_str_concat("(", mapped_type),
        ...
        const char *res_str = "{\n";
        res_str = _kai_str_concat(
            _kai_str_concat(
                _kai_str_concat(
                    _kai_str_concat(_kai_str_concat(res_str, "    "),
                                    mapped_type),
                    " __ret_val = "),
                ret_expr),
            ";\n");
        ...
        while (ci < ArrayList_Str_length(&(drop_calls))) {
          res_str = _kai_str_concat(
              _kai_str_concat(_kai_str_concat(res_str, "    "),
                              ArrayList_Str_get(&(drop_calls), ci)),
              "\n");
          ci = (ci + 1);
        }
      ...
      res_str = _kai_str_concat(
          _kai_str_concat(
              _kai_str_concat(_kai_str_concat(_kai_str_concat(res_str, "    "),
                                              mapped_type),
                              " __ret_val = "),
              val_str),
          ";\n");
  ...
  if (stmt.kind == StmtKind_sk_extern) {
    ...
    const char *proto = _kai_str_concat(
        _kai_str_concat(
            _kai_str_concat(
                _kai_str_concat(
                    _kai_str_concat(_kai_str_concat("extern ", ret_type), " "),
                    name),
                "("),
            params_str),
        ");\n");
  ...
  if (stmt.kind == StmtKind_sk_import) {
    ...
    const char *source = "";
    if ((ArrayList_Str_length(&(path)) > 0) &&
        (strcmp(ArrayList_Str_get(&(path), 0), "std") == 0)) {
      const char *path_str = "";
      int64_t i = 0;
      ...
      } else if (res1.tag == Result_Str_Int_err_TAG) {
        {
          ...
          if (get_exe_dir(buf, 1024) == 0) {
            ...
            const char *full_path =
                _kai_str_concat(_kai_str_concat(exe_dir, "/"), rel_path);
            const char *parent_path =
                _kai_str_concat(_kai_str_concat(exe_dir, "/../"), rel_path);
            const char *lib_path = _kai_str_concat(
                _kai_str_concat(exe_dir, "/../lib/kai/"), rel_path);
            ...
            if (res2.tag == Result_Str_Int_ok_TAG) {
              ...
              Result_Str_Int res3 =
                  read_to_string(self->allocator, parent_path);
      ...
      const char *file_path =
          _kai_str_concat(_kai_str_concat("src/", module_key), ".kai");
    ...
    if (has_source) {
      ...
      Parser parser =
          Parser_init_with_pools(self->allocator, lexer.tokens, self->expr_pool,
                                 self->stmt_pool, self->pattern_pool);
  ...
  if (stmt.kind == StmtKind_sk_match) {
    ...
    bool is_self_ptr = (((expr_node.kind == ExprKind_ek_identifier) &&
                         (strcmp(expr_node.ident_name, "self") == 0)) &&
                        (!self->cur_method_is_init));
    bool is_ptr = false;
    if ((((expr_type)[0] == ((char)(42))) ||
         ((expr_type)[0] == ((char)(38)))) ||
        is_self_ptr) {
      is_ptr = true;
    }
    ...
    while (case_idx < ArrayList_MatchCase_length(&(stmt.match_cases))) {
      MatchCase case_node =
          ArrayList_MatchCase_get(&(stmt.match_cases), case_idx);
      PatternNode pat_node =
          ArrayList_PatternNode_get(self->pattern_pool, case_node.pattern);
      ...
      if (pat_node.kind == PatternKind_pk_literal) {
        ...
        if (pat_node.lit_value.tag == TokenValue_tv_int_TAG) {
          ...
          if (v == ((char)(10))) {
            ...
            lit_str =
                _kai_str_concat(_kai_str_concat("'", char_to_str(v)), "'");
          }
        } else {
          lit_str = "0";
        }
        ...
        if ((strlen(base_type) > 0) &&
            (((base_type)[(strlen(base_type) - 1)] == ((char)(42))) ||
             ((base_type)[(strlen(base_type) - 1)] == ((char)(38))))) {
        ...
        if (Codegen_enum_has_payload(self, expr_type)) {
          cond = _kai_str_concat(
              _kai_str_concat(
                  _kai_str_concat(
                      _kai_str_concat(
                          _kai_str_concat(_kai_str_concat(expr_val, op),
                                          "tag == "),
                          base_type),
                      "_"),
                  var_name),
          ...
          cond = _kai_str_concat(
              _kai_str_concat(
                  _kai_str_concat(_kai_str_concat(expr_val, " == "), base_type),
                  "_"),
              var_name);
        }
      ...
      if (strlen(bindings_str) > 0) {
        ...
        full_block = _kai_str_concat(_kai_str_concat("{\n", bindings_str),
                                     substring(block_str, 1, body_len));
      }
      match_str = _kai_str_concat(
          _kai_str_concat(
              _kai_str_concat(_kai_str_concat(match_str, prefix), " "),
              full_block),
          " ");
      case_idx = (case_idx + 1);
    }
...
const char *Codegen_clean_enum_name(Codegen *self, const char *type_name) {
  ...
  bool done = false;
  while (!done) {
    if ((strlen(base_name) > 0) && (((base_name)[0] == ((char)(42))) ||
                                    ((base_name)[0] == ((char)(38))))) {
  ...
  while (!done) {
    ...
    if ((l > 0) && (((base_name)[(l - 1)] == ((char)(42))) ||
                    ((base_name)[(l - 1)] == ((char)(38))))) {
...
bool Codegen_enum_has_payload(Codegen *self, const char *enum_name) {
  ...
  StmtNode enum_stmt = ArrayList_StmtNode_get(
      self->stmt_pool, Codegen_str_to_int(self, idx_str));
...
const char *Codegen_generate(Codegen *self, int64_t top_stmt_idx) {
  ...
  final_code = _kai_str_concat(final_code, "#include <limits.h>\n");
  final_code = _kai_str_concat(final_code, "#endif\n\n");
  final_code = _kai_str_concat(
      final_code, "int64_t get_exe_dir(char* out_buf, int64_t max_len) {\n");
  final_code = _kai_str_concat(final_code, "#if defined(_WIN32)\n");
  final_code = _kai_str_concat(
      final_code,
      "    DWORD len = GetModuleFileNameA(NULL, out_buf, max_len);\n");
  final_code = _kai_str_concat(
      final_code, "    if (len == 0 || len >= max_len) return -1;\n");
  final_code =
      _kai_str_concat(final_code, "    for (int i = len - 1; i >= 0; i--) {\n");
  final_code = _kai_str_concat(
      final_code, "        if (out_buf[i] == '\\\\' || out_buf[i] == '/') {\n");
  ...
  final_code =
      _kai_str_concat(final_code, "    uint32_t size = sizeof(path);\n");
  final_code = _kai_str_concat(
      final_code,
      "    if (_NSGetExecutablePath(path, &size) != 0) return -1;\n");
  final_code = _kai_str_concat(final_code, "    char real_path[PATH_MAX];\n");
  final_code = _kai_str_concat(
      final_code, "    if (realpath(path, real_path) == NULL) return -1;\n");
  final_code = _kai_str_concat(
      final_code, "    char* last_slash = strrchr(real_path, '/');\n");
  final_code =
      _kai_str_concat(final_code, "    if (last_slash == NULL) return -1;\n");
  final_code = _kai_str_concat(final_code, "    *last_slash = '\\0';\n");
  final_code = _kai_str_concat(final_code,
                               "    strncpy(out_buf, real_path, max_len);\n");
  final_code =
      _kai_str_concat(final_code, "    out_buf[max_len - 1] = '\\0';\n");
  final_code = _kai_str_concat(final_code, "    return 0;\n");
  final_code = _kai_str_concat(final_code, "#else\n");
  final_code = _kai_str_concat(final_code, "    char path[PATH_MAX];\n");
  final_code = _kai_str_concat(final_code,
  ...
  while (ci < ArrayList_Str_length(&(self->cimport_headers))) {
    ...
    if (!is_baseline) {
      ...
      if ((!has_slash) && (!dot_start)) {
        final_code = _kai_str_concat(
            _kai_str_concat(_kai_str_concat(final_code, "#include <"), hdr),
            ">\n");
      } else {
        final_code = _kai_str_concat(
            _kai_str_concat(_kai_str_concat(final_code, "#include \""), hdr),
  ...
  final_code = _kai_str_concat(final_code, "\n");
  final_code =
      _kai_str_concat(final_code, "static inline void print_int(int64_t i) { "
                                  "printf(\"%lld\\n\", (long long)i); }\n");
  final_code = _kai_str_concat(
      final_code, "__thread void* _kai_current_allocator = NULL;\n");
  final_code = _kai_str_concat(
      final_code, "void _kai_set_current_allocator(void* allocator);\n");
  final_code = _kai_str_concat(
      final_code, "char* _kai_str_concat(const char* l, const char* r);\n\n");
  final_code = _kai_str_concat(
      _kai_str_concat(final_code, StringBuilder_to_str(&(self->struct_decls))),
      "\n");
  final_code = _kai_str_concat(
      _kai_str_concat(final_code, StringBuilder_to_str(&(self->func_decls))),
      "\n");
  final_code = _kai_str_concat(
      final_code, "void _kai_set_current_allocator(void* allocator) {\n");
  final_code =
      _kai_str_concat(final_code, "    _kai_current_allocator = allocator;\n");
  final_code = _kai_str_concat(final_code, "}\n");
  final_code = _kai_str_concat(
      final_code, "char* _kai_str_concat(const char* l, const char* r) {\n");
  ...
  final_code =
      _kai_str_concat(final_code, "    if (_kai_current_allocator) {\n");
  final_code = _kai_str_concat(
      final_code,
      "        buf = KaiAllocator_alloc((KaiAllocator*)_kai_current_allocator, "
      "total, 1);\n");
  final_code = _kai_str_concat(final_code, "    } else {\n");
  final_code = _kai_str_concat(final_code, "        buf = malloc(total);\n");
  final_code = _kai_str_concat(final_code, "    }\n");
  final_code = _kai_str_concat(
      final_code, "    if (buf) { strcpy(buf, l); strcat(buf, r); }\n");
  final_code = _kai_str_concat(final_code, "    return buf;\n");
  final_code = _kai_str_concat(final_code, "}\n\n");
  final_code =
      _kai_str_concat(final_code, StringBuilder_to_str(&(self->output)));
  return final_code;
}
bool fs_exists(const char *path) {
  {
...
void *LLVMCodegen_map_type(LLVMCodegen *self, const char *ktype) {
  printf("%s\n",
         _kai_str_concat(_kai_str_concat("LLVM: Mapping type: ", ktype), "\n"));
  if (strlen(ktype) == 0) {
    return LLVMVoidTypeInContext(self->ctx);
  }
  if ((strlen(ktype) > 0) && ((ktype)[0] == ((char)(63)))) {
    ...
    type_map_put(&(self->struct_types), concrete_name,
                 int_to_str((int64_t)(opt_ty)));
  ...
  if (LLVMCodegen_str_contains(self, ktype, ((char)(33)))) {
    ...
    type_map_put(&(self->struct_types), concrete_name,
                 int_to_str((int64_t)(res_ty)));
    if (strcmp(val_type, "Void") == 0) {
      void **types = (void **)(KaiAllocator_alloc(self->allocator, 8, 8));
  ...
  if ((strlen(ktype) > 0) && ((ktype)[0] == ((char)(42)))) {
  ...
  const char *clean_base = clean_t;
  int64_t lt_pos = LLVMCodegen_str_find(self, clean_t, ((char)(60)));
  if (lt_pos >= 0) {
    clean_base = substring(clean_t, 0, lt_pos);
  }
  ...
  if (strlen(s_ty_str) > 0) {
    ...
    if (((ktype)[0] == ((char)(42))) || ((ktype)[0] == ((char)(38)))) {
      return LLVMPointerType(s_ty, 0);
    }
    return s_ty;
  }
  ...
  if (strlen(e_ty_str) > 0) {
    ...
    if (LLVMCodegen_enum_has_payload(self, clean_base)) {
      return LLVMPointerType(e_ty, 0);
    }
    return LLVMInt64TypeInContext(self->ctx);
  }
  return LLVMInt64TypeInContext(self->ctx);
...
void *LLVMCodegen_get_or_declare_func(LLVMCodegen *self, const char *fname,
  ...
  void **param_types =
      (void **)(KaiAllocator_alloc(self->allocator, (param_count * 8), 8));
  if (param_count > 0) {
  ...
  void *fn_ty =
      LLVMFunctionType(ret_ll, (void *)(param_types), param_count, false);
...
void *LLVMCodegen_get_malloc(LLVMCodegen *self) {
  return LLVMCodegen_get_or_declare_func(self, "malloc", "*Void", "Int", "", "",
                                         1);
}
void *LLVMCodegen_get_memset(LLVMCodegen *self) {
  return LLVMCodegen_get_or_declare_func(self, "memset", "*Void", "*Void",
                                         "Int", "Int", 3);
}
void *LLVMCodegen_get_memcpy(LLVMCodegen *self) {
  return LLVMCodegen_get_or_declare_func(self, "memcpy", "*Void", "*Void",
                                         "*Void", "Int", 3);
}
void *LLVMCodegen_get_strlen(LLVMCodegen *self) {
  return LLVMCodegen_get_or_declare_func(self, "strlen", "Int", "Str", "", "",
                                         1);
}
void *LLVMCodegen_get_strcpy(LLVMCodegen *self) {
  return LLVMCodegen_get_or_declare_func(self, "strcpy", "Str", "Str", "Str",
                                         "", 2);
}
void *LLVMCodegen_get_strcat(LLVMCodegen *self) {
  return LLVMCodegen_get_or_declare_func(self, "strcat", "Str", "Str", "Str",
                                         "", 2);
}
void *LLVMCodegen_get_strcmp(LLVMCodegen *self) {
  return LLVMCodegen_get_or_declare_func(self, "strcmp", "Int", "Str", "Str",
                                         "", 2);
}
void *LLVMCodegen_get_or_declare_printf(LLVMCodegen *self) {
...
void LLVMCodegen_emit_str_concat_helper(LLVMCodegen *self) {
  ...
  void *la = LLVMBuildCall2(helper_builder,
                            LLVMFunctionType(LLVMInt64TypeInContext(self->ctx),
                                             (void *)(&(ret_type)), 1, false),
                            strlen_func, (void *)(&(a)), 1, "la");
  void *lb = LLVMBuildCall2(helper_builder,
                            LLVMFunctionType(LLVMInt64TypeInContext(self->ctx),
                                             (void *)(&(ret_type)), 1, false),
                            strlen_func, (void *)(&(b)), 1, "lb");
  void *total = LLVMBuildAdd(helper_builder, la, lb, "total");
  void *sz = LLVMBuildAdd(
      helper_builder, total,
      LLVMConstInt(LLVMInt64TypeInContext(self->ctx), 1, false), "sz");
  void *malloc_func = LLVMCodegen_get_malloc(self);
  void *malloc_param_ty = LLVMInt64TypeInContext(self->ctx);
  void *buf = LLVMBuildCall2(
      helper_builder,
      LLVMFunctionType(ret_type, (void *)(&(malloc_param_ty)), 1, false),
      malloc_func, (void *)(&(sz)), 1, "buf");
  ...
  (void)(LLVMBuildCall2(helper_builder, strcpy_ty, strcpy_func,
                        (void *)(cpy_params), 2, "discard"));
  void *strcat_func = LLVMCodegen_get_strcat(self);
  (cpy_params)[1] = b;
  (void)(LLVMBuildCall2(helper_builder, strcpy_ty, strcat_func,
                        (void *)(cpy_params), 2, "discard2"));
...
void LLVMCodegen_register_all_decls(LLVMCodegen *self) {
  ...
  while (idx < ArrayList_StmtNode_length(self->stmt_pool)) {
    ...
    if (stmt.kind == StmtKind_sk_struct_decl) {
      printf("%s\n",
             _kai_str_concat(_kai_str_concat("LLVM: Registering struct: ",
                                             stmt.struct_name),
                             "\n"));
      const char *existing =
          type_map_get(&(self->struct_types), stmt.struct_name);
      if (strlen(existing) == 0) {
        void *s_ty = LLVMStructCreateNamed(self->ctx, stmt.struct_name);
        type_map_put(&(self->struct_types), stmt.struct_name,
                     int_to_str((int64_t)(s_ty)));
        int64_t f_idx = 0;
        while (f_idx < ArrayList_StructField_length(&(stmt.struct_fields))) {
          StructField f =
              ArrayList_StructField_get(&(stmt.struct_fields), f_idx);
          const char *key =
              _kai_str_concat(_kai_str_concat(stmt.struct_name, "."), f.name);
    ...
    if (stmt.kind == StmtKind_sk_enum_decl) {
      ...
      if (strlen(existing) == 0) {
        void *e_ty = LLVMStructCreateNamed(self->ctx, stmt.enum_name);
        type_map_put(&(self->enum_types), stmt.enum_name,
                     int_to_str((int64_t)(e_ty)));
        ...
        while (v_idx < ArrayList_Variant_length(&(stmt.enum_variants))) {
          ...
          const char *tag_key = _kai_str_concat(
              _kai_str_concat(_kai_str_concat(stmt.enum_name, "_"), v.vname),
              "_TAG");
          const char *tag_key2 =
              _kai_str_concat(_kai_str_concat(stmt.enum_name, "."), v.vname);
    ...
    if (stmt.kind == StmtKind_sk_error_decl) {
      ...
      if (strlen(existing) == 0) {
        void *e_ty = LLVMStructCreateNamed(self->ctx, stmt.error_name);
        type_map_put(&(self->enum_types), stmt.error_name,
                     int_to_str((int64_t)(e_ty)));
        ...
        while (v_idx < ArrayList_Str_length(&(stmt.error_variants))) {
          ...
          const char *tag_key = _kai_str_concat(
              _kai_str_concat(_kai_str_concat(stmt.error_name, "_"), v_name),
              "_TAG");
          const char *tag_key2 =
              _kai_str_concat(_kai_str_concat(stmt.error_name, "."), v_name);
          type_map_put(&(self->enum_decls), tag_key, int_to_str(v_idx));
          type_map_put(&(self->enum_decls), tag_key2, int_to_str(v_idx));
          v_idx = (v_idx + 1);
        }
  ...
  while (idx < ArrayList_StmtNode_length(self->stmt_pool)) {
    ...
    if (stmt.kind == StmtKind_sk_struct_decl) {
      ...
      void **types =
          (void **)(KaiAllocator_alloc(self->allocator, (count * 8), 8));
      int64_t f_idx = 0;
      while (f_idx < count) {
    ...
    if (stmt.kind == StmtKind_sk_error_decl) {
      const char *e_ty_str = type_map_get(&(self->enum_types), stmt.error_name);
      void *e_ty = (void *)(LLVMCodegen_str_to_int(self, e_ty_str));
      void **types = (void **)(KaiAllocator_alloc(self->allocator, 16, 8));
      (types)[0] = LLVMInt8TypeInContext(self->ctx);
      (types)[1] = LLVMInt64TypeInContext(self->ctx);
...
void *LLVMCodegen_register_func_decl(LLVMCodegen *self, int64_t stmt_idx,
  ...
  if (strlen(struct_name) > 0) {
    ...
    if (((strcmp(method_name, "init") == 0) ||
         (strcmp(ret_ktype, struct_name) == 0)) ||
        (strcmp(ret_ktype, _kai_str_concat("*", struct_name)) == 0)) {
  ...
  while (i < ArrayList_Param_length(&(stmt.func_params))) {
    ...
    if (strcmp(p.name, "self") == 0) {
      (param_types)[p_idx] =
          LLVMPointerType(LLVMCodegen_map_type(self, struct_name), 0);
      const char *p_key =
          _kai_str_concat(_kai_str_concat(fname, "_param_"), int_to_str(i));
      type_map_put(&(self->func_param_types), p_key,
                   _kai_str_concat("*", struct_name));
    } else {
...
void LLVMCodegen_register_extern_decl(LLVMCodegen *self, int64_t stmt_idx) {
  ...
  while (i < param_count) {
    ...
    const char *p_key =
        _kai_str_concat(_kai_str_concat(name, "_param_"), int_to_str(i));
    type_map_put(&(self->func_param_types), p_key, p.ptype);
    i = (i + 1);
  }
  void *ret_ll = LLVMCodegen_map_type(self, stmt.extern_return);
  void *fn_ty =
      LLVMFunctionType(ret_ll, (void *)(param_types), param_count, false);
...
void LLVMCodegen_gen_func_body(LLVMCodegen *self, int64_t stmt_idx,
  ...
  while (i < ArrayList_Param_length(&(stmt.func_params))) {
    Param p = ArrayList_Param_get(&(stmt.func_params), i);
    void *param_val = LLVMGetParam(func_val, p_idx);
    if (strcmp(p.name, "self") == 0) {
      void *self_ll =
          LLVMPointerType(LLVMCodegen_map_type(self, struct_name), 0);
      void *addr = LLVMBuildAlloca(self->builder, self_ll, "self.addr");
      LLVMBuildStore(self->builder, param_val, addr);
      LLVMCodegen_sym_store(self, "self", addr,
                            _kai_str_concat("*", struct_name));
    } else {
      void *lltype = LLVMCodegen_map_type(self, p.ptype);
      void *addr = LLVMBuildAlloca(self->builder, lltype,
                                   _kai_str_concat(p.name, ".addr"));
      LLVMBuildStore(self->builder, param_val, addr);
  ...
  if (!self->last_was_term) {
    ...
    if ((strcmp(ret_ktype, "Void") == 0) || (strlen(ret_ktype) == 0)) {
      ...
      void *ret_ll = LLVMCodegen_map_type(self, ret_ktype);
      if (((ret_ktype)[0] == ((char)(42))) ||
          ((ret_ktype)[0] == ((char)(38)))) {
        void *zero_i64 =
            LLVMConstInt(LLVMInt64TypeInContext(self->ctx), 0, false);
        void *null_ptr =
            LLVMBuildBitCast(self->builder, zero_i64, ret_ll, "null_ptr");
...
void LLVMCodegen_gen_stmt(LLVMCodegen *self, int64_t stmt_idx) {
  ...
  if (stmt.kind == StmtKind_sk_var_decl) {
    ...
    void *addr =
        LLVMBuildAlloca(self->builder, lltype, _kai_str_concat(name, ".addr"));
  ...
  if (stmt.kind == StmtKind_sk_assignment) {
    ...
    if (lhs_node.kind == ExprKind_ek_field_access) {
      ExprNode struct_node =
          ArrayList_ExprNode_get(self->expr_pool, lhs_node.field_expr);
      const char *rec_type =
          LLVMCodegen_get_expr_type(self, lhs_node.field_expr);
      const char *base_type = LLVMCodegen_strip_pointers(self, rec_type);
      const char *key =
          _kai_str_concat(_kai_str_concat(base_type, "."), lhs_node.field_name);
      const char *idx_str = type_map_get(&(self->struct_field_indices), key);
      int64_t idx = LLVMCodegen_str_to_int(self, idx_str);
      void *rec_ptr = LLVMCodegen_gen_expr(self, lhs_node.field_expr);
      void *struct_lltype = LLVMCodegen_map_type(self, base_type);
      void *gep = LLVMBuildStructGEP2(self->builder, struct_lltype, rec_ptr,
                                      idx, "field_gep");
    ...
    if (lhs_node.kind == ExprKind_ek_index) {
      ...
      const char *arr_type = LLVMCodegen_get_expr_type(self, lhs_node.idx_expr);
      const char *elem_ktype = "Int";
      if ((strlen(arr_type) > 2) &&
          (strcmp(substring(arr_type, 0, 2), "[]") == 0)) {
        elem_ktype = substring(arr_type, 2, strlen(arr_type));
      }
      void *elem_lltype = LLVMCodegen_map_type(self, elem_ktype);
      void *gep = LLVMBuildGEP2(self->builder, elem_lltype, arr_ptr,
                                (void *)(&(idx_val)), 1, "idx_gep");
      LLVMBuildStore(self->builder, rhs_val, gep);
      return;
    }
    return;
  ...
  if (stmt.kind == StmtKind_sk_if) {
    ...
    void *cond_i1 = LLVMBuildICmp(
        self->builder, 33, cond_val,
        LLVMConstInt(LLVMInt64TypeInContext(self->ctx), 0, false), "cond_i1");
    void *then_bb =
        LLVMAppendBasicBlockInContext(self->ctx, self->cur_func, "then");
    void *else_bb =
        LLVMAppendBasicBlockInContext(self->ctx, self->cur_func, "else");
    void *merge_bb =
        LLVMAppendBasicBlockInContext(self->ctx, self->cur_func, "merge");
  ...
  if (stmt.kind == StmtKind_sk_while) {
    void *cond_bb =
        LLVMAppendBasicBlockInContext(self->ctx, self->cur_func, "loop_cond");
    void *body_bb =
        LLVMAppendBasicBlockInContext(self->ctx, self->cur_func, "loop_body");
    void *end_bb =
        LLVMAppendBasicBlockInContext(self->ctx, self->cur_func, "loop_end");
    ...
    ArrayList_Str_push(&(self->loop_cond_stack),
                       int_to_str((int64_t)(cond_bb)));
    ArrayList_Str_push(&(self->loop_step_stack),
                       int_to_str((int64_t)(cond_bb)));
  ...
  if (stmt.kind == StmtKind_sk_for) {
    ...
    void *var_addr = LLVMBuildAlloca(self->builder, i_ll, loop_var);
    LLVMBuildStore(self->builder, start_val, var_addr);
    LLVMCodegen_sym_store(self, loop_var, var_addr, "Int");
    void *cond_bb =
        LLVMAppendBasicBlockInContext(self->ctx, self->cur_func, "for_cond");
    void *body_bb =
        LLVMAppendBasicBlockInContext(self->ctx, self->cur_func, "for_body");
    void *step_bb =
        LLVMAppendBasicBlockInContext(self->ctx, self->cur_func, "for_step");
    void *end_bb =
        LLVMAppendBasicBlockInContext(self->ctx, self->cur_func, "for_end");
    LLVMBuildBr(self->builder, cond_bb);
    LLVMPositionBuilderAtEnd(self->builder, cond_bb);
    self->last_was_term = false;
    ...
    void *next_val = LLVMBuildAdd(self->builder, val_step,
                                  LLVMConstInt(i_ll, 1, false), "next_val");
  ...
  if (stmt.kind == StmtKind_sk_break) {
    const char *end_bb_str =
        ArrayList_Str_get(&(self->loop_end_stack),
                          (ArrayList_Str_length(&(self->loop_end_stack)) - 1));
  ...
  if (stmt.kind == StmtKind_sk_continue) {
    const char *step_bb_str =
        ArrayList_Str_get(&(self->loop_step_stack),
                          (ArrayList_Str_length(&(self->loop_step_stack)) - 1));
...
void *LLVMCodegen_gen_expr(LLVMCodegen *self, int64_t idx) {
  ...
  if (expr.kind == ExprKind_ek_binary_op) {
    ...
    if ((strcmp(ltype, "Str") == 0) && (strcmp(op, "+") == 0)) {
      ...
      void *res = LLVMBuildCall2(self->builder, fn_ty, concat_func,
                                 (void *)(params), 2, "concat_res");
      KaiAllocator_free(self->allocator, (void *)(params));
      return res;
    }
    if ((strcmp(ltype, "Str") == 0) &&
      ...
      (params)[1] = rv;
      void *str_ptr = LLVMPointerType(LLVMInt8TypeInContext(self->ctx), 0);
      void *fn_ty = LLVMFunctionType(LLVMInt64TypeInContext(self->ctx),
                                     (void *)(params), 2, false);
      void *cmp = LLVMBuildCall2(self->builder, fn_ty, strcmp_func,
                                 (void *)(params), 2, "cmp_res");
      void *res = (void *)(0);
      if (strcmp(op, "==") == 0) {
        res = LLVMBuildICmp(
            self->builder, 32, cmp,
      ...
      void *res_i64 = LLVMBuildZExt(self->builder, res,
                                    LLVMInt64TypeInContext(self->ctx), "zext");
      KaiAllocator_free(self->allocator, (void *)(params));
      return res_i64;
    }
    void *lv = LLVMCodegen_gen_expr(self, expr.binop_left);
    ...
    if (cmp_val != (void *)(0)) {
      return LLVMBuildZExt(self->builder, cmp_val,
                           LLVMInt64TypeInContext(self->ctx), "zext");
    }
    return lv;
  }
  if (expr.kind == ExprKind_ek_unary_op) {
    ...
    if (strcmp(op, "!") == 0) {
      ...
      void *val_i64 = LLVMCodegen_cast_to_i64(
          self, val, LLVMCodegen_get_expr_type(self, expr.unop_operand));
  ...
  if (expr.kind == ExprKind_ek_func_call) {
    ...
    if ((strcmp(fname, "cast") == 0) || (strcmp(fname, "as") == 0)) {
      if ((ArrayList_Str_length(&(expr.func_type_args)) > 0) &&
          (ArrayList_Int_length(&(expr.func_args)) > 0)) {
        return LLVMCodegen_gen_cast(
            self, ArrayList_Int_get(&(expr.func_args), 0),
            ArrayList_Str_get(&(expr.func_type_args), 0));
      }
      return LLVMCodegen_gen_expr(self,
                                  ArrayList_Int_get(&(expr.func_args), 0));
    }
    if ((strcmp(fname, "Char") == 0) || (strcmp(fname, "Int8") == 0)) {
      void *av =
          LLVMCodegen_gen_expr(self, ArrayList_Int_get(&(expr.func_args), 0));
      const char *src_type = LLVMCodegen_get_expr_type(
          self, ArrayList_Int_get(&(expr.func_args), 0));
      if (strcmp(src_type, "Int") == 0) {
        return LLVMBuildTrunc(self->builder, av,
                              LLVMInt8TypeInContext(self->ctx), "trunc");
      }
      return av;
    }
    if (strcmp(fname, "Int") == 0) {
      ...
      if (strcmp(src_type, "Float") == 0) {
        return LLVMBuildFPToSI(self->builder, av,
                               LLVMInt64TypeInContext(self->ctx), "fptosi");
      }
      if ((strcmp(src_type, "Char") == 0) || (strcmp(src_type, "Int8") == 0)) {
        return LLVMBuildSExt(self->builder, av,
                             LLVMInt64TypeInContext(self->ctx), "sext");
      }
      return av;
    }
    if (strcmp(fname, "Float") == 0) {
      ...
      if (strcmp(src_type, "Char") == 0) {
        void *ext = LLVMBuildSExt(self->builder, av,
                                  LLVMInt64TypeInContext(self->ctx), "sext");
    ...
    bool is_upper =
        ((first_char >= ((char)(65))) && (first_char <= ((char)(90))));
    if (is_upper) {
      ...
      void **args =
          (void **)(KaiAllocator_alloc(self->allocator, (arg_count * 8), 8));
      int64_t i = 0;
      while (i < arg_count) {
        (args)[i] =
            LLVMCodegen_gen_expr(self, ArrayList_Int_get(&(expr.func_args), i));
        i = (i + 1);
      }
      ...
      while (i < arg_count) {
        const char *p_key = _kai_str_concat(
            _kai_str_concat(init_name, "_param_"), int_to_str(i));
        const char *p_ktype = type_map_get(&(self->func_param_types), p_key);
        (param_types)[i] = LLVMCodegen_map_type(self, p_ktype);
        i = (i + 1);
      }
      void *fn_ty =
          LLVMFunctionType(ret_ll, (void *)(param_types), arg_count, false);
      void *res = LLVMBuildCall2(self->builder, fn_ty, func, (void *)(args),
                                 arg_count, "init_call");
  ...
  if (expr.kind == ExprKind_ek_method_call) {
    ...
    bool is_enum = ((strlen(base_type) > 0) &&
                    (strlen(type_map_get(&(self->enum_types), base_type)) > 0));
    if (is_enum) {
      void *malloc_func = LLVMCodegen_get_malloc(self);
      void *sz = LLVMConstInt(LLVMInt64TypeInContext(self->ctx), 16, false);
      void *malloc_val = LLVMBuildCall2(
          self->builder,
          LLVMFunctionType(LLVMPointerType(LLVMInt8TypeInContext(self->ctx), 0),
                           (void *)(&(sz)), 1, false),
          malloc_func, (void *)(&(sz)), 1, "malloc");
      void *struct_lltype = LLVMCodegen_map_type(self, base_type);
      void *cast_val =
          LLVMBuildBitCast(self->builder, malloc_val,
                           LLVMPointerType(struct_lltype, 0), "cast_val");
      void *memset_func = LLVMCodegen_get_memset(self);
      void **memset_params =
          (void **)(KaiAllocator_alloc(self->allocator, 24, 8));
      (memset_params)[0] = LLVMBuildBitCast(
          self->builder, cast_val,
          LLVMPointerType(LLVMInt8TypeInContext(self->ctx), 0), "bc");
      (memset_params)[1] =
          LLVMConstInt(LLVMInt64TypeInContext(self->ctx), 0, false);
      (memset_params)[2] =
          LLVMConstInt(LLVMInt64TypeInContext(self->ctx), 16, false);
      void **memset_param_types =
          (void **)(KaiAllocator_alloc(self->allocator, 24, 8));
      (memset_param_types)[0] =
          LLVMPointerType(LLVMInt8TypeInContext(self->ctx), 0);
      (memset_param_types)[1] = LLVMInt64TypeInContext(self->ctx);
      (memset_param_types)[2] = LLVMInt64TypeInContext(self->ctx);
      void *memset_ty =
          LLVMFunctionType(LLVMVoidTypeInContext(self->ctx),
                           (void *)(memset_param_types), 3, false);
      (void)(LLVMBuildCall2(self->builder, memset_ty, memset_func,
                            (void *)(memset_params), 3, "discard"));
      KaiAllocator_free(self->allocator, (void *)(memset_params));
      KaiAllocator_free(self->allocator, (void *)(memset_param_types));
      const char *tag_key = _kai_str_concat(
          _kai_str_concat(_kai_str_concat(base_type, "_"), mname), "_TAG");
      ...
      void *tag_gep = LLVMBuildStructGEP2(self->builder, struct_lltype,
                                          cast_val, 0, "tag_gep");
      LLVMBuildStore(
          self->builder,
          LLVMConstInt(LLVMInt8TypeInContext(self->ctx), tag_num, false),
          tag_gep);
      if (ArrayList_Int_length(&(expr.meth_args)) > 0) {
        int64_t arg_idx = ArrayList_Int_get(&(expr.meth_args), 0);
        void *val = LLVMCodegen_gen_expr(self, arg_idx);
        void *gep = LLVMBuildStructGEP2(self->builder, struct_lltype, cast_val,
                                        1, "payload_gep");
    ...
    const char *func_name =
        _kai_str_concat(_kai_str_concat(base_type, "_"), mname);
    ...
    if (((rec_type)[0] == ((char)(42))) || ((rec_type)[0] == ((char)(38)))) {
      (args)[0] = rec_val;
    } else {
      ExprNode rec_node =
          ArrayList_ExprNode_get(self->expr_pool, expr.meth_expr);
      if (rec_node.kind == ExprKind_ek_identifier) {
        ...
        void *addr = LLVMBuildAlloca(self->builder, lltype, "rec_temp");
    ...
    while (i < ArrayList_Int_length(&(expr.meth_args))) {
      (args)[(i + 1)] =
          LLVMCodegen_gen_expr(self, ArrayList_Int_get(&(expr.meth_args), i));
      i = (i + 1);
    }
    const char *ret_ktype = type_map_get(&(self->func_types), func_name);
    void *ret_ll = LLVMCodegen_map_type(self, ret_ktype);
    void **param_types =
        (void **)(KaiAllocator_alloc(self->allocator, (arg_count * 8), 8));
    (param_types)[0] =
        LLVMPointerType(LLVMCodegen_map_type(self, base_type), 0);
    i = 0;
    while (i < ArrayList_Int_length(&(expr.meth_args))) {
      const char *p_key =
          _kai_str_concat(_kai_str_concat(func_name, "_param_"), int_to_str(i));
      const char *p_ktype = type_map_get(&(self->func_param_types), p_key);
      (param_types)[(i + 1)] = LLVMCodegen_map_type(self, p_ktype);
      i = (i + 1);
    }
    void *fn_ty =
        LLVMFunctionType(ret_ll, (void *)(param_types), arg_count, false);
  ...
  if (expr.kind == ExprKind_ek_struct_init) {
    ...
    bool is_enum = ((strlen(sname) > 0) &&
                    LLVMCodegen_str_contains(self, sname, ((char)(46))));
    if (is_enum) {
      ...
      KaiAllocator_free(self->allocator, (void *)(memset_param_types));
      const char *tag_key = _kai_str_concat(
          _kai_str_concat(_kai_str_concat(enum_part, "_"), variant_name),
          "_TAG");
      const char *tag_val_str = type_map_get(&(self->enum_decls), tag_key);
      int64_t tag_num = 0;
      if (strlen(tag_val_str) > 0) {
    ...
    void *malloc_func = LLVMCodegen_get_malloc(self);
    void *sz = LLVMConstInt(LLVMInt64TypeInContext(self->ctx), 64, false);
    void *malloc_val = LLVMBuildCall2(
        self->builder,
        LLVMFunctionType(LLVMPointerType(LLVMInt8TypeInContext(self->ctx), 0),
                         (void *)(&(sz)), 1, false),
    ...
    (memset_params)[1] =
        LLVMConstInt(LLVMInt64TypeInContext(self->ctx), 0, false);
    (memset_params)[2] =
        LLVMConstInt(LLVMInt64TypeInContext(self->ctx), 64, false);
    void **memset_param_types =
        (void **)(KaiAllocator_alloc(self->allocator, 24, 8));
    (memset_param_types)[0] =
        LLVMPointerType(LLVMInt8TypeInContext(self->ctx), 0);
    (memset_param_types)[1] = LLVMInt64TypeInContext(self->ctx);
    (memset_param_types)[2] = LLVMInt64TypeInContext(self->ctx);
    void *memset_ty = LLVMFunctionType(LLVMVoidTypeInContext(self->ctx),
                                       (void *)(memset_param_types), 3, false);
    (void)(LLVMBuildCall2(self->builder, memset_ty, memset_func,
                          (void *)(memset_params), 3, "discard"));
    KaiAllocator_free(self->allocator, (void *)(memset_params));
  ...
  if (expr.kind == ExprKind_ek_borrow) {
    ...
    if (inner.kind == ExprKind_ek_field_access) {
      ...
      const char *base_type = LLVMCodegen_strip_pointers(self, rec_type);
      const char *key =
          _kai_str_concat(_kai_str_concat(base_type, "."), inner.field_name);
      const char *idx_str = type_map_get(&(self->struct_field_indices), key);
      int64_t idx = LLVMCodegen_str_to_int(self, idx_str);
      void *rec_ptr = LLVMCodegen_gen_expr(self, inner.field_expr);
      void *struct_lltype = LLVMCodegen_map_type(self, base_type);
      return LLVMBuildStructGEP2(self->builder, struct_lltype, rec_ptr, idx,
                                 "field_gep");
    }
    if (inner.kind == ExprKind_ek_index) {
      ...
      const char *arr_type = LLVMCodegen_get_expr_type(self, inner.idx_expr);
      const char *elem_ktype = "Int";
      if ((strlen(arr_type) > 2) &&
          (strcmp(substring(arr_type, 0, 2), "[]") == 0)) {
        elem_ktype = substring(arr_type, 2, strlen(arr_type));
      ...
      void *elem_lltype = LLVMCodegen_map_type(self, elem_ktype);
      return LLVMBuildGEP2(self->builder, elem_lltype, arr_ptr,
                           (void *)(&(idx_val)), 1, "idx_gep");
    }
  ...
  if (expr.kind == ExprKind_ek_array) {
    ...
    const char *elem_ktype = "Int";
    if (count > 0) {
      elem_ktype = LLVMCodegen_get_expr_type(
          self, ArrayList_Int_get(&(expr.arr_elements), 0));
    }
    void *elem_lltype = LLVMCodegen_map_type(self, elem_ktype);
    void *arr_lltype = LLVMArrayType(elem_lltype, count);
    void *addr = LLVMBuildAlloca(self->builder, arr_lltype, "arr_lit");
    int64_t i = 0;
    while (i < count) {
      void *val = LLVMCodegen_gen_expr(
          self, ArrayList_Int_get(&(expr.arr_elements), i));
      void *idx_const =
          LLVMConstInt(LLVMInt64TypeInContext(self->ctx), i, false);
      void **indices = (void **)(KaiAllocator_alloc(self->allocator, 16, 8));
      (indices)[0] = LLVMConstInt(LLVMInt64TypeInContext(self->ctx), 0, false);
      (indices)[1] = idx_const;
      void *gep = LLVMBuildGEP2(self->builder, arr_lltype, addr,
                                (void *)(indices), 2, "arr_elem_gep");
      LLVMBuildStore(self->builder, val, gep);
    ...
    void *start_gep = LLVMBuildGEP2(self->builder, arr_lltype, addr,
                                    (void *)(indices2), 2, "arr_start");
  ...
  if (expr.kind == ExprKind_ek_field_access) {
    ...
    if (base_node.kind == ExprKind_ek_identifier) {
      bool is_enum_val =
          (strlen(type_map_get(&(self->enum_decls), base_node.ident_name)) > 0);
      if (is_enum_val) {
        const char *tag_key = _kai_str_concat(
            _kai_str_concat(_kai_str_concat(base_node.ident_name, "_"),
                            expr.field_name),
            "_TAG");
        const char *tag_val_str = type_map_get(&(self->enum_decls), tag_key);
        int64_t tag_num = 0;
    ...
    const char *base_type = LLVMCodegen_strip_pointers(self, rec_type);
    const char *key =
        _kai_str_concat(_kai_str_concat(base_type, "."), expr.field_name);
    const char *idx_str = type_map_get(&(self->struct_field_indices), key);
    int64_t idx = LLVMCodegen_str_to_int(self, idx_str);
    void *rec_ptr = LLVMCodegen_gen_expr(self, expr.field_expr);
    void *struct_lltype = LLVMCodegen_map_type(self, base_type);
    void *gep = LLVMBuildStructGEP2(self->builder, struct_lltype, rec_ptr, idx,
                                    "field_gep");
    const char *ftype =
        LLVMCodegen_get_field_type(self, base_type, expr.field_name);
  ...
  if (expr.kind == ExprKind_ek_index) {
    ...
    const char *arr_type = LLVMCodegen_get_expr_type(self, expr.idx_expr);
    const char *elem_ktype = "Int";
    if ((strlen(arr_type) > 2) &&
        (strcmp(substring(arr_type, 0, 2), "[]") == 0)) {
      elem_ktype = substring(arr_type, 2, strlen(arr_type));
    } else if (strcmp(arr_type, "Str") == 0) {
      elem_ktype = "Char";
    }
    void *elem_lltype = LLVMCodegen_map_type(self, elem_ktype);
    void *gep = LLVMBuildGEP2(self->builder, elem_lltype, arr_ptr,
...
void *LLVMCodegen_gen_cast(LLVMCodegen *self, int64_t src_idx,
  ...
  if ((strlen(src_ktype) > 0) && ((src_ktype)[0] == ((char)(42)))) {
    if ((strlen(target_type) > 0) && ((target_type)[0] == ((char)(42)))) {
...
void LLVMCodegen_emit_print_call(LLVMCodegen *self, const char *ktype,
  ...
  if (strcmp(ktype, "Float") == 0) {
    ...
    fmt = "%c\n";
    void *int_val = LLVMBuildZExt(
        self->builder, val, LLVMInt32TypeInContext(self->ctx), "char_to_int");
    ...
    fmt = "%s\n";
    void *cond = LLVMBuildICmp(
        self->builder, 33, val,
        LLVMConstInt(LLVMInt64TypeInContext(self->ctx), 0, false), "bool_cond");
    void *true_str =
        LLVMBuildGlobalStringPtr(self->builder, "true", "true_str");
    void *false_str =
        LLVMBuildGlobalStringPtr(self->builder, "false", "false_str");
    void *select_str =
        LLVMBuildSelect(self->builder, cond, true_str, false_str, "select_str");
  ...
  (void)(LLVMBuildCall2(self->builder, printf_ty, printf_func, (void *)(args),
                        2, "print_call"));
  KaiAllocator_free(self->allocator, (void *)(args));
}
void LLVMCodegen_gen_match(LLVMCodegen *self, int64_t stmt_idx) {
  ...
  const char *expr_type = LLVMCodegen_get_expr_type(self, stmt.match_expr);
  void *end_bb =
      LLVMAppendBasicBlockInContext(self->ctx, self->cur_func, "match_end");
  bool is_enum = ((strlen(expr_type) > 0) &&
                  (strlen(type_map_get(&(self->enum_decls), expr_type)) > 0));
  ...
  if (has_payload) {
    ...
    void *tag_gep = LLVMBuildStructGEP2(self->builder, struct_lltype, expr_val,
                                        0, "tag_gep");
    void *loaded_tag = LLVMBuildLoad2(
        self->builder, LLVMInt8TypeInContext(self->ctx), tag_gep, "tag_val");
    tag_val = LLVMBuildZExt(self->builder, loaded_tag,
                            LLVMInt64TypeInContext(self->ctx), "tag_val_i64");
  } else if (is_enum) {
    tag_val = expr_val;
  } else {
    tag_val = expr_val;
  ...
  while (i < ArrayList_MatchCase_length(&(stmt.match_cases))) {
    ...
    PatternNode pat_node =
        ArrayList_PatternNode_get(self->pattern_pool, case_node.pattern);
    void *case_bb =
        LLVMAppendBasicBlockInContext(self->ctx, self->cur_func, "case_body");
    void *next_bb =
        LLVMAppendBasicBlockInContext(self->ctx, self->cur_func, "case_next");
    ...
    if (pat_node.kind == PatternKind_pk_else) {
      ...
      void *pat_const =
          LLVMConstInt(LLVMInt64TypeInContext(self->ctx), pat_tag, false);
      void *cmp =
          LLVMBuildICmp(self->builder, 32, tag_val, pat_const, "is_match");
      is_match =
          LLVMBuildZExt(self->builder, cmp, LLVMInt64TypeInContext(self->ctx),
                        "is_match_i64");
    } else if (pat_node.kind == PatternKind_pk_variant) {
      const char *var_name = pat_node.variant_name;
      const char *tag_key = _kai_str_concat(
          _kai_str_concat(_kai_str_concat(expr_type, "_"), var_name), "_TAG");
      const char *tag_val_str = type_map_get(&(self->enum_decls), tag_key);
      int64_t pat_tag = 0;
      if (strlen(tag_val_str) > 0) {
    ...
    void *cond_i1 = LLVMBuildICmp(
        self->builder, 33, is_match,
        LLVMConstInt(LLVMInt64TypeInContext(self->ctx), 0, false), "cond_i1");
    LLVMBuildCondBr(self->builder, cond_i1, case_bb, next_bb);
    LLVMPositionBuilderAtEnd(self->builder, case_bb);
    self->last_was_term = false;
    if ((pat_node.kind == PatternKind_pk_variant) &&
        (ArrayList_Str_length(&(pat_node.bindings)) > 0)) {
      const char *bind_var = ArrayList_Str_get(&(pat_node.bindings), 0);
      const char *bind_ktype = LLVMCodegen_get_variant_param_type(
          self, expr_type, pat_node.variant_name, 0);
      void *bind_ll = LLVMCodegen_map_type(self, bind_ktype);
      void *struct_lltype = LLVMCodegen_map_type(self, expr_type);
      void *payload_gep = LLVMBuildStructGEP2(self->builder, struct_lltype,
                                              expr_val, 1, "payload_gep");
      void *raw_payload =
          LLVMBuildLoad2(self->builder, LLVMInt64TypeInContext(self->ctx),
                         payload_gep, "raw_payload");
      void *cast_payload = raw_payload;
      if ((strcmp(bind_ktype, "Int") != 0) &&
          (strcmp(bind_ktype, "Bool") != 0)) {
        if ((strlen(bind_ktype) > 0) && ((bind_ktype)[0] == ((char)(42)))) {
          cast_payload = LLVMBuildIntToPtr(self->builder, raw_payload, bind_ll,
                                           "cast_payload");
        } else if (strcmp(bind_ktype, "Float") == 0) {
          cast_payload = LLVMBuildBitCast(self->builder, raw_payload,
                                          LLVMDoubleTypeInContext(self->ctx),
                                          "cast_payload");
        } else {
          void *ptr_ll = LLVMPointerType(bind_ll, 0);
          void *ptr_payload = LLVMBuildIntToPtr(self->builder, raw_payload,
                                                ptr_ll, "ptr_payload");
          cast_payload = LLVMBuildLoad2(self->builder, bind_ll, ptr_payload,
                                        "cast_payload");
        }
      }
      void *addr = LLVMBuildAlloca(self->builder, bind_ll,
                                   _kai_str_concat(bind_var, ".addr"));
...
void LLVMCodegen_handle_import(LLVMCodegen *self, int64_t stmt_idx) {
  ...
  if (has_source) {
    ...
    int64_t program_idx = Parser_parse_program(&(parser));
    if (program_idx >= 0) {
      LLVMCodegen_register_all_decls(self);
      LLVMCodegen_gen_stmt(self, program_idx);
    }
  }
}
const char *LLVMCodegen_get_expr_type(LLVMCodegen *self, int64_t idx) {
  ...
  if (expr.kind == ExprKind_ek_method_call) {
    ...
    bool is_enum = ((strlen(base) > 0) &&
                    (strlen(type_map_get(&(self->enum_types), base)) > 0));
    if (is_enum) {
      return base;
    }
    const char *key =
        _kai_str_concat(_kai_str_concat(base, "_"), expr.meth_name);
  ...
  if (expr.kind == ExprKind_ek_field_access) {
    ...
    if (base_node.kind == ExprKind_ek_identifier) {
      bool is_enum_val =
          (strlen(type_map_get(&(self->enum_types), base_node.ident_name)) > 0);
      if (is_enum_val) {
        return base_node.ident_name;
      }
    }
  ...
  if (expr.kind == ExprKind_ek_index) {
    ...
    if ((strlen(base_type) > 2) &&
        (strcmp(substring(base_type, 0, 2), "[]") == 0)) {
  ...
  if (expr.kind == ExprKind_ek_array) {
    ...
    if (ArrayList_Int_length(&(expr.arr_elements)) > 0) {
      const char *elem_type = LLVMCodegen_get_expr_type(
          self, ArrayList_Int_get(&(expr.arr_elements), 0));
  ...
  if (expr.kind == ExprKind_ek_borrow) {
    return _kai_str_concat("&",
                           LLVMCodegen_get_expr_type(self, expr.borrow_expr));
  }
  if (expr.kind == ExprKind_ek_deref) {
...
const char *LLVMCodegen_get_field_type(LLVMCodegen *self,
                                       ...
                                       const char *field_name) {
  const char *key =
      _kai_str_concat(_kai_str_concat(struct_name, "."), field_name);
...
bool LLVMCodegen_enum_has_payload(LLVMCodegen *self, const char *enum_name) {
  ...
  StmtNode enum_stmt = ArrayList_StmtNode_get(
      self->stmt_pool, LLVMCodegen_str_to_int(self, idx_str));
...
const char *LLVMCodegen_get_variant_param_type(LLVMCodegen *self,
  ...
  StmtNode stmt = ArrayList_StmtNode_get(self->stmt_pool,
                                         LLVMCodegen_str_to_int(self, idx_str));
  if (stmt.kind == StmtKind_sk_enum_decl) {
    int64_t i = 0;
    while (i < ArrayList_Variant_length(&(stmt.enum_variants))) {
      Variant v = ArrayList_Variant_get(&(stmt.enum_variants), i);
...
int main(int argc, char **argv) {
  ...
  if (fs_exists("/opt/homebrew/opt/llvm@21")) {
    llvm_flags = " -I /opt/homebrew/opt/llvm@21/include -L "
                 "/opt/homebrew/opt/llvm@21/lib -lLLVM";
  } else if (fs_exists("/opt/homebrew/opt/llvm@20")) {
    llvm_flags = " -I /opt/homebrew/opt/llvm@20/include -L "
                 "/opt/homebrew/opt/llvm@20/lib -lLLVM";
  }
  ...
  if (source_res.tag == Result_Str_Int_ok_TAG) {
    ...
    TypeChecker checker = TypeChecker_init(
        &(allocator), parser.stmt_pool, parser.expr_pool, parser.pattern_pool);
    bool success = TypeChecker_check_program(&(checker), program_idx);
    if (!success) {
      return 4;
    }
    if (emit_llvm) {
      LLVMCodegen gen_llvm =
          LLVMCodegen_init(&(allocator), parser.stmt_pool, parser.expr_pool,
                           parser.pattern_pool);
      ...
      if (write_res.tag == Result_Bool_Int_ok_TAG) {
        ...
        const char *cmd = _kai_str_concat(
            _kai_str_concat(_kai_str_concat("clang ", ll_file), " -o "),
            bin_name);
        {
      ...
      Codegen gen = Codegen_init(&(allocator), parser.stmt_pool,
                                 parser.expr_pool, parser.pattern_pool);
                ...
                _kai_str_concat(
                    _kai_str_concat(
                        _kai_str_concat(
                            _kai_str_concat(
                                _kai_str_concat(
                                    _kai_str_concat("clang ", exe_include_flag),
                                    llvm_flags),
                                " "),
                            opt_level),
                        " "),
